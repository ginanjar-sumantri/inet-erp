...
{
    public partial class Hotel : THotelBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._hotelBL.RowsCountPOSTrHotelHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            else
            {
                ...
                this.ListRepeater.DataSource = this._hotelBL.GetListPOSTrHotelHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //{
            bool _ex = this._hotelBL.GetSinglePOSTrHotelHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._hotelBL.DeleteMultiPOSTrHotelHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    if (_temp.Status != POSHotelDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _status.Text = HttpUtility.HtmlEncode(POSHotelDataMapper.GetStatusText((char)_temp.Status));

                Literal _suppName = (Literal)e.Item.FindControl("CustNameLiteral");
                _suppName.Text = HttpUtility.HtmlEncode(_temp.CustName);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._hotelBL.DeleteMultiApprovePOSTrHotelHd(_tempSplit, AppModule.GetValue(TransactionType.Hotel), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
