...
{
    public partial class HotelEdit : THotelBase
    {
        ...
        {
            POSTrHotelHd _posTrHotelHd = this._ticketingBL.GetSinglePOSTrHotelHd(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));

            this.TransNmbrTextBox.Text = _posTrHotelHd.TransNmbr;
            this.FileNoTextBox.Text = _posTrHotelHd.FileNmbr;
            ...
            this.BranchDropDownList.SelectedValue = _posTrHotelHd.BranchCode.ToString();
            ...
            {
                this.paymentDropDownList.SelectedValue = _posTrHotelHd.CashBankType;
            }
            ...
            this.CurrRateTextBox.Text = ((Decimal)_posTrHotelHd.ForexRate).ToString("#,##0.00");
            this.PPNPercentTextBox.Text = ((Decimal)_posTrHotelHd.PPNPercentage).ToString("#,##0.00");
            ...
            this.PPNRateTextBox.Text = ((Decimal)_posTrHotelHd.FakturPajakRate).ToString("#,##0.00");
            this.DiscountPercentageTextBox.Text = ((Decimal)_posTrHotelHd.DiscPercentage).ToString("#,##0.00");
            this.DiscForexTextBox.Text = ((Decimal)_posTrHotelHd.DiscForex).ToString("#,##0.00");
            this.CurrTextBox.Text = this.CurrCodeDropDownList.SelectedValue;
            this.AmountBaseTextBox.Text = ((Decimal)_posTrHotelHd.SubTotalForex).ToString("#,##0.00");
            this.PPNForexTextBox.Text = ((Decimal)_posTrHotelHd.PPNForex).ToString("#,##0.00");
            this.OtherForexTextBox.Text = ((Decimal)_posTrHotelHd.OtherForex).ToString("#,##0.00");
            this.TotalForexTextBox.Text = ((Decimal)_posTrHotelHd.TotalForex).ToString("#,##0.00");
        }
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if ((this.PaymentTypeDDL.SelectedValue == "AR") || (this.PaymentTypeDDL.SelectedValue == "Cash") && this.paymentDropDownList.SelectedValue != "null")
            {
                ...
                bool _result = this._ticketingBL.EditPOSTrHotelHd(_posTrHotelHd);
