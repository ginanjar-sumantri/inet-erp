<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="AirLineView.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Tour.AirLine.AirLineView" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="AirLineCodeTextBox" Width="250" BackColor="#CCCCCC"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="AirLineNameTextBox" Width="250" BackColor="#CCCCCC"
                                    ReadOnly="true"></asp:TextBox>
                            </td>
                        </tr>
                        <tr valign="top">
                                ...
                                <fieldset>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="LimitTextBox" Width="250" BackColor="#CCCCCC" ReadOnly="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
