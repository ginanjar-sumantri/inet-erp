...
{
    public partial class AirLine : AirLineBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._airLineBL.RowsCountAirLine(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._airLineBL.GetListAirLine(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._airLineBL.DeleteMulti(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsAirline _temp = (MsAirline)e.Item.DataItem;
                string _code = _temp.AirlineCode.ToString();
                ...
                Literal _airLineCode = (Literal)e.Item.FindControl("AirLineCodeLiteral");
                _airLineCode.Text = HttpUtility.HtmlEncode(_temp.AirlineCode);

                Literal _airLineName = (Literal)e.Item.FindControl("AirLineNameLiteral");
                _airLineName.Text = HttpUtility.HtmlEncode(_temp.AirlineName);
                ...
                _city.Text = HttpUtility.HtmlEncode(_temp.City);
