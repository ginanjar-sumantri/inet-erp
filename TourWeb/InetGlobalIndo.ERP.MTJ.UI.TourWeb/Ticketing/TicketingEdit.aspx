<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="TicketingEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Tour.Ticketing.TicketingEdit" %>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="FileNoTextBox" runat="server" BackColor="#CCCCCC" ReadOnly="true"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
