...
{
    public partial class Ticketing : TicketingBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._ticketingBL.RowsCountPOSTrTicketingHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._ticketingBL.GetListPOSTrTicketingHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //{
            bool _ex = this._ticketingBL.GetSinglePOSTrTicketingHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._ticketingBL.DeleteMultiPOSTrTicketingHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    if (_temp.Status != POSTicketingDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _status.Text = HttpUtility.HtmlEncode(POSTicketingDataMapper.GetStatusText((char)_temp.Status));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._ticketingBL.DeleteMultiApprovePOSTrTicketingHd(_tempSplit, AppModule.GetValue(TransactionType.Ticketing), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
