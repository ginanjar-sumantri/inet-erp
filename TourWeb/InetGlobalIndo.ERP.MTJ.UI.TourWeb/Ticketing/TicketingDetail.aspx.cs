...
{
    public partial class TicketingDetail : TicketingBase
    {
        ...
        //private string _reportPath1 = "Ticketing/TicketingPrintPreview.rdlc";
        ...
        private string _imgView = "images/view.jpg";
        ...
        public void ShowData()
        {
            ...
            byte _decimalPlace = this._currencyBL.GetDecimalPlace(_posTrTicketingHd.CurrCode);

            this.TransNoTextBox.Text = _posTrTicketingHd.TransNmbr;
            this.FileNmbrTextBox.Text = _posTrTicketingHd.FileNmbr;
            this.DateTextBox.Text = DateFormMapper.GetValue(_posTrTicketingHd.TransDate);
            this.PaymentTypeTextBox.Text = (_posTrTicketingHd.PaymentType == "AR" ? "Account Receiveable" : "Cash");
            this.BranchTextBox.Text = (_posTrTicketingHd.BranchCode == null ? "" : this._accountBL.GetSingleBranchAccount(_posTrTicketingHd.BranchCode.ToString()).BranchAccName);
            this.PaymentTextBox.Text = _paymentBL.GetPaymentName(_posTrTicketingHd.CashBankType);
            ...
            if (_posTrTicketingHd.SalesID != "")
            {
                MsEmployee _employee = this._employeeBL.GetSingleEmp(_posTrTicketingHd.SalesID);
                String _emp = "";
                if (_employee == null)
                {
                    _emp = _posTrTicketingHd.OperatorID;
                }
                else
                {
                    _emp = _employee.EmpName;
                }
                 //= _employee.EmpName == null ? "" : _employee.EmpName.ToString();
                this.SalesTextBox.Text = _emp;
                //this.SalesTextBox.Text = ((this._employeeBL.GetSingleEmp(_posTrTicketingHd.SalesID).EmpName) == DBNull.Value ? _posTrTicketingHd.OperatorID : (this._employeeBL.GetSingleEmp(_posTrTicketingHd.SalesID).EmpName));
            }
            this.RemarkTextBox.Text = _posTrTicketingHd.Remark;
            this.CurrCodeTextBox.Text = _posTrTicketingHd.CurrCode;
            this.CurrRateTextBox.Text = Convert.ToDecimal(_posTrTicketingHd.ForexRate).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.PPNPercentTextBox.Text = Convert.ToDecimal(_posTrTicketingHd.PPNPercentage).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            ...
            this.PPNRateTextBox.Text = Convert.ToDecimal(_posTrTicketingHd.FakturPajakRate).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.DiscPercentTextBox.Text = Convert.ToDecimal(_posTrTicketingHd.DiscPercentage).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.DiscForexTextBox.Text = Convert.ToDecimal(_posTrTicketingHd.DiscForex).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.CurrTextBox.Text = _posTrTicketingHd.CurrCode;
            this.AmountBaseTextBox.Text = Convert.ToDecimal(_posTrTicketingHd.SubTotalForex).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.PPNForexTextBox.Text = Convert.ToDecimal(_posTrTicketingHd.PPNForex).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.OtherForexTextBox.Text = Convert.ToDecimal(_posTrTicketingHd.OtherForex).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.TotalForexTextBox.Text = Convert.ToDecimal(_posTrTicketingHd.TotalForex).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.StatusLabel.Text = POSTicketingDataMapper.GetStatusText((char)_posTrTicketingHd.Status);
        ...
        private double RowCount()
        {
            ...
            _result = this._ticketingBL.RowsCountPOSTrTicketingDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        public void ShowDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._ticketingBL.GetListPOSTrTicketingDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == POSTicketingDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == POSTicketingDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == POSTicketingDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == POSTicketingDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == POSTicketingDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._ticketingBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == POSTicketingDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._ticketingBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == POSTicketingDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._ticketingBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._ticketingBL.DeleteMultiPOSTrTicketingDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                POSTrTicketingHd _posTrTicketingHd = _ticketingBL.GetSinglePOSTrTicketingHd(_temp.TransNmbr);
                ...
                {
                    //if (this.StatusHiddenField.Value == POSTicketingDataMapper.GetStatus(TransStatus.Posted).ToString())
                    //{
                ...
                this._permPrintPreview = this._permBL.PermissionValidation1(this._menuID, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Revisi);
                ...
                Literal _product = (Literal)e.Item.FindControl("TicketTypeLiteral");
                _product.Text = HttpUtility.HtmlEncode(_temp.TicketType);

                Literal _rrNo = (Literal)e.Item.FindControl("AirLinesLiteral");
                _rrNo.Text = HttpUtility.HtmlEncode(_airLineBL.GetSingleAirLine(_temp.AirlineCode).AirlineName);

                Literal _poNo = (Literal)e.Item.FindControl("TicketDateLiteral");
                _poNo.Text = HttpUtility.HtmlEncode(DateFormMapper.GetValue(_temp.TicketDate));

                Literal _selling = (Literal)e.Item.FindControl("SellingPriceLiteral");
                _selling.Text = HttpUtility.HtmlEncode(Convert.ToDecimal(_temp.SellingPrice).ToString("#,##0.00"));
            }
        }
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportTourBL.TicketingPrintPreview(this.TransNoTextBox.Text);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            string _result = this._ticketingBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
