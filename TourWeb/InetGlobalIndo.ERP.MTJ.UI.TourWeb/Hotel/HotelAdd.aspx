<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="HotelAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Tour.Hotel.HotelAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="HotelCodeTextBox" Width="250"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="HotelCodeRequiredFieldValidator" runat="server" ErrorMessage="HotelCode Must Be Filled"
                                    Text="*" ControlToValidate="HotelCodeTextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="HotelNameTextBox" Width="250"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="HotelNameRequiredFieldValidator" runat="server" ErrorMessage="HotelName Must Be Filled"
                                    Text="*" ControlToValidate="HotelNameTextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="EmailTextBox"
                                                    Text="*" ErrorMessage="You must enter an valid email address" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">
