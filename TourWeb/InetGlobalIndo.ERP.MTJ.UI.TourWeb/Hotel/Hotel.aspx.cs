...
{
    public partial class Hotel : HotelBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._HotelBL.RowsCountPOSMsHotel(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._HotelBL.GetListPOSMsHotel(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._HotelBL.DeleteMulti(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsHotel _temp = (POSMsHotel)e.Item.DataItem;
                string _code = _temp.HotelCode.ToString();
                ...
                Literal _hotelCode = (Literal)e.Item.FindControl("HotelCodeLiteral");
                _hotelCode.Text = HttpUtility.HtmlEncode(_temp.HotelCode);

                Literal _hotelName = (Literal)e.Item.FindControl("HotelNameLiteral");
                _hotelName.Text = HttpUtility.HtmlEncode(_temp.HotelName);

                Literal _address = (Literal)e.Item.FindControl("AddressLiteral");
                _address.Text = HttpUtility.HtmlEncode(_temp.Address1);

                Literal _city = (Literal)e.Item.FindControl("CityLiteral");
                _city.Text = HttpUtility.HtmlEncode(_cityBL.GetCityNameByCode(_temp.CityCode));

                Literal _telephone = (Literal)e.Item.FindControl("TelephoneLiteral");
                _telephone.Text = HttpUtility.HtmlEncode(_temp.Telephone);
            }
        }
