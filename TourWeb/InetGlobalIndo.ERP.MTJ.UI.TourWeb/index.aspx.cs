...
public partial class index : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.ModuleTitleLiteral.Text = "Tour";
        ...
        if (!this.Page.IsPostBack)
        {
            ...
            _topNavigationMenu.RenderItem(0, _roles, ERPModule.Tour, this.Menu2, new UserBL().GetCompanyId(HttpContext.Current.User.Identity.Name));
