...
{
    public sealed class LeaveTempBL : Base
    {
        public LeaveTempBL()
        {
        ...
        public double RowsCountLeaveAdd(string _prmCategory, string _prmKeyword)
        {
            ...
            try
            {
                String _type = LeaveAddDataMapper.GetTypeText(LeaveType.Temp);
            ...
            try
            {
                using (TransactionScope _scope = new TransactionScope())
                {
                    ...
                    if (_result == "")
                    {
                        ...
                        _transActivity.TransType = AppModule.GetValue(TransactionType.HRMLeaveAdd);
                        _transActivity.TransNmbr = _prmCode.ToString();
                        _transActivity.FileNmbr = _leaveAdd.FileNmbr;
                        _transActivity.Username = _prmuser;
        ...
        public string Posting(string _prmCode, string _prmuser)
        {
            ...
            try
            {
                ...
                if (_result == "")
                {
                    ...
                    _transActivity.TransType = AppModule.GetValue(TransactionType.HRMLeaveAdd);
                    _transActivity.TransNmbr = _prmCode.ToString();
                    _transActivity.FileNmbr = this.GetSingleLeaveAdd(_prmCode).FileNmbr;
                    _transActivity.Username = _prmuser;
