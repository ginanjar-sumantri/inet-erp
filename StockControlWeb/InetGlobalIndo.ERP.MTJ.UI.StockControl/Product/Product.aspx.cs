    ...
    public partial class Product : ProductBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.ImportButton1.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/import_excel.jpg";
        ...
        private double RowCount()
        {
            ...
            _result = this._productBL.RowsCountProduct(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        {
            this.GetFormatExcelLiteral.Text = "<a href='" + ApplicationConfig.StockControlFormatVirDirPath + "Product.xls'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download_excel.jpg" + "' border='0'>" + "</a>";
            this.GetFormatExcelSalesPriceLiteral.Text = "<a href='" + ApplicationConfig.StockControlFormatVirDirPath + "ProductSalesPrice.xls'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download_excel.jpg" + "' border='0'>" + "</a>";
            ...
            {
                this.ListRepeater.DataSource = this._productBL.GetListProduct(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Literal _productBLCode = (Literal)e.Item.FindControl("ProductCodeLiteral");
                _productBLCode.Text = HttpUtility.HtmlEncode(_temp.ProductCode);

                Literal _productBLName = (Literal)e.Item.FindControl("ProductNameLiteral");
                _productBLName.Text = HttpUtility.HtmlEncode(_temp.ProductName);

                Literal _productBLSubGroup = (Literal)e.Item.FindControl("ProductSubGroupLiteral");
                _productBLSubGroup.Text = HttpUtility.HtmlEncode(_temp.ProductSubGroupName);

                Literal _productBLType = (Literal)e.Item.FindControl("ProductTypeLiteral");
                _productBLType.Text = HttpUtility.HtmlEncode(_temp.ProductTypeName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._productBL.DeleteMultiProduct(_tempSplit);
        ...
        protected void ImportButton2_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect(this._importPage2);
        }
    }
}