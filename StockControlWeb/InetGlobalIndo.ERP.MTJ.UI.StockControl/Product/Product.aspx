<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="Product.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Product.Product" %>
                                ...
                                <table cellpadding="3" cellspacing="0" width="100%" border="0">
                                    <tr>
                                        <td>
                                            ...
                                            &nbsp;<asp:Literal runat="server" ID="GetFormatExcelSalesPriceLiteral" />
                                            &nbsp;<asp:ImageButton runat="server" ID="ImportButton1" OnClick="ImportButton2_Click" />
                                        </td>
                                        <td align="right">
