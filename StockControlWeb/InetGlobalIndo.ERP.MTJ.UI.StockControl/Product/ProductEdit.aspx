<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ProductEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Product.ProductEdit" %>
                                ...
                                <table cellpadding="3" cellspacing="0" width="0" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Product Sub Group Must Be Filled"
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="SellingPriceTextBox" Width="150"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
