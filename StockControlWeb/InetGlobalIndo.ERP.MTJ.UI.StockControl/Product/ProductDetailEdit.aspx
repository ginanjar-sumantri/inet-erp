<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ProductDetailEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Product.ProductDetailEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="UnitConvertTextBox" runat="server"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="RateTextBox" MaxLength="18" Width="150"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="UnitTextBox" Width="210" ReadOnly="true" BackColor="#CCCCCC">
                                </asp:TextBox>
                            </td>
                        </tr>
                        <tr>
