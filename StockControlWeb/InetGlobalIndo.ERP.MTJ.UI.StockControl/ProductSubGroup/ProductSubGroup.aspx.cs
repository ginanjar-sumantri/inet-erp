...
{
    public partial class ProductSubGroup : ProductSubGroupBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._productSubGroupBL.RowsCountProductSubGroup(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        //{
        //    double q = this._productSubGroupBL.RowsCountProductSubGroup(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._productSubGroupBL.GetListProductSubGroup(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string _code = _temp.ProductSubGrpCode.ToString();
                ...
                Literal _productSubGroupBLCode = (Literal)e.Item.FindControl("ProductSubGroupCodeLiteral");
                _productSubGroupBLCode.Text = HttpUtility.HtmlEncode(_temp.ProductSubGrpCode);

                Literal _productSubGroupBLName = (Literal)e.Item.FindControl("ProductSubGroupNameLiteral");
                _productSubGroupBLName.Text = HttpUtility.HtmlEncode(_temp.ProductSubGrpName);

                Literal _productGroup = (Literal)e.Item.FindControl("ProductGroupLiteral");
                _productGroup.Text = _productSubGroupBL.GetProductGroupNameByCode(_temp.ProductGroup);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._productSubGroupBL.DeleteMultiProductSubGroup(_tempSplit);
