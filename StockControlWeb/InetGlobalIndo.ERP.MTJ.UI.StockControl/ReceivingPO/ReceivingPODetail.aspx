<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReceivingPODetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.ReceivingPO.ReceivingPODetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="CarNoTextBox" ReadOnly="true" BackColor="#CCCCCC"
                                        MaxLength="30" Width="210"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="DriverTextBox" ReadOnly="true" BackColor="#CCCCCC"
                                        MaxLength="40" Width="280"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="SJSuppNoTextBox" ReadOnly="true" BackColor="#CCCCCC"
                                        MaxLength="30" Width="210"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="SubledTextBox" Width="280px" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="SJSuppDateTextBox" Width="100" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:CheckBox ID="FgLocationCheckBox" runat="server" Text="Single Location" Enabled="false" />
                                    <asp:TextBox ID="WrhsLocationTextBox" runat="server" ReadOnly="true" BackColor="#CCCCCC"
