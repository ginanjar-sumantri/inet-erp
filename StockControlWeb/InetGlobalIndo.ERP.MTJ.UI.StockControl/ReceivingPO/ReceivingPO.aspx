<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReceivingPO.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.ReceivingPO.ReceivingPO" %>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 200px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Supplier" ID="field5" class="SortLinkButton" runat="server"
                                                    OnClick="field5_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 160px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="PO No." ID="field6" class="SortLinkButton" runat="server" OnClick="field6_Click"></asp:LinkButton></b>
                                        </td>
                                        <%--<td style="width: 80px" class="tahoma_11_white" align="center">
                                            <b>Warehouse</b>
                                        </td>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="WrhsSubledLiteral"></asp:Literal>
                                                </td>--%>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
