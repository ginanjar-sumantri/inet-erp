...
{
    public partial class ReceivingPODetail : ReceivingPOBase
    {
        ...
        public void ShowData()
        {
            ...
            else
            {
                ...
                {
                    this.SubledTextBox.Text = _custBL.GetNameByCode(_stcReceiveHd.WrhsSubLed);
                }
                else if (_stcReceiveHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
                {
                    this.SubledTextBox.Text = _suppBL.GetSuppNameByCode(_stcReceiveHd.WrhsSubLed);
                }
            }
            ...
            this.WrhsLocationTextBox.Text = _warehouseBL.GetWarehouseLocationNameByCode(_stcReceiveHd.LocationCode);

            this.StatusHiddenField.Value = _stcReceiveHd.Status.ToString();
            this.StatusLabel.Text = ReceivingPODataMapper.GetStatusText(_stcReceiveHd.Status);
        ...
        private double RowCount()
        {
            ...
            _result = this._receivingPOBL.RowsCountSTCReceiveDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        public void ShowDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._receivingPOBL.GetListSTCReceiveDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text);
            }
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == ReceivingPODataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCReceiveHd _temp2 = this._receivingPOBL.GetSingleSTCReceiveHd(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
                STCReceiveDt _temp = (STCReceiveDt)e.Item.DataItem;

                string _code1 = _temp.ProductCode.ToString();
                string _code2 = _temp.LocationCode.ToString();
                string _code3 = _temp2.PONo.ToString();
                ...
                if (this.StatusHiddenField.Value != ReceivingPODataMapper.GetStatus(TransStatus.Posted).ToString())
                {
                    _editButton.PostBackUrl = this._editDetailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)) + "&" + this._productKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code1, ApplicationConfig.EncryptionKey)) + "&" + this._locationKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code2, ApplicationConfig.EncryptionKey)) + "&" + this._codeKey2 + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code3, ApplicationConfig.EncryptionKey));
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == ReceivingPODataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == ReceivingPODataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == ReceivingPODataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == ReceivingPODataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == ReceivingPODataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._receivingPOBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            {
                string _result = this._receivingPOBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
                ...
                {
                    this.WarningLabel.Text = "Approve Success";
                }
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == ReceivingPODataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._receivingPOBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
                ...
                {
                    this.WarningLabel.Text = "Posting Success";
                }
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == ReceivingPODataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.ReasonPanel.Visible = true;
                //string _result = this._receivingPOBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
                ...
                //else
                //{
                //    this.WarningLabel.Text = "Unposting Success";
                //}
            }
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportStockControlBL.ReceivingPOPrintPreview(_transNo);

            this.ReportViewer1.LocalReport.DataSources.Clear();
            this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);

            string _path = _reportListBL.GetPathPrintPreview(AppModule.GetValue(TransactionType.ReceivingPO), _userBL.GetCompanyId(HttpContext.Current.User.Identity.Name));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            String _result = this._receivingPOBL.DeleteMultiSTCReceiveDt(_tempsplit, this.TransNoTextBox.Text);

            if (_result != "")
            {
                if (_result.Substring(0, 5) == ApplicationConfig.Error)
                {
                    _error = _result.Substring(6, _result.Length - 6);
                }
            }
            else
            {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.ReceivingPO), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.WarningLabel.Text = _result;
