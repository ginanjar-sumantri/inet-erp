...
{
    public partial class StockTypeFileView : StockTypeFileBase
    {
        ...
        private void ShowData()
        {
            ...
            this.AccountNameTextBox.Text = _accountBL.GetAccountNameByCode(AccountTextBox.Text);
        }
        ...
        private void ShowTransType(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._stockTypeBL.GetListTransTypeForStockType(_prmCurrentPage, _maxrow, this.StockTypeCodeTextBox.Text);
        ...
        {
            Response.Redirect(this._addDtPage + "?" + _codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)));
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockTypeBL.DeleteMultiStockTypeDt(_tempsplit, this.StockTypeCodeTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsStockTypeDt _temp = (MsStockTypeDt)e.Item.DataItem;

                string _code = _temp.TransType.ToString();
                ...
                Literal _transTypeCode = (Literal)e.Item.FindControl("TransTypeCode");
                _transTypeCode.Text = HttpUtility.HtmlEncode(_temp.TransType);

                Literal _transTypeName = (Literal)e.Item.FindControl("TransTypeName");
                _transTypeName.Text = HttpUtility.HtmlEncode(_temp.TransTypeName);

                Literal _fgAccount = (Literal)e.Item.FindControl("FgAccount");
                _fgAccount.Text = HttpUtility.HtmlEncode(_temp.FgAccount.ToString());
            }
        }
        ...
        private double RowCount()
        {
            ...
            _result = this._stockTypeBL.RowsCountForStockTypeDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void DataPagerTopRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "DataPager")
            {
                ...
                this.ShowTransType(Convert.ToInt32(e.CommandArgument));
            }
        }
