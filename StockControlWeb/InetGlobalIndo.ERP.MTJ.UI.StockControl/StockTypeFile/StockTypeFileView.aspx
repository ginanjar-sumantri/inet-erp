<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockTypeFileView.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockTypeFile.StockTypeFileView" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="StockTypeCodeTextBox" Width="100" MaxLength="10" ReadOnly="true"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="StockTypeNameTextBox" Width="350" MaxLength="50"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="AccountTextBox" ReadOnly="true" BackColor="#CCCCCC"
                                        Width="100"></asp:TextBox>
                                    <asp:TextBox runat="server" ID="AccountNameTextBox" ReadOnly="true" BackColor="#CCCCCC"
