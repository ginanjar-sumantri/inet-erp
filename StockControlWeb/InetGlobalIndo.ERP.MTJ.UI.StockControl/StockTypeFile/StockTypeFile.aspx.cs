...
{
    public partial class StockTypeFile : StockTypeFileBase
    {
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockTypeBL.DeleteMultiStockType(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsStockType _temp = (MsStockType)e.Item.DataItem;

                string _code = _temp.StockTypeCode.ToString();
                ...
                Literal _stockTypeCode = (Literal)e.Item.FindControl("StockTypeCodeLiteral");
                _stockTypeCode.Text = HttpUtility.HtmlEncode(_temp.StockTypeCode);

                Literal _stockTypeName = (Literal)e.Item.FindControl("StockTypeNameLiteral");
                _stockTypeName.Text = HttpUtility.HtmlEncode(_temp.StockTypeName);

                Literal _account = (Literal)e.Item.FindControl("AccountLiteral");
                _account.Text = this._accountBL.GetAccountNameByCode(_temp.Account);
        ...
        private double RowCount()
        {
            ...
            _result = this._stockTypeBL.RowsCountStockType(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockTypeBL.GetListStockType(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
