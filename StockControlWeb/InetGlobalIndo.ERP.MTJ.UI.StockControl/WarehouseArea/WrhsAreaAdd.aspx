<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="WrhsAreaAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.WarehouseArea.WrhsAreaAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="WrhsAreaCodeTextBox" Width="100" MaxLength="10"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="WrhsAreaCodeRequiredFieldValidator" runat="server"
                                    ErrorMessage="Warehouse Area Code Must Be Filled" Text="*" ControlToValidate="WrhsAreaCodeTextBox"
