...
{
    public partial class WrhsArea : WarehouseAreaBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._wrhsArea.RowsCountWrhsArea(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._wrhsArea.GetListWrhsArea(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsWrhsArea _temp = (MsWrhsArea)e.Item.DataItem;

                string _code = _temp.WrhsAreaCode.ToString();
                ...
                Literal _wrhsAreaCode = (Literal)e.Item.FindControl("WrhsAreaCodeLiteral");
                _wrhsAreaCode.Text = HttpUtility.HtmlEncode(_temp.WrhsAreaCode);

                Literal _wrhsAreaName = (Literal)e.Item.FindControl("WrhsAreaNameLiteral");
                _wrhsAreaName.Text = HttpUtility.HtmlEncode(_temp.WrhsAreaName);

                Literal _address1 = (Literal)e.Item.FindControl("Address1Literal");
                _address1.Text = HttpUtility.HtmlEncode(_temp.Address1);

                Literal _address2 = (Literal)e.Item.FindControl("Address2Literal");
                _address2.Text = HttpUtility.HtmlEncode(_temp.Address2);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._wrhsArea.DeleteMultiWrhsArea(_tempSplit);
