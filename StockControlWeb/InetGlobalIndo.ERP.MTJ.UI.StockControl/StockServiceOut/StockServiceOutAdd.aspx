<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockServiceOutAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockServiceOut.StockServiceOutAdd" %>
                    ...
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="CustomerCustomValidator" runat="server" ErrorMessage="Customer Must Be Filled"
                                    Text="*" ClientValidationFunction="DropDownValidation" ControlToValidate="CustomerDropDownList"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="ReceivedByTextBox" Width="210" MaxLength="30"></asp:TextBox>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td>
