...
{
    public partial class StockServiceOut : StockServiceOutBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockServiceOutBL.RowsCountSTCServiceOutHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockServiceOutBL.GetListSTCServiceOutHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text.Trim());
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCServiceOutHd _temp = (STCServiceOutHd)e.Item.DataItem;
                ...
                if (_tempStatus.ToLower() == StockServiceOutDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
                ...
                _rRNoLiteral.Text = HttpUtility.HtmlEncode(_temp.RRNo);
                ...
                _statusLiteral.Text = HttpUtility.HtmlEncode(StockServiceOutDataMapper.GetStatusText(_temp.Status));
                ...
                Literal _issuedByLiteral = (Literal)e.Item.FindControl("IssuedByLiteral");
                _issuedByLiteral.Text = HttpUtility.HtmlEncode(_temp.IssuedBy);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockServiceOutBL.GetSingleSTCServiceOutHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockServiceOutBL.DeleteMultiSTCServiceOutHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockServiceOutBL.DeleteMultiApproveSTCServiceOutHd(_tempSplit, AppModule.GetValue(TransactionType.StockServiceOut), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
