<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockTransferExternalRRDetailEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockTransferExternalRR.StockTransferExternalRRDetailEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="QtySJTextBox" runat="server" Width="150" MaxLength="18" BackColor="#CCCCCC"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="QtyLossTextBox" runat="server" Width="150" BackColor="#CCCCCC"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
