...
{
    public partial class StockTransferExternalRR : StockTransferExternalRRBase
    {
        private WarehouseBL _wrhs = new WarehouseBL();
        private StockTransferExternalSJBL _stcTransOutBL = new StockTransferExternalSJBL();
        private StockTransferExternalRRBL _stcTransEx = new StockTransferExternalRRBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._stcTransEx.RowsCountSTCTransInHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stcTransEx.GetListSTCTransInHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stcTransEx.GetSingleSTCTransInHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stcTransEx.DeleteMultiSTCTransInHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCTransInHd _temp = (STCTransInHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockTransferExternalRRDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockTransferExternalRRDataMapper.GetStatusText(_temp.Status));
                ...
                Literal _transReff = (Literal)e.Item.FindControl("TransReffLiteral");
                _transReff.Text = HttpUtility.HtmlEncode(_temp.FileNoTransReff);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stcTransEx.DeleteMultiApproveSTCTransInHd(_tempSplit, AppModule.GetValue(TransactionType.StockTransferExternalRR), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
