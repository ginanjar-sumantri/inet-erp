<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockTransferExternalRRDetailAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockTransferExternalRR.StockTransferExternalRRDetailAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="DefaultHeadContentPlaceHolder" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function CountQtyLoss(_prmQtySJ, _prmQty, _prmQtyLoss)
        {
            _prmQtyLoss.value = parseInt(_prmQtySJ.value) - _prmQty.value;
            
            return _prmQtyLoss.value;
        }
    </script>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="LocationSrcDropDownList" runat="server" AutoPostBack="true"
                                    OnSelectedIndexChanged="LocationSrcDropDownList_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:CustomValidator runat="server" ID="CustomValidator2" ClientValidationFunction="DropDownValidation"
                                    ControlToValidate="LocationSrcDropDownList" Text="*" ErrorMessage="Location Src Must Be Choosed"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator runat="server" ID="CustomValidator3" ClientValidationFunction="DropDownValidation"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="QtySJTextBox" runat="server" BackColor="#CCCCCC" Width="150" MaxLength="18"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="QtyLossTextBox" runat="server" Width="150" MaxLength="18" BackColor="#CCCCCC"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
