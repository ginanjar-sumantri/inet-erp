...
{
    public partial class StockTransferExternalRRDetail : StockTransferExternalRRBase
    {
        ...
        private string _reportPath1 = "StockTransferExternalRR/JournalEntryPrintPreview.rdlc";
        private string _reportPath2 = "StockTransferExternalRR/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stcTransInBL.RowsCountSTCTransInDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stcTransInBL = new StockTransferExternalRRBL();
            ...
            this.SJNoTextBox.Text = _stcTransOutBL.GetFileNmbrFromSTCTransOut(_stcTransInHd.TransReff);
            this.WrhsSrcTextBox.Text = _wrhs.GetWarehouseNameByCode(_stcTransInHd.WrhsSrc);
            ...
            this.WrhsDestTextBox.Text = _wrhs.GetWarehouseNameByCode(_stcTransInHd.WrhsDest);
            ...
            this.StatusHiddenField.Value = _stcTransInHd.Status.ToString();
            this.StatusLabel.Text = StockTransferExternalRRDataMapper.GetStatusText(_stcTransInHd.Status);
            ...
            {
                this.ListRepeater.DataSource = this._stcTransInBL.GetListSTCTransInDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text);
            }
            this.ListRepeater.DataBind();

            this.AllCheckBox.Checked = this.IsCheckedAll();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalRRDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalRRDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalRRDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalRRDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalRRDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalRRDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stcTransInBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalRRDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stcTransInBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalRRDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stcTransInBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalRRDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stcTransInBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportStockControlBL.STTransReceivingPrintPreview(this.TransNoTextBox.Text);

            this.ReportViewer1.LocalReport.DataSources.Clear();
            this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);

            string _path = _reportListBL.GetPathPrintPreview(AppModule.GetValue(TransactionType.StockTransferExternalRR), _userBL.GetCompanyId(HttpContext.Current.User.Identity.Name));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stcTransInBL.DeleteMultiSTCTransInDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCTransInDt _temp = (STCTransInDt)e.Item.DataItem;
                ...
                if (this.StatusHiddenField.Value.ToLower() != StockTransferExternalRRDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
                ...
                _location.Text = HttpUtility.HtmlEncode(_wrhs.GetWarehouseLocationNameByCode(_temp.LocationCode));

                Literal _qtySJ = (Literal)e.Item.FindControl("QtySJLiteral");
                _qtySJ.Text = HttpUtility.HtmlEncode((_temp.QtySJ == 0) ? "0" : _temp.QtySJ.ToString("#,##0.##"));

                Literal _qty = (Literal)e.Item.FindControl("QtyLiteral");
                _qty.Text = HttpUtility.HtmlEncode((_temp.Qty == 0) ? "0" : _temp.Qty.ToString("#,##0.##"));

                Literal _qtyLoss = (Literal)e.Item.FindControl("QtyLossLiteral");
                _qtyLoss.Text = HttpUtility.HtmlEncode((_temp.QtyLoss == 0) ? "0" : _temp.QtyLoss.ToString("#,##0.##"));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.StockTransferExternalRR), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.WarningLabel.Text = _result;
