<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockTransferExternalRRDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockTransferExternalRR.StockTransferExternalRRDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="SJNoTextBox" runat="server" Width="150" ReadOnly="true" BackColor="#CCCCCC">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="DriverTextBox" MaxLength="40" Width="280" ReadOnly="true"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="CarNoTextBox" MaxLength="30" Width="210" ReadOnly="true"
                                        BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="right">
                                                        <asp:Literal runat="server" ID="QtyLossLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="left">
