...
{
    public partial class StockOpname : StockOpnameBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockOpnameBL.RowsCountSTCOpnameHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockOpnameBL.GetListSTCOpnameHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCOpnameHd _temp = (STCOpnameHd)e.Item.DataItem;
                ...
                if (_tempStatus.ToLower() == StockOpnameDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
                ...
                _statusLiteral.Text = HttpUtility.HtmlEncode(StockOpnameDataMapper.GetStatusText(_temp.Status));

                Literal _warehouseLiteral = (Literal)e.Item.FindControl("WarehouseLiteral");
                _warehouseLiteral.Text = this._warehouseBL.GetWarehouseNameByCode(_temp.WrhsCode);
                ...
                Literal _operatorLiteral = (Literal)e.Item.FindControl("OperatorLiteral");
                _operatorLiteral.Text = HttpUtility.HtmlEncode(_temp.Operator);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockOpnameBL.GetSingleSTCOpnameHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockOpnameBL.DeleteMultiSTCOpnameHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockOpnameBL.DeleteMultiApproveSTCOpnameHd(_tempSplit, AppModule.GetValue(TransactionType.StockOpname), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
