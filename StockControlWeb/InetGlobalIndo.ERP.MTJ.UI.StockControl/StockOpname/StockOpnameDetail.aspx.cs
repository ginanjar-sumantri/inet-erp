...
{
    public partial class StockOpnameDetail : StockOpnameBase
    {
        ...
        private string _reportPath1 = "StockOpname/STOpnamePrintPreview.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stockOpnameBL.RowsCountSTCOpnameDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stockOpnameBL = new StockOpnameBL();
            ...
            this.WarehouseTextBox.Text = this._warehouseBL.GetWarehouseNameByCode(_stcOpnameHd.WrhsCode);

            if (_stcOpnameHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
            {
                this.WarehouseSubledTextBox.Text = this._customerBL.GetNameByCode(_stcOpnameHd.WrhsSubLed);
            }
            else if (_stcOpnameHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
            {
                this.WarehouseSubledTextBox.Text = this._supplierBL.GetSuppNameByCode(_stcOpnameHd.WrhsSubLed);
            }
            ...
            this.StatusLabel.Text = StockOpnameDataMapper.GetStatusText(_stcOpnameHd.Status);
            this.StatusHiddenField.Value = _stcOpnameHd.Status.ToString();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockOpnameDataMapper.GetStatus(TransStatus.Posted).ToString().Trim().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockOpnameDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockOpnameDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockOpnameDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockOpnameDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        public void ShowDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockOpnameBL.GetListSTCOpnameDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCOpnameDt _temp = (STCOpnameDt)e.Item.DataItem;
                ...
                if (this.StatusHiddenField.Value.Trim().ToLower() == StockOpnameDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
                ...
                Literal _qtySystemLiteral = (Literal)e.Item.FindControl("QtySystemLiteral");
                _qtySystemLiteral.Text = HttpUtility.HtmlEncode((_temp.QtySystem == 0) ? "0" : _temp.QtySystem.ToString("#,##0.##"));

                Literal _qtyActualLiteral = (Literal)e.Item.FindControl("QtyActualLiteral");
                _qtyActualLiteral.Text = HttpUtility.HtmlEncode((_temp.QtyActual == 0) ? "0" : _temp.QtyActual.ToString("#,##0.##"));

                Literal _qtyOpnameLiteral = (Literal)e.Item.FindControl("QtyOpnameLiteral");
                _qtyOpnameLiteral.Text = HttpUtility.HtmlEncode((_temp.QtyOpname == 0) ? "0" : _temp.QtyOpname.ToString("#,##0.##"));
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportStock.STOpnamePrintPreview(this.TransNoTextBox.Text);
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockOpnameDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stockOpnameBL.GetApproval(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockOpnameDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stockOpnameBL.Approve(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockOpnameDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stockOpnameBL.Posting(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockOpnameDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stockOpnameBL.UnPosting(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockOpnameBL.DeleteMultiSTCOpnameDt(_tempsplit, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.StockOpname), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.Label.Text = _result;
