<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockReceivingOtherEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockReceivingOther.StockReceivingOtherEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="WarehouseDropDownList">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="ReceiveFromTextBox" Width="280" MaxLength="40"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
