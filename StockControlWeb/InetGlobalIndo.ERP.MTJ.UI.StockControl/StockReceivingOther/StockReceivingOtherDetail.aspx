<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockReceivingOtherDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockReceivingOther.StockReceivingOtherDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="StockTypeTextBox" Width="350" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="ReceiveFromTextBox" Width="280" MaxLength="40" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="CarNoTextBox" Width="210" MaxLength="30" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="DriverTextBox" Width="280" MaxLength="40" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="SJNoTextBox" Width="210" MaxLength="30" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="SJDateTextBox" Width="100" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td>
