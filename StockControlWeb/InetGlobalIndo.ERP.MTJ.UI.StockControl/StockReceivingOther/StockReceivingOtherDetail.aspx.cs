...
{
    public partial class StockReceivingOtherDetail : StockReceivingOtherBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockReceivingOtherBL.RowsCountSTCRROtherDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stockReceivingOtherBL = new StockReceivingOtherBL();
            ...
            this.StatusLabel.Text = StockReceivingOtherDataMapper.GetStatusText(_stcRROtherHd.Status);
            this.StatusHiddenField.Value = _stcRROtherHd.Status.ToString();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingOtherDataMapper.GetStatus(TransStatus.Posted).ToString().Trim().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingOtherDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingOtherDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingOtherDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingOtherDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        //{
        //    double q = this._stockReceivingOtherBL.RowsCountSTCRROtherDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        public void ShowDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockReceivingOtherBL.GetListSTCRROtherDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingOtherDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingOtherDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stockReceivingOtherBL.GetApproval(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingOtherDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stockReceivingOtherBL.Approve(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingOtherDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stockReceivingOtherBL.Posting(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingOtherDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stockReceivingOtherBL.UnPosting(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string _path = _reportListBL.GetPathPrintPreview(AppModule.GetValue(TransactionType.StockReceivingOther), _userBL.GetCompanyId(HttpContext.Current.User.Identity.Name));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockReceivingOtherBL.DeleteMultiSTCRROtherDt(_tempsplit, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.StockReceivingOther), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.Label.Text = _result;
