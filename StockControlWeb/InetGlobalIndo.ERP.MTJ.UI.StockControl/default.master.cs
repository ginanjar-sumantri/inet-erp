...
public partial class _default : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.Page.IsPostBack == true)
        {
            ...
            //this.Menu1.Items.Add(_quickLaunchNavMenu.RenderItem(25, AppModule.GetValue(ERPModule.StockControl), "administrators", null));
            //_quickLaunchNavMenu.Dispose();

            //string _imageUrl = ApplicationConfig.HomeWebAppURL + "images/stock_control_small.jpg";
            //string _titleTree = "&nbsp;Stock Control";
            //QuickLaunchNavigationMenu _quickLaunchNavNode = new QuickLaunchNavigationMenu();
            //this.TreeView1.ShowLines = true;
            //this.TreeView1.Nodes.Add(_quickLaunchNavNode.RenderNode(25, AppModule.GetValue(ERPModule.StockControl), "administrators", null, _imageUrl, _titleTree));
            //_quickLaunchNavNode.Dispose();

            //string _dir = Request.ServerVariables["appl_physical_path"];
            //string _title = "stock control";
            //QuickLaunchNavigationMenu _quicklaunchsitemapPath = new QuickLaunchNavigationMenu();
            //_quicklaunchsitemapPath.GenerateSiteMapPath(25, AppModule.GetValue(ERPModule.StockControl), "administrators", null, _dir, _title, 25);
            ...
            //_topNavigationMenu.RenderItem(0, _roles, ERPModule.StockControl, this.Menu2, new UserBL().GetCompanyId(HttpContext.Current.User.Identity.Name));
