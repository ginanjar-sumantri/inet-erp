...
{
    public partial class StockIssueRequestFA : StockIssueRequestFABase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockIssueFABL.RowsCountSTCRequestHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockIssueFABL.GetListSTCRequestHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockIssueFABL.GetSingleSTCRequestHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockIssueFABL.DeleteMultiSTCRequestHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCRequestHd _temp = (STCRequestHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockIssueRequestFADataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockIssueRequestFADataMapper.GetStatusText(_temp.Status));

                Literal _orgUnitDesc = (Literal)e.Item.FindControl("OrgUnitDescLiteral");
                _orgUnitDesc.Text = HttpUtility.HtmlEncode(_temp.Description);

                Literal _requestBy = (Literal)e.Item.FindControl("RequestByLiteral");
                _requestBy.Text = HttpUtility.HtmlEncode(_temp.RequestBy);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockIssueFABL.DeleteMultiApproveSTCRequestHd(_tempSplit, AppModule.GetValue(TransactionType.StockIssueRequestFA), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
