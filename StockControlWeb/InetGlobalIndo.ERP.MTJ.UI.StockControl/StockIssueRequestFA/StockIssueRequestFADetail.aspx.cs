...
{
    public partial class StockIssueRequestFADetail : StockIssueRequestFABase
    {
        ...
        //private string _reportPath1 = "StockIssueRequestFA/STRequestFAPrintPreview.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stockIssueFABL.RowsCountSTCRequestDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stockIssueFABL = new StockIssueRequestFABL();
            STCRequestHd _stcRequestHd = this._stockIssueFABL.GetSingleSTCRequestHd(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            ...
            this.StatusLabel.Text = StockIssueRequestFADataMapper.GetStatusText(_stcRequestHd.Status);
            ...
            {
                this.ListRepeater.DataSource = this._stockIssueFABL.GetListSTCRequestDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text);
            }
            this.ListRepeater.DataBind();

            this.AllCheckBox.Checked = this.IsCheckedAll();
            
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestFADataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestFADataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestFADataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestFADataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestFADataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockIssueFABL.DeleteMultiSTCRequestDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if ((this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestFADataMapper.GetStatus(TransStatus.Posted).ToString().ToLower()) && (_temp.DoneClosing.ToString().Trim().ToLower() == StockIssueRequestFADataMapper.GetStatusDetail(StockIssueRequestFAStatusDt.Open).ToString().Trim().ToLower()) && _temp.Qty > (((_temp.QtyWIS == null) ? 0 : _temp.QtyWIS) + ((_temp.QtyClose == null) ? 0 : _temp.QtyClose)))
                {
                ...
                _doneClosing.Text = HttpUtility.HtmlEncode(StockIssueRequestFADataMapper.GetStatusTextDetail(_doneClose1));
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportStockControlBL.STRequestFAPrintPreview(this.TransNoTextBox.Text);

            this.ReportViewer1.LocalReport.DataSources.Clear();
            this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);

            string _path = _reportListBL.GetPathPrintPreview(AppModule.GetValue(TransactionType.StockIssueRequestFA), _userBL.GetCompanyId(HttpContext.Current.User.Identity.Name));
        ...
        protected void ListRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "CloseButton")
            {
                ...
                string _result = this._stockIssueFABL.Closing(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), e.CommandArgument.ToString(), this.DescriptionHiddenField.Value, HttpContext.Current.User.Identity.Name);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.StockIssueRequestFA), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.WarningLabel.Text = _result;
