...
{
    public partial class StockIssueRequestFADetailAdd : StockIssueRequestFABase
    {
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            _stcRequestDt.DoneClosing = StockIssueRequestFADataMapper.GetStatusDetail(StockIssueRequestFAStatusDt.Open);
            bool _result = this._stockIssueFABL.AddSTCRequestDt(_stcRequestDt);
