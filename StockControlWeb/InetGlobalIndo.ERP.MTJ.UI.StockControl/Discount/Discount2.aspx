<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="Discount2.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Discount.Discount" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Discount Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Discount Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterListTemplate" runat="server">
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="DiscountNameLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                    <tr class="bgcolor_gray">
                                        <td style="width: 1px" colspan="25">
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="DiscountID" HeaderText="DiscountID" ReadOnly="True" 
                                                        SortExpression="DiscountID" />
                                                </Columns>
                                            </asp:GridView>
                                            <asp:LinqDataSource ID="LinqDataSource1" runat="server" 
                                                ContextTypeName="InetGlobalIndo.ERP.MTJ.DBFactory.ERPManSys.MTJERPManSysDataContext" 
                                                GroupBy="DiscountID" Select="new (key as DiscountID, it as Master_Discounts)" 
                                                TableName="Master_Discounts">
                                            </asp:LinqDataSource>
