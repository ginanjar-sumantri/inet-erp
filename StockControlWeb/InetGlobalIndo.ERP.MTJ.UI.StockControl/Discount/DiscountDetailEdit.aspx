<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DiscountDetailEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Discount.DiscountDetailEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="LevelTextBox" Width="50px" MaxLength="3" ReadOnly="true"
                                    BackColor="#CCCCCC">
                                </asp:TextBox>
                            </td>
                        </tr>
