...
namespace InetGlobalIndo.ERP.MTJ.UI.StockControl.Discount
{
    public partial class Discount : DiscountBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._discountBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._discountBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Master_Discount _temp = (Master_Discount)e.Item.DataItem;

                string _code = _temp.DiscountCode.ToString();
                ...
                Literal _discountCode = (Literal)e.Item.FindControl("DiscountCodeLiteral");
                _discountCode.Text = HttpUtility.HtmlEncode(_temp.DiscountID);

                Literal _discountName = (Literal)e.Item.FindControl("DiscountNameLiteral");
                _discountName.Text = HttpUtility.HtmlEncode(_temp.DiscountName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._discountBL.DeleteMulti(_tempSplit);
