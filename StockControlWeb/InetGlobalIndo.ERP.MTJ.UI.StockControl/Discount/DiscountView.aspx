<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DiscountView.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Discount.DiscountView" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="DiscountCodeTextBox" Width="100" MaxLength="10" BackColor="#CCCCCC"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="DiscountNameTextBox" Width="210" BackColor="#CCCCCC"
                                    ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterListTemplate" runat="server">
                                                    ...
                                                    <td align="right">
                                                        <asp:Literal runat="server" ID="LevelLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="right">
