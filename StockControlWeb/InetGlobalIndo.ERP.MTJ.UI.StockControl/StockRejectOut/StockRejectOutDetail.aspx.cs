...
{
    public partial class StockRejectOutDetail : StockRejectOutBase
    {
        ...
        private string _reportPath1 = "StockRejectOut/JournalEntryPrintPreview.rdlc";
        private string _reportPath2 = "StockRejectOut/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stockRejectOutBL.RowsCountSTCRejectOutDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stockRejectOutBL = new StockRejectOutBL();
            ...
            this.RefNoTextBox.Text = this._purchaseReturBL.GetSinglePRCReturHd(_stcRejectOutHd.PurchaseRetur).FileNmbr == null ? "" : this._purchaseReturBL.GetSinglePRCReturHd(_stcRejectOutHd.PurchaseRetur).FileNmbr;
            this.DateTextBox.Text = DateFormMapper.GetValue(_stcRejectOutHd.TransDate);
            this.SupplierTextBox.Text = this._suppBL.GetSuppNameByCode(_stcRejectOutHd.SuppCode);
            this.AttnTextBox.Text = _stcRejectOutHd.Attn;
            this.WarehouseTextBox.Text = _warehouseBL.GetWarehouseNameByCode(_stcRejectOutHd.WrhsCode);
            if (_stcRejectOutHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
            {
                this.SubledTextBox.Text = _custBL.GetNameByCode(_stcRejectOutHd.WrhsSubLed);
            }
            else if (_stcRejectOutHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
            {
                this.SubledTextBox.Text = _suppBL.GetSuppNameByCode(_stcRejectOutHd.WrhsSubLed);
            }
            else
            {
            ...
            this.StatusHiddenField.Value = _stcRejectOutHd.Status.ToString();
            this.StatusLabel.Text = StockRejectOutDataMapper.GetStatusText(_stcRejectOutHd.Status);
            ...
            {
                this.ListRepeater.DataSource = this._stockRejectOutBL.GetListSTCRejectOutDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text);
            }
            this.ListRepeater.DataBind();

            this.AllCheckBox.Checked = this.IsCheckedAll();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectOutDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectOutDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectOutDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                this.ActionButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/" + _imgApprove;

                this._permApprove = this._permBL.PermissionValidation1(this._menuID, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.GetApproval);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectOutDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectOutDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockRejectOutBL.DeleteMultiSTCRejectOutDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCRejectOutHd _stcRejectOutHd = this._stockRejectOutBL.GetSingleSTCRejectOutHd(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
                STCRejectOutDt _temp = (STCRejectOutDt)e.Item.DataItem;

                string _code1 = _temp.ProductCode.ToString();
                string _code2 = _stcRejectOutHd.PurchaseRetur.ToString();
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectOutDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stockRejectOutBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectOutDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stockRejectOutBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectOutDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stockRejectOutBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectOutDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stockRejectOutBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.StockRejectOut), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.WarningLabel.Text = _result;
