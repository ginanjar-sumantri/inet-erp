...
{
    public partial class StockRejectOut : StockRejectOutBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockRejectOutBL.RowsCountSTCRejectOutHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockRejectOutBL.GetListSTCRejectOutHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockRejectOutBL.GetSingleSTCRejectOutHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockRejectOutBL.DeleteMultiSTCRejectOutHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCRejectOutHd _temp = (STCRejectOutHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockRejectOutDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockRejectOutDataMapper.GetStatusText(_temp.Status));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockRejectOutBL.DeleteMultiApproveSTCRejectOutHd(_tempSplit, AppModule.GetValue(TransactionType.StockRejectOut), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
