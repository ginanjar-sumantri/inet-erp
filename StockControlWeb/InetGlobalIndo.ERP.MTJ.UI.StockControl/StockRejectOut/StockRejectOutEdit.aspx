<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockRejectOutEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockRejectOut.StockRejectOutEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="AttnTextBox" MaxLength="40" Width="280"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="PurchaseReturDropDownList">
                                </asp:DropDownList>
                                <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="Purchase Must Be Filled"
                                    Text="*" ControlToValidate="PurchaseReturDropDownList" ClientValidationFunction="DropDownValidation"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
