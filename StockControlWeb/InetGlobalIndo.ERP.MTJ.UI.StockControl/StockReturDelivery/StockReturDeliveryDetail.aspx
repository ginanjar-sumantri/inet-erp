<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockReturDeliveryDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockReturDelivery.StockReturDeliveryDetail"
    Title="Untitled Page" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" Width="150" ID="TransNoTextBox" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="RRReturTextBox" Width="150" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="WarehouseCodeTextBox" Width="280" ReadOnly="true"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="WrhsSubledTextBox" Width="420" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td>
                            ...
                            <tr>
                                <td colspan="3">
                                    <table cellpadding="3" cellspacing="0" border="0" width="0">
                                        ...
                                        <tr>
                                            <td colspan="7">
                                                <asp:DropDownList ID="CreateJurnalDDL" runat="server" Visible="False">
