...
{
    public partial class StockReturDelivery : StockReturDeliveryBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stcReturBL.RowsCountSTCReturSJHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stcReturBL.GetListSTCReturSJHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stcReturBL.GetSingleSTCReturSJHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stcReturBL.DeleteMultiSTCReturSJHd(_tempSplit);
                if (_result == true)
                {
            ...
            //bool _result = this._stcReturBL.DeleteMultiSTCReturHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCReturSJHd _temp = (STCReturSJHd)e.Item.DataItem;
                ...
                if (_temp.Status.ToString().ToLower() == STCReturDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
                ...
                Literal _fileNmbr = (Literal)e.Item.FindControl("FileNoLiteral");
                ...
                string _statusText = STCReturDataMapper.GetStatusText(_temp.Status);
                ...
                Literal _reqReturNo = (Literal)e.Item.FindControl("RRReturNoLiteral");
                _reqReturNo.Text = HttpUtility.HtmlEncode((_temp.RRReturNo == "null") ? "" : this._stcReturBL.GetSingleSTCReturRRHd(_temp.RRReturNo).FileNmbr);
                //_reqReturNo.Text = HttpUtility.HtmlEncode((_temp.ReqReturNo == "null") ? "" : HttpUtility.HtmlEncode(_temp.ReqReturNo));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stcReturBL.DeleteMultiApproveSTCReturSJHd(_tempSplit, AppModule.GetValue(TransactionType.StockRejectIn), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
