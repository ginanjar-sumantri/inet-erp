...
{
    public partial class StockReturDeliveryDetail : StockReturDeliveryBase
    {
        ...
        private string _reportPath1 = "StockReceivingRetur/JournalEntryPrintPreview.rdlc";
        private string _reportPath2 = "StockReceivingRetur/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stcReturBL.RowsCountSTCReturSJDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        public void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.TransNoTextBox.Text = _stcReturSJHd.TransNmbr;
            this.FileNoTextBox.Text = _stcReturSJHd.FileNmbr;
            this.TransDateTextBox.Text = DateFormMapper.GetValue(_stcReturSJHd.TransDate);
            this.StatusLabel.Text = STCReturDataMapper.GetStatusText(_stcReturSJHd.Status);
            this.CustCodeTextBox.Text = this._customerBL.GetNameByCode(_stcReturSJHd.CustCode);
            this.RRReturTextBox.Text = this._stcReturBL.GetSingleSTCReturRRHd(_stcReturSJHd.RRReturNo).FileNmbr;
            //this.ReqReturTextBox.Text = _stcReturSJHd.ReqReturNo;
            this.RemarkTextBox.Text = _stcReturSJHd.Remark;
            this.WarehouseCodeTextBox.Text = _warehouseBL.GetWarehouseNameByCode(_stcReturSJHd.WrhsCode);

            if (_stcReturSJHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.NoSubled))
            {
                this.WrhsSubledTextBox.Text = "";
            }
            else
            {
                if (_stcReturSJHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
                {
                    this.WrhsSubledTextBox.Text = this._customerBL.GetNameByCode(_stcReturSJHd.WrhsSubLed.ToString());
                }
                else if (_stcReturSJHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
                {
                    this.WrhsSubledTextBox.Text = this._supplierBL.GetSuppNameByCode(_stcReturSJHd.WrhsSubLed.ToString());
                }
            }

            this.StatusHiddenField.Value = _stcReturSJHd.Status.ToString();
            ...
            {
                this.ListRepeater.DataSource = this._stcReturBL.GetListSTCReturSJDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text.Trim());
            }
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == STCReturDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stcReturBL.GetApprSTCReturSJHd(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == STCReturDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stcReturBL.ApproveSTCReturSJHd(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == STCReturDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stcReturBL.PostingSTCReturSJHd(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stcReturBL.DeleteMultiSTCReturSJDt(this.TransNoTextBox.Text, _tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCReturSJDt _temp = (STCReturSJDt)e.Item.DataItem;
                //string _code = _temp.TransNmbr.ToString();
                string _code1 = _temp.ProductCode;
                string _code2 = (_temp.LocationCode == null) ? "" : _temp.LocationCode;
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            string _result = this._stcReturBL.UnpostingSTCReturSJHd(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
