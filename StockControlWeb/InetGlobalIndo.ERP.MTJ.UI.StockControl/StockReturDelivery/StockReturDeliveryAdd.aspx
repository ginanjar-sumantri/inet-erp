<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockReturDeliveryAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockReturDelivery.StockReturDeliveryAdd" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="FgLocationCheckBox" runat="server" Text="Single Location" 
                                    oncheckedchanged="FgLocationCheckBox_CheckedChanged" AutoPostBack="true"/>
