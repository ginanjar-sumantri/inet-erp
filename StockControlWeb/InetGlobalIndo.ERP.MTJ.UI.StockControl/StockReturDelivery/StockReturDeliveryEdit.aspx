<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockReturDeliveryEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockReturDelivery.StockReturDeliveryEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="TransNmbrTextBox" Width="150" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="Customer Code Must Be Filled"
                                    Text="*" ClientValidationFunction="DropDownValidation" ControlToValidate="CustNameDropDownList"></asp:CustomValidator>--%>
                                <asp:TextBox runat="server" ID="CustNameTextBox" Width="300" BackColor="#CCCCCC"
                        ...
                        <tr>
                            ...
                            <td>
                                <%--<asp:DropDownList runat="server" ID="RRReturNoDropDownList">
                                </asp:DropDownList>--%>
                                <asp:TextBox runat="server" ID="RRReturNoTextBox" Width="180" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
