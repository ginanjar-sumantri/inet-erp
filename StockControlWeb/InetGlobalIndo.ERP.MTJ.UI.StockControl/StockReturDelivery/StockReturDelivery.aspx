<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockReturDelivery.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockReturDelivery.StockReturDelivery" %>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="RRReturNoLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
