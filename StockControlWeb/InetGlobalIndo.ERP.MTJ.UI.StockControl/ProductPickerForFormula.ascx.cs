...
public partial class ProductPickerForFormula : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            this.btnSearch.OnClientClick = "window.open('../Search/Search.aspx?valueCatcher=findProduct2&configCode=" + this.productPickerMode.Value + "','_popSearch','width=550,height=700,toolbar=0,location=0,status=0,scrollbars=1');return false;";
            String spawnJS = "<script language='JavaScript'>\n";
            ////////////////////DECLARE FUNCTION FOR CATCHING PRODUCT SEARCH
            spawnJS += "function findProduct2(x) {\n";
            ...
            spawnJS += "function enterProductCode2() {\n";
            ...
            this.productCode.Attributes.Add("onkeydown", "if(event.keyCode==13){return enterProductCode2();}");
