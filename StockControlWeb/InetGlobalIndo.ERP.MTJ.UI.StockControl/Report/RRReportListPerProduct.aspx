<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="RRReportListPerProduct.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.RRReportListPerProduct" %>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ProductSubGroupDropDownList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ProductSubGroupDropDownList_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ProductTypeDropDownList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ProductTypeDropDownList_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
