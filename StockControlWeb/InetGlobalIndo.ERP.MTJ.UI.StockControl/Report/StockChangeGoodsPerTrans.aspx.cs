...
{
    public partial class StockChangeGoodsPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockChangeGoodsPerTransSummary.rdlc";
        private string _reportPath1 = "Report/StockChangeGoodsPerTransDetail.rdlc";
        ...
        private string _awal = "ctl00_DefaultBodyContentPlaceHolder_WrhsSrcCheckBoxList_";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockChangeGoodsPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Change Goods Per Transaction Report";
        ...
        private void ShowWhrsSrc(Int32 _prmCurrentPage)
        {
            string _tempWrhsGroupSrc = (this.WrhsGrpSrcDropDownList.SelectedValue == "null") ? "" : this.WrhsGrpSrcDropDownList.SelectedValue;
            string _tempWrhsAreSrc = (this.WrhsAreaSrcDropDownList.SelectedValue == "null") ? "" : this.WrhsAreaSrcDropDownList.SelectedValue;

            this.WrhsSrcCheckBoxList.ClearSelection();
            this.WrhsSrcCheckBoxList.Items.Clear();
            this.WrhsSrcCheckBoxList.DataTextField = "WrhsName";
            this.WrhsSrcCheckBoxList.DataValueField = "WrhsCode";
            this.WrhsSrcCheckBoxList.DataSource = this._wrhsBL.GetListDDLWrhsForReport(_tempWrhsGroupSrc, _tempWrhsAreSrc, _prmCurrentPage, _maxrow);
            this.WrhsSrcCheckBoxList.DataBind();
            ...
            int i = 0;
            foreach (ListItem _item in this.WrhsSrcCheckBoxList.Items)
            {
            ...
            List<MsWarehouse> _listMsWarehouse = this._wrhsBL.GetListDDLWrhsForReport(_tempWrhsGroupSrc, _tempWrhsAreSrc);
        ...
        protected void ShowWrhsGrpSrc()
        {
            this.WrhsGrpSrcDropDownList.Items.Clear();
            this.WrhsGrpSrcDropDownList.DataSource = this._wrhsBL.GetListWrhsGroupForDDL();
            this.WrhsGrpSrcDropDownList.DataValueField = "WrhsGroupCode";
            this.WrhsGrpSrcDropDownList.DataTextField = "WrhsGroupName";
            this.WrhsGrpSrcDropDownList.DataBind();
            this.WrhsGrpSrcDropDownList.Items.Insert(0, new ListItem("[Choose One]", "null"));
        }

        protected void ShowWrhsAreaSrc()
        {
            this.WrhsAreaSrcDropDownList.Items.Clear();
            this.WrhsAreaSrcDropDownList.DataSource = this._wrhsBL.GetListWrhsAreaForDDL();
            this.WrhsAreaSrcDropDownList.DataValueField = "WrhsAreaCode";
            this.WrhsAreaSrcDropDownList.DataTextField = "WrhsAreaName";
            this.WrhsAreaSrcDropDownList.DataBind();
            this.WrhsAreaSrcDropDownList.Items.Insert(0, new ListItem("[Choose One]", "null"));
        }

        protected void WrhsGrpSrcDropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.ViewState[this._currPageKey] = 0;
        ...
        protected void WrhsAreaSrcDropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.ViewState[this._currPageKey] = 0;
        ...
        public void ClearData()
        {
            ...
            this.WrhsGrpSrcDropDownList.SelectedValue = "null";
            this.WrhsAreaSrcDropDownList.SelectedValue = "null";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                _wrhsDest = this.AllHidden2.Value;
            }
            else
            {
                if (this.AllCheckBox2.Checked == true)
                {
                    _wrhsDest = this.TempHidden2.Value;
                }
                else
                {
                    _wrhsDest = this.CheckHidden2.Value;
                }
            }

            if (this.GrabAllCheckBox.Checked == true)
            {
                _wrhsSrc = this.AllHidden.Value;
            }
            else
            {
                if (this.AllCheckBox.Checked == true)
                {
                    _wrhsSrc = this.TempHidden.Value;
                }
                else
                {
                    _wrhsSrc = this.CheckHidden.Value;
                }
            }

            ReportDataSource _reportDataSource1 = this._report.StockChangeGoodsPerTrans(_startDateTime, _endDateTime, _wrhsSrc, _wrhsDest, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
            ...
            _reportParam[3] = new ReportParameter("Str1", _wrhsSrc, true);
            _reportParam[4] = new ReportParameter("Str2", _wrhsDest, true);
            _reportParam[5] = new ReportParameter("Str3", "", false);
            _reportParam[6] = new ReportParameter("FgReport", this.FgReportDropDownList.SelectedValue, false);
        ...
        private double RowCountWrhsSrc()
        {
            double _result1 = 0;
            string _tempWrhsGrpSrc = (this.WrhsGrpSrcDropDownList.SelectedValue == "null") ? "" : this.WrhsGrpSrcDropDownList.SelectedValue;
            string _tempWrhsAreaSrc = (this.WrhsAreaSrcDropDownList.SelectedValue == "null") ? "" : this.WrhsAreaSrcDropDownList.SelectedValue;

            _result1 = this._wrhsBL.RowsCountWarehouseReport(_tempWrhsGrpSrc, _tempWrhsAreaSrc);
        ...
        protected void DataPagerTopRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "DataPager")
            {
                ...
                this.ShowWhrsSrc(Convert.ToInt32(e.CommandArgument));
                this.SetCheckBox();
            }
        }
        ...
        protected void DataPagerButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (Control _item in this.DataPagerTopRepeater.Controls)
            {
                if (((TextBox)_item.Controls[3]).Text != "")
                {
                    ...
                    if (_reqPage > this.RowCountWrhsSrc())
                    {
                        ((TextBox)_item.Controls[3]).Text = this.RowCountWrhsSrc().ToString();
                        _reqPage = Convert.ToInt32(this.RowCountWrhsSrc()) - 1;
                        break;
                    }
                    else if (_reqPage < 0)
                    {
        ...
        protected void SetCheckAllCheckBox()
        {
            ...
            if (this.WrhsSrcCheckBoxList.Items.Count < 1)
            {
                this.AllCheckBox.Checked = false;
            }
        }
