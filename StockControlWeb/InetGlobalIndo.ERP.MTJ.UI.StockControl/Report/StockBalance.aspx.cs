...
{
    public partial class StockBalance : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockBalancePerProduct.rdlc";
        private string _reportPath1 = "Report/StockBalancePerProductGroup.rdlc";
        private string _reportPath2 = "Report/StockBalancePerProductSubGroup.rdlc";
        private string _reportPath3 = "Report/StockBalancePerProductType.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockBalance, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Balance Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockBalance(_startDateTime, _productSubGrpCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToChar(this.FgQtyRadioButtonList.SelectedValue), Convert.ToDecimal(this.FgDivideDropDownList.SelectedValue));
            ...
            _reportParam[4] = new ReportParameter("FgReport", this.FgReportDropDownList.SelectedValue, true);
            _reportParam[5] = new ReportParameter("FgQty", this.FgQtyRadioButtonList.SelectedValue, true);
            _reportParam[6] = new ReportParameter("FgDivide", this.FgDivideDropDownList.SelectedValue, true);
