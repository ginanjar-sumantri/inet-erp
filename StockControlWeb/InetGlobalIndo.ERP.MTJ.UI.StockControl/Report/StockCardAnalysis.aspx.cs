...
{
    public partial class StockCardAnalysis : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockCardAnalisPerProductWarehouse.rdlc";
        private string _reportPath1 = "Report/StockCardAnalisPerTransType.rdlc";
        ...
        private string _awal3 = "ctl00_DefaultBodyContentPlaceHolder_TransTypeCheckBoxList_";
        private string _akhir3 = "";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockCard, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Card Per Product & Warehouse Report";
        ...
        {
            this.TransTypeCheckBoxList.ClearSelection();
            this.TransTypeCheckBoxList.Items.Clear();
            this.TransTypeCheckBoxList.DataTextField = "TransTypeName";
            this.TransTypeCheckBoxList.DataValueField = "TransTypeName";
            this.TransTypeCheckBoxList.DataSource = this._productBL.GetListViewStockTransType(this.TransTypeCategoryDropDownList.SelectedValue, this.KeywordTextBox1.Text);
            this.TransTypeCheckBoxList.DataBind();

            this.AllCheckBox3.Attributes.Add("OnClick", "CheckBox_ClickAll(" + this.AllCheckBox3.ClientID + ", " + this.CheckHidden3.ClientID + ", '" + _awal3 + "', '" + _akhir3 + "', '" + _tempHidden3 + "', 'true');");

            int i = 0;
            foreach (ListItem _item in this.TransTypeCheckBoxList.Items)
            {
                _item.Attributes.Add("OnClick", "CheckBox_Click(" + this.CheckHidden3.ClientID + ", " + _awal3 + i.ToString() + ", '" + _item.Value + "', '" + _awal3 + "', '" + _akhir3 + "', '" + _cbox3 + "', 'true');");
                i++;
            }
        }

        protected void SetCheckBox3()
        {
            int i = 0;
            foreach (ListItem _item in this.TransTypeCheckBoxList.Items)
            {
                ...
                _item.Selected = this.CheckHidden3.Value.Contains(_item.Value);
                ...
                {
                    this.TempHidden3.Value = _item.Value;
                }
                else
                {
                    this.TempHidden3.Value += "," + _item.Value;
        ...
        private void ShowProduct(Int32 _prmCurrentPage)
        {
            ...
            this.ProductCodeCheckBoxList.DataSource = this._productBL.GetListDDLProductForReport(_prmCurrentPage, _maxrow, this.ProductSubGroupDropDownList.SelectedValue, this.ProductTypeDropDownList.SelectedValue, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            ...
            List<MsProduct> _listMsProduct = this._productBL.GetListDDLProductForReport(_tempProductSubGroup, _tempProductType, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.AllCheckBox3.Checked == true)
            {
                _transType = this.TempHidden3.Value;
            }
            else
            {
                _transType = this.CheckHidden3.Value;
            }

            //if (this.ReportTypeDropDownList.SelectedValue == "TransType")
            //{
            //    _wrhsCode = "";
            //    _productCode = "";
            //}
            ...
            List<master_ReportList> _msReportList = _reporListBL.GetReportListDDL("SCAnalis", new UserBL().GetCompanyId(HttpContext.Current.User.Identity.Name));
            String[] _reportPath = new String[2];
            int i = 0;
            foreach (var _row in _msReportList)
            {
                 _reportPath[i] = _row.ReportPath;
                 i = i + 1;
            }

            if (this.FromTextBox.Text == "")
                this.FromTextBox.Text = "000";
            if (this.ToTextBox.Text == "")
                this.ToTextBox.Text = "zzz";
            ...
            {
                if (_transType != "")
                    _rptPath = _reportPath[1];
                else
                    _rptPath = _reportPath[0];
            }
            else 
            {
                _rptPath = "";
            ...
            ReportDataSource _reportDataSource1 = this._report.StockCardAnalysis(_startDateTime, _endDateTime, _productCode, _wrhsCode, _transType, this.FromTextBox.Text, this.ToTextBox.Text);
            ...
            //if (this.ReportTypeDropDownList.SelectedValue == "TransType")
            //{
            this.ReportViewer1.LocalReport.ReportPath = Request.ServerVariables["APPL_PHYSICAL_PATH"] + _rptPath;
            //}
            //else 
            //{
            ...
            _reportParam[3] = new ReportParameter("Str1", _wrhsCode, true);
            _reportParam[4] = new ReportParameter("Str2", _productCode, true);
            _reportParam[5] = new ReportParameter("From", this.FromTextBox.Text, true);
            _reportParam[6] = new ReportParameter("To", this.ToTextBox.Text, true);
            _reportParam[7] = new ReportParameter("Trans1", _transType, true);
        ...
        protected void GoImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            //this.ViewState[this._currPageKey] = 0;
            //this.ProductPanel.Visible = false;
            //this.TansTypePanel.Visible = true;
            //this.RangePanel.Visible = false;
            //this.SelectionPanel.Visible = true;
            this.ShowTransType();
            this.SetCheckBox3();
        ...
        //protected void ChangeReportType()
        //{
        //    this.ClearData();
        ...
        //        this.TansTypePanel.Visible = false;
