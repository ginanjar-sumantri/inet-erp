...
{
    public partial class StockAdjustPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockAdjustPerTransSummary.rdlc";
        private string _reportPath1 = "Report/StockAdjustPerTransDetail.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockAdjustPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Adjust Per Transaction Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockAdjustPerTrans(_startDateTime, _endDateTime, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
