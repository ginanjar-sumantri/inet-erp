...
{
    public partial class STCSalesReturPerCust : ReportBase
    {
        ...
        private string _reportPath0 = "Report/STCSalesReturPerCustSummaryCust.rdlc";
        private string _reportPath1 = "Report/STCSalesReturPerCustSummaryProduct.rdlc";
        private string _reportPath2 = "Report/STCSalesReturPerCustSummaryTrans.rdlc";
        private string _reportPath3 = "Report/STCSalesReturPerCustDetailProduct.rdlc";
        private string _reportPath4 = "Report/STCSalesReturPerCustDetailTrans.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSTCSalesReturPerCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Retur Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.STCSalesReturPerCust(_startDateTime, _endDateTime, _custCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
