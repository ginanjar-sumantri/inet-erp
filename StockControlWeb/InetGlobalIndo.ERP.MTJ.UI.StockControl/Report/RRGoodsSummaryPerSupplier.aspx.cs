...
{
    public partial class RRGoodsSummaryPerSupplier : ReportBase
    {
        ...
        private string _reportPath0 = "Report/RRGoodsSummaryPerSupplier.rdlc";
        private string _reportPath1 = "Report/RRGoodsSummaryPerSupplierProduct.rdlc";
        private string _reportPath2 = "Report/RRGoodsSummaryPerProductSupplier.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDRRGoodsSummaryPerSupplier, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "RR Goods Summary Per Supplier Report";
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "RRGoodsSumPerSupp";
        ...
        private void ShowSupplier(Int32 _prmCurrentPage)
        {
            ...
            this.SuppCodeCheckBoxList.DataSource = this._suppBL.GetListDDLSuppForReport(_tempSuppGroup, _tempSuppType, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, _prmCurrentPage, _maxrow);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.HeaderReportList1.ReportGroup == "RRGoodsSumPerSupp")
            {
                _validate = ValidateDiffDate();
                _warning = "Difference Between Start and End Period Must Not Greater Than 12 Months";
                
            }
            if (this.HeaderReportList1.ReportGroup == "RRGoodsSumPerSuppYear")
            {
            ...
            if (_validate == true)
            {
                ...
                if (this.HeaderReportList1.SelectedText == "Per Supplier Quantity")
                {
                    _FgAmount = "0";
                    _FgReport = "0";
                }
                if (this.HeaderReportList1.SelectedText == "Per Supplier Amount")
                {
                    _FgAmount = "1";
                    _FgReport = "0";
                }
                if (this.HeaderReportList1.SelectedText == "Per Supplier - Product Quantity")
                {
                    _FgAmount = "0";
                    _FgReport = "1";
                }
                if (this.HeaderReportList1.SelectedText == "Per Supplier - Product Amount")
                {
                    _FgAmount = "1";
                    _FgReport = "1";
                }
                if (this.HeaderReportList1.SelectedText == "Per Product - Supplier Quantity")
                {
                    _FgAmount = "0";
                    _FgReport = "2";
                }
                if (this.HeaderReportList1.SelectedText == "Per Product - Supplier Amount")
                {
                    _FgAmount = "1";
                    _FgReport = "2";
                }
                if (this.HeaderReportList1.SelectedText == "Per Supplier - Product Quantity By Year")
                {
                    _FgAmount = "0";
                ...
                if (this.HeaderReportList1.SelectedText == "Per Supplier - Product Ammount By Year")
                {
                    _FgAmount = "1";
                    _start = this.StartYearTextBox.Text.PadLeft(4, '0');
                    _end = this.EndYearTextBox.Text.PadLeft(4, '0');
                ...
                {
                    _reportDataSource1 = this._report.RRGoodsSummaryPerSupp(_start, _end, _suppCode, _productSubGroup, _FgReport, _FgAmount, this.FilterDropDownList.SelectedValue, this.SupplierFromTextBox.Text, this.SupplierToTextBox.Text);
                    ...
                    _reportParam[4] = new ReportParameter("Str2", _productSubGroup, true);
                    _reportParam[5] = new ReportParameter("Str3", "", true);
                    _reportParam[6] = new ReportParameter("FgReport", _FgReport, true);
                    _reportParam[7] = new ReportParameter("FgAmount", _FgAmount, true);
                    _reportParam[8] = new ReportParameter("FgType", "RR", true);
                    _reportParam[9] = new ReportParameter("FgFilter", this.FilterDropDownList.SelectedValue, true);
                    _reportParam[10] = new ReportParameter("FromSupplier", this.SupplierFromTextBox.Text, true);
                    _reportParam[11] = new ReportParameter("ToSupplier", this.SupplierToTextBox.Text, true);
                ...
                {
                    _reportDataSource1 = this._report.RRGoodsSummaryPerSupp(_start, _end, _suppCode, _productSubGroup, _FgAmount, this.FilterDropDownList.SelectedValue, this.SupplierFromTextBox.Text, this.SupplierToTextBox.Text);
                    this.ReportViewer1.LocalReport.DataSources.Clear();
                    this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);
                    ...
                    _reportParam[4] = new ReportParameter("Str2", _productSubGroup, true);
                    _reportParam[5] = new ReportParameter("Str3", "", true);
                    _reportParam[6] = new ReportParameter("FgReport", _FgAmount, true);
        ...
        protected void FilterReportRadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                this.HeaderReportList1.ReportGroup = "RRGoodsSumPerSuppYear";
                this.HeaderReportList1.Render();
