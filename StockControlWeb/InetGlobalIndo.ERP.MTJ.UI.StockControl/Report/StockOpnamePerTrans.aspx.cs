...
{
    public partial class StockOpnamePerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockOpnamePerTransSummary.rdlc";
        private string _reportPath1 = "Report/StockOpnamePerTransDetail.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockOpnamePerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Opname Per Transaction Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockOpnamePerTrans(_startDateTime, _endDateTime, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
