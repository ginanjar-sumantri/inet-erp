<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReceivingReportPerSupplier.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.ReceivingReportPerSupplier" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="ReportTypeDropDownList">
                                                ...
                                                <asp:ListItem Value="0">Summary By Supplier </asp:ListItem>
                                                <asp:ListItem Value="1">Detail by Supplier</asp:ListItem>
                                                <asp:ListItem Value="2">Detail By Product, Supplier</asp:ListItem>
                                            </asp:DropDownList>
