<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockBalanceByProductValue.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.StockBalanceByProductValue" %>
                            ...
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            <asp:DropDownList ID="ModeDDL" runat="server">
                                                <asp:ListItem Text="With (0)" Value="0"></asp:ListItem>
                                                <asp:ListItem Text="without (0)" Value="1"></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
