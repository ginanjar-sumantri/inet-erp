...
{
    public partial class SuratJalanUnInvoicePerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SuratJalanUnInvoicePerProdSummaryReport.rdlc";
        private string _reportPath1 = "Report/SuratJalanUnInvoicePerProdSumByProdCustomerReport.rdlc";
        private string _reportPath2 = "Report/SuratJalanUnInvoicePerProdDetailByProdCustomerReport.rdlc";
        private string _reportPath3 = "Report/SuratJalanUnInvoicePerProdDetailProdWarehouseReport.rdlc";
        private string _reportPath4 = "Report/SuratJalanUnInvoicePerProdSumByProdReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSuratJalanUnInvoicePerProd, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Bill Of Lading Un-Invoice Per Product Report";
        ...
        public void ClearData()
        {
            ...
            if (_bolReferenceType == "SO")
                this.HeaderReportList1.ReportGroup = "SJUnInvoicePerProdSO";
            else if (_bolReferenceType == "DO")
                this.HeaderReportList1.ReportGroup = "SJUnInvoicePerProdDO";

            this.StartDateTextBox.Text = DateFormMapper.GetValue(DateTime.Now);
            //this.ReportTypeDropDownList.SelectedValue = "null";
            this.ReportStatusDropDownList.SelectedValue = "null";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.SuratJalanUnInvoicePerProduct(_startDateTime, _custCode, _wrhsCode, this.HeaderReportList1.SelectedIndex, this.ReportStatusDropDownList.SelectedValue, this.FilterDropDownList.SelectedValue, this.CustomerFromTextBox.Text, this.CustomerToTextBox.Text);
            ...
            _reportParam[2] = new ReportParameter("Str2", _wrhsCode, true);
