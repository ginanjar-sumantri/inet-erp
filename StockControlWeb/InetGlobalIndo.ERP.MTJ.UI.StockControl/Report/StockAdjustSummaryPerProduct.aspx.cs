...
{
    public partial class StockAdjustSummaryPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockAdjustSummaryPerProductProd.rdlc";
        private string _reportPath1 = "Report/StockAdjustSummaryPerProductProdGroup.rdlc";
        private string _reportPath2 = "Report/StockAdjustSummaryPerProductProdSubGroup.rdlc";
        private string _reportPath3 = "Report/StockAdjustSummaryPerProductProdType.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockAdjustSummaryPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Adjust Summary Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.StockAdjustSummaryPerProduct(_start,_end, _productSubGrpCode, _productType, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), 0);
