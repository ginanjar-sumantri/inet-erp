...
{
    public partial class StockOpnameSummaryPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockOpnameSummaryPerProductProd.rdlc";
        private string _reportPath1 = "Report/StockOpnameSummaryPerProductProdGroup.rdlc";
        private string _reportPath2 = "Report/StockOpnameSummaryPerProductProdSubGroup.rdlc";
        private string _reportPath3 = "Report/StockOpnameSummaryPerProductProdType.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockOpnameSummaryPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Opname Summary Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.StockOpnameSummaryPerProduct(_start,_end, _productSubGrpCode, _productType, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), 0);
