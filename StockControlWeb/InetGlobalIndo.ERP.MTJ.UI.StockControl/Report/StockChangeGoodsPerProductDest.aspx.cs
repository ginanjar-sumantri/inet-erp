...
{
    public partial class StockChangeGoodsPerProductDest : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockChangeGoodsPerProductDestSummaryTrans.rdlc";
        private string _reportPath1 = "Report/StockChangeGoodsPerProductDestSummaryWrhs.rdlc";
        private string _reportPath2 = "Report/StockChangeGoodsPerProductDestDetailWrhsDest.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockChangeGoodsPerProductDest, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Change Goods Per Product Destination Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockChangeGoodsPerProductDest(_startDateTime, _endDateTime, _productCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
