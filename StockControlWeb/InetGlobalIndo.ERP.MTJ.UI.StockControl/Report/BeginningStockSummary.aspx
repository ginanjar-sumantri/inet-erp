<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="BeginningStockSummary.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.BeginningStock" %>
                            ...
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="FgReportDDL">
                                                <asp:ListItem Value="null" Text="[Choose One]"></asp:ListItem>
                                                <asp:ListItem Value="0">Summary Per Warehouse</asp:ListItem>
                                                <asp:ListItem Value="1">Summary Per Product</asp:ListItem>
                                                <asp:ListItem Value="2">Detail Per Product</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:CustomValidator ID="FgReportCustomValidator" runat="server" ErrorMessage="Report Type By Must Be Choosed"
                                                Text="*" ClientValidationFunction="DropDownValidation" ControlToValidate="FgReportDDL"></asp:CustomValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
