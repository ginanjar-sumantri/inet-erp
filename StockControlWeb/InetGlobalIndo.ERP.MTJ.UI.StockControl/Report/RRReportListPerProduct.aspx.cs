...
{
    public partial class RRReportListPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/RRReportListPerProduct.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "RR Report List Per Product";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (_from.Length <= _to.Length)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.RRReportListPerProduct(_startDateTime, _endDateTime, _product, _from, _to);
