<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockChangeGoodsPerTrans.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.StockChangeGoodsPerTrans" %>
                        ...
                        <tr>
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    ...
                                    <tr>
                                        <td>
                                            Warehouse Group Source
                                        </td>
                                        <td>
                                            :
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="WrhsGrpSrcDropDownList" runat="server" AutoPostBack="True"
                                                OnSelectedIndexChanged="WrhsGrpSrcDropDownList_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="WrhsAreaSrcDropDownList" runat="server" AutoPostBack="True"
                                                OnSelectedIndexChanged="WrhsAreaSrcDropDownList_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:CheckBoxList runat="server" ID="WrhsSrcCheckBoxList" RepeatColumns="3">
                                            </asp:CheckBoxList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Warehouse Group Destination
                                        </td>
                                        <td>
                                            :
                                        </td>
