...
{
    public partial class StockCardValue : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockCardValue.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockCardValue, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Card Value Per Product & Warehouse Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockCardValue(_startDateTime, _endDateTime, _productCode, _wrhsCode, this.FromTextBox.Text, this.ToTextBox.Text);
