<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockChangeGoodsSummaryPerProductSrc.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.StockChangeGoodsSummaryPerProductSrc" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="FgReportDropDownList" runat="server">
                                                ...
                                                <asp:ListItem Text="Product Group" Value="5"></asp:ListItem>
                                                <asp:ListItem Text="Product Sub Group" Value="6"></asp:ListItem>
                                                <asp:ListItem Text="Product Type" Value="7"></asp:ListItem>
                                            </asp:DropDownList>
