...
{
    public partial class StockChangeGoodsSummaryPerProductSrc : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockChangeGoodsSummaryPerProductSrcProd.rdlc";
        private string _reportPath1 = "Report/StockChangeGoodsSummaryPerProductSrcProdGroup.rdlc";
        private string _reportPath2 = "Report/StockChangeGoodsSummaryPerProductSrcProdSubGroup.rdlc";
        private string _reportPath3 = "Report/StockChangeGoodsSummaryPerProductSrcProdType.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockChangeGoodsSummaryPerProductSrc, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Change Goods Summary Per Product Source Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.StockChangeGoodsSummaryPerProductSrc(_start, _end, _productSubGrpCode, _productType, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), 0);
