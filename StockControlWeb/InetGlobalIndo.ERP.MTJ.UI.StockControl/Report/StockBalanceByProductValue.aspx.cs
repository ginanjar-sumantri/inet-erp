...
{
    public partial class StockBalanceByProductValue : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockBalanceByProductValueAVG.rdlc";
        private string _reportPath1 = "Report/StockBalanceByProductValueNotAVG.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockBalanceByProductValue, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Balance By Product Value";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (_from.Length <= _to.Length)
            {
                ...
                DateTime _transDateTime = new DateTime(DateFormMapper.GetValue(this.TransDateTextBox.Text).Year, DateFormMapper.GetValue(this.TransDateTextBox.Text).Month, DateFormMapper.GetValue(this.TransDateTextBox.Text).Day, 0, 0, 0);
                
                ReportDataSource _reportDataSource1 = this._report.StockBalanceByProductValue(this.ModeDDL.SelectedValue, _transDateTime, _product, _from, _to);
                ...
                String _cogsMethod = _companyConfig.GetSingle(CompanyConfigure.COGSMethod).SetValue.Trim();
                ...
                _reportParam[0] = new ReportParameter("Mode", this.ModeDDL.SelectedValue, true);
                _reportParam[1] = new ReportParameter("TransDate", _transDateTime.ToString(), true);
