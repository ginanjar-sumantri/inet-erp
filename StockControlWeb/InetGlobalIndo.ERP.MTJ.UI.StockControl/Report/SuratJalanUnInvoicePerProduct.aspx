<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SuratJalanUnInvoicePerProduct.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.SuratJalanUnInvoicePerProduct" %>
                                    ...
                                    <%--<tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="ReportTypeDropDownList">
                                                ...
                                                <asp:ListItem Value="1">Summary Per Product, Customer </asp:ListItem>
                                                <asp:ListItem Value="2">Detail Per Product</asp:ListItem>
                                                <asp:ListItem Value="3">Detail Per  Product, Warehouse</asp:ListItem>
                                                <asp:ListItem Value="4">Summary Per Product </asp:ListItem>
                                            </asp:DropDownList>
