...
{
    public partial class StockCard : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockCard.rdlc";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockCard(_startDateTime, _endDateTime, _productCode, _wrhsCode, this.FromTextBox.Text, this.ToTextBox.Text);
