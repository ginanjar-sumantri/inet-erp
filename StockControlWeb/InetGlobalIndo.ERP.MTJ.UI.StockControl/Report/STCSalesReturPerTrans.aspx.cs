...
{
    public partial class STCSalesReturPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/STCSalesReturSummaryPerTrans.rdlc";
        private string _reportPath1 = "Report/STCSalesReturDetailPerTrans.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSTCSalesReturPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.STCSalesReturPerTrans(_startDateTime, _endDateTime, _custCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
