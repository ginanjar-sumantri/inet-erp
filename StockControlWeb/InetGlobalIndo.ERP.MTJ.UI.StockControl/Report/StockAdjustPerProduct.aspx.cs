...
{
    public partial class StockAdjustPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockAdjustPerProductSummaryTrans.rdlc";
        private string _reportPath1 = "Report/StockAdjustPerProductSummaryWrhs.rdlc";
        private string _reportPath2 = "Report/StockAdjustPerProductDetailWrhs.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockAdjustPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Adjust Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockAdjustPerProduct(_startDateTime, _endDateTime, _productCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
