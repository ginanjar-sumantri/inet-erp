...
{
    public partial class StockCardPerDate : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockCardPerDate.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockCardPerDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Card Per Date Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockCardPerDate(_startDateTime, _endDateTime, _productCode, _wrhsCode, this.FromTextBox.Text, this.ToTextBox.Text);
