<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SuratJalanPerWarehouse.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.SuratJalanPerWarehouse" %>
                                    ...
                                    <%-- <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="ReportTypeDropDownList">
                                                ...
                                                <asp:ListItem Value="0">Summary Per Warehouse </asp:ListItem>
                                                <asp:ListItem Value="1">Detail Per Warehouse</asp:ListItem>
                                                <asp:ListItem Value="2">Detail Per Warehouse, Product</asp:ListItem>
                                            </asp:DropDownList>
                                                            ...
                                                            <asp:Panel DefaultButton="DataPagerButton2" ID="DataPagerPanel2" runat="server">
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" OnClick="SearchImageButton1_Click" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <table border="0" cellpadding="2" cellspacing="0" width="100%">
