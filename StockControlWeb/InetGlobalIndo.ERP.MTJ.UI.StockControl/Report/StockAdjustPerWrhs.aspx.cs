...
{
    public partial class StockAdjustPerWrhs : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockAdjustPerWrhsSummaryTrans.rdlc";
        private string _reportPath1 = "Report/StockAdjustPerWrhsSummaryProduct.rdlc";
        private string _reportPath2 = "Report/StockAdjustPerWrhsDetailTrans.rdlc";
        private string _reportPath3 = "Report/StockAdjustPerWrhsDetailProduct.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockAdjustPerWrhs, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Adjust Per Warehouse Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockAdjustPerWrhs(_startDateTime, _endDateTime, _productCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
