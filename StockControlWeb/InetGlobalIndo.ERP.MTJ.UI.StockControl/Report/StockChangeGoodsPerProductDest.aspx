<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockChangeGoodsPerProductDest.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.StockChangeGoodsPerProductDest" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="FgReportDropDownList" runat="server">
                                                ...
                                                <asp:ListItem Text="Summary Transaction" Value="0"></asp:ListItem>
                                                <asp:ListItem Text="Summary Warehouse" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="Detail Warehouse Destination" Value="2"></asp:ListItem>
                                            </asp:DropDownList>
