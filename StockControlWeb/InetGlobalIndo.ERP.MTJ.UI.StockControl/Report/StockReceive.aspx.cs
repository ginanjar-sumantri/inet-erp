...
{
    public partial class StockReceive : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockReceivePerProduct.rdlc";
        private string _reportPath1 = "Report/StockReceivePerProductGroup.rdlc";
        private string _reportPath2 = "Report/StockReceivePerProductSubGroup.rdlc";
        private string _reportPath3 = "Report/StockReceivePerProductType.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockReceive, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Receive Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockReceive(_startDateTime, _productSubGrpCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(!this.WrhsCheckBox.Checked));
