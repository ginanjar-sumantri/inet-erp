...
{
    public partial class StockOpnamePerWrhs : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockOpnamePerWrhsSummaryTrans.rdlc";
        private string _reportPath1 = "Report/StockOpnamePerWrhsSummaryProduct.rdlc";
        private string _reportPath2 = "Report/StockOpnamePerWrhsDetailTrans.rdlc";
        private string _reportPath3 = "Report/StockOpnamePerWrhsDetailProduct.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockOpnamePerWrhs, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Opname Per Warehouse Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockOpnamePerWrhs(_startDateTime, _endDateTime, _productCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
