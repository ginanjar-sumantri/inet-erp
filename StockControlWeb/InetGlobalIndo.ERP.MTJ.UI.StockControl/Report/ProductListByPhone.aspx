<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ProductListByPhone.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.ProductListByPhone" %>
                            ...
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="PhoneTypeFromTextBox" runat="server" Width="150"></asp:TextBox>
                                        </td>
                                        <td>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="PhoneTypeToTextBox" runat="server" Width="150"></asp:TextBox>
                                        </td>
