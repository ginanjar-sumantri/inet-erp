<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockCardAnalysis.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.StockCardAnalysis" %>
                                    ...
                                    <%--<tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ReportTypeDropDownList" runat="server" AutoPostBack="true"
                                                OnSelectedIndexChanged="ReportTypeDropDownList_SelectedIndexChanged">
                                                <asp:ListItem Text="Product" Value="Product" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="Trans Type" Value="TransType"></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>--%>
                                    <tr>
                                            ...
                                            <fieldset>
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td colspan="7">
                                                            <asp:Panel ID="GoPanel" DefaultButton="GoImageButton1" runat="server">
                                                                <table cellpadding="0" cellspacing="2" border="0">
                                                                    <tr>
                                                                        <td>
                                                                            <b>Quick Search :</b>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="TransTypeCategoryDropDownList" runat="server">
                                                                                <%--<asp:ListItem Value="Code" Text="Product Code"></asp:ListItem>--%>
                                                                                <asp:ListItem Value="Name" Text="Trans Type Name"></asp:ListItem>
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:ImageButton ID="GoImageButton1" runat="server" OnClick="GoImageButton1_Click" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </asp:Panel>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <table>
                                                                <tr>
                                                                    <td align="left">
                                                                        <asp:CheckBox runat="server" ID="AllCheckBox3" Text="Check All" />
                                                                        <%--<asp:CheckBox runat="server" ID="CheckBox2" Text="Grab All" />--%>
                                                                    </td>
                                                                    <td>
                                                                        <asp:HiddenField ID="CheckHidden3" runat="server" />
                                                                        <asp:HiddenField ID="TempHidden3" runat="server" />
                                                                        <asp:HiddenField ID="AllHidden3" runat="server" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBoxList runat="server" ID="TransTypeCheckBoxList" RepeatColumns="3">
                                                            </asp:CheckBoxList>
                                                        </td>
                                                    </tr>
                                                </table>
