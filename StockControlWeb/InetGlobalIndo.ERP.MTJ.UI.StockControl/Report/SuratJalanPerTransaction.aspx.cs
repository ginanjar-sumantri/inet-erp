...
{
    public partial class SuratJalanPerTransaction : ReportBase
    {
        ...
        //private string _reportPath0 = "Report/SuratJalanPerTransSumReport.rdlc";
        //private string _reportPath1 = "Report/SuratJalanPerTransDetailReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSuratJalanPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Bill Of Lading Per Transaction Report";
        ...
        public void ClearData()
        {
            ...
            if (_bolReferenceType == "SO")
                this.HeaderReportList1.ReportGroup = "SJPerTransSO";
            else if (_bolReferenceType == "DO")
                this.HeaderReportList1.ReportGroup = "SJPerTransDO";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.SuratJalanPerTransaction(_startDateTime, _endDateTime, _wrhsCode, _productCode, this.HeaderReportList1.SelectedIndex, this.ReportStatusDropDownList.SelectedValue, this.FilterDropDownList.SelectedValue, this.ProductFromTextBox.Text, this.ProductToTextBox.Text);
            ...
            _reportParam[8] = new ReportParameter("FromProduct", this.ProductFromTextBox.Text, true);
            _reportParam[9] = new ReportParameter("ToProduct", this.ProductToTextBox.Text, true);
            _reportParam[10] = new ReportParameter("CompanyName", new UserBL().ConnectionCompany(HttpContext.Current.User.Identity.Name), false);
        ...
        protected void FilterDropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (this.FilterDropDownList.SelectedValue == "0")
            {
                ...
                this.SetCheckBox();
                this.SetCheckBox2();
                this.ProductFromTextBox.Text = "";
                this.ProductToTextBox.Text = "";
            }
            else
            {
