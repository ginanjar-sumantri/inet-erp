...
{
    public partial class SuratJalanUnInvoicePerWarehouse : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SuratJalanUnInvoicePerWrhsSumByTransactionReport.rdlc";
        private string _reportPath1 = "Report/SuratJalanUnInvoicePerWrhsSumByProductReport.rdlc";
        private string _reportPath2 = "Report/SuratJalanUnInvoicePerWrhsDetailTransactionReport.rdlc";
        private string _reportPath3 = "Report/SuratJalanUnInvoicePerWrhsDetailProductReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSuratJalanUnInvoicePerWrhs, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Bill Of Lading Un-Invoice Per Warehouse Report";
        ...
        public void ClearData()
        {
            ...
            if (_bolReferenceType == "SO")
                this.HeaderReportList1.ReportGroup = "SJUnInvoicePerWrhsSO";
            else if (_bolReferenceType == "DO")
                this.HeaderReportList1.ReportGroup = "SJUnInvoicePerWrhsDO";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.SuratJalanUnInvoicePerWarehouse(_startDateTime, _wrhsCode, _productCode, this.HeaderReportList1.SelectedIndex, this.ReportStatusDropDownList.SelectedValue, this.FilterDropDownList.SelectedValue, this.ProductFromTextBox.Text, this.ProductToTextBox.Text);
            ...
            _reportParam[7] = new ReportParameter("FromProduct", this.ProductFromTextBox.Text, true);
            _reportParam[8] = new ReportParameter("ToProduct", this.ProductToTextBox.Text, true);
