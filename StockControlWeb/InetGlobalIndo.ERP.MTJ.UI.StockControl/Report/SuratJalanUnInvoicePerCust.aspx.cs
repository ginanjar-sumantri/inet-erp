...
{
    public partial class SuratJalanUnInvoicePerCust : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SuratJalanUnInvoicePerCustSumByTransactionReport.rdlc";
        private string _reportPath1 = "Report/SuratJalanUnInvoicePerCustSumByProductReport.rdlc";
        private string _reportPath2 = "Report/SuratJalanUnInvoicePerCustDetailTransactionReport.rdlc";
        private string _reportPath3 = "Report/SuratJalanUnInvoicePerCustDetailProductReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSuratJalanUnInvoicePerCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Bill Of Lading Un-Invoice Per Customer Report";

                this.ViewState[this._currPageKey] = 0;
                this.ViewState[this._currPageKey2] = 0;

                this.CalendarScriptLiteral.Text = "<input id='button1' type='button' onclick='displayCalendar(" + this.StartDateTextBox.ClientID + ",&#39" + DateFormMapper.GetFormat() + "&#39,this)' value='...' />";

                this.ViewButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/view2.jpg";
                this.ResetButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/reset.jpg";
                this.SearchImageButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/go.jpg";
                this.SearchImageButton2.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/go.jpg";
        ...
        private void ShowProduct(Int32 _prmCurrentPage)
        {
            ...
            this.ProductCodeCheckBoxList.DataSource = this._productBL.GetListForDDLProduct(_tempProductGroup, _tempProductSubGroup, _tempProductType, this.CategoryDropDownList2.SelectedValue, this.KeywordTextBox2.Text, _prmCurrentPage, _maxrow);
        ...
        public void ClearData()
        {
            ...
            if (_bolReferenceType == "SO")
                this.HeaderReportList1.ReportGroup = "SJUnInvoicePerCustSO";
            else if (_bolReferenceType == "DO")
                this.HeaderReportList1.ReportGroup = "SJUnInvoicePerCustDO";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.CustomerFromTextBox.Text == "")
                this.CustomerFromTextBox.Text = "000";
            if (this.CustomerToTextBox.Text == "")
                this.CustomerToTextBox.Text = "zzz";
            ...
            ReportDataSource _reportDataSource1 = this._report.SuratJalanUnInvoicePerCustomer(_startDateTime, _custCode, _productCode, this.HeaderReportList1.SelectedIndex, this.ReportStatusDropDownList.SelectedValue, this.FilterDropDownList.SelectedValue, this.CustomerFromTextBox.Text, this.CustomerToTextBox.Text, this.ProductFromTextBox.Text, this.ProductToTextBox.Text);
            ...
            //}
            //else if (this.ReportTypeDropDownList.SelectedValue == "3")
            //{
            ...
            _reportParam[1] = new ReportParameter("Str1", _custCode, true);
            _reportParam[2] = new ReportParameter("Str2", _productCode, true);
            _reportParam[3] = new ReportParameter("Str3", "", true);
            _reportParam[4] = new ReportParameter("FgReport", this.HeaderReportList1.SelectedIndex, true);
            _reportParam[5] = new ReportParameter("FgType", this.ReportStatusDropDownList.SelectedValue, true);
            _reportParam[6] = new ReportParameter("FgFilter", this.FilterDropDownList.SelectedValue, true);
            _reportParam[7] = new ReportParameter("FromCustomer", this.CustomerFromTextBox.Text, true);
            _reportParam[8] = new ReportParameter("ToCustomer", this.CustomerToTextBox.Text, true);
            _reportParam[9] = new ReportParameter("FromProduct", this.ProductFromTextBox.Text, true);
            _reportParam[10] = new ReportParameter("ToProduct", this.ProductToTextBox.Text, true);
            _reportParam[11] = new ReportParameter("CompanyName", new UserBL().ConnectionCompany(HttpContext.Current.User.Identity.Name), false);
        ...
        protected void SetCheckBox2()
        {
            ...
            foreach (ListItem _item in this.CustCodeCheckBoxList.Items)
            {
                _item.Attributes.Add("OnClick", "CheckBox_Click(" + this.CheckHidden.ClientID + ", " + _awal2 + i.ToString() + ", '" + _item.Value + "', '" + _awal2 + "', '" + _akhir2 + "', '" + _cbox2 + "', 'true');");
        ...
        protected void SearchImageButton_Click2(object sender, EventArgs e)
        {
            this.ViewState[this._currPageKey] = 0;
