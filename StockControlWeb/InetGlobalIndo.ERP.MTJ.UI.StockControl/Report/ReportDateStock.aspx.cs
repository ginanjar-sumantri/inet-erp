...
{
    public partial class ReportDateStock : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ReportDateStockPerProduct.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDRRReportListPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Report Date Stok List Per Product";
        ...
        private double RowCount()
        {
            ...
            _result = this._productBL.RowsCountDDLProductForReport(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        {
            var hasil = this._productBL.GetListDDLProductForReport(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.ReportDateStockListPerProduct(_product, Convert.ToInt32(this.FilterDropDownList.SelectedValue), this.FromTextBox.Text, this.ToTextBox.Text);
            ...
            _reportParam[0] = new ReportParameter("Str", _product, true);
            _reportParam[1] = new ReportParameter("FgFilter", this.FilterDropDownList.SelectedValue, true);
            _reportParam[2] = new ReportParameter("From", this.FromTextBox.Text, true);
            _reportParam[3] = new ReportParameter("To", this.ToTextBox.Text, true);
