...
{
    public partial class ReceivingReportPerSupplier : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ReceivingReportSummaryBySupplier.rdlc";
        private string _reportPath1 = "Report/ReceivingReportDetailBySupplier.rdlc";
        private string _reportPath2 = "Report/ReceivingReportDetailByProductSupplier.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Receiving Report Per Supplier";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //ReportDataSource _reportDataSource1 = this._report.ReceivingReportSupplier(_startDateTime, _endDateTime, _suppCode, _wrhsCode, this.ReportTypeDropDownList.SelectedValue);
            ...
            //_reportParam[5] = new ReportParameter("FgReport", this.ReportTypeDropDownList.SelectedValue, true);
