...
{
    public partial class StockOpnamePerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockOpnamePerProductSummaryTrans.rdlc";
        private string _reportPath1 = "Report/StockOpnamePerProductSummaryWrhs.rdlc";
        private string _reportPath2 = "Report/StockOpnamePerProductDetailWrhs.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockOpnamePerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Opname Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockOpnamePerProduct(_startDateTime, _endDateTime, _productCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
