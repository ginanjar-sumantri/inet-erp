...
{
    public partial class StockChangeGoodsPerProductSrc : ReportBase
    {
        ...
        private string _reportPath0 = "Report/StockChangeGoodsPerProductSrcSummaryTrans.rdlc";
        private string _reportPath1 = "Report/StockChangeGoodsPerProductSrcSummaryWrhs.rdlc";
        private string _reportPath2 = "Report/StockChangeGoodsPerProductSrcDetailWrhsSrc.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDStockChangeGoodsPerProductSrc, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Stock Change Goods Per Product Source Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.StockChangeGoodsPerProductSrc(_startDateTime, _endDateTime, _productCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
