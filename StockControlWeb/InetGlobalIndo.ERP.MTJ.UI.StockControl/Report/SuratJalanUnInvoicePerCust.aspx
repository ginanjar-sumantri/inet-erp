<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SuratJalanUnInvoicePerCust.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.SuratJalanUnInvoicePerCust" %>
                                    ...
                                    <%--<tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="ReportTypeDropDownList">
                                                ...
                                                <asp:ListItem Value="0">Summary By Transaction</asp:ListItem>
                                                <asp:ListItem Value="1">Summary By Product </asp:ListItem>
                                                <asp:ListItem Value="2">Detail By Transaction</asp:ListItem>
                                                <asp:ListItem Value="3">Detail By Product</asp:ListItem>
                                            </asp:DropDownList>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="ReportStatusDropDownList">
                                                ...
                                                <asp:ListItem Value="1">Price SO</asp:ListItem>
                                            </asp:DropDownList>
                                                                ...
                                                                <asp:Panel DefaultButton="DataPagerButton" ID="DataPagerPanel" runat="server">
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:ImageButton ID="SearchImageButton2" runat="server" CausesValidation="false" OnClick="SearchImageButton_Click2" />
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="7">
                                                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                                                    <tr>
                                                                        <td>
                                                                            <asp:TextBox ID="CustomerFromTextBox" runat="server"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            To
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="CustomerToTextBox" runat="server"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
