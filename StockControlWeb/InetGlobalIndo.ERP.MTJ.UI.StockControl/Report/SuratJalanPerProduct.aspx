<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SuratJalanPerProduct.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.SuratJalanPerProduct" %>
                                    ...
                                    <%--<tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="ReportTypeDropDownList">
                                                ...
                                                <asp:ListItem Value="1">Summary By Product, Customer</asp:ListItem>
                                                <asp:ListItem Value="2">Detail By Product, Customer</asp:ListItem>
                                                <asp:ListItem Value="3">Detail By Product, Warehouse</asp:ListItem>
                                                <asp:ListItem Value="4">Summary By Product</asp:ListItem>
                                            </asp:DropDownList>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox ID="ProdCodeFromTextBox" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            ~
                                                        </td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="ProdCodeToTextBox" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            ...
                                            <fieldset>
                                                ...
                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:DropDownList ID="CategoryDropDownList1" runat="server">
                                                                                <asp:ListItem Value="Code" Text="Warehouse Code"></asp:ListItem>
                                                                                <asp:ListItem Value="Name" Text="Warehouse Name"></asp:ListItem>
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td>
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <asp:CheckBoxList ID="WarehouseCheckBoxList" RepeatColumns="3" runat="server" RepeatDirection="Vertical">
                                                            </asp:CheckBoxList>
                                                        </td>
                                                    </tr>
                                                </table>
