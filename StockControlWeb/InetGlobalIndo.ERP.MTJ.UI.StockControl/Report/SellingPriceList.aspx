<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SellingPriceList.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.SellingPriceList" %>
                            ...
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ReportDDL" runat="server">
                                                <asp:ListItem Text="Sales Price" Value="1"></asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="TypeDDL" runat="server">
                                                <asp:ListItem Text="Group By Product" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="Group By Product Sub Group" Value="2"></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ByDDL" runat="server" OnSelectedIndexChanged="ByDDL_SelectedIndexChanged"
                                                AutoPostBack="true">
                                                <asp:ListItem Text="By Range" Value="range"></asp:ListItem>
                                                <asp:ListItem Text="By Check" Value="check"></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
