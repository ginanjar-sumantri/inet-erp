...
{
    public partial class SuratJalanUnInvoicePerTrans : ReportBase
    {
        ...
        //private string _reportPath0 = "Report/SuratJalanUnInvoicePerTransSumReport.rdlc";
        //private string _reportPath1 = "Report/SuratJalanUnInvoicePerTransDetailReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSuratJalanUnInvoicePerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Bill Of Lading UnInvoice Per Transaction Report";
        ...
        public void ClearData()
        {
            ...
            if (_bolReferenceType == "SO")
                this.HeaderReportList1.ReportGroup = "SJUnInvoicePerTransSO";
            else if (_bolReferenceType == "DO")
                this.HeaderReportList1.ReportGroup = "SJUnInvoicePerTransDO";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.SuratJalanUnInvoicePerTrans(_startDateTime, _wrhsCode, _productCode, this.HeaderReportList1.SelectedIndex, ReportStatusDropDownList.SelectedValue, this.FilterDropDownList.SelectedValue, this.ProductFromTextBox.Text, this.ProductToTextBox.Text);
