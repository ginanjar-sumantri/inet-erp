<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockAdjustPerWrhs.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.StockAdjustPerWrhs" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="FgReportDropDownList" runat="server">
                                                ...
                                                <asp:ListItem Text="Summary Product" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="Detail Transaction" Value="2"></asp:ListItem>
                                                <asp:ListItem Text="Detail Product" Value="3"></asp:ListItem>
                                            </asp:DropDownList>
