...
{
    public partial class SuratJalanPerCustomer : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SuratJalanPerCustSumByCustReport.rdlc";
        private string _reportPath1 = "Report/SuratJalanPerCustDetailByCustReport.rdlc";
        private string _reportPath2 = "Report/SuratJalanPerCustDetailByProdCustReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSuratJalanPerCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Bill Of Lading Per Customer Report";
                ...
                this.CalendarScriptLiteral2.Text = "<input id='button2' type='button' onclick='displayCalendar(" + this.EndDateTextBox.ClientID + ",&#39" + DateFormMapper.GetFormat() + "&#39,this)' value='...' />";
        ...
        public void ClearData()
        {
            ...
            if (_bolReferenceType == "SO")
                this.HeaderReportList1.ReportGroup = "SJPerCustSO";
            else if (_bolReferenceType == "DO")
                this.HeaderReportList1.ReportGroup = "SJPerCustDO";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.SuratJalanPerCustomer(_startDateTime, _endDateTime, _custCode, _productCode, this.HeaderReportList1.SelectedIndex, this.ReportStatusDropDownList.SelectedValue, this.FilterDropDownList.SelectedValue, this.CustomerFromTextBox.Text, this.CustomerToTextBox.Text, this.ProductFromTextBox.Text, this.ProductToTextBox.Text);
            ...
            _reportParam[6] = new ReportParameter("FgType", this.ReportStatusDropDownList.SelectedValue, true);
            _reportParam[7] = new ReportParameter("FgFilter", this.FilterDropDownList.SelectedValue, true);
            _reportParam[8] = new ReportParameter("FromCustomer", this.CustomerFromTextBox.Text, true);
            _reportParam[9] = new ReportParameter("ToCustomer", this.CustomerToTextBox.Text, true);
            _reportParam[10] = new ReportParameter("FromProduct", this.ProductFromTextBox.Text, true);
            _reportParam[11] = new ReportParameter("ToProduct", this.ProductToTextBox.Text, true);
            _reportParam[12] = new ReportParameter("CompanyName", new UserBL().ConnectionCompany(HttpContext.Current.User.Identity.Name), false);
        ...
        protected void DataPagerTopRepeater_ItemCommand2(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "DataPager")
            {
