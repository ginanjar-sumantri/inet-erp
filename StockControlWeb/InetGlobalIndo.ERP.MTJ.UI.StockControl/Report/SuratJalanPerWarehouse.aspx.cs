...
{
    public partial class SuratJalanPerWarehouse : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SuratJalanPerWrhsSumByWarehouseReport.rdlc";
        private string _reportPath1 = "Report/SuratJalanPerWrhsDetailByWarehouseReport.rdlc";
        private string _reportPath2 = "Report/SuratJalanPerWrhsDetailByWarehouseProdReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSuratJalanPerWrhs, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Bill Of Lading Per Warehouse Report";
                ...
                this.ImageButton1.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/go.jpg";
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "SumPerWHS";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.SuratJalanPerWarehouse(_startDateTime, _endDateTime, _wrhsCode, _productCode, this.HeaderReportList1.SelectedIndex, ReportStatusDropDownList.SelectedValue, Convert.ToInt32(this.SelectionDropDownList.SelectedValue), this.ProdCodeFromTextBox.Text, this.ProdCodeToTextBox.Text);
            ...
            _reportParam[9] = new ReportParameter("FromProduct", this.ProdCodeFromTextBox.Text, true);
            _reportParam[10] = new ReportParameter("ToProduct", this.ProdCodeToTextBox.Text, true);
        ...
        private double RowCountProduct()
        {
            ...
            _result1 = this._productBL.RowsCountProductForReport(_tempProductGroup, _tempProductSubGroup, _tempProductType, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
