<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockOpnamePerProduct.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.Report.StockOpnamePerProduct" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="FgReportDropDownList" runat="server">
                                                ...
                                                <asp:ListItem Text="Detail Warehouse" Value="2"></asp:ListItem>
                                            </asp:DropDownList>
