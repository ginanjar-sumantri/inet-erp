...
{
    public partial class SuratJalanPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SuratJalanPerProductSummaryReport.rdlc";
        private string _reportPath1 = "Report/SuratJalanPerProductSumByProdCustomerReport.rdlc";
        private string _reportPath2 = "Report/SuratJalanPerProductDetailByProdCustomerReport.rdlc";
        private string _reportPath3 = "Report/SuratJalanPerProductSumByProdWarehouseReport.rdlc";
        private string _reportPath4 = "Report/SuratJalanPerProductSumByProdReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSuratJalanPerProd, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Bill Of Lading Per Product Report";
        ...
        public void ShowWarehouse(Int32 _prmCurrentPage)
        {
            ...
            var hasil = this._wrhsBL.GetListDDLWrhsForReport(_tempWrhsGroup, _tempWrhsArea, _prmCurrentPage, _maxrow, this.CategoryDropDownList1.SelectedValue, this.KeywordTextBox1.Text);
        ...
        public void ClearData()
        {
            ...
            if (_bolReferenceType == "SO")
                this.HeaderReportList1.ReportGroup = "DOperProdSo";
            else if (_bolReferenceType == "DO")
                this.HeaderReportList1.ReportGroup = "DOperProdDo";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.ProdCodeFromTextBox.Text == "")
                this.ProdCodeFromTextBox.Text = "000";
            if (this.ProdCodeToTextBox.Text == "")
                this.ProdCodeToTextBox.Text = "zzz";

            ReportDataSource _reportDataSource1 = this._report.SuratJalanPerProduct(_startDateTime, _endDateTime, _wrhsCode, _productCode, this.HeaderReportList1.SelectedIndex, ReportStatusDropDownList.SelectedValue, Convert.ToInt32(this.SelectionDropDownList.SelectedValue), this.ProdCodeFromTextBox.Text, this.ProdCodeToTextBox.Text);
            ...
            //}
            //else if (this.ReportTypeDropDownList.SelectedValue == "4")
            //{
            ...
            _reportParam[2] = new ReportParameter("Str1", _wrhsCode, true);
            ...
            _reportParam[9] = new ReportParameter("FromCustomer", this.ProdCodeFromTextBox.Text, true);
            _reportParam[10] = new ReportParameter("ToCustomer", this.ProdCodeToTextBox.Text, false);
