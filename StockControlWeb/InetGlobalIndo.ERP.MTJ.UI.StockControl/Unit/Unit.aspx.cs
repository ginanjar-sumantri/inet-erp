...
namespace InetGlobalIndo.ERP.MTJ.UI.StockControl.Unit
{
    public partial class Unit : UnitBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._unitBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        //{
        //    double q = this._unitBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._unitBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsUnit _temp = (MsUnit)e.Item.DataItem;
                string _code = _temp.UnitCode.ToString();
                ...
                _viewButton.PostBackUrl = this._viewPage + "?" + this._codeKey + "=" + _code;
                ...
                _editButton.PostBackUrl = this._editPage + "?" + this._codeKey + "=" + _code;
                ...
                Literal _unitCode = (Literal)e.Item.FindControl("UnitCodeLiteral");
                _unitCode.Text = HttpUtility.HtmlEncode(_temp.UnitCode);

                Literal _unitName = (Literal)e.Item.FindControl("UnitNameLiteral");
                _unitName.Text = HttpUtility.HtmlEncode(_temp.UnitName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._unitBL.DeleteMulti(_tempSplit);
