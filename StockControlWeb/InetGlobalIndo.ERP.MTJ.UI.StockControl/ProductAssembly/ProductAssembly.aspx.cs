...
{
    public partial class ProductAssembly : ProductAssemblyBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._productAssemblyBL.RowsCountSTCTrProductAssembly(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._productAssemblyBL.GetListSTCTrProductAssembly(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
