<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="BillOfLadingDetailAddRef.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.BillOfLading.BillOfLadingDetailAddRef" %>
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:CustomValidator ID="DONoDropDownListCustomValidator" runat="server" ErrorMessage="DO No Must Be Filled"
