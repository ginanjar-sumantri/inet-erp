...
{
    public partial class BillOfLadingDetailAddRef : BillOfLadingBase
    {
        ...
        private void ShowDONo()
        {
            ...
            this.DONoDropDownList.DataSource = this._deliveryOrderBL.GetListDONoForDDLInDO(this.CustCodeHiddenField.Value);
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            _stcSJDtReference.ReferenceNmbr = this.DONoDropDownList.SelectedValue;
            _stcSJDtReference.TransDate = _billOfLadingBL.GetSingleMKTDOHd(this.DONoDropDownList.SelectedValue).TransDate;
