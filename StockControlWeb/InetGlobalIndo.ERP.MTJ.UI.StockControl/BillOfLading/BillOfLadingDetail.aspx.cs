...
{
    public partial class BillOfLadingDetail : BillOfLadingBase
    {
        ...
        private string _reportPath1 = "BillOfLading/JournalEntryPrintPreview.rdlc";
        private string _reportPath2 = "BillOfLading/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (this.StatusHiddenField.Value.Trim().ToLower() != BillOfLadingDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
                    ...
                    _editButton.PostBackUrl = this._editDetailPage + "?" + _transNmbr + "&" + _doNumber + "&" + _productKey + "&" + _locationKey;
                ...
                Literal _itemNo = (Literal)e.Item.FindControl("ItemNoLiteral");
                _itemNo.Text = HttpUtility.HtmlEncode(_temp.ItemID.ToString());
        ...
        {
            Response.Redirect(_addDetailRefPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(this.TransNoTextBox.Text, ApplicationConfig.EncryptionKey)));
        }
        ...
        protected void GenerateDetailButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._BillOfLadingBL.GenerateSTCSJDtDO(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void ListRepeater2_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                _fileNmbrLiteral.Text = HttpUtility.HtmlEncode("DO");
