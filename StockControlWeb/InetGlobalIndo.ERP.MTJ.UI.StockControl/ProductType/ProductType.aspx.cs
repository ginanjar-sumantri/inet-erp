...
namespace InetGlobalIndo.ERP.MTJ.UI.StockControl
{
    public partial class ProductType : ProductTypeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._prodTypeBL.RowsCountProductType(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        //{
        //    double q = this._prodTypeBL.RowsCountProductType(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._prodTypeBL.GetListProductType(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsProductType _temp = (MsProductType)e.Item.DataItem;
                string _code = _temp.ProductTypeCode.ToString();
                ...
                Literal _prodTypeCode = (Literal)e.Item.FindControl("ProdTypeCodeLiteral");
                _prodTypeCode.Text = HttpUtility.HtmlEncode(_temp.ProductTypeCode);

                Literal _prodTypeName = (Literal)e.Item.FindControl("ProdTypeNameLiteral");
                _prodTypeName.Text = HttpUtility.HtmlEncode(_temp.ProductTypeName);

                Literal _prodCat = (Literal)e.Item.FindControl("ProdCatLiteral");
                _prodCat.Text = HttpUtility.HtmlEncode(_temp.ProductCategory);

                Literal _isUsingPG = (Literal)e.Item.FindControl("IsUsingPGLiteral");
                _isUsingPG.Text = HttpUtility.HtmlEncode(ProductTypeDataMapper.UsingPG(_temp.IsUsingPG));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._prodTypeBL.DeleteMultiProductType(_tempSplit);
