...
{
    public partial class StockReceivingCustomerDetail : StockReceivingCustomerBase
    {
        ...
        private string _reportPath1 = "StockReceivingCustomer/JournalEntryPrintPreview.rdlc";
        private string _reportPath2 = "StockReceivingCustomer/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stockReceivingCustomerBL.RowsCountSTCRROtherDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stockReceivingCustomerBL = new StockReceivingCustomerBL();
            ...
            this.WarehouseTextBox.Text = this._warehouseBL.GetWarehouseNameByCode(_stcRROtherHd.WrhsCode);

            if (_stcRROtherHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
            {
                this.WarehouseSubledTextBox.Text = this._customerBL.GetNameByCode(_stcRROtherHd.WrhsSubLed);
            }
            ...
            this.StockTypeTextBox.Text = this._stockTypeBL.GetStockTypeNameByCode(_stcRROtherHd.StockType);
            this.CustomerTextBox.Text = this._customerBL.GetNameByCode(_stcRROtherHd.CustCode);
            ...
            this.StatusLabel.Text = StockReceivingCustomerDataMapper.GetStatusText(_stcRROtherHd.Status);
            this.StatusHiddenField.Value = _stcRROtherHd.Status.ToString();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingCustomerDataMapper.GetStatus(TransStatus.Posted).ToString().Trim().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingCustomerDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingCustomerDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingCustomerDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingCustomerDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        //{
        //    double q = this._stockReceivingCustomerBL.RowsCountSTCRROtherDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        public void ShowDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockReceivingCustomerBL.GetListSTCRROtherDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCRROtherDt _temp = (STCRROtherDt)e.Item.DataItem;
                ...
                if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingCustomerDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingCustomerDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stockReceivingCustomerBL.GetApproval(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingCustomerDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stockReceivingCustomerBL.Approve(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingCustomerDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stockReceivingCustomerBL.Posting(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockReceivingCustomerDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stockReceivingCustomerBL.UnPosting(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportStockControlBL.STReceivingCustomerPrintPreview(this.TransNoTextBox.Text);

            this.ReportViewer1.LocalReport.DataSources.Clear();
            this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);

            string _path = _reportListBL.GetPathPrintPreview(AppModule.GetValue(TransactionType.StockReceivingCustomer), _userBL.GetCompanyId(HttpContext.Current.User.Identity.Name));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockReceivingCustomerBL.DeleteMultiSTCRROtherDt(_tempsplit, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
