...
{
    public partial class StockReceivingCustomerDetailAdd : StockReceivingCustomerBase
    {
        ...
        {
            string _tempWarehouseCode = this._stockReceivingCustomerBL.GetWarehouseCodeByCode(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockReceivingCustomerBL.AddSTCRROtherDt(_stcRROtherDt);
