<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PriceGroupAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.PriceGroup.PriceGroupAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="PriceGroupCodeTextBox" Width="100" MaxLength="5"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="PriceGroupRequiredFieldValidator" runat="server"
                                    ErrorMessage="Price Group Code Must Be Filled" Text="*" ControlToValidate="PriceGroupCodeTextBox"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="YearTextBox" Width="70" MaxLength="4"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="YearRequiredFieldValidator" runat="server" ErrorMessage="Year Must Be Filled"
