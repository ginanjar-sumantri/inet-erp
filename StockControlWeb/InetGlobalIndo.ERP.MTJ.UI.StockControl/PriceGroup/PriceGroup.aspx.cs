...
{
    public partial class PriceGroup : PriceGroupBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._priceGroupBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        {
            this.GetFormatExcelLiteral.Text = "<a href='" + ApplicationConfig.StockControlFormatVirDirPath + "Price Group.xls'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download_excel.jpg" + "' border='0'>" + "</a>";
            ...
            {
                this.ListRepeater.DataSource = this._priceGroupBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Master_PriceGroup _temp = (Master_PriceGroup)e.Item.DataItem;
                string _code = _temp.PriceGroupCode;
                string _year = _temp.Year.ToString();
                ...
                _viewButton.PostBackUrl = this._viewPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._yearKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_year, ApplicationConfig.EncryptionKey));
                ...
                _editButton.PostBackUrl = this._editPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._yearKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_year, ApplicationConfig.EncryptionKey));
                ...
                Literal _priceGroupCode = (Literal)e.Item.FindControl("PriceGroupCodeLiteral");
                _priceGroupCode.Text = HttpUtility.HtmlEncode(_temp.PriceGroupCode);

                Literal _priceGroupYear = (Literal)e.Item.FindControl("PriceGroupYearLiteral");
                _priceGroupYear.Text = HttpUtility.HtmlEncode(_temp.Year.ToString());

                Literal _currency = (Literal)e.Item.FindControl("CurrencyLiteral");
                _currency.Text = HttpUtility.HtmlEncode(_temp.CurrCode);

                byte _decimalPlaceForex = this._currencyBL.GetDecimalPlace(_temp.CurrCode.Trim());
                Literal _amountForex = (Literal)e.Item.FindControl("AmountForexLiteral");
                _amountForex.Text = (_temp.AmountForex == 0 ? "0" : HttpUtility.HtmlEncode(_temp.AmountForex.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlaceForex))));

                Literal _fgActive = (Literal)e.Item.FindControl("ActiveLiteral");
                _fgActive.Text = HttpUtility.HtmlEncode(PriceGroupDataMapper.IsActive(_temp.FgActive));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._priceGroupBL.DeleteMulti(_tempSplit);
