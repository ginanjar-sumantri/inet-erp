<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PriceGroupImport.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.PriceGroup.PriceGroupImport" %>
    ...
    <asp:Panel runat="server" ID="LogPanel">
        <table>
            ...
            <tr>
                <td>
                    <fieldset>
                        <legend>Price Group Import Log</legend>
