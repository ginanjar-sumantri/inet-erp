<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="WrhsGroupEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.WarehouseGroup.WrhsGroupEdit" %>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="WrhsGroupNameRequiredFieldValidator" runat="server"
                                    ErrorMessage="WrhsGroup Name Must Be Filled" Text="*" ControlToValidate="WrhsGroupNameTextBox"
