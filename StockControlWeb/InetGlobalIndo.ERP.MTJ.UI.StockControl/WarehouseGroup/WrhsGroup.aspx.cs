...
{
    public partial class WrhsGroup : WarehouseGroupBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._wrhsGroup.RowsCountWrhsGroup(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._wrhsGroup.GetListWrhsGroup(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsWrhsGroup _temp = (MsWrhsGroup)e.Item.DataItem;
                string _code = _temp.WrhsGroupCode.ToString();
                ...
                Literal _wrhsGroupCode = (Literal)e.Item.FindControl("WrhsGroupCodeLiteral");
                _wrhsGroupCode.Text = HttpUtility.HtmlEncode(_temp.WrhsGroupCode);

                Literal _wrhsGroupName = (Literal)e.Item.FindControl("WrhsGroupNameLiteral");
                _wrhsGroupName.Text = HttpUtility.HtmlEncode(_temp.WrhsGroupName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._wrhsGroup.DeleteMultiWrhsGroup(_tempSplit);
