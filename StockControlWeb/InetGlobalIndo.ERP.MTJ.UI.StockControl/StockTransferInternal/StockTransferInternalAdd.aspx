<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockTransferInternalAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockTransferInternal.StockTransferInternalAdd" %>
                    ...
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="WrhsAreaCustomValidator" runat="server" ClientValidationFunction="DropDownValidation"
                                    Text="*" ControlToValidate="WrhsAreaDropDownList" ErrorMessage="Warehouse Area must be filled"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
