...
{
    public partial class StockTransferInternal : StockTransferInternalBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stcTransInternalBL.RowsCountSTCTransferHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stcTransInternalBL.GetListSTCTransferHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stcTransInternalBL.GetSingleSTCTransferHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stcTransInternalBL.DeleteMultiSTCTransferHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCTransferHd _temp = (STCTransferHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockTransferInternalDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockTransferInternalDataMapper.GetStatusText(_temp.Status));

                Literal _wrhsArea = (Literal)e.Item.FindControl("WrhsAreaLiteral");
                _wrhsArea.Text = HttpUtility.HtmlEncode(_wrhsBL.GetWrhsAreaNameByCode(_temp.WrhsArea));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stcTransInternalBL.DeleteMultiAprroveSTCTransferHd(_tempSplit, AppModule.GetValue(TransactionType.StockTransferInternal), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
