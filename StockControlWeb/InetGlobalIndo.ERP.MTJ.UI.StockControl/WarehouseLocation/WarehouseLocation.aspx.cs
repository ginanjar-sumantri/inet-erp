...
{
    public partial class WarehouseLocation : WarehouseLocationBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._warehouseBL.RowsCountWrhsLocation(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._warehouseBL.GetListWrhsLocation(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsWrhsLocation _temp = (MsWrhsLocation)e.Item.DataItem;

                string _code = _temp.WLocationCode.ToString();
                ...
                Literal _wLocationCode = (Literal)e.Item.FindControl("WLocationCodeLiteral");
                _wLocationCode.Text = HttpUtility.HtmlEncode(_temp.WLocationCode);

                Literal _wLocationName = (Literal)e.Item.FindControl("WLocationNameLiteral");
                _wLocationName.Text = HttpUtility.HtmlEncode(_temp.WLocationName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._warehouseBL.DeleteMultiWrhsLocation(_tempSplit);
