<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockChangeGoodDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockChangeGood.StockChangeGoodDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="WrhsSrcTextBox" Width="280" ReadOnly="true" BackColor="#CCCCCC">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="SrcSubledTextBox" Width="420" ReadOnly="true" BackColor="#CCCCCC">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="WrhsDestTextBox" Width="280" ReadOnly="true" BackColor="#CCCCCC">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="DestSubledTextBox" Width="420" ReadOnly="true" BackColor="#CCCCCC">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="OperatorTextBox" MaxLength="40" Width="280" ReadOnly="true"
                                ...
                                <td>
                                    ...
                                    <table cellpadding="3" cellspacing="1" width="100%" border="0">
                                        <tr class="bgcolor_gray">
                                            ...
                                            <td style="width: 100px" class="tahoma_11_white" align="center">
                                                <b>Product Source Code</b>
                                            </td>
                                            <td style="width: 200px" class="tahoma_11_white" align="center">
                                                <b>Product Source Name</b>
                                            </td>
                                            <td style="width: 100px" class="tahoma_11_white" align="center">
                                                <b>Location Source</b>
                                            </td>
                                            <td style="width: 100px" class="tahoma_11_white" align="center">
                                                <b>Product Destination Code</b>
                                            </td>
                                            <td style="width: 200px" class="tahoma_11_white" align="center">
                                                <b>Product Destination Name</b>
                                            </td>
                                            <td style="width: 100px" class="tahoma_11_white" align="center">
                                        ...
                                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="center">
                                                        <asp:Literal runat="server" ID="ProductSrcCodeLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Literal runat="server" ID="ProductSrcLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Literal runat="server" ID="LocationSrcLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="center">
                                                        <asp:Literal runat="server" ID="ProductDestCodeLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Literal runat="server" ID="ProductDestLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="left">
                                                        <asp:Literal runat="server" ID="LocationDestLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="right">
