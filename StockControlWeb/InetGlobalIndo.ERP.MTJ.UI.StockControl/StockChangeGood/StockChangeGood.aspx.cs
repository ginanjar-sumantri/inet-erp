...
{
    public partial class StockChangeGood : StockChangeGoodBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stcChangeGoodBL.RowsCountSTCChangeHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stcChangeGoodBL.GetListSTCChangeHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stcChangeGoodBL.GetSingleSTCChangeHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stcChangeGoodBL.DeleteMultiSTCChangeHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCChangeHd _temp = (STCChangeHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockChangeGoodDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockChangeGoodDataMapper.GetStatusText(_temp.Status));

                Literal _wrhsSrc = (Literal)e.Item.FindControl("WrhsSrcLiteral");
                _wrhsSrc.Text = HttpUtility.HtmlEncode(_temp.WrhsSrcName);

                Literal _wrhsDest = (Literal)e.Item.FindControl("WrhsDestLiteral");
                _wrhsDest.Text = HttpUtility.HtmlEncode(_temp.WrhsDestName);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stcChangeGoodBL.DeleteMultiApproveSTCChangeHd(_tempSplit, AppModule.GetValue(TransactionType.StockChangeGood), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
