...
{
    public partial class StockChangeGoodDetail : StockChangeGoodBase
    {
        ...
        //private string _reportPath1 = "StockChangeGood/STChangeGoodPrintPreview.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stcChangeGoodBL.RowsCountSTCChangeDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stcChangeGoodBL = new StockChangeGoodBL();
            ...
            this.WrhsSrcTextBox.Text = _wrhs.GetWarehouseNameByCode(_stcChangeGoodHd.WrhsSrc);
            this.WrhsDestTextBox.Text = _wrhs.GetWarehouseNameByCode(_stcChangeGoodHd.WrhsDest);
            this.OperatorTextBox.Text = _stcChangeGoodHd.Operator;
            this.RemarkTextBox.Text = _stcChangeGoodHd.Remark;
            if (_stcChangeGoodHd.WrhsSrcFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.NoSubled))
            {
                this.SrcSubledTextBox.Text = "";
            }
            else
            {
                if (_stcChangeGoodHd.WrhsSrcFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
                {
                    this.SrcSubledTextBox.Text = _custBL.GetNameByCode(_stcChangeGoodHd.WrhsSrcSubLed);
                }
                else if (_stcChangeGoodHd.WrhsSrcFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
                {
                    this.SrcSubledTextBox.Text = _suppBL.GetSuppNameByCode(_stcChangeGoodHd.WrhsSrcSubLed);
                }
            }
            if (_stcChangeGoodHd.WrhsDestFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.NoSubled))
            {
                this.DestSubledTextBox.Text = "";
            }
            else
            {
                if (_stcChangeGoodHd.WrhsDestFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
                {
                    this.DestSubledTextBox.Text = _custBL.GetNameByCode(_stcChangeGoodHd.WrhsDestSubLed);
                }
                else if (_stcChangeGoodHd.WrhsDestFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
                {
                    this.DestSubledTextBox.Text = _suppBL.GetSuppNameByCode(_stcChangeGoodHd.WrhsDestSubLed);
                }
            }

            this.StatusHiddenField.Value = _stcChangeGoodHd.Status.ToString();
            this.StatusLabel.Text = StockChangeGoodDataMapper.GetStatusText(_stcChangeGoodHd.Status);
            ...
            {
                this.ListRepeater.DataSource = this._stcChangeGoodBL.GetListSTCChangeDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text);
            }
            this.ListRepeater.DataBind();

            this.AllCheckBox.Checked = this.IsCheckedAll();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockChangeGoodDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockChangeGoodDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockChangeGoodDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockChangeGoodDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockChangeGoodDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockChangeGoodDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stcChangeGoodBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockChangeGoodDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stcChangeGoodBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockChangeGoodDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stcChangeGoodBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockChangeGoodDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stcChangeGoodBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportStockControlBL.STChangeGoodPrintPreview(this.TransNoTextBox.Text);

            this.ReportViewer1.LocalReport.DataSources.Clear();
            this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);

            string _path = _reportListBL.GetPathPrintPreview(AppModule.GetValue(TransactionType.StockChangeGood), _userBL.GetCompanyId(HttpContext.Current.User.Identity.Name));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stcChangeGoodBL.DeleteMultiSTCChangeDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCChangeDt _temp = (STCChangeDt)e.Item.DataItem;

                string _code1 = _temp.ProductSrc.ToString();
                string _code2 = _temp.LocationSrc.ToString();
                ...
                if (this.StatusHiddenField.Value.ToLower() != StockChangeGoodDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
                ...
                Literal _productSrcCode = (Literal)e.Item.FindControl("ProductSrcCodeLiteral");
                _productSrcCode.Text = HttpUtility.HtmlEncode(_temp.ProductSrc);

                Literal _productSrc = (Literal)e.Item.FindControl("ProductSrcLiteral");
                _productSrc.Text = HttpUtility.HtmlEncode(_productBL.GetProductNameByCode(_temp.ProductSrc));

                Literal _locationSrc = (Literal)e.Item.FindControl("LocationSrcLiteral");
                _locationSrc.Text = HttpUtility.HtmlEncode(_wrhs.GetWarehouseLocationNameByCode(_temp.LocationSrc));

                Literal _productDestCode = (Literal)e.Item.FindControl("ProductDestCodeLiteral");
                _productDestCode.Text = HttpUtility.HtmlEncode(_temp.ProductDest);

                Literal _productDest = (Literal)e.Item.FindControl("ProductDestLiteral");
                _productDest.Text = HttpUtility.HtmlEncode(_productBL.GetProductNameByCode(_temp.ProductDest));

                Literal _locationDest = (Literal)e.Item.FindControl("LocationDestLiteral");
                _locationDest.Text = HttpUtility.HtmlEncode(_wrhs.GetWarehouseLocationNameByCode(_temp.LocationDest));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.StockChangeGood), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.WarningLabel.Text = _result;
