...
{
    public partial class StockBeginning : StockBeginningBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockBeginBL.RowsCountSTCAdjustHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockBeginBL.GetListSTCAdjustHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockBeginBL.GetSingleSTCAdjustHdHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockBeginBL.DeleteMultiSTCAdjustHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (_temp.Status != StockBeginningDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockBeginningDataMapper.GetStatusText(_temp.Status));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockBeginBL.DeleteMultiApproveSTCAdjustHd(_tempSplit, AppModule.GetValue(TransactionType.StockBeginning), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
