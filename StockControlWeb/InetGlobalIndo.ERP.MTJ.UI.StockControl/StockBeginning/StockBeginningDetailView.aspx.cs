...
{
    public partial class StockBeginningDetailView : StockBeginningBase
    {
        ...
        private void ShowData(int _prmCurrentPage)
        {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (_stockBeginBL.GetSingleSTCAdjustHd(_transNo).Status != StockBeginningDataMapper.GetStatus(TransStatus.Posted))
                {
