...
{
    public partial class StockBeginningDetail : StockBeginningBase
    {
        ...
        private string _reportPath1 = "StockBeginning/STBeginPrintPreview.rdlc";
        private string _reportPath2 = "StockBeginning/JournalEntryPrintPreview.rdlc";
        private string _reportPath3 = "StockBeginning/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stockBeginBL.RowsCountSTCAdjustDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            this.GetFormatExcelLiteral.Text = "<a href='" + ApplicationConfig.StockControlFormatVirDirPath + "StockBeginning.xls'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download_excel.jpg" + "' border='0'>" + "</a>";

            _stockBeginBL = new StockBeginningBL();
            ...
            {
                this.SubledTextBox.Text = _custBL.GetNameByCode(_stcAdjustHd.WrhsSubled);
            }
            else if (_stcAdjustHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
            {
                this.SubledTextBox.Text = _suppBL.GetSuppNameByCode(_stcAdjustHd.WrhsSubled);
            }
            else
            {
            ...
            {
                this.ListRepeater.DataSource = this._stockBeginBL.GetListSTCAdjustDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text);
            }
            this.ListRepeater.DataBind();

            this.AllCheckBox.Checked = this.IsCheckedAll();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockBeginningDataMapper.GetStatus(TransStatus .Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
                this.GetFormatExcelLiteral.Visible = false;
            ...
            else
            {
                ...
                this.GetFormatExcelLiteral.Visible = true;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockBeginningDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockBeginningDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockBeginningDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockBeginningDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockBeginBL.DeleteMultiSTCAdjustDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        {
            Response.Redirect(this._stockBeginningImportPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)));
        }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                decimal _priceCost = (_temp.PriceCost == null) ? ' ' : Convert.ToDecimal(_temp.PriceCost);
                _price.Text = HttpUtility.HtmlEncode((_priceCost == 0) ? "0" : _priceCost.ToString("#,##0.##"));

                Literal _total = (Literal)e.Item.FindControl("TotalLiteral");
                decimal _totalCost = (_temp.TotalCost == null) ? 0 : Convert.ToDecimal(_temp.TotalCost);
                _total.Text = HttpUtility.HtmlEncode((_totalCost == 0) ? "0" : _totalCost.ToString("#,##0.##"));
            }
        }
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockBeginningDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stockBeginBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockBeginningDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stockBeginBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockBeginningDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stockBeginBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockBeginningDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stockBeginBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportStockControlBL.STBeginPrintPreview(this.TransNoTextBox.Text);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.StockBeginning), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.WarningLabel.Text = _result;
