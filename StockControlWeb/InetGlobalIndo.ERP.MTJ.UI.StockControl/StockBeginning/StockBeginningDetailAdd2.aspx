<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockBeginningDetailAdd2.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockBeginning.StockBeginningDetailAdd2" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="SerialNumberTextBox" runat="server" Width="250">
                                </asp:TextBox>
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="SerialNumberTextBox"
                                    Text="*" ErrorMessage="Serial Number Must Be Filled"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
