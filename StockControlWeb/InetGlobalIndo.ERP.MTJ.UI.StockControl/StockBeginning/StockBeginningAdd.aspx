<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockBeginningAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockBeginning.StockBeginningAdd" %>
                            ...
                            <ContentTemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Warehouse Must Be Choosed"
