...
{
    public partial class StockAdjustmentEdit : StockAdjustmentBase
    {
        ...
        public void ShowData()
        {
            ...
            this.StockTypeDropDownList.SelectedValue = _stcAdjustHd.StockType;
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockAdjustBL.EditSTCAdjustHd(_stcAdjustHd);
        ...
        protected void SaveAndViewDetailButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            _stcAdjustHd.WrhsSubled = ((this.SubledDropDownList.SelectedValue == "null") ? "" : this.SubledDropDownList.SelectedValue);
            _stcAdjustHd.StockType = this.StockTypeDropDownList.SelectedValue;
            _stcAdjustHd.UserPrep = HttpContext.Current.User.Identity.Name;
            _stcAdjustHd.DatePrep = DateTime.Now;
