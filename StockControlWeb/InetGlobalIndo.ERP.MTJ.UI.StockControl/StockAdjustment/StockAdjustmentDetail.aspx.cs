...
{
    public partial class StockAdjustmentDetail : StockAdjustmentBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockAdjustBL.RowsCountSTCAdjustDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stockAdjustBL = new StockAdjustmentBL();
            ...
            this.CurrencyTextBox.Text = _stcAdjustHd.CurrCode;
            ...
            {
                this.OpnameNoTextBox.Text = this._stockAdjustBL.GetFileNmbrSTCOpnameHd(_stcAdjustHd.OpnameNo);
            }
            else
            {
                this.OpnameNoTextBox.Text = "";
            }
            this.RemarkTextBox.Text = _stcAdjustHd.Remark;
            this.OperatorTextBox.Text = _stcAdjustHd.Operator;
            this.WarehouseTextBox.Text = _warehouseBL.GetWarehouseNameByCode(_stcAdjustHd.WrhsCode);
            if (_stcAdjustHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
            {
                this.SubledTextBox.Text = _cust.GetNameByCode(_stcAdjustHd.WrhsSubled);
            }
            else if (_stcAdjustHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
            {
                this.SubledTextBox.Text = _supp.GetSuppNameByCode(_stcAdjustHd.WrhsSubled);
            }
            else
            {
                this.SubledTextBox.Text = "";
            }
            this.StockTypeTextBox.Text = _stockTypeBL.GetStockTypeNameByCode(_stcAdjustHd.StockType);
            this.StatusHiddenField.Value = _stcAdjustHd.Status.ToString();
            this.StatusLabel.Text = StockAdjustmentDataMapper.GetStatusText(_stcAdjustHd.Status);
            ...
            {
                this.ListRepeater.DataSource = this._stockAdjustBL.GetListSTCAdjustDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
            this.ListRepeater.DataBind();

            this.AllCheckBox.Checked = this.IsCheckedAll();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockAdjustmentDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockAdjustmentDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockAdjustmentDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockAdjustmentDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockAdjustmentDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockAdjustBL.DeleteMultiSTCAdjustDt(_tempSplit, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCAdjustHd _stcAdjustHd = this._stockAdjustBL.GetSingleSTCAdjustHd(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
                STCAdjustDt _temp = (STCAdjustDt)e.Item.DataItem;
                ...
                _adjust.Text = HttpUtility.HtmlEncode(_temp.FgAdjust.ToString());
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockAdjustmentDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stockAdjustBL.GetAppr(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockAdjustmentDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stockAdjustBL.Approve(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockAdjustmentDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stockAdjustBL.Posting(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);
