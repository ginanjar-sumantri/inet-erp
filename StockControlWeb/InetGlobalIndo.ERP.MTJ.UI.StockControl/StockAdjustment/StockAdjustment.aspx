<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockAdjustment.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockAdjustment.StockAdjustment" %>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="OpnameNoLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
