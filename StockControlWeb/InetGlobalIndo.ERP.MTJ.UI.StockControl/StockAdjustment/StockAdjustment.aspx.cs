...
{
    public partial class StockAdjustment : StockAdjustmentBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockAdjustBL.RowsCountSTCAdjustHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockAdjustBL.GetListSTCAdjustHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockAdjustBL.GetSingleSTCAdjustHdHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockAdjustBL.DeleteMultiSTCAdjustHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCAdjustHd _temp = (STCAdjustHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockAdjustmentDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                Literal _opnameNo = (Literal)e.Item.FindControl("OpnameNoLiteral");
                _opnameNo.Text = HttpUtility.HtmlEncode(_temp.FileNo);

                Literal _warehouse = (Literal)e.Item.FindControl("WarehouseLiteral");
                _warehouse.Text = HttpUtility.HtmlEncode(_temp.WrhsName);

                Literal _stockType = (Literal)e.Item.FindControl("StockTypeLiteral");
                _stockType.Text = HttpUtility.HtmlEncode(_temp.StockTypeName);
            }
        }
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockAdjustBL.DeleteMultiApproveSTCAdjustHd(_tempSplit, AppModule.GetValue(TransactionType.StockAdjustment), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
