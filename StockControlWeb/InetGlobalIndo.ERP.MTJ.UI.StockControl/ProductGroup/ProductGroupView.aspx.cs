...
{
    public partial class ProductGroupView : ProductGroupBase
    {
        private ProductBL _productGroup = new ProductBL();
        ...
        {
            MsProductGroup _msProductGroup = this._productGroup.GetSingle(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
