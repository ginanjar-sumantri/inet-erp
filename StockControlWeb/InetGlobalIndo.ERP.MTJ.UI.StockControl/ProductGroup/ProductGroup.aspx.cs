...
{
    public partial class ProductGroup : ProductGroupBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._productGroupBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        //{
        //    double q = this._productGroupBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._productGroupBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string _code = _temp.ProductGrpCode.ToString();
                ...
                Literal _productGroupBLCode = (Literal)e.Item.FindControl("ProductGroupCodeLiteral");
                _productGroupBLCode.Text = HttpUtility.HtmlEncode(_temp.ProductGrpCode);

                Literal _productGroupBLName = (Literal)e.Item.FindControl("ProductGroupNameLiteral");
                _productGroupBLName.Text = HttpUtility.HtmlEncode(_temp.ProductGrpName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._productGroupBL.DeleteMulti(_tempSplit);
