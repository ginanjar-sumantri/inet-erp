...
{
    public partial class ProductDisAssembly : ProductDisAssemblyBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._productAssemblyBL.RowsCountSTCTrProductDisAssembly(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._productAssemblyBL.GetListSTCTrProductDisAssembly(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._productAssemblyBL.GetSTCTrProductAssemblyForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._productAssemblyBL.DeleteMultiSTCTrProductAssembly(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCTrProductAssembly _temp = (STCTrProductAssembly)e.Item.DataItem;
                ...
                if (_temp.Status != TransactionDataMapper.GetStatusByte(TransStatus.Posted))
                {
                ...
                _status.Text = NCPSalesDataMapper.GetStatusText(_temp.Status);

                Literal _qty = (Literal)e.Item.FindControl("QtyLiteral");
                _qty.Text = HttpUtility.HtmlEncode(_temp.Qty.ToString("#,##0.##"));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._productAssemblyBL.DeleteMultiApproveSTCTrProductAssembly(_tempSplit, AppModule.GetValue(TransactionType.BillOfLading), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
