...
{
    public partial class CogsProcessAdd : CogsProcessBase
    {
        ...
        {
            STCProcessHd _STCProcessHd = new STCProcessHd();
            ...
            string _result = this._cogsProcessBL.AddStcProcessHd(_STCProcessHd);
