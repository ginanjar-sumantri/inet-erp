...
using InetGlobalIndo.ERP.MTJ.UI.StockControl.CogsProcess;

namespace InetGlobalIndo.ERP.MTJ.UI.StockControl.CogsProcess
{
    public partial class CogsProcess : CogsProcessBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._cogsProcessBL.RowsCountStcProcessHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._cogsProcessBL.GetListStcProcessHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._cogsProcessBL.GetSingleStcProcessHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._cogsProcessBL.DeleteMultiStcProcessHd(_tempSplit);
                if (_result == true)
                {
            ...
            //bool _result = this._stockAdjustBL.DeleteMultiSTCProcessHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCProcessHd _temp = (STCProcessHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockAdjustmentDataMapper.GetStatus(TransStatus.Posted)&&_temp.Status != StockAdjustmentDataMapper.GetStatus(TransStatus.Complete))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockAdjustmentDataMapper.GetStatusText(_temp.Status));

                Literal _startDate = (Literal)e.Item.FindControl("StartDateLiteral");
                _startDate.Text = DateFormMapper.GetValue(_temp.StartDate);

                Literal _endDate = (Literal)e.Item.FindControl("EndDateLiteral");
                _endDate.Text = DateFormMapper.GetValue(_temp.EndDate);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._cogsProcessBL.DeleteMultiApproveStcProcessHd(_tempSplit, AppModule.GetValue(TransactionType.StockAdjustment), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
