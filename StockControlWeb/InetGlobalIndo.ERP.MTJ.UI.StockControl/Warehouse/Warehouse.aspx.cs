...
{
    public partial class Warehouse : WarehouseBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._warehouse.RowsCountWarehouse(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._warehouse.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsWarehouse _temp = (MsWarehouse)e.Item.DataItem;
                string _code = _temp.WrhsCode.ToString();
                ...
                Literal _warehouseCode = (Literal)e.Item.FindControl("WarehouseCodeLiteral");
                _warehouseCode.Text = HttpUtility.HtmlEncode(_temp.WrhsCode);

                Literal _warehouseName = (Literal)e.Item.FindControl("WarehouseNameLiteral");
                _warehouseName.Text = HttpUtility.HtmlEncode(_temp.WrhsName);

                Literal _warehouseGroup = (Literal)e.Item.FindControl("WarehouseGroupLiteral");
                _warehouseGroup.Text = HttpUtility.HtmlEncode(_warehouse.GetWrhsGroupNameByCode(_temp.WrhsGroup));

                Literal _warehouseArea = (Literal)e.Item.FindControl("WarehouseAreaLiteral");
                _warehouseArea.Text = HttpUtility.HtmlEncode(_warehouse.GetWrhsAreaNameByCode(_temp.WrhsArea));

                Literal _status = (Literal)e.Item.FindControl("StatusLiteral");
                _status.Text = WarehouseDataMapper.GetStatus(_temp.FgActive);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._warehouse.DeleteMulti(_tempSplit);
