...
{
    public partial class WarehouseDetail : WarehouseBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._warehouse.RowsCountMsWarehouseWrhsLocation(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        public void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._warehouse.GetListMsWarehouseWrhsLocation(_prmCurrentPage, _maxrow, this.WarehouseCodeTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._warehouse.DeleteMultiMsWarehouseWrhsLocation(_tempSplit, this.WarehouseCodeTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsWarehouse_MsWrhsLocation _temp = (MsWarehouse_MsWrhsLocation)e.Item.DataItem;
                string _code = _temp.WLocation.ToString();
                ...
                Literal _wrhsLocCode = (Literal)e.Item.FindControl("WrhsLocCodeLiteral");
                _wrhsLocCode.Text = HttpUtility.HtmlEncode(_temp.WLocation);

                Literal _wrhsLocName = (Literal)e.Item.FindControl("WrhsLocNameLiteral");
                _wrhsLocName.Text = HttpUtility.HtmlEncode(_temp.WLocationName);
            }
        }
