...
{
    public partial class DirectBillOfLading : DirectBillOfLadingBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._directBillOfLadingBL.RowsCountSTCTrDirectSJHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._directBillOfLadingBL.GetListSTCTrDirectSJHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._directBillOfLadingBL.GetSingleSTCTrDirectSJHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._directBillOfLadingBL.DeleteMultiSTCTrDirectSJHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCTrDirectSJHd _temp = (STCTrDirectSJHd)e.Item.DataItem;
                ...
                if (_temp.Status != DirectBillOfLadingDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                string _statusText = DirectBillOfLadingDataMapper.GetStatusText(_temp.Status);
                ...
                _custCode.Text = HttpUtility.HtmlEncode(_temp.CustCode);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._directBillOfLadingBL.DeleteMultiApproveSTCTrDirectSJHd(_tempSplit, AppModule.GetValue(TransactionType.DirectBillOfLading), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
