...
{
    public partial class StockTransferExternalSJDetail : StockTransferExternalSJBase
    {
        ...
        private string _reportPath1 = "ReceivingPO/JournalEntryPrintPreview.rdlc";
        private string _reportPath2 = "ReceivingPO/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stcTransOutBL.RowsCountSTCTransOutDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stcTransOutBL = new StockTransferExternalSJBL();
            ...
            this.WrhsSrcTextBox.Text = _wrhsBL.GetWarehouseNameByCode(_stcTransOutHd.WrhsSrc);
            this.WrhsDestTextBox.Text = _wrhsBL.GetWarehouseNameByCode(_stcTransOutHd.WrhsDest);
            ...
            if (_stcTransOutHd.RequestNo != "null")
            {
                this.RequestNoTextBox.Text = _stcTransReq.GetFileNmbrSTCTransReqHd(_stcTransOutHd.RequestNo);
            }
            else
            {
                this.RequestNoTextBox.Text = "";
            }

            this.WrhsAreaSrcTextBox.Text = _wrhsBL.GetWrhsAreaNameByCode(_stcTransOutHd.WrhsAreaSrc);
            this.WrhsAreaDestTextBox.Text = _wrhsBL.GetWrhsAreaNameByCode(_stcTransOutHd.WrhsAreaDest);
            if (_stcTransOutHd.WrhsSrcFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.NoSubled))
            {
                this.SrcSubledTextBox.Text = "";
            }
            else
            {
                if (_stcTransOutHd.WrhsSrcFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
                {
                    this.SrcSubledTextBox.Text = _custBL.GetNameByCode(_stcTransOutHd.WrhsSrcSubLed);
                }
                else if (_stcTransOutHd.WrhsSrcFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
                {
                    this.SrcSubledTextBox.Text = _suppBL.GetSuppNameByCode(_stcTransOutHd.WrhsSrcSubLed);
                }
            }
            if (_stcTransOutHd.WrhsDestFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.NoSubled))
            {
                this.DestSubledTextBox.Text = "";
            }
            else
            {
                if (_stcTransOutHd.WrhsDestFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
                {
                    this.DestSubledTextBox.Text = _custBL.GetNameByCode(_stcTransOutHd.WrhsDestSubLed);
                }
                else if (_stcTransOutHd.WrhsDestFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
                {
                    this.DestSubledTextBox.Text = _suppBL.GetSuppNameByCode(_stcTransOutHd.WrhsDestSubLed);
                }
            }

            this.StatusHiddenField.Value = _stcTransOutHd.Status.ToString();
            this.StatusLabel.Text = StockTransferExternalSJDataMapper.GetStatusText(_stcTransOutHd.Status);
            ...
            {
                this.ListRepeater.DataSource = this._stcTransOutBL.GetListSTCTransOutDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text);
            }
            this.ListRepeater.DataBind();

            this.AllCheckBox.Checked = this.IsCheckedAll();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalSJDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalSJDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalSJDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalSJDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalSJDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalSJDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stcTransOutBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalSJDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stcTransOutBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalSJDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stcTransOutBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockTransferExternalSJDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stcTransOutBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportStockControlBL.STTransDeliveryPrintPreview(this.TransNoTextBox.Text);

            this.ReportViewer1.LocalReport.DataSources.Clear();
            this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);

            string _path = _reportListBL.GetPathPrintPreview(AppModule.GetValue(TransactionType.StockTransferExternalSJ), _userBL.GetCompanyId(HttpContext.Current.User.Identity.Name));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stcTransOutBL.DeleteMultiSTCTransOutDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCTransOutDt _temp = (STCTransOutDt)e.Item.DataItem;
                ...
                if (this.StatusHiddenField.Value.ToLower() != StockTransferExternalSJDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
                ...
                _location.Text = HttpUtility.HtmlEncode(_wrhsBL.GetWarehouseLocationNameByCode(_temp.LocationCode));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.StockTransferExternalSJ), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.WarningLabel.Text = _result;
