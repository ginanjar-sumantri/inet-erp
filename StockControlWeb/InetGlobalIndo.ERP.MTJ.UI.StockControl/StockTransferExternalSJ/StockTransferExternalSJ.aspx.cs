...
{
    public partial class StockTransferExternalSJ : StockTransferExternalSJBase
    {
        private WarehouseBL _wrhs = new WarehouseBL();
        private StockTransferExternalSJBL _stcTransExSJ = new StockTransferExternalSJBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._stcTransExSJ.RowsCountSTCTransOutHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stcTransExSJ.GetListSTCTransOutHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stcTransExSJ.GetSingleSTCTransOutHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stcTransExSJ.DeleteMultiSTCTransOutHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCTransOutHd _temp = (STCTransOutHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockTransferExternalSJDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockTransferExternalSJDataMapper.GetStatusText(_temp.Status));

                Literal _wrhsSrc = (Literal)e.Item.FindControl("WrhsAreaSrcLiteral");
                _wrhsSrc.Text = HttpUtility.HtmlEncode(_temp.WrhsSrcName);

                Literal _wrhsDest = (Literal)e.Item.FindControl("WrhsAreaDestLiteral");
                _wrhsDest.Text = HttpUtility.HtmlEncode(_temp.WrhsDestName);

                Literal _requestNo = (Literal)e.Item.FindControl("RequestNoLiteral");
                _requestNo.Text = HttpUtility.HtmlEncode(_temp.FileNoRequest);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stcTransExSJ.DeleteMultiApproveSTCTransOutHd(_tempSplit, AppModule.GetValue(TransactionType.StockTransferExternalSJ), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
