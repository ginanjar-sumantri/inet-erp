...
{
    public partial class StockServiceInDetail : StockServiceInBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockServiceInBL.RowsCountSTCServiceInDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stockServiceInBL = new StockServiceInBL();
            ...
            this.CustomerTextBox.Text = this._customerBL.GetNameByCode(_stcServiceInHd.CustCode);
            this.WarehouseTextBox.Text = this._warehouseBL.GetWarehouseNameByCode(_stcServiceInHd.WrhsCode);

            if (_stcServiceInHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
            {
                this.WarehouseSubledTextBox.Text = this._customerBL.GetNameByCode(_stcServiceInHd.WrhsSubLed);
            }
            ...
            this.StatusLabel.Text = StockServiceInDataMapper.GetStatusText(_stcServiceInHd.Status);
            this.StatusHiddenField.Value = _stcServiceInHd.Status.ToString();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockServiceInDataMapper.GetStatus(TransStatus.Posted).ToString().Trim().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockServiceInDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockServiceInDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockServiceInDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockServiceInDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        //{
        //    double q = this._stockServiceInBL.RowsCountSTCServiceInDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        public void ShowDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockServiceInBL.GetListSTCServiceInDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCServiceInDt _temp = (STCServiceInDt)e.Item.DataItem;
                ...
                if (this.StatusHiddenField.Value.Trim().ToLower() == StockServiceInDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockServiceInDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stockServiceInBL.GetApproval(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockServiceInDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stockServiceInBL.Approve(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockServiceInDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stockServiceInBL.Posting(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockServiceInDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stockServiceInBL.UnPosting(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockServiceInBL.DeleteMultiSTCServiceInDt(_tempsplit, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportStockControlBL.STServiceInPrintPreview(this.TransNoTextBox.Text);

            this.ReportViewer1.LocalReport.DataSources.Clear();
            this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);

            string _path = "StockServiceIn\\StockServiceInPrintPreview.rdlc";
