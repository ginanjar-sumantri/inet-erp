...
{
    public partial class StockServiceIn : StockServiceInBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockServiceInBL.RowsCountSTCServiceInHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockServiceInBL.GetListSTCServiceInHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text.Trim());
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCServiceInHd _temp = (STCServiceInHd)e.Item.DataItem;
                ...
                if (_tempStatus.ToLower() == StockServiceInDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
                ...
                _statusLiteral.Text = HttpUtility.HtmlEncode(StockServiceInDataMapper.GetStatusText(_temp.Status));
                ...
                _receivedByLiteral.Text = HttpUtility.HtmlEncode(_temp.ReceivedBy);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockServiceInBL.GetSingleSTCServiceInHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockServiceInBL.DeleteMultiSTCServiceInHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockServiceInBL.DeleteMultiApproveSTCServiceInHd(_tempSplit, AppModule.GetValue(TransactionType.StockServiceIn), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
