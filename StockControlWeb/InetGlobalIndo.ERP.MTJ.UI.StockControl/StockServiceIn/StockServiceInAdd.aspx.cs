...
{
    public partial class StockServiceInAdd : StockServiceInBase
    {
        ...
        {
            STCServiceInHd _stcServiceInHd = new STCServiceInHd();
            ...
            _stcServiceInHd.Status = StockServiceInDataMapper.GetStatus(TransStatus.OnHold);
            ...
            string _result = this._stockServiceInBL.AddSTCServiceInHd(_stcServiceInHd);
