<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockServiceInDetailEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockServiceIn.StockServiceInDetailEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="IMEINoTextBox" Width="150" MaxLength="18" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="QtyTextBox" Width="150" MaxLength="18" BackColor="#CCCCCC" ReadOnly="true"></asp:TextBox>
