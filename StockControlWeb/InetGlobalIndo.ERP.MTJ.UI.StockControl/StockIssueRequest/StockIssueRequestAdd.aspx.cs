...
{
    public partial class StockIssueRequestAdd : StockIssueRequestBase
    {
        ...
        protected void NextButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            _stcRequestHd.Status = StockIssueRequestDataMapper.GetStatus(TransStatus.OnHold);
            ...
            _stcRequestHd.FgType = AppModule.GetValue(TransactionType.StockIssueRequest);
            ...
            string _result = this._stockIssueBL.AddSTCRequestHd(_stcRequestHd);
