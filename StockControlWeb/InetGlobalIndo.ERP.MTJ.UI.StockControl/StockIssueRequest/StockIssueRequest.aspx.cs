...
{
    public partial class StockIssueRequest : StockIssueRequestBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockIssueBL.RowsCountSTCRequestHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockIssueBL.GetListSTCRequestHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockIssueBL.GetSingleSTCRequestHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockIssueBL.DeleteMultiSTCRequestHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (_temp.Status != StockIssueRequestDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockIssueRequestDataMapper.GetStatusText(_temp.Status));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockIssueBL.DeleteMultiApproveSTCRequestHd(_tempSplit, AppModule.GetValue(TransactionType.StockIssueRequest), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
