...
{
    public partial class StockIssueRequestDetail : StockIssueRequestBase
    {
        ...
        //private string _reportPath1 = "StockIssueRequest/STRequestPrintPreview.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stockIssueBL.RowsCountSTCRequestDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stockIssueBL = new StockIssueRequestBL();
            ...
            this.OrgUnitTextBox.Text = _orgBL.GetDescriptionByCode(_stcRequestHd.OrgUnit);
            this.RequestByTextBox.Text = _stcRequestHd.RequestBy;
            this.RemarkTextBox.Text = _stcRequestHd.Remark;
            this.StatusHiddenField.Value = _stcRequestHd.Status.ToString();
            ...
            {
                this.ListRepeater.DataSource = this._stockIssueBL.GetListSTCRequestDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text);
            }
            this.ListRepeater.DataBind();

            this.AllCheckBox.Checked = this.IsCheckedAll();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockIssueBL.DeleteMultiSTCRequestDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCRequestDt _temp = (STCRequestDt)e.Item.DataItem;
                ...
                if ((this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower()) && (_temp.DoneClosing.ToString().Trim().ToLower() == StockIssueRequestDataMapper.GetStatusDetail(StockIssueRequestStatusDt.Open).ToString().Trim().ToLower()) && _temp.Qty > (((_temp.QtyWIS == null) ? 0 : _temp.QtyWIS) + ((_temp.QtyClose == null) ? 0 : _temp.QtyClose)))
                {
                ...
                _doneClosing.Text = HttpUtility.HtmlEncode(StockIssueRequestDataMapper.GetStatusTextDetail(_doneClose1));
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stockIssueBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stockIssueBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stockIssueBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueRequestDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stockIssueBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportStockControlBL.STRequestPrintPreview(this.TransNoTextBox.Text);

            this.ReportViewer1.LocalReport.DataSources.Clear();
            this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);

            string _path = _reportListBL.GetPathPrintPreview(AppModule.GetValue(TransactionType.StockIssueRequest), _userBL.GetCompanyId(HttpContext.Current.User.Identity.Name));
        ...
        protected void ListRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "CloseButton")
            {
                ...
                string _result = this._stockIssueBL.Closing(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), e.CommandArgument.ToString(), this.DescriptionHiddenField.Value, HttpContext.Current.User.Identity.Name);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.StockIssueRequest), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.WarningLabel.Text = _result;
