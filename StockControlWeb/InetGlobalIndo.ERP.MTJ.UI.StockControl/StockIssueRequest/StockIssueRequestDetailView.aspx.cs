...
{
    public partial class StockIssueRequestDetailView : StockIssueRequestBase
    {
        ...
        {
            STCRequestDt _stcRequestDt = this._stockIssueBL.GetSingleSTCRequestDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), Rijndael.Decrypt(this._nvcExtractor.GetValue(this._productKey), ApplicationConfig.EncryptionKey));
            STCRequestHd _stcRequestHd = this._stockIssueBL.GetSingleSTCRequestHd(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            ...
            this.StatusLabel.Text = StockIssueRequestDataMapper.GetStatusTextDetail((_stcRequestDt.DoneClosing == null) ? ' ' : Convert.ToChar(_stcRequestDt.DoneClosing));
        }
