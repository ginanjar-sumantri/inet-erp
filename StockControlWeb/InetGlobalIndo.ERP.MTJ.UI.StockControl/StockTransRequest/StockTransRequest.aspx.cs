...
{
    public partial class StockTransRequest : StockTransRequestBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockTransReqBL.RowsCountSTCTransReqHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockTransReqBL.GetListSTCTransReqHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCTransReqHd _temp = (STCTransReqHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockTransRequestDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockTransRequestDataMapper.GetStatusText(_temp.Status));

                Literal _wrhsSrc = (Literal)e.Item.FindControl("WrhsSrcLiteral");
                _wrhsSrc.Text = HttpUtility.HtmlEncode(_wrhsBL.GetWrhsAreaNameByCode(_temp.WrhsAreaSrc));

                Literal _wrhsDest = (Literal)e.Item.FindControl("WrhsDestLiteral");
                _wrhsDest.Text = HttpUtility.HtmlEncode(_wrhsBL.GetWrhsAreaNameByCode(_temp.WrhsAreaDest));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockTransReqBL.GetSingleSTCTransReqHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockTransReqBL.DeleteMultiSTCTransReqHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockTransReqBL.DeleteMultiApproveSTCTransReqHd(_tempSplit, AppModule.GetValue(TransactionType.StockTransRequest), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
