...
{
    public partial class StockIssueSlip : StockIssueSlipBase
    {
        private StockIssueSlipBL _stockIssueSlipBL = new StockIssueSlipBL();
        private StockIssueRequestBL _stockIssueRequest = new StockIssueRequestBL();
        ...
        private string _homePage = "StockIssueSlip.aspx";
        private string _addPage = "StockIssueSlipAdd.aspx";
        private string _editPage = "StockIssueSlipEdit.aspx";
        private string _detailPage = "StockIssueSlipDetail.aspx";
        ...
        private double RowCount()
        {
            ...
            _result = this._stockIssueSlipBL.RowsCountSTCIssueSlipHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockIssueSlipBL.GetListSTCIssueSlipHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockIssueSlipBL.GetSingleSTCIssueSlipHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockIssueSlipBL.DeleteMultiSTCIssueSlipHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCIssueSlipHd _temp = (STCIssueSlipHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockIssueSlipDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockIssueSlipDataMapper.GetStatusText(_temp.Status));

                Literal _warehouse = (Literal)e.Item.FindControl("WarehouseLiteral");
                _warehouse.Text = HttpUtility.HtmlEncode(_temp.WrhsName);

                Literal _requestNo = (Literal)e.Item.FindControl("RequestNoLiteral");
                _requestNo.Text = HttpUtility.HtmlEncode(_temp.FileNo);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockIssueSlipBL.DeleteMultiApproveSTCIssueSlipHd(_tempSplit, AppModule.GetValue(TransactionType.StockIssueSlip), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
