...
{
    public partial class StockIssueSlipDetail : StockIssueSlipBase
    {
        ...
        //private string _reportPath1 = "StockIssueSlip/STIssueSlipPrintPreview.rdlc";
        ...
        private string _reportPath1 = "StockIssueSlip/JournalEntryPrintPreview.rdlc";
        private string _reportPath2 = "StockIssueSlip/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stockIssueSlipBL.RowsCountSTCIssueSlipDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stockIssueSlipBL = new StockIssueSlipBL();
            ...
            this.WarehouseTextBox.Text = _warehouseBL.GetWarehouseNameByCode(_stcIssueSlipHd.WrhsCode);
            if (_stcIssueSlipHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
            {
                this.SubledTextBox.Text = _custBL.GetNameByCode(_stcIssueSlipHd.WrhsSubLed);
            }
            else if (_stcIssueSlipHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
            {
                this.SubledTextBox.Text = _suppBL.GetSuppNameByCode(_stcIssueSlipHd.WrhsSubLed);
            }
            else
            {
            ...
            this.StatusHiddenField.Value = _stcIssueSlipHd.Status.ToString();
            this.StatusLabel.Text = StockAdjustmentDataMapper.GetStatusText(_stcIssueSlipHd.Status);
            ...
            {
                this.ListRepeater.DataSource = this._stockIssueSlipBL.GetListSTCIssueSlipDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
            this.ListRepeater.DataBind();

            this.AllCheckBox.Checked = this.IsCheckedAll();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueSlipDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueSlipDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueSlipDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueSlipDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueSlipDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueSlipDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stockIssueSlipBL.GetAppr(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueSlipDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                Boolean _statusBudget = this._stockIssueSlipBL.IsBudgetNotExist(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));

                if (_statusBudget == true)
                {
                    this._stockIssueSlipBL = new StockIssueSlipBL();
                    string _result = this._stockIssueSlipBL.Approve(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);
                    this.ApproveRow.Visible = false;
                    this.WarningLabel.Text = _result;
                }
                else
                {
                    Boolean _statusAmount = this._stockIssueSlipBL.CheckAmountBudget(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            ...
            {
                string _result = this._stockIssueSlipBL.Posting(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockIssueSlipDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stockIssueSlipBL.Unposting(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportStockControlBL.STIssueSlipPrintPreview(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));

            this.ReportViewer1.LocalReport.DataSources.Clear();
            this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);

            string _path = _reportListBL.GetPathPrintPreview(AppModule.GetValue(TransactionType.StockIssueSlip), _userBL.GetCompanyId(HttpContext.Current.User.Identity.Name));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockIssueSlipBL.DeleteMultiSTCIssueSlipDt(_tempSplit, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCIssueSlipDt _temp = (STCIssueSlipDt)e.Item.DataItem;
                ...
                if (this.StatusHiddenField.Value != StockIssueSlipDataMapper.GetStatus(TransStatus.Posted).ToString())
                {
                    _editButton.PostBackUrl = this._editDetailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)) + "&" + this._productKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code1, ApplicationConfig.EncryptionKey)) + "&" + this._locationKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code2, ApplicationConfig.EncryptionKey));
                ...
                Literal _stockType = (Literal)e.Item.FindControl("StockTypeLiteral");
                _stockType.Text = HttpUtility.HtmlEncode(_stockTypeBL.GetStockTypeNameByCode(_temp.StockType));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.StockIssueSlip), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.WarningLabel.Text = _result;
