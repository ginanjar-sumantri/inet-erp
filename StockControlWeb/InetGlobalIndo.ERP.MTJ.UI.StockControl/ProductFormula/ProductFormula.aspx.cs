...
{
    public partial class ProductFormula : ProductFormulaBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._productBL.RowsCountProductFormula(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._productBL.GetListProductFormula(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string _code = _temp.ProductCodeAssembly.ToString();
                ...
                _productCode.Text = HttpUtility.HtmlEncode(_temp.ProductCodeAssembly);

                Literal _productName = (Literal)e.Item.FindControl("ProductNameLiteral");
                _productName.Text = HttpUtility.HtmlEncode(_temp.ProductAssemblyName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._productBL.DeleteMultiProductFormula(_tempSplit);
