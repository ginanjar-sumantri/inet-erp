<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ProductFormulaEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.ProductFormula.ProductFormulaEdit" %>
                    ...
                    <table>
                        <asp:Panel runat="server" ID="ProductChoosePanel">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="ProductCodeHdTextBox" runat="server" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="ProductNameHdTextBox" runat="server" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                            </tr>
                        </asp:Panel>
                    </table>
