<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockIssueFAEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockIssueFixedAsset.StockIssueFAEdit" %>
                    ...
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="ReqNoCustomValidator" runat="server" ErrorMessage="Request No Must Be Choosed"
