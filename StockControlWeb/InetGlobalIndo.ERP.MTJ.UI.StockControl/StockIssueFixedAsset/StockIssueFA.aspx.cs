...
{
    public partial class StockIssueFA : StockIssueFixedAssetBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockIssueFABL.RowsCountSTCIssueToFAHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockIssueFABL.GetListSTCIssueToFAHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockIssueFABL.GetSingleSTCIssueToFAHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockIssueFABL.DeleteMultiSTCIssueToFAHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCIssueToFAHd _temp = (STCIssueToFAHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockIssueFixedAssetDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockIssueFixedAssetDataMapper.GetStatusText(_temp.Status));

                Literal _warehouse = (Literal)e.Item.FindControl("WarehouseLiteral");
                _warehouse.Text = HttpUtility.HtmlEncode(_temp.WrhsName);

                Literal _stockType = (Literal)e.Item.FindControl("ReqAssetNoLiteral");
                _stockType.Text = HttpUtility.HtmlEncode(_temp.FileNo);
            }
        }
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockIssueFABL.DeleteMultiApproveSTCIssueToFAHd(_tempSplit, AppModule.GetValue(TransactionType.StockIssueToFA), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
