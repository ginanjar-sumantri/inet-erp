<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockIssueFAAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockIssueFixedAsset.StockIssueFAAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="ReqNoDropDownList">
                                </asp:DropDownList>
                                <asp:CustomValidator ID="ReqNoCustomValidator" runat="server" ErrorMessage="Request Asset No Must Be Choosed"
                                    Text="*" ControlToValidate="ReqNoDropDownList" ClientValidationFunction="DropDownValidation"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
