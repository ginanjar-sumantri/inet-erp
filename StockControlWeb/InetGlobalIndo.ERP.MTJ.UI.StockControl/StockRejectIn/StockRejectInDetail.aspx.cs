...
{
    public partial class StockRejectInDetail : StockRejectInBase
    {
        ...
        private string _reportPath1 = "StockRejectIn/JournalEntryPrintPreview.rdlc";
        private string _reportPath2 = "StockRejectIn/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._stockRejectInBL.RowsCountSTCRejectInDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _stockRejectInBL = new StockRejectInBL();
            ...
            this.TransReffTextBox.Text = this._stockRejectOutBL.GetFileNmbrSTCRejectOutHd(_stcRejectInHd.TransReff);
            this.SupplierTextBox.Text = _suppBL.GetSuppNameByCode(_stcRejectInHd.SuppCode);
            this.WarehouseTextBox.Text = _warehouseBL.GetWarehouseNameByCode(_stcRejectInHd.WrhsCode);
            if (_stcRejectInHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Customer))
            {
                this.SubledTextBox.Text = _custBL.GetNameByCode(_stcRejectInHd.WrhsSubLed);
            }
            else if (_stcRejectInHd.WrhsFgSubLed == WarehouseDataMapper.GetSubledStatus(WarehouseSubledStatus.Supplier))
            {
                this.SubledTextBox.Text = _suppBL.GetSuppNameByCode(_stcRejectInHd.WrhsSubLed);
            }
            else
            {
            ...
            this.StatusHiddenField.Value = _stcRejectInHd.Status.ToString();
            this.StatusLabel.Text = StockRejectInDataMapper.GetStatusText(_stcRejectInHd.Status);
            ...
            {
                this.ListRepeater.DataSource = this._stockRejectInBL.GetListSTCRejectInDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text);
            }
            this.ListRepeater.DataBind();

            this.AllCheckBox.Checked = this.IsCheckedAll();

            if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectInDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectInDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectInDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectInDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectInDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockRejectInBL.DeleteMultiSTCRejectInDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCRejectInHd _stcRejectInHd = this._stockRejectInBL.GetSingleSTCRejectInHd(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
                STCRejectInDt _temp = (STCRejectInDt)e.Item.DataItem;
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectInDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._stockRejectInBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectInDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._stockRejectInBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectInDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._stockRejectInBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == StockRejectInDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._stockRejectInBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
