...
{
    public partial class StockRejectIn : StockRejectInBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockRejectInBL.RowsCountSTCRejectInHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockRejectInBL.GetListSTCRejectInHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockRejectInBL.GetSingleSTCRejectInHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockRejectInBL.DeleteMultiSTCRejectInHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCRejectInHd _temp = (STCRejectInHd)e.Item.DataItem;
                ...
                if (_temp.Status != StockRejectInDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(StockRejectInDataMapper.GetStatusText(_temp.Status));

                Literal _transReff = (Literal)e.Item.FindControl("TransReffLiteral");
                _transReff.Text = HttpUtility.HtmlEncode(_temp.TransReff);

                Literal _suppName = (Literal)e.Item.FindControl("SuppNameLiteral");
                _suppName.Text = HttpUtility.HtmlEncode(_temp.SuppName);

                Literal _warehouse = (Literal)e.Item.FindControl("WrhsNameLiteral");
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockRejectInBL.DeleteMultiApproveSTCRejectInHd(_tempSplit, AppModule.GetValue(TransactionType.StockRejectIn), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
