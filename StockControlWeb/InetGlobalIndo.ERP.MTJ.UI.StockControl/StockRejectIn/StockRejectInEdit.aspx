<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockRejectInEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockRejectIn.StockRejectInEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="TransReffDropDownList" AutoPostBack="True" OnSelectedIndexChanged="TransReffDropDownList_SelectedIndexChanged">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="SupplierTextBox" Width="420" BackColor="#CCCCCC"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
