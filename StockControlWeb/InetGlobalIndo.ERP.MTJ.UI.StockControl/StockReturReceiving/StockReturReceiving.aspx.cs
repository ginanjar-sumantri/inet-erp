...
{
    public partial class StockReturReceiving : StockReturReceivingBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stcReturBL.RowsCountSTCReturRRHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stcReturBL.GetListSTCReturRRHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stcReturBL.GetSingleSTCReturRRHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stcReturBL.DeleteMultiSTCReturRRHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                STCReturRRHd _temp = (STCReturRRHd)e.Item.DataItem;
                ...
                Literal _reqReturNo = (Literal)e.Item.FindControl("ReqReturNoLiteral");
                _reqReturNo.Text = HttpUtility.HtmlEncode((_temp.ReqReturNo == "null") ? "" : this._reqSalesReturBL.GetFileNmbrMKTReqReturHd(_temp.ReqReturNo));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stcReturBL.DeleteMultiApproveSTCReturRRHd(_tempSplit, AppModule.GetValue(TransactionType.StockRejectIn), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
