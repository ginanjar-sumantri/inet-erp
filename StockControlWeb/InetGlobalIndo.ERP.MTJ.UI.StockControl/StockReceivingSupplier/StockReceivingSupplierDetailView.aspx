<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="StockReceivingSupplierDetailView.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.StockControl.StockReceivingSupplier.StockReceivingSupplierDetailView" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="PriceCostTextBox" runat="server" Width="150" ReadOnly="True" BackColor="#CCCCCC"></asp:TextBox>
