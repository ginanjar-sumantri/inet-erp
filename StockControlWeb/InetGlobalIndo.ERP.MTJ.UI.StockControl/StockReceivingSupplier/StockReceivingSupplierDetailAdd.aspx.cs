...
{
    public partial class StockReceivingSupplierDetailAdd : StockReceivingSupplierBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.ProductPicker1.ProductCode != "")
            {
                ...
                {
                    //this.PriceCostTextBox.Attributes.Add("ReadOnly", "false");
        ...
        public void SetAttribute()
        {
            ...
            //this.PriceCostTextBox.Attributes.Add("OnKeyDown", "return Numeric();");
            this.TotalCostTextBox.Attributes.Add("ReadOnly", "true");
        ...
        {
            string _tempWarehouseCode = this._stockReceivingSupplierBL.GetWarehouseCodeByCode(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockReceivingSupplierBL.AddSTCRROtherDt(_stcRROtherDt);
