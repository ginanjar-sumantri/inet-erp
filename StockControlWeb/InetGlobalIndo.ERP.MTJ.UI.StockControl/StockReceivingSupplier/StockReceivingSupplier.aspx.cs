...
{
    public partial class StockReceivingSupplier : StockReceivingSupplierBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._stockReceivingSupplierBL.RowsCountSTCRROtherHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._stockReceivingSupplierBL.GetListSTCRROtherHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (_tempStatus.ToLower() == StockReceivingSupplierDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
                ...
                _statusLiteral.Text = HttpUtility.HtmlEncode(StockReceivingSupplierDataMapper.GetStatusText(_temp.Status));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._stockReceivingSupplierBL.GetSingleSTCRROtherHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._stockReceivingSupplierBL.DeleteMultiSTCRROtherHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._stockReceivingSupplierBL.DeleteMultiApproveSTCRROtherHd(_tempSplit, AppModule.GetValue(TransactionType.StockReceivingSupplier), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
