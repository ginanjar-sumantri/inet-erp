...
{
    public partial class StockReceivingSupplierDetailEdit : StockReceivingSupplierBase
    {
        ...
        {
            STCRROtherDt _stcRROtherDt = this._stockReceivingSupplierBL.GetSingleSTCRROtherDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), Rijndael.Decrypt(this._nvcExtractor.GetValue(this._productKey), ApplicationConfig.EncryptionKey), Rijndael.Decrypt(this._nvcExtractor.GetValue(this._locationKey), ApplicationConfig.EncryptionKey));
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._stockReceivingSupplierBL.EditSTCRROtherDt(_stcRROtherDt);
