...
{
    public sealed class StockIssueRequestFABL : Base
    {
        public StockIssueRequestFABL()
        {
        }
        ...
        public double RowsCountSTCRequestHd(string _prmCategory, string _prmKeyword)
        {
            ...
            var _query =
                (
                    ...
                    where _stcRequestHd.FgType == AppModule.GetValue(TransactionType.StockIssueRequestFA)
                        ...
                        && _stcRequestHd.Status != StockIssueRequestFADataMapper.GetStatus(TransStatus.Deleted)
        ...
        public bool GetSingleSTCRequestHdApprove(string[] _prmCode)
        {
            ...
            try
            {
                for (int i = 0; i < _prmCode.Length; i++)
                {
                    ...
                    {
                        if (_stcRequestHd.Status != StockIssueRequestFADataMapper.GetStatus(TransStatus.Posted))
                        {
                            _result = true;
                        }
                        else
        ...
        public bool DeleteMultiApproveSTCRequestHd(string[] _prmCode, string _prmTransType, string _prmUsername, byte _prmActivitiesID, string _prmReason)
        {
            ...
            try
            {
                for (int i = 0; i < _prmCode.Length; i++)
                {
                    ...
                    if (_stcRequestHd.Status == StockIssueRequestFADataMapper.GetStatus(TransStatus.Approved))
                    {
                    ...
                    if (_stcRequestHd != null)
                    {
                        ...
                        else if (_stcRequestHd.FileNmbr != "" && _stcRequestHd.Status == StockIssueRequestFADataMapper.GetStatus(TransStatus.Approved))
                        {
                            _stcRequestHd.Status = StockIssueRequestFADataMapper.GetStatus(TransStatus.Deleted);
                            _result = true;
                        }
        ...
        public string GetAppr(string _prmTransNmbr, int _prmYear, int _prmPeriod, string _prmuser)
        {
            ...
            try
            {
                int _success = this.db.S_STRequestFAGetAppr(_prmTransNmbr, _prmYear, _prmPeriod, _prmuser, ref _errorMsg);
                ...
                if (_errorMsg == "")
                {
                    ...
                    _transActivity.TransType = AppModule.GetValue(TransactionType.StockIssueRequestFA);
        ...
        public string Approve(string _prmTransNmbr, int _prmYear, int _prmPeriod, string _prmuser)
        {
            ...
            try
            {
                ...
                {
                    int _success = this.db.S_STRequestFAApprove(_prmTransNmbr, _prmYear, _prmPeriod, _prmuser, ref _errorMsg);

                    if (_errorMsg == "")
                    {
                        STCRequestHd _stcRequestHd = this.GetSingleSTCRequestHd(_prmTransNmbr);
                        foreach (S_SAAutoNmbrResult item in this.db.S_SAAutoNmbr(_stcRequestHd.TransDate.Year, _stcRequestHd.TransDate.Month, AppModule.GetValue(TransactionType.StockIssueRequestFA), this._companyTag, ""))
                        {
        ...
        public string Posting(string _prmTransNmbr, int _prmYear, int _prmPeriod, string _prmuser)
        {
            ...
            try
            {
                ...
                STCRequestHd _stcRequestHd = this.db.STCRequestHds.Single(_temp => _temp.TransNmbr.Trim().ToLower() == _prmTransNmbr.Trim().ToLower() && _temp.FgType == StockIssueRequestFADataMapper.GetFgType(StockRequestType.RequestFA));
                String _locked = _transCloseBL.IsExistAndLocked(_stcRequestHd.TransDate);
                if (_locked == "")
                {
                    int _success = this.db.S_STRequestFAPost(_prmTransNmbr, _prmYear, _prmPeriod, _prmuser, ref _errorMsg);
        ...
        public string Unposting(string _prmTransNmbr, int _prmYear, int _prmPeriod, string _prmuser)
        {
            ...
            try
            {
                ...
                if (_locked == "")
                {
                    int _success = this.db.S_STRequestFAUnPost(_prmTransNmbr, _prmYear, _prmPeriod, _prmuser, ref _errorMsg);
        ...
        public List<STCRequestHd> GetListReqNoForDDLIssueFA()
        {
            List<STCRequestHd> _result = new List<STCRequestHd>();
            ...
            try
            {
                var _query = (
                                ...
                                where _v_STReq.FgType == AppModule.GetValue(TransactionType.StockIssueRequestFA)
        ...
        public List<MsProduct> GetListProductForDDLIssueFADt(string _prmReqNo)
        {
        ...
        public decimal GetQtyV_STRequestForIssuesByReqCode(string _prmReqCode, string _prmProductCode)
        {
            decimal _result = 0;
            ...
            try
            {
                var _query = (
                                ...
                                where _v_STReqIssue.Request_No.Trim().ToLower() == _prmReqCode.Trim().ToLower()
        ...
        public string GetUnitV_STRequestForIssuesByReqCode(string _prmReqCode, string _prmProductCode)
        {
            string _result = "";
