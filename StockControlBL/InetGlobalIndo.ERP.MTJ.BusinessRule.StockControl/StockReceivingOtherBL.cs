...
{
    public sealed class StockReceivingOtherBL : Base
    {
        public StockReceivingOtherBL()
        {
        ...
        public double RowsCountSTCRROtherHd(string _prmCategory, string _prmKeyword)
        {
            ...
            var _query =
                (
                    ...
                    where _stcRROtherHd.RRType.Trim().ToLower() == StockReceivingOtherDataMapper.GetRRTypeStatus(RRTypeStatus.Other).ToString().Trim().ToLower()
                      ...
                      && _stcRROtherHd.Status != StockReceivingOtherDataMapper.GetStatus(TransStatus.Deleted)
        ...
        public bool GetSingleSTCRROtherHdApprove(string[] _prmCode)
        {
            ...
            try
            {
                for (int i = 0; i < _prmCode.Length; i++)
                {
                    ...
                    {
                        if (_stcRROtherHd.Status != StockReceivingOtherDataMapper.GetStatus(TransStatus.Posted))
                        {
                            _result = true;
                        }
                        else
        ...
        public bool DeleteMultiApproveSTCRROtherHd(string[] _prmCode, string _prmTransType, string _prmUsername, byte _prmActivitiesID, string _prmReason)
        {
            ...
            try
            {
                for (int i = 0; i < _prmCode.Length; i++)
                {
                    ...
                    if (_stcRROtherHd.Status == StockReceivingOtherDataMapper.GetStatus(TransStatus.Approved))
                    {
                    ...
                    if (_stcRROtherHd != null)
                    {
                        ...
                        else if (_stcRROtherHd.FileNmbr != "" && _stcRROtherHd.Status == StockReceivingOtherDataMapper.GetStatus(TransStatus.Approved))
                        {
                            _stcRROtherHd.Status = StockReceivingOtherDataMapper.GetStatus(TransStatus.Deleted);
                            _result = true;
                        }
        ...
        public string GetApproval(string _prmCode, string _prmuser)
        {
            ...
            try
            {
                this.db.S_STRROtherGetAppr(_prmCode, 0, 0, _prmuser, ref _result);
                ...
                if (_result == "")
                {
                    ...
                    _transActivity.TransType = AppModule.GetValue(TransactionType.StockReceivingOther);
        ...
        public string Approve(string _prmCode, string _prmuser)
        {
            ...
            try
            {
                ...
                {
                    this.db.S_STRROtherApprove(_prmCode, 0, 0, _prmuser, ref _result);

                    if (_result == "")
                    {
                        STCRROtherHd _stcRROtherHd = this.GetSingleSTCRROtherHd(_prmCode);
                        foreach (S_SAAutoNmbrResult item in this.db.S_SAAutoNmbr(_stcRROtherHd.TransDate.Year, _stcRROtherHd.TransDate.Month, AppModule.GetValue(TransactionType.StockReceivingOther), this._companyTag, ""))
                        {
        ...
        public string Posting(string _prmCode, string _prmuser)
        {
            ...
            try
            {
                ...
                STCRROtherHd _stcRROtherHd = this.db.STCRROtherHds.Single(_temp => _temp.TransNmbr.Trim().ToLower() == _prmCode.Trim().ToLower() && _temp.RRType == StockReceivingOtherDataMapper.GetRRTypeStatus(RRTypeStatus.Other).ToString());
                String _locked = _transCloseBL.IsExistAndLocked(_stcRROtherHd.TransDate);
                if (_locked == "")
                {
                    this.db.S_STRROtherPost(_prmCode, 0, 0, _prmuser, ref _result);
        ...
        public string UnPosting(string _prmCode, string _prmuser)
        {
            ...
            try
            {
                ...
                if (_locked == "")
                {
                    this.db.S_STRROtherUnPost(_prmCode, 0, 0, _prmuser, ref _result);
