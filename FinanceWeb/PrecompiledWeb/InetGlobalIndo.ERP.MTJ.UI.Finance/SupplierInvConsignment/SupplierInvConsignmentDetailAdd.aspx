<%@ page language="C#" masterpagefile="~/default.master" autoeventwireup="true" inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.SupplierInvConsignment.SupplierInvConsignmentDetailAdd, App_Web_dshk2im5" %>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:CustomValidator ID="SJTypeCustomValidator" runat="server" ClientValidationFunction="DropDownValidation"
                                            ErrorMessage="SJ Type Must Be Filled" Text="*" ControlToValidate="SJTypeDropDownList">
                                        </asp:CustomValidator>
