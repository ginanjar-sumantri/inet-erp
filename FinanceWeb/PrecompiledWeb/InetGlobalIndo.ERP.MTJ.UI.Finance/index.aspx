<%@ page language="C#" autoeventwireup="true" inherits="index, App_Web_p-s3bmy4" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <title><asp:Literal ID="ModuleTitleLiteral" runat="server"></asp:Literal></title>
...
<body runat="server" id="bodyIndex" style="margin: 0px 0px 0px 0px">
                        ...
                        <td valign="bottom" height="45px">
                            <div>
                                <asp:Menu ID="Menu2" runat="server" DynamicHorizontalOffset="2"
                                    Font-Names="Century Gothic" Orientation="Horizontal" VerticalPadding="0px" CssClass="bawah"
                                    StaticDisplayLevels="1" StaticMenuItemStyle-VerticalPadding="0" StaticMenuItemStyle-Font-Name="Century Gothic"
                                    ...
                                    DynamicHoverStyle-ForeColor="#FFFFFF" BorderWidth="0px">
    ...
    <iframe id="mainFrame" runat="server" style="border: 0; width: 100%" frameborder="0" ></iframe>
</body>
