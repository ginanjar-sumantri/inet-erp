...
{
    public partial class LimitAuthorization : LimitAuthorizationBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._limitAuthorBL.RowsCountLimitAuthor;
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._limitAuthorBL.GetListLimitAuthor(_prmCurrentPage, _maxrow);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Master_LimitAuthorization _msLimitAuthor = (Master_LimitAuthorization)e.Item.DataItem;

                string _role = _msLimitAuthor.RoleID.ToString();
                string _transType = _msLimitAuthor.TransTypeCode;
                string _code = _msLimitAuthor.RoleID.ToString() + "=" + _msLimitAuthor.TransTypeCode;
                ...
                _viewButton.PostBackUrl = this._viewPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_role, ApplicationConfig.EncryptionKey)) + "&" + this._transTypeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_transType, ApplicationConfig.EncryptionKey));
                ...
                _editButton.PostBackUrl = this._editPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_role, ApplicationConfig.EncryptionKey)) + "&" + this._transTypeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_transType, ApplicationConfig.EncryptionKey));
                ...
                _transTypeLiteral.Text = HttpUtility.HtmlEncode(_msLimitAuthor.TransTypeName);

                Literal _roleLiteral = (Literal)e.Item.FindControl("RoleLiteral");
                _roleLiteral.Text = HttpUtility.HtmlEncode(_msLimitAuthor.RoleName);

                Literal _limitLiteral = (Literal)e.Item.FindControl("LimitLiteral");
                _limitLiteral.Text = HttpUtility.HtmlEncode((_msLimitAuthor.Limit == 0) ? "0" : (_msLimitAuthor.Limit).ToString("#,###.##"));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._limitAuthorBL.DeleteMultiLimitAuthor(_tempsplit);
