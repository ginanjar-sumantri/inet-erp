<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReceiptTradeCrAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.ReceiptTrade.ReceiptTradeCrAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="InvoiceNoDropDownList" AutoPostBack="true" OnSelectedIndexChanged="InvoiceNoDropDownList_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:CustomValidator runat="server" ID="InvoiceNoCustomValidator" ControlToValidate="InvoiceNoDropDownList"
                                    ClientValidationFunction="DropDownValidation" ErrorMessage="Invoice No must be filled"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="FgValueTextBox" runat="server" BackColor="#CCCCCC" Width="50"></asp:TextBox>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td>
