...
{
    public partial class ReceiptTradeHd : ReceiptTradeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._receiptBL.RowsCountFINReceiptTradeHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._receiptBL.GetListFINReceiptTradeHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINReceiptTradeHd _temp = (FINReceiptTradeHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != ReceiptTradeDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                Literal _transaction = (Literal)e.Item.FindControl("ReceiptNoLiteral");
                ...
                _status.Text = HttpUtility.HtmlEncode(ReceiptTradeDataMapper.GetStatusText(_temp.Status));

                Literal _customer = (Literal)e.Item.FindControl("CustomerLiteral");
                _customer.Text = HttpUtility.HtmlEncode(_temp.CustomerName);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._receiptBL.GetSingleFINReceiptTradeHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._receiptBL.DeleteMultiFINReceiptTradeHd(_tempSplit);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._receiptBL.DeleteMultiApproveFINReceiptTradeHd(_tempSplit, AppModule.GetValue(TransactionType.ReceiptTrade), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
