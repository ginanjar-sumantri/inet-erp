<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustomerNoteDetailAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.CustomerNote.CustomerNoteDetailAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="SJNoDropDownList" AutoPostBack="True" OnSelectedIndexChanged="SJNoDropDownList_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:CustomValidator ID="SJNoRequiredFieldValidator" runat="server" ErrorMessage="SJ No Must Be Filled"
                                    Text="*" ControlToValidate="SJNoDropDownList" Display="Dynamic"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="ProductDropDownList" AutoPostBack="True" OnSelectedIndexChanged="ProductDropDownList_SelectedIndexChanged">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="SONoTextBox" Width="150" BackColor="#CCCCCC"></asp:TextBox>
