...
{
    public partial class CustomerNoteAdd : CustomerNoteBase
    {
        ...
        {
            FINCustInvHd _finDNCustHd = new FINCustInvHd();
            ...
            _finDNCustHd.Status = CustomerNoteDataMapper.GetStatus(TransStatus.OnHold);
            ...
            string _result = this._customerNoteBL.AddFINCustInvHd(_finDNCustHd);
