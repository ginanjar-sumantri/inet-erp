...
{
    public partial class CustomerNote : CustomerNoteBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._customerNoteBL.RowsCountFINCustInvHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._customerNoteBL.GetListFINCustInvHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._customerNoteBL.GetSingleFINCustInvHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._customerNoteBL.DeleteMultiFINCustInvHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINCustInvHd _temp = (FINCustInvHd)e.Item.DataItem;
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._customerNoteBL.DeleteMultiApproveFINCustInvHd(_tempSplit, AppModule.GetValue(TransactionType.CustomerNote), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
