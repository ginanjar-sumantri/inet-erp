<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="GiroReceiptChangeDetailView.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.GiroReceiptChange.GiroReceiptChangeDetailView" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="OldGiroTextBox" runat="server" ReadOnly="true" BackColor="#cccccc">
                                </asp:TextBox>
                            </td>
                        </tr>
                        <tr>
