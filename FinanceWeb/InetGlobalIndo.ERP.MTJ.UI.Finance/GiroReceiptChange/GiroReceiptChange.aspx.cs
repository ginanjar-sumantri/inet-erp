...
{
    public partial class GiroReceiptChange : GiroReceiptChangeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finChangeGiroInBL.RowsCountFINChangeGiroInHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finChangeGiroInBL.GetListFINChangeGiroInHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._finChangeGiroInBL.GetSingleFINChangeGiroInHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._finChangeGiroInBL.DeleteMultiFINChangeGiroInHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINChangeGiroInHd _temp = (FINChangeGiroInHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != GiroReceiptChangeDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _status.Text = HttpUtility.HtmlEncode(GiroReceiptChangeDataMapper.GetStatusText(_temp.Status));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._finChangeGiroInBL.DeleteMultiApproveFINChangeGiroInHd(_tempSplit, AppModule.GetValue(TransactionType.ChangeGiroReceipt), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
