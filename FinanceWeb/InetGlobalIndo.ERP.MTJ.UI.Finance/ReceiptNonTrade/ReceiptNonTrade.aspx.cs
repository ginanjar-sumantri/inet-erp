...
{
    public partial class ReceiptNonTrade : ReceiptNonTradeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._paymentNonTradeBL.RowsCountPaymentNonTrade(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._paymentNonTradeBL.GetListFINReceiptNonTradeHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINReceiptNonTradeHd _temp = (FINReceiptNonTradeHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != ReceiptNonTradeDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _statusLiteral.Text = ReceiptNonTradeDataMapper.GetStatusText(_temp.Status);

                Literal _custNameLiteral = (Literal)e.Item.FindControl("CustLiteral");
                _custNameLiteral.Text = HttpUtility.HtmlEncode(_temp.CustName);

                Literal _currencyLiteral = (Literal)e.Item.FindControl("CurrLiteral");
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._paymentNonTradeBL.GetSingleFINReceiptNonTradeDbForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._paymentNonTradeBL.DeleteMultiFINReceiptNonTradeHd(_tempSplit);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._paymentNonTradeBL.DeleteMultiApproveFINReceiptNonTradeDb(_tempSplit, AppModule.GetValue(TransactionType.ReceiptNonTrade), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
