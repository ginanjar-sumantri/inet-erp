<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReceiptNonTradeEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.ReceiptNonTrade.ReceiptNonTradeEdit" %>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="DropDownValidation"
                                    ErrorMessage="Customer Must Be Filled" Text="*" ControlToValidate="CustDropDownList"></asp:CustomValidator>
                            </td>
                        </tr>
