<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReceiptNonTradeDbView.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.ReceiptNonTrade.ReceiptNonTradeDbView" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="ReceiptTypeTextBox" Width="200" BackColor="#CCCCCC"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="BankGiroTextBox" Width="200" BackColor="#CCCCCC"
                                    ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
