<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReceiptNonTradeDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.ReceiptNonTrade.ReceiptNonTradeDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="CustTextBox" Width="150" MaxLength="12" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="CurrTextBox" Width="70" MaxLength="12" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                    <asp:TextBox runat="server" ID="CurrRateTextBox" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td>
                                        ...
                                        <asp:Repeater runat="server" ID="ListRepeater2" OnItemDataBound="ListRepeater2_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="right">
                                                        <asp:Literal runat="server" ID="BankExpenseLiteral"></asp:Literal>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                    ...
                    <table>
                        <tr>
                            <td style="width: 100px" align="right">
                                <asp:Label ID="ReceiptLabel" runat="server"></asp:Label>
                            </td>
                            <td style="width: 100px" align="right">
                                <asp:Label ID="ChargesLabel" runat="server"></asp:Label>
                            </td>
                            <td style="width: 100px" align="right">
