...
{
    public partial class NotaDebitCustomerDetailAdd : NotaDebitCustomerBase
    {
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            int _maxItemNo = this._notaDebitCustomerBL.GetMaxNoItemFINDNCustDt(_transNo);

            FINDNCustDt _finDNCustDt = new FINDNCustDt();
            _finDNCustDt.TransNmbr = _transNo;
            _finDNCustDt.ItemNo = _maxItemNo + 1;
            ...
            _finDNCustDt.Qty = Convert.ToInt32(this.QtyTextBox.Text);
            _finDNCustDt.Unit = this.UnitDropDownList.SelectedValue;

            bool _result = this._notaDebitCustomerBL.AddFINDNCustDt(_finDNCustDt);
