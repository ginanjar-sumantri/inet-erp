...
{
    public partial class NotaDebitCustomerDetail : NotaDebitCustomerBase
    {
        ...
        private string _reportPath1 = "NotaDebitCustomer/DebitNoteCustomer.rdlc";
        private string _awal = "ctl00_DefaultBodyContentPlaceHolder_ListRepeater_ctl";
        private string _akhir = "_ListCheckBox";
        private string _cbox = "ctl00_DefaultBodyContentPlaceHolder_AllCheckBox";
        private string _tempHidden = "ctl00$DefaultBodyContentPlaceHolder$TempHidden";

        private string _reportPath2 = "NotaDebitCustomer/JournalEntryPrintPreview.rdlc";
        private string _reportPath3 = "NotaDebitCustomer/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._notaDebitCustomerBL.RowsCountFINDNCustDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitCustDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitCustDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitCustDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitCustDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        {
            _notaDebitCustomerBL = new NotaDebitCustomerBL();
            FINDNCustHd _finDNCustHd = this._notaDebitCustomerBL.GetSingleFINDNCustHdView(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));

            _decimalPlace = _currencyBL.GetDecimalPlace(_finDNCustHd.CurrCode);
            ...
            this.StatusLabel.Text = NotaDebitCustDataMapper.GetStatusText(_finDNCustHd.Status);
            this.CustTextBox.Text = _finDNCustHd.CustName;
            this.CurrCodeTextBox.Text = _finDNCustHd.CurrCode;
            this.CurrRateTextBox.Text = (_finDNCustHd.ForexRate == 0) ? "0" : _finDNCustHd.ForexRate.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            if (_finDNCustHd.PPNRate != null)
            {
                decimal _totalForex = Convert.ToDecimal(_finDNCustHd.TotalForex);
                this.TotalForexTextBox.Text = (_totalForex == 0) ? "0" : _totalForex.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            }
            this.TermTextBox.Text = _finDNCustHd.TermName;
            this.CurrTextBox.Text = _finDNCustHd.CurrCode;
            this.StatusLabel.Text = NotaDebitCustDataMapper.GetStatusText(_finDNCustHd.Status);
            this.StatusHiddenField.Value = _finDNCustHd.Status.ToString();
            this.AttnTextBox.Text = _finDNCustHd.Attn;
            this.RemarkTextBox.Text = _finDNCustHd.Remark;
            if (_finDNCustHd.PPNRate != null)
            {
                decimal _ppnRate = Convert.ToDecimal(_finDNCustHd.PPNRate);
                this.PPNRateTextBox.Text = (_ppnRate == 0) ? "0" : _ppnRate.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            }
            if (_finDNCustHd.PPN != null)
            {
                decimal _ppn = Convert.ToDecimal(_finDNCustHd.PPN);
            ...
            {
                decimal _ppnForex = Convert.ToDecimal(_finDNCustHd.PPNForex);
            ...
            {
                decimal _amountBase = Convert.ToDecimal(_finDNCustHd.BaseForex);
            ...
            {
                decimal _discForex = Convert.ToDecimal(_finDNCustHd.DiscForex);
                this.DiscForexTextBox.Text = (_discForex == 0) ? "0" : _discForex.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            }
            this.BillToTextBox.Text = _finDNCustHd.BillToName;
            this.CustPONoTextBox.Text = _finDNCustHd.CustPONo;

            this.ShowActionButton();
            this.ShowPreviewButton();

            if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitCustDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        public void ShowDataDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._notaDebitCustomerBL.GetListFINDNCustDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitCustDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._notaDebitCustomerBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitCustDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._notaDebitCustomerBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitCustDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._notaDebitCustomerBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitCustDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._notaDebitCustomerBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._notaDebitCustomerBL.DeleteMultiFINDNCustDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINDNCustDt _temp = (FINDNCustDt)e.Item.DataItem;
                ...
                else
                {
                    ...
                    {
                        _editButton2.PostBackUrl = this._editDetailPage + "?" + this._codeItem + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(this.TransNoTextBox.Text, ApplicationConfig.EncryptionKey));
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportFinanceBL.DebitNoteCustomerPrintPreview(this.TransNoTextBox.Text);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.NotaDebitCustomer), this.TransNoTextBox.Text, this.FileNmbrTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.Label.Text = _result;
