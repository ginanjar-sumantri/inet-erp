...
{
    public partial class NotaDebitCustomer : NotaDebitCustomerBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._notaDebitCustomerBL.RowsCountFINDNCustHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._notaDebitCustomerBL.GetListFINDNCustHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._notaDebitCustomerBL.GetSingleFINDNCustHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._notaDebitCustomerBL.DeleteMultiFINDNCustHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINDNCustHd _temp = (FINDNCustHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != NotaDebitCustDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _status.Text = NotaDebitCustDataMapper.GetStatusText(_temp.Status);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._notaDebitCustomerBL.DeleteMultiApproveFINDNCustHd(_tempSplit, AppModule.GetValue(TransactionType.NotaDebitCustomer), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
