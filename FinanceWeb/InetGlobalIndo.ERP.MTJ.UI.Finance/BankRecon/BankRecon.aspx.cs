...
{
    public partial class BankRecon : BankReconBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._BankReconBL.RowsCountFinance_BankRecon(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._BankReconBL.GetListFinance_BankRecon(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Finance_BankRecon _temp = (Finance_BankRecon)e.Item.DataItem;

                string _code = _temp.BankReconCode.ToString();
                ...
                {
                    if (_temp.Status.ToString().Trim().ToLower() == BankReconDataMapper.GetStatusByte(TransStatus.Posted).ToString().Trim().ToLower())
                    {
                        _editButton.Visible = false;
                    }
                    else
                ...
                _status.Text = HttpUtility.HtmlEncode(BankReconDataMapper.GetStatusText(_temp.Status));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._BankReconBL.GetSingleFinance_BankReconStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._BankReconBL.DeleteMultiFinance_BankRecon(_tempSplit);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._BankReconBL.DeleteMultiApproveFinance_BankRecon(_tempSplit, AppModule.GetValue(TransactionType.BankRecon), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
