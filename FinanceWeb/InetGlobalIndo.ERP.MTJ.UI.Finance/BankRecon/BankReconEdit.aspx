<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="BankReconEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.BankRecon.BankReconEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="PayTypeDDL" 
                                    onselectedindexchanged="PayTypeDDL_SelectedIndexChanged" 
