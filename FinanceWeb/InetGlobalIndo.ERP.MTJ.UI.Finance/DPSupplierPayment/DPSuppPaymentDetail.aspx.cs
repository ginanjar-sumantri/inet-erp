...
{
    public partial class DPSuppPaymentDetail : DPSupplierPaymentBase
    {
        ...
        private string _reportPath1 = "DPSupplierPayment/FNDPSuppPrintPreview.rdlc";
        private string _reportPath2 = "DPSupplierPayment/JournalEntryPrintPreview.rdlc";
        private string _reportPath3 = "DPSupplierPayment/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._finDPSuppBL.RowsCountFINDPSuppDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _finDPSuppBL = new FINDPSuppPayBL();
            ...
            this.StatusLabel.Text = DPSuppPayDataMapper.GetStatusText(_finDPSuppHd.Status);
            this.StatusHiddenField.Value = _finDPSuppHd.Status.ToString();
            ...
            {
                this.ListRepeater.DataSource = this._finDPSuppBL.GetListFINDPSuppDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text);
            }
            this.ListRepeater.DataBind();

            this.AllCheckBox.Checked = this.IsCheckedAll();

            if (this.StatusHiddenField.Value.Trim().ToLower() == DPSuppPayDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == DPSuppPayDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == DPSuppPayDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                ...
                {
                    if (this._pettyBL.CheckLimitAuthorization(AppModule.GetValue(TransactionType.DPSuppPay), HttpContext.Current.User.Identity.Name, Convert.ToDecimal((this.TotalForexTextBox.Text == "") ? "0" : this.TotalForexTextBox.Text)) == true)
                    {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == DPSuppPayDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == DPSuppPayDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._finDPSuppBL.DeleteMultiFINDPSuppDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINDPSuppDt _temp = (FINDPSuppDt)e.Item.DataItem;
                FINDPSuppHd _finDPSuppHd = this._finDPSuppBL.GetSingleFINDPSuppHd(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
                ...
                _paymentType.Text = HttpUtility.HtmlEncode(_payBL.GetPaymentName(_temp.PayType));
                ...
                _bankPaymentLiteral.Text = HttpUtility.HtmlEncode(_temp.BankPaymentName);
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == DPSuppPayDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._finDPSuppBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == DPSuppPayDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._finDPSuppBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == DPSuppPayDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._finDPSuppBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == DPSuppPayDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._finDPSuppBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportFinanceBL.FNDPSuppPrintPreview(this.TransNoTextBox.Text);
