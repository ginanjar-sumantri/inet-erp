...
{
    public partial class DPSuppPayment : DPSupplierPaymentBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finDPSuppBL.RowsCountFINDPSuppHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finDPSuppBL.GetListFINDPSuppHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._finDPSuppBL.GetSingleFINDPSuppHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._finDPSuppBL.DeleteMultiFINDPSuppHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINDPSuppHd _temp = (FINDPSuppHd)e.Item.DataItem;
                ...
                if (_temp.Status != DPSuppPayDataMapper.GetStatus(TransStatus.Posted))
                {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._finDPSuppBL.DeleteMultiApproveFINDPSuppHd(_tempSplit, AppModule.GetValue(TransactionType.DPSuppPay), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
