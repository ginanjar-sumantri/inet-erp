<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DPSuppPaymentEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.DPSupplierPayment.DPSuppPaymentEdit" %>
    ...
    <asp:Panel DefaultButton="SaveButton" ID="Panel1" runat="server">
        <table cellpadding="3" cellspacing="0" width="0" border="0">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="PONoTextBox" runat="server" Width="150" MaxLength="20" ReadOnly="true"
                        BackColor="#CCCCCC">
                    </asp:TextBox>
                </td>
            </tr>
