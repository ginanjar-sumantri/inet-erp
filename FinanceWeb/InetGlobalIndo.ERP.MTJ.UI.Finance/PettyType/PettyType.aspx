<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PettyType.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.PettyType.PettyType" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Petty Type Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Petty Type Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                    ...
                                    <asp:Repeater ID="ListRepeater" runat="server" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="PettyTypeCodeLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="PettyTypeNameLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="AccountCodeLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal ID="AccountNameLiteral" runat="server"></asp:Literal>
                                                </td>
                                                <%--<td align ="center">
                                    <%# DataBinder.Eval(Container.DataItem, "FgReport")%>
                                </td>--%>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
