...
{
    public partial class PettyType : PettyTypeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._pettyBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._pettyBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsPetty _msPetty = (MsPetty)e.Item.DataItem;

                string _code = _msPetty.PettyCode.ToString();
                ...
                Literal _pettyTypeCode = (Literal)e.Item.FindControl("PettyTypeCodeLiteral");
                _pettyTypeCode.Text = HttpUtility.HtmlEncode(_msPetty.PettyCode);

                Literal _pettyTypeName = (Literal)e.Item.FindControl("PettyTypeNameLiteral");
                _pettyTypeName.Text = HttpUtility.HtmlEncode(_msPetty.PettyName);

                Literal _AccountCode = (Literal)e.Item.FindControl("AccountCodeLiteral");
                _AccountCode.Text = HttpUtility.HtmlEncode(_msPetty.Account);

                Literal _AccountName = (Literal)e.Item.FindControl("AccountNameLiteral");
                _AccountName.Text = HttpUtility.HtmlEncode(_msPetty.AccountName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._pettyBL.DeleteMulti(_tempsplit);
