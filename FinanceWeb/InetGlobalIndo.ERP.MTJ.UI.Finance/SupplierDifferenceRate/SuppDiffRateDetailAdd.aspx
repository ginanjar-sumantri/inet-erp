<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SuppDiffRateDetailAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.SupplierDifferenceRate.SuppDiffRateDetailAdd" %>
                    ...
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator runat="server" ID="InvoiceNoCustomValidator" ClientValidationFunction="DropDownValidation"
