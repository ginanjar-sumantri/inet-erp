...
{
    public partial class SuppDiffRateDetail : SupplierDifferenceRateBase
    {
        private FINAPRateBL _finAPRateBL = new FINAPRateBL();
        private ReportFinanceBL _reportFinanceBL = new ReportFinanceBL();
        private PaymentTradeBL _paymentTradedBL = new PaymentTradeBL();
        ...
        private string _reportPath1 = "SupplierDifferenceRate/DifferenceRateAP.rdlc";
        private string _awal = "ctl00_DefaultBodyContentPlaceHolder_ListRepeater_ctl";
        private string _akhir = "_ListCheckBox";
        private string _cbox = "ctl00_DefaultBodyContentPlaceHolder_AllCheckBox";
        private string _tempHidden = "ctl00$DefaultBodyContentPlaceHolder$TempHidden";

        private string _reportPath2 = "SupplierDifferenceRate/JournalEntryPrintPreview.rdlc";
        private string _reportPath3 = "SupplierDifferenceRate/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        public void ShowData()
        {
            ...
            _decimalPlace = this._currencyBL.GetDecimalPlace(_finAPRateHd.CurrCode);
            ...
            this.StatusLabel.Text = APRateDataMapper.GetStatusText(_finAPRateHd.Status);
            this.StatusHiddenField.Value = _finAPRateHd.Status.ToString();
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == APRateDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        private double RowCount()
        {
            ...
            _result = this._finAPRateBL.RowsCountFINAPRateDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        private void ShowDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finAPRateBL.GetListFINAPRateDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == APRateDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == APRateDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == APRateDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == APRateDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._finAPRateBL.DeleteMultiFINAPRateDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINAPRateDt _temp = (FINAPRateDt)e.Item.DataItem;
                ...
                Literal _prmInvoiceNo = (Literal)e.Item.FindControl("InvoiceNoLiteral");
                _prmInvoiceNo.Text = HttpUtility.HtmlEncode(_temp.FileNoInvoice);

                Literal _suppName = (Literal)e.Item.FindControl("SuppNameLiteral");
                _suppName.Text = HttpUtility.HtmlEncode(_temp.SuppName);

                Literal _forexRate = (Literal)e.Item.FindControl("ForexRateLiteral");
                _forexRate.Text = HttpUtility.HtmlEncode((_temp.ForexRate == 0) ? "0" : _temp.ForexRate.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace)));
                ...
                decimal _adjustValue = _temp.NewAmountHome - _temp.AmountHome;
                _adjust.Text = HttpUtility.HtmlEncode((_adjustValue == 0) ? "0" : _adjustValue.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlaceHome)));

                Literal _isApplyToPPN = (Literal)e.Item.FindControl("IsApplyToPPNLiteral");
                _isApplyToPPN.Text = APRateDataMapper.GetIsApplyToPPN(_temp.IsApplyToPPN);
            }
        }
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == APRateDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._finAPRateBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == APRateDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._finAPRateBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == APRateDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._finAPRateBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == APRateDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._finAPRateBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportFinanceBL.DifferenceRateAPPrintPreview(this.TransNoTextBox.Text);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.APRate), this.TransNoTextBox.Text, this.FileNmbrTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.WarningLabel.Text = _result;
