<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SuppDiffRateEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.SupplierDifferenceRate.SuppDiffRateEdit" %>
                            ...
                            <ContentTemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="CurrRateTextBox" runat="server" BackColor="#CCCCCC" ReadOnly="True"
