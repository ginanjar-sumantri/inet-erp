...
{
    public partial class DPCustomerList : DPCustomerListBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finDPCustListBL.RowsCountFINDPCustList(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finDPCustListBL.GetListFINDPCustList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINDPCustList _temp = (FINDPCustList)e.Item.DataItem;
                ...
                if (_temp.Status == DPCustListDataMapper.GetStatus(TransStatus.Posted))
                {
                    _editButton.Visible = false;
                }
                else
                ...
                Literal _transCode = (Literal)e.Item.FindControl("TransNmbrLiteral");
                _transCode.Text = HttpUtility.HtmlEncode(_temp.TransNmbr);
                ...
                Literal _currCode = (Literal)e.Item.FindControl("CurrLiteral");
                _currCode.Text = HttpUtility.HtmlEncode(_temp.CurrCode);

                Literal _status = (Literal)e.Item.FindControl("StatusLiteral");
                _status.Text = DPCustListDataMapper.GetStatusText(_temp.Status);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._finDPCustListBL.GetSingleFINDPCustListForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._finDPCustListBL.DeleteMultiFINDPCustList(_tempSplit);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._finDPCustListBL.DeleteMultiApproveFINDPCustList(_tempSplit, AppModule.GetValue(TransactionType.FINDPCustList), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
