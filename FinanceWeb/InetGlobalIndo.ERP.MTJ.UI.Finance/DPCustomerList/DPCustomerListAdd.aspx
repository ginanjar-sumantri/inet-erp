<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DPCustomerListAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.DPCustomerList.DPCustomerListAdd" %>
        ...
        <table cellpadding="3" cellspacing="0" width="0" border="0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <%--<img src="../calendar/img.gif" id="dp_date" style="cursor: pointer; border: 1px solid red;"
                        title="Date selector" onmouseover="this.style.background='red';" onmouseout="this.style.background=''"
                        align="absmiddle" />

                    <script type="text/javascript">
	                Calendar.setup({
		                inputField     :    "ctl00_DefaultBodyContentPlaceHolder_DPCustListDateTextBox",    	// id of the input field
		                ifFormat       :    "%Y-%m-%d",        	// format of the input field
		                showsTime      :    false,            	// will display a time selector
		                button         :    "dp_date", 	 	    // trigger for the calendar (button ID)
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="CustCodeCustomValidator" runat="server" ErrorMessage="Customer Must be filled"
                        Text="*" ControlToValidate="CustCodeDropDownList" ClientValidationFunction="DropDownValidation"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList runat="server" ID="SONoDropDownList" AutoPostBack="true" OnSelectedIndexChanged="SONoDropDownList_SelectedIndexChanged">
                    </asp:DropDownList>
                    <%--<asp:TextBox runat="server" ID="SONoTextBox" MaxLength="20"></asp:TextBox>--%>
                </td>
            </tr>
