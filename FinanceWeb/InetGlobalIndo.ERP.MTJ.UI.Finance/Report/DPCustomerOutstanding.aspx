<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DPCustomerOutstanding.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.DPCustomerOutstanding" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                    ...
                                                    <asp:ListItem Value="1">Summary By Invoice</asp:ListItem>
                                                    <asp:ListItem Value="2">Summary By Customer - Invoice</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:CustomValidator ID="FgTypeCustomValidator" runat="server" ErrorMessage="Fg Report Must Be Choosed"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox ID="PeriodDateTextBox" runat="server" Width="100" BackColor="#CCCCCC"></asp:TextBox>
                                                            <%--<input id="date_start" type="button" onclick="displayCalendar(ctl00_DefaultBodyContentPlaceHolder_PeriodDateTextBox,'yyyy-mm-dd',this)"
                                                                value="..." />--%>
                                                            <asp:Literal ID="PeriodDateLiteral" runat="server"></asp:Literal>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
