...
{
    public partial class GiroCustListCustomer : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInListCustSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroInListCustSummaryBankGiro.rdlc";
        private string _reportPath2 = "Report/GiroInListCustSummaryDueDate.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustListCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Listing Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustListCustomer(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
