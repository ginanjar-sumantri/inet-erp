<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReceiptPerDate.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.ReceiptPerDate" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgTypeDropDownList">
                                                    ...
                                                    <asp:ListItem Value="1">Summary By Receipt Type</asp:ListItem>
                                                    <asp:ListItem Value="2">Summary By Receipt </asp:ListItem>
                                                    <asp:ListItem Value="3">Summary By Detail Customer </asp:ListItem>
                                                    <asp:ListItem Value="4">Detail Receipt Type</asp:ListItem>
                                                </asp:DropDownList>
