...
{
    public partial class PaymentAndReceiptAnalysisMonthly : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PaymentAndReceiptAnalysisMonthly.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPaymentAndReceiptAnalysisMonthly, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PageTitleLiteral.Text = "Payment And Receipt Analysis Monthly Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._reportBL.PaymentAndReceiptAnalysisMonthly(_start, _end, _payType, "", this.DivideByDropDownList.SelectedValue, Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
            ...
            {
                this.WarningLabel.Text = "Period cannot more than 6 months";
            }
        }
