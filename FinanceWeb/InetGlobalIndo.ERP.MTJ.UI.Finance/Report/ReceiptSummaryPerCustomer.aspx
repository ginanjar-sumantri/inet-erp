<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReceiptSummaryPerCustomer.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.ReceiptSummaryPerCustomer" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="TypeDropDownList">
                                                ...
                                                <asp:ListItem Value="0">Summary Per Customer</asp:ListItem>
                                                <asp:ListItem Value="1">Summary Per Receipt Type</asp:ListItem>
                                            </asp:DropDownList>
