<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="GiroCustomerPerCustomer.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.GiroCustomerPerCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="DefaultBodyContentPlaceHolder" runat="Server">
    <asp:Panel ID="Panel1" DefaultButton="ViewButton" runat="server">
        <table cellpadding="3" cellspacing="0" width="100%" border="0">
                                ...
                                <td>
                                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                    ...
                                                    <asp:ListItem Value="0">Summary Giro</asp:ListItem>
                                                    <asp:ListItem Value="1">Summary Bank Payment</asp:ListItem>
                                                    <asp:ListItem Value="2">Summary Bank Setor</asp:ListItem>
                                                    <asp:ListItem Value="3">Summary Bank Cair Date</asp:ListItem>
                                                </asp:DropDownList>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CheckBoxList runat="server" ID="BankGiroCheckBoxList" RepeatColumns="3">
                                                </asp:CheckBoxList>
                                            </td>
                                        </tr>
                                        <tr>
            ...
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="1600px"
