...
{
    public partial class GiroCustTolakBankGiro : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInTolakBankGiroSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroInTolakBankGiroSummaryCustomer.rdlc";
        private string _reportPath2 = "Report/GiroInTolakBankGiroSummaryBankSetor.rdlc";
        private string _reportPath3 = "Report/GiroInTolakBankGiroSummaryTolakDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustTolakBankGiro, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Tolak Per Bank Giro Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustTolakBankGiro(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
