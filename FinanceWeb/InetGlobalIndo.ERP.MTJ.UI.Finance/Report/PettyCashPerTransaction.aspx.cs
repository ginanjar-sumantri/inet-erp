...
{
    public partial class PettyCashPerTransaction : ReportBase
    {
        ...
        private string _reportPath2 = "Report/PettyCashPerTransactionDetail.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Petty Cash Per Transaction Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.PettyCashPerTransaction(_startDateTime, _endDateTime, _pettyCode, _currCode, this.GroupByDropDownList.SelectedValue, Convert.ToInt32(this.PettyCashReportDropDownList.SelectedValue));
