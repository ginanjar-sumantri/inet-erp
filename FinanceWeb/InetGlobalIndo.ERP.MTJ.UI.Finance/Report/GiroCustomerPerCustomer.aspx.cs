...
{
    public partial class GiroCustomerPerCustomer : ReportBase
    {
        ...
        private string _reportPath2 = "Report/SummaryGiroInBankSetorPerCustomer.rdlc";
        private string _reportPath1 = "Report/SummaryGiroInBankPaymentPerCustomer.rdlc";
        private string _reportPath0 = "Report/SummaryGiroInPerCustomer.rdlc";
        private string _reportPath3 = "Report/SummaryGiroInCairDatePerCustomer.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustCairCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Cair Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustomerPerCustomer(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
