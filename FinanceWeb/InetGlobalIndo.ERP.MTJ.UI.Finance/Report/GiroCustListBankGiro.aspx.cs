...
{
    public partial class GiroCustListBankGiro : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInListBankGiroSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroInListBankGiroSummaryCustomer.rdlc";
        private string _reportPath2 = "Report/GiroInListBankGiroSummaryDueDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustListBankGiro, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Listing Per Bank Giro Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustListBankGiro(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
