...
{
    public partial class GiroSuppTolakBankPayment : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroOutTolakBankPaymentSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroOutTolakBankPaymentSummarySupplier.rdlc";
        private string _reportPath2 = "Report/GiroOutTolakBankPaymentSummaryTolakDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppTolakBankPayment, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Tolak Per Bank Payment Report";
        ...
        {
            this.BankPaymentCheckBoxList.DataTextField = "PayName";
            this.BankPaymentCheckBoxList.DataValueField = "PayCode";
            this.BankPaymentCheckBoxList.DataSource = this._paymentBL.GetListDDLGiroPayment();
            this.BankPaymentCheckBoxList.DataBind();
        }
        ...
        public void ClearData()
        {
            ...
            this.BankPaymentCheckBoxList.ClearSelection();
            this.SuppCodeCheckBoxList.ClearSelection();
        }
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var hasilBankPayment = this._paymentBL.GetListDDLGiroPayment();

            for (var i = 0; i < hasilBankPayment.Count(); i++)
            {
                if (this.BankPaymentCheckBoxList.Items[i].Selected == true)
                {
                    if (i == 0)
                    {
                        _bankPayment += this.BankPaymentCheckBoxList.Items[i].Value;
                    }
                    else
                    {
                        _bankPayment += "," + this.BankPaymentCheckBoxList.Items[i].Value;
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSuppTolakBankPayment(_startDateTime, _endDateTime, _suppCode, _bankPayment, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
            ...
            _reportParam[4] = new ReportParameter("Str2", _bankPayment, true);
