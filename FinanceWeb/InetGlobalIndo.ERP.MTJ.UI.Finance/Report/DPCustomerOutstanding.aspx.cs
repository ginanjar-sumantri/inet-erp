...
{
    public partial class DPCustomerOutstanding : ReportBase
    {
        ...
        private string _reportPath0 = "Report/DPCustOutStandingByCustReport.rdlc";
        private string _reportPath1 = "Report/DPCustOutStandingByInvReport.rdlc";
        private string _reportPath2 = "Report/DPCustOutStandingByCustINVReport.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDDPCustomerOutstanding, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PeriodDateLiteral.Text = "<input id='button1' type='button' onclick='displayCalendar(" + this.PeriodDateTextBox.ClientID + ",&#39" + DateFormMapper.GetFormat() + "&#39,this)' value='...' />";

                this.PageTitleLiteral.Text = "DP Customer Outstanding Report";
        ...
        {
            this.PeriodDateTextBox.Attributes.Add("ReadOnly", "True");
        }
        ...
        public void ClearData()
        {
            ...
            this.PeriodDateTextBox.Text = DateFormMapper.GetValue(now);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            DateTime _period = new DateTime(DateFormMapper.GetValue(this.PeriodDateTextBox.Text).Year, DateFormMapper.GetValue(this.PeriodDateTextBox.Text).Month, DateFormMapper.GetValue(this.PeriodDateTextBox.Text).Day, 23, 59, 59);

            ReportDataSource _reportDataSource1 = this._reportBL.DPCustomerOutstanding(_period, _custCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
            ...
            _reportParam[0] = new ReportParameter("Date", _period.ToString(), true);
