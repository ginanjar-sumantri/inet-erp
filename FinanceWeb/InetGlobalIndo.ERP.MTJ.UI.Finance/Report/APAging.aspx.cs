...
{
    public partial class APAging : ReportBase
    {
        ...
        private string _reportPath0 = "Report/APAgingBySupplier.rdlc";
        private string _reportPath1 = "Report/APAgingBySupplierInvoice.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDAPAging, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Account Payable Aging Report";
        ...
        public void SetAttribute()
        {
            ...
            this.Period0TextBox.Attributes.Add("ReadOnly", "True");
            this.Period2TextBox.Attributes.Add("ReadOnly", "True");
            this.Period4TextBox.Attributes.Add("ReadOnly", "True");
            this.Period1TextBox.Attributes.Add("OnKeyDown", "return Numeric();");
            this.Period3TextBox.Attributes.Add("OnKeyDown", "return Numeric();");
            this.Period5TextBox.Attributes.Add("OnKeyDown", "return Numeric();");
            this.Period1TextBox.Attributes.Add("OnBlur", "CekAndFillRange(" + this.Period0TextBox.ClientID + ", " + this.Period1TextBox.ClientID + ", " + this.Period2TextBox.ClientID + ")");
            this.Period3TextBox.Attributes.Add("OnBlur", "CekAndFillRange(" + this.Period2TextBox.ClientID + ", " + this.Period3TextBox.ClientID + ", " + this.Period4TextBox.ClientID + ")");
            this.Period5TextBox.Attributes.Add("OnBlur", "CekRange(" + this.Period4TextBox.ClientID + ", " + this.Period5TextBox.ClientID + ");");
        }
        ...
        public void ClearData()
        {
            ...
            this.SuppCodeCheckBoxList.ClearSelection();
            this.Period0TextBox.Text = "0";
            this.Period1TextBox.Text = "";
            this.Period2TextBox.Text = "";
            this.Period3TextBox.Text = "";
            this.Period4TextBox.Text = "";
            this.Period5TextBox.Text = "";
        }
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //var hasilSupp = this._suppBL.GetListDDLSuppForReport(_tempSuppGroup, _tempSuppType);
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.APAging(_startDateTime, _currCode, _suppCode, Convert.ToInt32(this.Period1TextBox.Text), Convert.ToInt32(this.Period3TextBox.Text), Convert.ToInt32(this.Period5TextBox.Text), Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.BackDropDownList.SelectedValue));
            ...
            _reportParam[5] = new ReportParameter("ID1", this.Period1TextBox.Text, true);
            _reportParam[6] = new ReportParameter("ID2", this.Period3TextBox.Text, true);
            _reportParam[7] = new ReportParameter("ID3", this.Period5TextBox.Text, true);
            _reportParam[8] = new ReportParameter("FgCurr", this.GroupByDropDownList.SelectedValue, true);
            _reportParam[9] = new ReportParameter("FgReport", this.FgReportDropDownList.SelectedValue, true);
            _reportParam[10] = new ReportParameter("FgBack", this.BackDropDownList.SelectedValue, true);
        ...
        protected void Period1TextBox_TextChanged(object sender, EventArgs e)
        {
            this.WarningLabel.Text = "";

            if (Convert.ToInt32(this.Period1TextBox.Text) >= Convert.ToInt32(this.Period0TextBox.Text))
            {
                this.Period2TextBox.Text = (Convert.ToInt32(this.Period1TextBox.Text) + 1).ToString();
            }
            else
            {
                this.WarningLabel.Text = "Range 1 Cannot Below than " + this.Period0TextBox.Text;
                this.Period1TextBox.Text = "";
            }
        }

        protected void Period3TextBox_TextChanged(object sender, EventArgs e)
        {
            this.WarningLabel.Text = "";

            if (Convert.ToInt32(this.Period3TextBox.Text) >= Convert.ToInt32(this.Period2TextBox.Text))
            {
                this.Period4TextBox.Text = (Convert.ToInt32(this.Period3TextBox.Text) + 1).ToString();
            }
            else
            {
                this.WarningLabel.Text = "Range 2 Cannot Below than " + this.Period2TextBox.Text;
                this.Period3TextBox.Text = "";
            }
        }

        protected void Period5TextBox_TextChanged(object sender, EventArgs e)
        {
            this.WarningLabel.Text = "";

            if (Convert.ToInt32(this.Period3TextBox.Text) < Convert.ToInt32(this.Period2TextBox.Text))
            {
                this.WarningLabel.Text = "Range 3 Cannot Below than " + this.Period4TextBox.Text;
                this.Period5TextBox.Text = "";
            }
        }
    }
