...
{
    public partial class PurchaseInvoicePurchasePriceHistory : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseInvoicePurchasePriceHistory.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseInvoicePurchasePriceHistory, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Invoice Purchase Price History Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PurchaseInvoicePurchasePriceHistory(_startDateTime, _endDateTime, _productCode);
