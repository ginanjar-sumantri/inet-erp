...
{
    public partial class PaymentSummaryPerSupplier : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PaymentSummaryPerSupplierSummarySupplier.rdlc";
        private string _reportPath1 = "Report/PaymentSummaryPerSupplierSummaryPaymentType.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPaymentSummaryPerSupplier, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Payment Summary Per Supplier";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._reportBL.PaymentSummaryPerSupplier(_start, _end, _payType, _suppCode, this.DivideByDropDownList.SelectedValue, Convert.ToInt32(this.FilterDropDownList.SelectedValue), Convert.ToInt32(this.TypeDropDownList.SelectedValue), Convert.ToInt32(this.CurrencyTypeDropDownList.SelectedValue));
