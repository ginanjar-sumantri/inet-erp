<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="APListing.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.APListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="DefaultBodyContentPlaceHolder" runat="Server">
    <asp:Panel ID="Panel1" DefaultButton="ViewButton" runat="server">
        <table cellpadding="3" cellspacing="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                    ...
                                                    <asp:ListItem Value="1">Summary By Supplier - Invoice</asp:ListItem>
                                                </asp:DropDownList>
            ...
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer" runat="server" Width="100%" Height="1760px"
