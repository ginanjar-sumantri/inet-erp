...
{
    public partial class DPSupplierReturPerTransaction : ReportBase
    {
        private ReportFinanceBL _report = new ReportFinanceBL();
        private PermissionBL _permBL = new PermissionBL();
        private SupplierBL _suppBL = new SupplierBL();

        private string _reportPath0 = "Report/DPSupplierReturPerTransactionSummary.rdlc";
        private string _reportPath1 = "Report/DPSupplierReturPerTransactionDetail.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDDPSupplierReturPerTransaction, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "DP Supplier Retur Per Transaction";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.DPSupplierReturPerTransaction(_startDateTime, _endDateTime, _suppCode, "", "", Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
