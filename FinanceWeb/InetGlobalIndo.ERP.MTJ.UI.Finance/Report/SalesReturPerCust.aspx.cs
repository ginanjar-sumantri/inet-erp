...
{
    public partial class SalesReturPerCust : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SalesReturPerCustSummaryCust.rdlc";
        private string _reportPath1 = "Report/SalesReturPerCustSummaryTrans.rdlc";
        private string _reportPath2 = "Report/SalesReturPerCustDetailTrans.rdlc";
        private string _reportPath3 = "Report/SalesReturPerCustSummaryProduct.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesReturPerCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.SalesReturPerCust(_startDateTime, _endDateTime, _custCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
