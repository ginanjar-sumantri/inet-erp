...
{
    public partial class GiroSupplierCairPerDate : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SummaryBankPaymentPerCairDate.rdlc";
        private string _reportPath1 = "Report/SummarySupplierPerCairDate.rdlc";
        private string _reportPath2 = "Report/SummaryGiroPerCairDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppCairDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Cair Per Date Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSupplierCairDate(_startDateTime, _endDateTime, _suppCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
