...
{
    public partial class ARStatementOfAccount : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ARStatementOfAccount.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDARStatementOfAccount, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PageTitleLiteral.Text = "Account Receivable Statement of Account Report";
        ...
        public void ClearData()
        {
            ...
            this.CheckHidden.Value = "";
            this.TempHidden.Value = "";
            this.YearTextBox.Text = now.Year.ToString();
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            this.ReportViewer.LocalReport.AddTrustedCodeModuleInCurrentAppDomain(ApplicationConfig.CommonDLL);
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ARStatementOfAccount(Convert.ToInt32(this.YearTextBox.Text), Convert.ToInt32(this.PeriodTextBox.Text), _custCode);
