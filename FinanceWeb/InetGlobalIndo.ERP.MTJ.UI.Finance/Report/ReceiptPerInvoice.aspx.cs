...
{
    public partial class ReceiptPerInvoice : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ReceiptPerInvoiceSummaryInvoiceReport.rdlc";
        private string _reportPath1 = "Report/ReceiptPerInvoiceSummaryCustomerReport.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDReceiptPerInvoice, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Receipt Per Invoice Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ReceiptPerInvoice(_startDateTime, _endDateTime, _custCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
            ...
            _reportParam[6] = new ReportParameter("FgDetail", this.FgReportDropDownList.SelectedValue, true);
