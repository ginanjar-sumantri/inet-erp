...
{
    public partial class GiroCustomerPerBankSetor : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SummaryGiroInPerBankSetor.rdlc";
        private string _reportPath1 = "Report/SummaryGiroInCustomerPerBankSetor.rdlc";
        private string _reportPath2 = "Report/SummaryGiroInBankPaymentPerBankSetor.rdlc";
        private string _reportPath3 = "Report/SummaryGiroInCairDatePerBankSetor.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustCairBankSetor, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Cair Per Bank Setor Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustomerPerBankSetor(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
