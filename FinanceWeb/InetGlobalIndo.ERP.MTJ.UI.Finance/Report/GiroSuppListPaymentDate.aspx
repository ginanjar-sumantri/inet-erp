<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="GiroSuppListPaymentDate.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.GiroSuppListPaymentDate" %>
                                ...
                                <td>
                                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                    ...
                                                    <asp:ListItem Value="2">Summary Bank Payment</asp:ListItem>
                                                </asp:DropDownList>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CheckBoxList runat="server" ID="BankPaymentCheckBoxList" RepeatColumns="3">
                                                </asp:CheckBoxList>
                                            </td>
                                        </tr>
                                        <tr>
