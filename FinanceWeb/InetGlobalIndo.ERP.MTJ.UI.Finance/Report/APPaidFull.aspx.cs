...
{
    public partial class APPaidFull : ReportBase
    {
        ...
        private string _reportPath0 = "Report/APPaidFull.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDAPPaidFull, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Account Payable Paid Full Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.APPaidFull(_startDateTime, _endDateTime, _currCode, _suppCode);
            ...
            _reportParam[6] = new ReportParameter("GroupBy", "0", false);
