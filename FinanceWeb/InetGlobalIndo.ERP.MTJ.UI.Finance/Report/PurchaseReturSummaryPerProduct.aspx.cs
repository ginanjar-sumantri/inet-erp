...
{
    public partial class PurchaseReturSummaryPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseReturSummaryPerProductProdQty.rdlc";
        private string _reportPath1 = "Report/PurchaseReturSummaryPerProductProdGroupQty.rdlc";
        private string _reportPath2 = "Report/PurchaseReturSummaryPerProductProdSubGroupQty.rdlc";
        private string _reportPath3 = "Report/PurchaseReturSummaryPerProductProdTypeQty.rdlc";

        private string _reportPath4 = "Report/PurchaseReturSummaryPerProductProdAmount.rdlc";
        private string _reportPath5 = "Report/PurchaseReturSummaryPerProductProdGroupAmount.rdlc";
        private string _reportPath6 = "Report/PurchaseReturSummaryPerProductProdSubGroupAmount.rdlc";
        private string _reportPath7 = "Report/PurchaseReturSummaryPerProductProdTypeAmount.rdlc";

        private string _reportPath8 = "Report/PurchaseReturSummaryPerProductProdAmountQty.rdlc";
        private string _reportPath9 = "Report/PurchaseReturSummaryPerProductProdGroupAmountQty.rdlc";
        private string _reportPath10 = "Report/PurchaseReturSummaryPerProductProdSubGroupAmountQty.rdlc";
        private string _reportPath11 = "Report/PurchaseReturSummaryPerProductProdTypeAmountQty.rdlc";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.PurchaseReturSummaryPerProduct(_start, _end, _productSubGrpCode, _suppCode, this.DivideByDropDownList.SelectedValue, Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
