...
{
    public partial class GiroSuppODBankGiro : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroOutODBankGiroSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroOutODBankGiroSummarySupplier.rdlc";
        private string _reportPath2 = "Report/GiroOutODBankGiroSummaryDueDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppODBankPayment, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Over Due Per Bank Payment Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSuppODBankGiro(_startDateTime, _suppCode, _bankPayment, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
            ...
            _reportParam[3] = new ReportParameter("Str2", _bankPayment, true);
