...
{
    public partial class SalesInvoicePerCust : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SalesInvoicePerCustSummaryCust.rdlc";
        private string _reportPath1 = "Report/SalesInvoicePerCustSummaryTrans.rdlc";
        private string _reportPath2 = "Report/SalesInvoicePerCustSummaryProduct.rdlc";
        private string _reportPath3 = "Report/SalesInvoicePerCustDetailTrans.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesInvoicePerCustomer, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Invoice Per Customer Report";
        ...
        public void ClearData()
        {
            ...
            this.CustCodeCheckBoxList.ClearSelection();
            this.HeaderReportList1.ReportGroup = "SalesInvoicePerCust";
        }
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.SalesInvoicePerCustomer(_startDateTime, _endDateTime, _currCode, _custCode, Convert.ToInt32(this.HeaderReportList1.SelectedIndex), this.GroupByDropDownList.SelectedValue, this.FilterDropDownList.SelectedValue, this.CustomerFromTextBox.Text, this.CustomerToTextBox.Text);
            ...
            _reportParam[5] = new ReportParameter("Str3", this.GroupByDropDownList.SelectedValue, true);
