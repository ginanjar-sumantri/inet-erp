...
{
    public partial class DifferenceRateCustHistory : ReportBase
    {
        ...
        private string _reportPath0 = "Report/DifferenceRateCustHistoryReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDDiffRateCustomerPerHistory, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Difference Rate Customer History";
        ...
        private double RowCountSupplier()
        {
            ...
            _result1 = this._customerBL.RowsCountCustReport(_tempCustGroup, _tempCustType);
        ...
        protected void DataPagerTopRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "DataPager")
            {
                ...
                this.ShowCust(Convert.ToInt32(e.CommandArgument));
                this.SetCheckBox();
            }
        }
        ...
        private void ShowCust(Int32 _prmCurrentPage)
        {
            string _tempCustGroup = (this.CustGroupDropDownList.SelectedValue == "null") ? "" : this.CustGroupDropDownList.SelectedValue;
            string _tempCustType = (this.CustTypeDropDownList.SelectedValue == "null") ? "" : this.CustTypeDropDownList.SelectedValue;
            ...
            this.CustCodeCheckBoxList.DataSource = this._customerBL.GetListDDLCustomer(_tempCustGroup, _tempCustType, _prmCurrentPage, _maxrow);
            ...
            List<MsCustomer> _listMsCustomer = this._customerBL.GetListDDLCustomer(_tempCustGroup, _tempCustType);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.DifferenceRateCustHistory(_startDateTime, _endDateTime, _currCode, _custCode, "");
