...
{
    public partial class ReceiptSummaryPerCustomer : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ReceiptSumPerCustomerByCust.rdlc";
        private string _reportPath1 = "Report/ReceiptSumPerCustomerByReceipt.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDReceiptSummaryPerCustomer, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Receipt Summary per Customer";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._reportBL.ReceiptSummaryPerCustomer(_start, _end, _payType, _custCode, this.DivideByDropDownList.SelectedValue, Convert.ToInt32(this.FilterDropDownList.SelectedValue), Convert.ToInt32(this.TypeDropDownList.SelectedValue), Convert.ToInt32(this.CurrencyTypeDropDownList.SelectedValue));
