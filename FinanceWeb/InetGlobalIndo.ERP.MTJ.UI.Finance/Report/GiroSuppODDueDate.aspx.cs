...
{
    public partial class GiroSuppODDueDate : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroOutODDueDateSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroOutODDueDateSummarySupplier.rdlc";
        private string _reportPath2 = "Report/GiroOutODDueDateSummaryBankGiro.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppODDueDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Over Due Per Due Date Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSuppODDueDate(_startDateTime, _suppCode, _bankPayment, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
