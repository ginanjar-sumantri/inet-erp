...
{
    public partial class GiroCustODBankGiro : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInODBankGiroSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroInODBankGiroSummaryCustomer.rdlc";
        private string _reportPath2 = "Report/GiroInODBankGiroSummaryDueDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustODBankGiro, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Over Due Per Bank Giro Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustODBankGiro(_startDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
            ...
            _reportParam[3] = new ReportParameter("Str2", _bankGiro, true);
