...
{
    public partial class PaymentPerSupplier : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PaymentPerSupplierSummarySupplier.rdlc";
        private string _reportPath1 = "Report/PaymentPerSupplierDetailSupplier.rdlc";
        private string _reportPath2 = "Report/PaymentPerSupplierSummaryPaymentType.rdlc";
        private string _reportPath3 = "Report/PaymentPerSupplierDetailPaymentType.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPaymentPerSupplier, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Payment Per Supplier";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PaymentPerSupplier(_startDateTime, _endDateTime, _payType, _suppCode, "", Convert.ToInt32(this.FilterDropDownList.SelectedValue), Convert.ToInt32(this.TypeDropDownList.SelectedValue), Convert.ToInt32(this.CurrencyTypeDropDownList.SelectedValue));
