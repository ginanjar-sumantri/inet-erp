...
{
    public partial class DPCustomerIssue : ReportBase
    {
        ...
        private string _reportPath0 = "Report/DPCustIssueByCustomerReport.rdlc";
        private string _reportPath1 = "Report/DPCustIssueByInvoiceReport.rdlc";
        private string _reportPath2 = "Report/DPCustIssueByCustInvoiceReport.rdlc";


        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDDPCustomerIssue, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "DP Customer Issue Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.DPCustomerIssue(_startDateTime, _endDateTime, _custCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
