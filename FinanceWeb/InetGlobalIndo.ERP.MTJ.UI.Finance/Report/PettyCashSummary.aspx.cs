...
{
    public partial class PettyCashSummary : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PettyCashSummary.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPettyCashSummary, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Petty Cash Summary Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.PettyCashPerSummary(_start, _end, _pettyCode, _currCode, this.DivideByDropDownList.SelectedValue, Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
                ...
                _reportParam[5] = new ReportParameter("FgReport", this.GroupByDropDownList.SelectedValue, true);
