<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ARListing.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.ARListing" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                    ...
                                                    <asp:ListItem Value="1">Summary By Customer - Invoice</asp:ListItem>
                                                    <asp:ListItem Value="2">Summary By Customer - Invoice Description</asp:ListItem>
                                                    <asp:ListItem Value="3">Summary By Customer - Invoice Detail</asp:ListItem>
                                                </asp:DropDownList>
