...
{
    public partial class DifferenceRateCustPerDate : ReportBase
    {
        private ReportFinanceBL _report = new ReportFinanceBL();
        private PermissionBL _permBL = new PermissionBL();
        private CurrencyBL _currencyBL = new CurrencyBL();

        private string _reportPath0 = "Report/DifferenceRateCustPerDateReport.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {

            this._permAccess = this._permBL.PermissionValidation1(this._menuIDDiffRateCustomerPerDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Difference Rate Customer Per Date";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.DifferenceRateCustomerPerDate(_startDateTime, _endDateTime, _currCode, "", "");
