...
{
    public partial class GiroCustListReceiptDate : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInListReceiptDateSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroInListReceiptDateSummaryCust.rdlc";
        private string _reportPath2 = "Report/GiroInListReceiptDateSummaryBankGiro.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustListReceiptDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Listing Per Receipt Date Report";
        ...
        private void ShowBankGiro()
        {
            ...
            this.BankGiroCheckBoxList.Items.Clear();
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustListReceiptDate(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
