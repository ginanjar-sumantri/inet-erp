...
{
    public partial class ReceiptPerReceiptType : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ReceiptPerReceiptTypeSummaryReceiptReport.rdlc";
        private string _reportPath1 = "Report/ReceiptPerReceiptTypeDetailReceiptReport.rdlc";
        private string _reportPath2 = "Report/ReceiptPerReceiptTypeSummaryCustomerReport.rdlc";
        private string _reportPath3 = "Report/ReceiptPerReceiptTypeDetailReceiptReport.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDReceiptPerReceiptType, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Receipt Per Receipt Type Report";
        ...
        protected void ShowReceiptType(Int32 _prmCurrentPage)
        {
            this.ReceiptTypeCheckBoxList.ClearSelection();
            this.ReceiptTypeCheckBoxList.Items.Clear();
            this.ReceiptTypeCheckBoxList.DataSource = this._paymentBL.GetListReceiptTypeForReport(_prmCurrentPage, _maxrow2);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                _receiptType = this.TempHidden2.Value;
            }
            else
            {
                _receiptType = this.CheckHidden2.Value;
            }
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ReceiptPerReceiptType(_startDateTime, _endDateTime, _receiptType, _custCode, Convert.ToInt32(this.FgTypeDropDownList.SelectedValue), Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
            ...
            _reportParam[3] = new ReportParameter("Str1", _receiptType, true);
