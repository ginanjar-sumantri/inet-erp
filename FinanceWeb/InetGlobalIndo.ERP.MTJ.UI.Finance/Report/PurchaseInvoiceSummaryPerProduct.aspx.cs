...
{
    public partial class PurchaseInvoiceSummaryPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseInvoiceSummaryPerProductProdQty.rdlc";
        private string _reportPath1 = "Report/PurchaseInvoiceSummaryPerProductProdGroupQty.rdlc";
        private string _reportPath2 = "Report/PurchaseInvoiceSummaryPerProductProdSubGroupQty.rdlc";
        private string _reportPath3 = "Report/PurchaseInvoiceSummaryPerProductProdTypeQty.rdlc";

        private string _reportPath4 = "Report/PurchaseInvoiceSummaryPerProductProdAmount.rdlc";
        private string _reportPath5 = "Report/PurchaseInvoiceSummaryPerProductProdGroupAmount.rdlc";
        private string _reportPath6 = "Report/PurchaseInvoiceSummaryPerProductProdSubGroupAmount.rdlc";
        private string _reportPath7 = "Report/PurchaseInvoiceSummaryPerProductProdTypeAmount.rdlc";

        private string _reportPath8 = "Report/PurchaseInvoiceSummaryPerProductProdAmountQty.rdlc";
        private string _reportPath9 = "Report/PurchaseInvoiceSummaryPerProductProdGroupAmountQty.rdlc";
        private string _reportPath10 = "Report/PurchaseInvoiceSummaryPerProductProdSubGroupAmountQty.rdlc";
        private string _reportPath11 = "Report/PurchaseInvoiceSummaryPerProductProdTypeAmountQty.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseInvoiceSummaryPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Invoice Summary Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.PurchaseInvoiceSummaryPerProduct(_start, _end, _productSubGrpCode, _suppCode, this.DivideByDropDownList.SelectedValue, Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
