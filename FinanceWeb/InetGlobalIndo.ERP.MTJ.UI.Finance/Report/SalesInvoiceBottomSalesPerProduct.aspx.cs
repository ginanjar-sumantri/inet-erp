...
{
    public partial class SalesInvoiceBottomSalesPerProduct : ReportBase
    {
        private ReportFinanceBL _reportBL = new ReportFinanceBL();
        private ProductBL _productBL = new ProductBL();
        private PermissionBL _permBL = new PermissionBL();

        private string _reportPath0 = "Report/SalesInvoiceBottomSalesPerProduct.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesInvoiceBottomSalesPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Invoice Bottom Sales Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.SalesInvoiceBottomSalesPerProduct(_startDateTime, _endDateTime, _productSubGroupCode, this.RecordTextBox.Text, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
