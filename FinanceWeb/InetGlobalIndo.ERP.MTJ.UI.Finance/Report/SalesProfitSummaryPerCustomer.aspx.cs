...
{
    public partial class SalesProfitSummaryPerCustomer : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SalesProfitSummaryPerCustReport.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesProfitDetailPerCustomer, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PageTitleLiteral.Text = "Sales Profit Summary Per Customer";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._reportBL.SalesProfitSumPerCustomer(_start, _end, _custCode, "", this.DivideByDropDownList.SelectedValue);
