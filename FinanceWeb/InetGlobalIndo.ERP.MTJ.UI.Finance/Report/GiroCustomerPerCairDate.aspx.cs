...
{
    public partial class GiroCustomerPerCairDate : ReportBase
    {
        ...
        private string _reportPath2 = "Report/SummaryGiroInBankPaymentPerCairDate.rdlc";
        private string _reportPath1 = "Report/SummaryGiroInCustomerPerCairDate.rdlc";
        private string _reportPath0 = "Report/SummaryGiroInPerCairDate.rdlc";
        private string _reportPath3 = "Report/SummaryGiroInBankSetorPerCairDate.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustCairDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Cair Per Date Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustomerPerCairDate(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
