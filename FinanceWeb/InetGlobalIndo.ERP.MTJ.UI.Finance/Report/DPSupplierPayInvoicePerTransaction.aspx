<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DPSupplierPayInvoicePerTransaction.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.DPSupplierPayInvoicePerTransaction" %>
                                ...
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:CustomValidator Text="*" ID="FgCustomValidator" ClientValidationFunction="DropDownValidation"
                                                ControlToValidate="FgReportDropDownList" runat="server" ErrorMessage="Report Type Must Be Filled"></asp:CustomValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
