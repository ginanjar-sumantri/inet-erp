...
{
    public partial class GiroSuppListBankPayment : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroOutListBankPaymentSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroOutListBankPaymentSummarySupplier.rdlc";
        private string _reportPath2 = "Report/GiroOutListBankPaymentSummaryDueDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppListBankPayment, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Listing Per Bank Payment Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSuppListBankPayment(_startDateTime, _endDateTime, _suppCode, _bankPayment, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
