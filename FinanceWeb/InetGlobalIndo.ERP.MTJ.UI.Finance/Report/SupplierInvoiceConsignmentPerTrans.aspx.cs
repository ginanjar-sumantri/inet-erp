...
{
    public partial class SupplierInvoiceConsignmentPerTrans : ReportBase
    {
        ...
        //private string _reportPath0 = "Report/SupplierInvoiceConsignmentPerTransSummary.rdlc";
        //private string _reportPath1 = "Report/SupplierInvoiceConsignmentPerTransDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSupplierInvoiceConsignmentPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
        ...
        public void ClearData()
        {
            ...
            this.SuppCodeCheckBoxList.ClearSelection();
            this.HeaderReportList1.ReportGroup = "SupplierInvoiceConsignmentPerTrans";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.SupplierInvoiceConsignmentPerTrans(_startDateTime, _endDateTime, _suppCode, _currCode, this.SuppFromTextBox.Text.Trim(), this.SuppToTextBox.Text.Trim(), _fgReport);
