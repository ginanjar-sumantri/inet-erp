...
{
    public partial class SalesProfitDetailPerCustomer : ReportBase
    {
        private ReportFinanceBL _report = new ReportFinanceBL();
        private CustomerBL _custBL = new CustomerBL();
        private PermissionBL _permBL = new PermissionBL();

        private string _reportPath0 = "Report/SalesProfitDetailPerCustomer.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Profit Detail Per Customer";
