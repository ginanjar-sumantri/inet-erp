<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SupplierInvoiceConsignmentPerProductSummary.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.SupplierInvoiceConsignmentPerProductSummary" %>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="SuppGroupDDL" runat="server" AutoPostBack="True" OnSelectedIndexChanged="SuppGroupDDL_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="SuppTypeDDL" runat="server" AutoPostBack="True" OnSelectedIndexChanged="SuppTypeDDL_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="7">
                                                                    <table border="0" cellpadding="3" cellspacing="0" width="0">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:TextBox ID="SuppFromTextBox" runat="server"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                To
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="SuppToTextBox" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
