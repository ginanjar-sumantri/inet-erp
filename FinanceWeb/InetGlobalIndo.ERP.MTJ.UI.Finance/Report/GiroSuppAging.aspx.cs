...
{
    public partial class GiroSuppAging : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroOutAgingSummarySupplier.rdlc";
        private string _reportPath1 = "Report/GiroOutAgingSummaryGiroSupplier.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppAging, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Aging Report";
        ...
        {
            this.BankCodeCheckBoxList.DataTextField = "BankName";
            this.BankCodeCheckBoxList.DataValueField = "BankCode";
            this.BankCodeCheckBoxList.DataSource = this._bankBL.GetList();
            this.BankCodeCheckBoxList.DataBind();
        }
        ...
        public void ClearData()
        {
            ...
            this.SuppCodeCheckBoxList.ClearSelection();
            this.BankCodeCheckBoxList.ClearSelection();
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var hasilBank = this._bankBL.GetList();

            for (var i = 0; i < hasilBank.Count(); i++)
            {
                if (this.BankCodeCheckBoxList.Items[i].Selected == true)
                {
                    if (_bankCode == "")
                    {
                        _bankCode += this.BankCodeCheckBoxList.Items[i].Value;
                    }
                    else
                    {
                        _bankCode += "," + this.BankCodeCheckBoxList.Items[i].Value;
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSuppAging(_startDateTime, _suppCode, _bankCode, Convert.ToInt32(this.Period1TextBox.Text), Convert.ToInt32(this.Period3TextBox.Text), Convert.ToInt32(this.Period5TextBox.Text), Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.BackDropDownList.SelectedValue));
            ...
            _reportParam[1] = new ReportParameter("Str1", _suppCode, true);
            _reportParam[2] = new ReportParameter("Str2", _bankCode, true);
            _reportParam[3] = new ReportParameter("ID1", this.Period1TextBox.Text, true);
            _reportParam[4] = new ReportParameter("ID2", this.Period3TextBox.Text, true);
            _reportParam[5] = new ReportParameter("ID3", this.Period5TextBox.Text, true);
            _reportParam[6] = new ReportParameter("GroupBy", this.FgReportDropDownList.SelectedValue, true);
            _reportParam[7] = new ReportParameter("FgBack", this.BackDropDownList.SelectedValue, true);
