...
{
    public partial class GiroCustListDueDate : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInListDueDateSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroInListDueDateSummaryCustomer.rdlc";
        private string _reportPath2 = "Report/GiroInListDueDateSummaryBankGiro.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustListDueDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Listing Per Due Date";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustListDueDate(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
