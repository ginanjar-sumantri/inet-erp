<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PaymentPerDate.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.PaymentPerDate" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="TypeDropDownList">
                                                ...
                                                <asp:ListItem Value="1">Summary Payment Type</asp:ListItem>
                                                <asp:ListItem Value="2">Summary Transaction</asp:ListItem>
                                                <asp:ListItem Value="3">Detail Supplier</asp:ListItem>
                                                <asp:ListItem Value="4">Detail Payment Type</asp:ListItem>
                                            </asp:DropDownList>
