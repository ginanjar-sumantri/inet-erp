...
{
    public partial class GiroCustAging : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInAgingSummaryCustomer.rdlc";
        private string _reportPath1 = "Report/GiroInAgingSummaryGiro.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustAging, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Aging Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //var hasilCust = this._custBL.GetListCustomerForDDL();
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustAging(_startDateTime, _bankCode, _custCode, Convert.ToInt32(this.Period1TextBox.Text), Convert.ToInt32(this.Period3TextBox.Text), Convert.ToInt32(this.Period5TextBox.Text), Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.BackDropDownList.SelectedValue));
            ...
            _reportParam[3] = new ReportParameter("Str2", _bankCode, true);
            _reportParam[4] = new ReportParameter("ID1", this.Period1TextBox.Text, true);
            _reportParam[5] = new ReportParameter("ID2", this.Period3TextBox.Text, true);
            _reportParam[6] = new ReportParameter("ID3", this.Period5TextBox.Text, true);
            _reportParam[7] = new ReportParameter("GroupBy", this.FgReportDropDownList.SelectedValue, true);
            _reportParam[8] = new ReportParameter("FgBack", this.BackDropDownList.SelectedValue, true);
