...
{
    public partial class SalesInvoicePerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SalesInvoicePerTransSummary.rdlc";
        private string _reportPath1 = "Report/SalesInvoicePerTransDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesInvoicePerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Invoice Per Transaction Report";
        ...
        public void ClearData()
        {
            ...
            this.CustCodeCheckBoxList.ClearSelection();
            this.HeaderReportList1.ReportGroup = "SalesInvoicePerTrans";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.SalesInvoicePerTrans(_startDateTime, _endDateTime, _currCode, _custCode, _fgReport, this.FilterDropDownList.SelectedValue, this.CustomerFromTextBox.Text, this.CustomerToTextBox.Text, "000", "zzz");
            ...
            _reportParam[6] = new ReportParameter("FgReport", _fgReport.ToString(), true);
            ...
            _reportParam[10] = new ReportParameter("FromProduct", "000", true);
