...
{
    public partial class DifferenceRateSupplierHistory : ReportBase
    {
        ...
        private string _reportPath0 = "Report/DifferenceRateSupplierHistory.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDDifferenceRateSupplierHistory, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Difference Rate Supplier History";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.DifferenceRateSupplierHistory(_startDateTime, _endDateTime, _currCode, _suppCode, "");
