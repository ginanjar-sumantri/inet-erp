...
{
    public partial class ARListing : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ARListingByCustomer.rdlc";
        private string _reportPath1 = "Report/ARListingByCustomerInvoice.rdlc";
        private string _reportPath2 = "Report/ARListingByCustomerInvoiceDesc.rdlc";
        private string _reportPath3 = "Report/ARListingByCustomerInvoiceDetail.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Account Receivable Listing Report";
        ...
        private void ShowCustomer(Int32 _prmCurrentPage)
        {
            ...
            List<MsCustomer> _listMsCustomer = this._custBL.GetListDDLCustomer(_tempCustomerGroup, _tempCustomerType, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ARListing(_startDateTime, _endDateTime, _currCode, _custCode, Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
            ...
            _reportParam[6] = new ReportParameter("FgCurr", this.GroupByDropDownList.SelectedValue, false);
