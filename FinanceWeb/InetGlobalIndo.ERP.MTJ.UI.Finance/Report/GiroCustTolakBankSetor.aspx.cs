...
{
    public partial class GiroCustTolakBankSetor : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInTolakBankSetorSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroInTolakBankSetorSummaryCustomer.rdlc";
        private string _reportPath2 = "Report/GiroInTolakBankSetorSummaryBankGiro.rdlc";
        private string _reportPath3 = "Report/GiroInTolakBankSetorSummaryTolakDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustTolakBankSetor, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Tolak Per Bank Setor Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustTolakBankSetor(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
