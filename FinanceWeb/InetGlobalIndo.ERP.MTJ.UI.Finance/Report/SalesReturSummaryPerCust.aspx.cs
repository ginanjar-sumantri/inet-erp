...
{
    public partial class SalesReturSummaryPerCust : ReportBase
    {
        private ReportFinanceBL _report = new ReportFinanceBL();
        private PermissionBL _permBL = new PermissionBL();
        private CustomerBL _custBL = new CustomerBL();

        private string _reportPath0 = "Report/SalesReturSummaryPerCust.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesReturSummaryPerCustomer, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Retur Summary Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.SalesReturSummaryPerCustomer(_start, _end, _custCode, this.DivideByDropDownList.SelectedValue, Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
