...
{
    public partial class CustomerHistory : ReportBase
    {
        ...
        private string _reportPath0 = "Report/CustomerHistory.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDCustomerHistory, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Customer History Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.CustomerHistory(_startDateTime, _endDateTime, _custCode, this.GroupByDropDownList.SelectedValue);
            ...
            _reportParam[4] = new ReportParameter("Str2", this.GroupByDropDownList.SelectedValue, true);
