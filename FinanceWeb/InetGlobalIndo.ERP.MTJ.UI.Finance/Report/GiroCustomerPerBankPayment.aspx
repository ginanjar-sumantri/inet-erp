<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="GiroCustomerPerBankPayment.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.GiroCustomerPerBankPayment" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                    ...
                                                    <asp:ListItem Value="1">Summary Customer</asp:ListItem>
                                                    <asp:ListItem Value="2">Summary Bank Setor</asp:ListItem>
                                                    <asp:ListItem Value="3">Summary Cair Date</asp:ListItem>
                                                </asp:DropDownList>
