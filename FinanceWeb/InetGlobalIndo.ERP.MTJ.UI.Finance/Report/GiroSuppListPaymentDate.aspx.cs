...
{
    public partial class GiroSuppListPaymentDate : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroOutListPaymentDateSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroOutListPaymentDateSummarySupplier.rdlc";
        private string _reportPath2 = "Report/GiroOutListPaymentDateSummaryBankPayment.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppListPaymentDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Listing Per Payment Date Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var _hasilBankPayment = this._paymentBL.GetListDDLGiroPayment();

            for (var i = 0; i < _hasilBankPayment.Count(); i++)
            {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSuppListPaymentDate(_startDateTime, _endDateTime, _suppCode, _bankPayment, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
