...
{
    public partial class ARAging : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ARAgingByCustomer.rdlc";
        private string _reportPath1 = "Report/ARAgingByCustomerInvoice.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDARAging, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Account Receivable Aging Report";
        ...
        private void ShowCustomer(Int32 _prmCurrentPage)
        {
            ...
            this.CustCodeCheckBoxList.DataSource = this._custBL.GetListDDLCustomer(_tempCustomerGroup, _tempCustomerType, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, _prmCurrentPage, _maxrow);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ARAging(_startDateTime, _currCode, _custCode, Convert.ToInt32(this.Period1TextBox.Text), Convert.ToInt32(this.Period3TextBox.Text), Convert.ToInt32(this.Period5TextBox.Text), Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.BackDropDownList.SelectedValue));
        ...
        private double RowCountCustomer()
        {
            ...
            _result1 = this._custBL.RowsCountCustomerReport(_tempCustGroup, _tempCustType, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
