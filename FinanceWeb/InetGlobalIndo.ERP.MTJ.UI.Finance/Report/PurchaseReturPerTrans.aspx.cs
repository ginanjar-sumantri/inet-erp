...
{
    public partial class PurchaseReturPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseReturPerTransSummary.rdlc";
        private string _reportPath1 = "Report/PurchaseReturPerTransDetail.rdlc";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.PurchaseReturPerTrans(_startDateTime, _endDateTime, _suppCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
