<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SalesInvoicePerCust.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.SalesInvoicePerCust" %>
                                        ...
                                        <%--<tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                    ...
                                                    <asp:ListItem Value="2">Summary Product</asp:ListItem>
                                                    <asp:ListItem Value="3">Detail Transaction</asp:ListItem>
                                                </asp:DropDownList>
