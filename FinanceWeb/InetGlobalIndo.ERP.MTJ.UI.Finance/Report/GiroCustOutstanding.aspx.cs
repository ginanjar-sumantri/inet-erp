...
{
    public partial class GiroCustOutstanding : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInOutSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroInOutSummaryCustomer.rdlc";
        private string _reportPath2 = "Report/GiroInOutSummaryBankGiro.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustOutstanding, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Outstanding Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustOutstanding(_startDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
