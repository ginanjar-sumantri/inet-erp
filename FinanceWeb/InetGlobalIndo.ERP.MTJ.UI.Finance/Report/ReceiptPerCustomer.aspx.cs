...
{
    public partial class ReceiptPerCustomer : ReportBase
    {
        ...
        private string _reportPath0 = "Report/CurrencySummaryCustomer.rdlc";
        private string _reportPath1 = "Report/CurrencyDetailCustomer.rdlc";
        private string _reportPath2 = "Report/CurrencySummaryReceipt.rdlc";
        private string _reportPath3 = "Report/CurrencyDetailReceiptType.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDReceiptPerCustomer, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Receipt Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ReceiptPerCustomer(_startDateTime, _endDateTime, _receiptCode, _custCode, Convert.ToInt32(this.FgTypeDropDownList.SelectedValue), Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
