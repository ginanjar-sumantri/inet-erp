...
{
    public partial class PaymentPerDate : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PaymentPerDateSummarySupplier.rdlc";
        private string _reportPath1 = "Report/PaymentPerDateSummaryPaymentType.rdlc";
        private string _reportPath2 = "Report/PaymentPerDateSummaryTransaction.rdlc";
        private string _reportPath3 = "Report/PaymentPerDateDetailSupplier.rdlc";
        private string _reportPath4 = "Report/PaymentPerDateDetailPaymentType.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPaymentPerDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Payment Per Date";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PaymentPerDate(_startDateTime, _endDateTime, _payType, _suppCode, "", Convert.ToInt32(this.FilterDropDownList.SelectedValue), Convert.ToInt32(this.TypeDropDownList.SelectedValue), Convert.ToInt32(this.CurrencyTypeDropDownList.SelectedValue));
            ...
            else if (this.TypeDropDownList.SelectedValue == "4")
            {
