<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustomerHistory.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.CustomerHistory" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="GroupByDropDownList" runat="server">
                                                    ...
                                                    <asp:ListItem Text="Home Currency" Value="1"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
