...
{
    public partial class GiroSupplierCairPerBankPayment : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SummaryGiroPerBankPayment.rdlc";
        private string _reportPath1 = "Report/SummarySupplierPerBankPayment.rdlc";
        private string _reportPath2 = "Report/SummaryCairDatePerBankPayment.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppCairBankPayment, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Cair Per Bank Payment Report";
        ...
        private void ShowSupplier(Int32 _prmCurrentPage)
        {
            ...
            List<MsSupplier> _listMsSupplier = this._supplierBL.GetListDDLSuppForReport(_tempSuppGroup, _tempSuppType);
        ...
        {
            this.BankGiroCheckBoxList.DataTextField = "BankName";
            this.BankGiroCheckBoxList.DataValueField = "BankCode";
            this.BankGiroCheckBoxList.DataSource = this._bankBL.GetList();
            this.BankGiroCheckBoxList.DataBind();
        }
        ...
        public void ClearData()
        {
            ...
            this.SuppCodeCheckBoxList.ClearSelection();
            this.BankGiroCheckBoxList.ClearSelection();
        }
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var hasilBankGiro = this._bankBL.GetList();
            ...
            for (var i = 0; i < hasilBankGiro.Count(); i++)
            {
                if (this.BankGiroCheckBoxList.Items[i].Selected == true)
                {
                    if (i == 0)
                    {
                        _bankGiro += this.BankGiroCheckBoxList.Items[i].Value;
                    }
                    else
                    {
                        _bankGiro += "," + this.BankGiroCheckBoxList.Items[i].Value;
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroBankPaymentCairDate(_startDateTime, _endDateTime, _suppCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
            ...
            _reportParam[4] = new ReportParameter("Str2", _bankGiro, true);
