...
{
    public partial class CashFlowCashSummary : ReportBase
    {
        ...
        private string _reportPath0 = "Report/CashFlowSummaryReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDCashFlowSummary, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Cash Flow Summary Report";
        ...
        private double RowCount()
        {
            ...
            _result = this._cashFlowFileBL.RowsCountMsAccGroupDt(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        {
            var hasil = this._cashFlowFileBL.GetListMsAccGroupDt(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportFinanceBL.CashFlowCashSummary(_startDateTime, _endDateTime, this.CheckHidden.Value, _from, _to);
            ...
            _reportParam[2] = new ReportParameter("Str1", this.CheckHidden.Value, true);
