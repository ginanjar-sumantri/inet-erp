...
{
    public partial class APListing : ReportBase
    {
        ...
        private string _reportPath0 = "Report/APListingBySupplier.rdlc";
        private string _reportPath1 = "Report/APListingBySupplierInvoice.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDAPListing, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Account Payable Listing Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.APListing(_startDateTime, _endDateTime, _currCode, _suppCode, Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
