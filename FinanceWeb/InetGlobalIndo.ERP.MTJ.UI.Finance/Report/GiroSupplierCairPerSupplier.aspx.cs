...
{
    public partial class GiroSupplierCairPerSupplier : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SummaryGiroPerSupplier.rdlc";
        private string _reportPath1 = "Report/SummaryBankPaymentPerSupplier.rdlc";
        private string _reportPath2 = "Report/SummaryCairDatePerSupplier.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppCairSupp, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Cair Per Supplier Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSupplierPerSupplier(_startDateTime, _endDateTime, _suppCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
