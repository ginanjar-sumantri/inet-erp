...
{
    public partial class SalesInvoicePerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SalesInvoicePerProductSummaryProduct.rdlc";
        private string _reportPath1 = "Report/SalesInvoicePerProductSummaryCust.rdlc";
        private string _reportPath2 = "Report/SalesInvoicePerProductSummaryTrans.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesInvoicePerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Invoice Per Product Report";
        ...
        public void ClearData()
        {
            ...
            this.ProductCheckBoxList.ClearSelection();
            this.HeaderReportList1.ReportGroup = "SalesInvoicePerProduct";
        }
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.SalesInvoicePerProduct(_startDateTime, _endDateTime, _currCode, _productCode, Convert.ToInt32(this.HeaderReportList1.SelectedIndex), Convert.ToInt32(this.GroupByDropDownList.SelectedValue), this.FilterDropDownList.SelectedValue, this.ProductFromTextBox.Text, this.ProductToTextBox.Text);
