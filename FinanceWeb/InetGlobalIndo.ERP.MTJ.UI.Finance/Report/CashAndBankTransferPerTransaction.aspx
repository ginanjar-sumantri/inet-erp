<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CashAndBankTransferPerTransaction.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.CashAndBankTransferPerTransaction" %>
                            ...
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                   ...
                                   <%-- <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="PettyCashReportDropDownList">
                                                <asp:ListItem Value="null" Text="[Choose One]"></asp:ListItem>
                                                <asp:ListItem Value="0">Summary</asp:ListItem>
                                                <asp:ListItem Value="1">Summary Petty</asp:ListItem>
                                                <asp:ListItem Value="2">Detail</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:CustomValidator ID="PettyCashReportCustomValidator" runat="server" ErrorMessage="Type Must Be Choosed"
                                                Text="*" ClientValidationFunction="DropDownValidation" ControlToValidate="PettyCashReportDropDownList"></asp:CustomValidator>
                                        </td>
                                    </tr>
--%>
                                    <tr>
