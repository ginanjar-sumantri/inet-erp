...
{
    public partial class SalesInvoiceTopSalesPerCust : ReportBase
    {
        private ReportFinanceBL _reportBL = new ReportFinanceBL();
        private CustomerBL _custBL = new CustomerBL();
        private PermissionBL _permBL = new PermissionBL();

        private string _reportPath0 = "Report/SalesInvoiceTopSalesPerCust.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesInvoiceTopSalesPerCustomer, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Invoice Top Sales Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.SalesInvoiceTopSalesPerCustomer(_startDateTime, _endDateTime, _custGroupCode, this.RecordTextBox.Text);
