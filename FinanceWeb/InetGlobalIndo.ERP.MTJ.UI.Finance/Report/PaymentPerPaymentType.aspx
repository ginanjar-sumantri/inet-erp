<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PaymentPerPaymentType.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.PaymentPerPaymentType" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="TypeDropDownList">
                                                ...
                                                <asp:ListItem Value="0">Summary Payment Type</asp:ListItem>
                                                <asp:ListItem Value="2">Summary Supplier</asp:ListItem>
                                                <asp:ListItem Value="1">Detail Payment Type</asp:ListItem>
