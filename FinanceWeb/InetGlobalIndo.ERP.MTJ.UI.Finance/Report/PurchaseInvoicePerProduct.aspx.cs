...
{
    public partial class PurchaseInvoicePerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseInvoicePerProductSummaryProduct.rdlc";
        private string _reportPath1 = "Report/PurchaseInvoicePerProductSummarySupp.rdlc";
        private string _reportPath2 = "Report/PurchaseInvoicePerProductSummaryTrans.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseInvoicePerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Invoice Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PurchaseInvoicePerProduct(_startDateTime, _endDateTime, _currCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
            ...
            _reportParam[3] = new ReportParameter("Str1", _productCode, true);
