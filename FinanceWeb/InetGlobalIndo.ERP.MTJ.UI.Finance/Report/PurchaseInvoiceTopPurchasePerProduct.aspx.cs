...
{
    public partial class PurchaseInvoiceTopPurchasePerProduct : ReportBase
    {
        private ReportFinanceBL _reportBL = new ReportFinanceBL();
        private ProductBL _productBL = new ProductBL();
        private PermissionBL _permBL = new PermissionBL();

        private string _reportPath0 = "Report/PurchaseInvoiceTopPurchasePerProduct.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseInvoiceTopPurchasePerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Invoice Top Purchase Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PurchaseInvoiceTopPurchasePerProduct(_startDateTime, _endDateTime, _productSubGroupCode, this.RecordTextBox.Text, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
