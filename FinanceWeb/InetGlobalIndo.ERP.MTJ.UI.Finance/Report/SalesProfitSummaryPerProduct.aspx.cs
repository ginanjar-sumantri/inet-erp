...
{
    public partial class SalesProfitSummaryPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SalesProfitSummaryPerProduct.rdlc";
        private string _reportPath1 = "Report/SalesProfitSummaryPerProductGroup.rdlc";
        private string _reportPath2 = "Report/SalesProfitSummaryPerProductSubGroup.rdlc";
        private string _reportPath3 = "Report/SalesProfitSummaryPerProductType.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesProfitSummaryPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Profit Summary Per Product";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.SalesProfitSummaryPerProduct(_startDateTime, _endDateTime, _productSubGroupCode, _productCode, "", Convert.ToInt32(this.TypeDropDownList.SelectedValue));
            ...
            _reportParam[2] = new ReportParameter("Str1", _productSubGroupCode, true);
            _reportParam[3] = new ReportParameter("Str2", _productCode, true);
            _reportParam[4] = new ReportParameter("Str3", "", false);
            _reportParam[5] = new ReportParameter("FgReport", this.TypeDropDownList.SelectedValue, true);
