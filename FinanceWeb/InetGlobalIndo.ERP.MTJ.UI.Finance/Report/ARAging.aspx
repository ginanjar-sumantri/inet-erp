<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ARAging.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.ARAging" %>
                                                ...
                                                <asp:Panel ID="Panel2" DefaultButton="GoImageButton" runat="server">
                                                    <table cellpadding="0" cellspacing="2" border="0">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:ImageButton ID="GoImageButton" runat="server" CausesValidation="false" 
                                                                    onclick="GoImageButton_Click" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </asp:Panel>
