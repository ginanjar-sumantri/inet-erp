...
{
    public partial class PaymentSummaryPerPaymentType : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PaymentSummaryPerPaymentTypeSummaryPaymentType.rdlc";
        private string _reportPath1 = "Report/PaymentSummaryPerPaymentTypeSummarySupplier.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPaymentSummaryPerPaymentType, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Payment Summary Per Payment Type";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._reportBL.PaymentSummaryPerPaymentType(_start, _end, _payType, _suppCode, this.DivideByDropDownList.SelectedValue, Convert.ToInt32(this.FilterDropDownList.SelectedValue), Convert.ToInt32(this.TypeDropDownList.SelectedValue), Convert.ToInt32(this.CurrencyTypeDropDownList.SelectedValue));
