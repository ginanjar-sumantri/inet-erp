...
{
    public partial class PaymentInvoice : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PaymentInvoice.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPaymentInvoice, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Payment Invoice";
        ...
        public void ClearData()
        {
            ...
            this.SuppCodeCheckBoxList.ClearSelection();
            this.SuppTypeDropDownList.SelectedValue = "0";
        }
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PaymentInvoice(_startDateTime, _endDateTime, _suppCode, "", "", Convert.ToInt32(this.SummaryTypeDropDownList.SelectedValue));
            ...
            _reportParam[5] = new ReportParameter("FgDetail", this.SummaryTypeDropDownList.SelectedValue, true);
