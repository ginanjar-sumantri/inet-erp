<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PurchaseReturPerProduct.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.PurchaseReturPerProduct" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                ...
                                                <asp:ListItem Value="2">Summary Retur No.</asp:ListItem>
                                            </asp:DropDownList>
