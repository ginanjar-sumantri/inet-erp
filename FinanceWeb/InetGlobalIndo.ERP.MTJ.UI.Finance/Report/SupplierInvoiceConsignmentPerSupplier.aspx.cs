...
{
    public partial class SupplierInvoiceConsignmentPerSupplier : ReportBase
    {
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSupplierInvoiceConsignmentPerSupplier, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Supplier Invoice Per Transaction Report";
        ...
        public void ClearData()
        {
            ...
            this.SuppCodeCheckBoxList.ClearSelection();
            this.HeaderReportList1.ReportGroup = "SupplierInvoiceConsignmentPerSupplier";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            String _fgCurr = this.GroupByDropDownList.SelectedValue;
            ReportDataSource _reportDataSource1 = this._reportBL.SupplierInvoiceConsignmentPerSupplier(_startDateTime, _endDateTime, _suppCode, _currCode, _fgCurr, this.SuppFromTextBox.Text.Trim(), this.SuppToTextBox.Text.Trim(), _fgReport);
            ...
            _reportParam[5] = new ReportParameter("Str3", _fgCurr, true);
            _reportParam[6] = new ReportParameter("From", this.SuppFromTextBox.Text.Trim(), true);
            _reportParam[7] = new ReportParameter("To", this.SuppToTextBox.Text.Trim(), true);
            _reportParam[8] = new ReportParameter("FgReport", _fgReport.ToString(), true);
