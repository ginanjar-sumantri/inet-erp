...
{
    public partial class SalesReturPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SalesReturPerProductSummaryProduct.rdlc";
        private string _reportPath1 = "Report/SalesReturPerProductSummaryCust.rdlc";
        private string _reportPath2 = "Report/SalesReturPerProductSummaryTrans.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesReturPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Retur Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.SalesReturPerProduct(_startDateTime, _endDateTime, _custCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
