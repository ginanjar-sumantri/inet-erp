...
{
    public partial class GiroCustTolakDate : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInTolakDateSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroInTolakDateSummaryCustomer.rdlc";
        private string _reportPath2 = "Report/GiroInTolakDateSummaryBankGiro.rdlc";
        private string _reportPath3 = "Report/GiroInTolakDateSummaryBankSetor.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustTolakDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Tolak Per Date Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustTolakDate(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
