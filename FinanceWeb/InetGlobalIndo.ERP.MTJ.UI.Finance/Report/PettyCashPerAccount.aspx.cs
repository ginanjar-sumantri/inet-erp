...
{
    public partial class PettyCashPerAccount : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PettyCashPerAccountSummary.rdlc";
        private string _reportPath1 = "Report/PettyCashPerAccountSummaryTransation.rdlc";
        private string _reportPath2 = "Report/PettyCashPerAccountSummaryDetail.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPettyCashPerAccount, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Petty Cash Per Account Report";
        ...
        {
            var hasil = this._pettyBL.GetListForReport(_prmCurrentPage, this._maxrow);

            this.PettyTypeCheckBoxList.DataSource = hasil;
            this.PettyTypeCheckBoxList.DataValueField = "PettyCode";
            this.PettyTypeCheckBoxList.DataTextField = "PettyName";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.PettyCashPerAccount(_startDateTime, _endDateTime, _pettyCode, _currCode, this.GroupByDropDownList.SelectedValue, Convert.ToInt32(this.PettyCashReportDropDownList.SelectedValue));
            ...
            _reportParam[5] = new ReportParameter("FgReport", this.PettyCashReportDropDownList.SelectedValue, true);
