...
{
    public partial class GiroCustomerPerBankPayment : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SummaryGiroInPerBankGiro.rdlc";
        private string _reportPath1 = "Report/SummaryGiroInCustomerPerBankGiro.rdlc";
        private string _reportPath2 = "Report/SummaryGiroInBankSetorPerBankGiro.rdlc";
        private string _reportPath3 = "Report/SummaryGiroInCairDatePerBankGiro.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustCairBankGiro, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Cair Per Bank Giro Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustomerPerBankGiro(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
