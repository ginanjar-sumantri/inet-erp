<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PaymentSummaryPerSupplier.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.PaymentSummaryPerSupplier" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="TypeDropDownList">
                                                ...
                                                <asp:ListItem Value="1">Sumary Payment Type</asp:ListItem>
                                            </asp:DropDownList>
