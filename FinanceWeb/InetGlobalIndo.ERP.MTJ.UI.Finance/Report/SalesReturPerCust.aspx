<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SalesReturPerCust.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.SalesReturPerCust" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                ...
                                                <asp:ListItem Value="1">Summary Retur No.</asp:ListItem>
                                                <asp:ListItem Value="2">Detail Retur No.</asp:ListItem>
                                                <asp:ListItem Value="3">Summary Product</asp:ListItem>
                                            </asp:DropDownList>
