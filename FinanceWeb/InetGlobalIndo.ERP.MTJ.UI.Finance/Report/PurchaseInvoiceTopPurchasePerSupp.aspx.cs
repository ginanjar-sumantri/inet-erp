...
{
    public partial class PurchaseInvoiceTopPurchasePerSupp : ReportBase
    {
        private ReportFinanceBL _reportBL = new ReportFinanceBL();
        private SupplierBL _suppBL = new SupplierBL();
        private PermissionBL _permBL = new PermissionBL();

        private string _reportPath0 = "Report/PurchaseInvoiceTopPurchasePerSupplier.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseInvoiceTopPurchasePerSupplier, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Invoice Top Purchase Per Supplier Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PurchaseInvoiceTopPurchasePerSupplier(_startDateTime, _endDateTime, _suppGroupCode, this.RecordTextBox.Text);
