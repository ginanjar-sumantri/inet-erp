...
{
    public partial class GiroCustODCustomer : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInODCustSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroInODCustSummaryBankGiro.rdlc";
        private string _reportPath2 = "Report/GiroInODCustSummaryDueDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustODCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Over Due Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustODCustomer(_startDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
