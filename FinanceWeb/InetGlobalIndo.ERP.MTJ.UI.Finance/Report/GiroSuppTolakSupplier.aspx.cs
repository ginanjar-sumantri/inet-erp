...
{
    public partial class GiroSuppTolakSupplier : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroOutTolakSupplierSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroOutTolakSupplierSummaryBankPayment.rdlc";
        private string _reportPath2 = "Report/GiroOutTolakSupplierSummaryTolakDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppTolakSupp, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Tolak Per Supplier Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSuppTolakSupp(_startDateTime, _endDateTime, _suppCode, _bankPayment, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
