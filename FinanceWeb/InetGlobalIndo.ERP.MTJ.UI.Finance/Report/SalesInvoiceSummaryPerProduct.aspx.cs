...
{
    public partial class SalesInvoiceSummaryPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SalesInvoiceSummaryPerProductProdQty.rdlc";
        private string _reportPath1 = "Report/SalesInvoiceSummaryPerProductProdGroupQty.rdlc";
        private string _reportPath2 = "Report/SalesInvoiceSummaryPerProductProdSubGroupQty.rdlc";
        private string _reportPath3 = "Report/SalesInvoiceSummaryPerProductProdTypeQty.rdlc";

        private string _reportPath4 = "Report/SalesInvoiceSummaryPerProductProdAmount.rdlc";
        private string _reportPath5 = "Report/SalesInvoiceSummaryPerProductProdGroupAmount.rdlc";
        private string _reportPath6 = "Report/SalesInvoiceSummaryPerProductProdSubGroupAmount.rdlc";
        private string _reportPath7 = "Report/SalesInvoiceSummaryPerProductProdTypeAmount.rdlc";

        private string _reportPath8 = "Report/SalesInvoiceSummaryPerProductProdAmountQty.rdlc";
        private string _reportPath9 = "Report/SalesInvoiceSummaryPerProductProdGroupAmountQty.rdlc";
        private string _reportPath10 = "Report/SalesInvoiceSummaryPerProductProdSubGroupAmountQty.rdlc";
        private string _reportPath11 = "Report/SalesInvoiceSummaryPerProductProdTypeAmountQty.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesInvoiceSummaryPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Invoice Summary Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.SalesInvoiceSummaryPerProduct(_start, _end, _productSubGrpCode, _custCode, this.DivideByDropDownList.SelectedValue, Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
                ...
                _reportParam[3] = new ReportParameter("Str2", _custCode, false);
