...
{
    public partial class GiroSuppListDueDate : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroOutListDueDateSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroOutListDueDateSummarySupplier.rdlc";
        private string _reportPath2 = "Report/GiroOutListDueDateSummaryBankPayment.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppListDueDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Listing Per Due Date";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSuppListDueDate(_startDateTime, _endDateTime, _suppCode, _bankPayment, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
