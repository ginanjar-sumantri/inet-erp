...
{
    public partial class PurchaseInvoicePerSupp : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseInvoicePerSuppSummarySupp.rdlc";
        private string _reportPath1 = "Report/PurchaseInvoicePerSuppSummaryTrans.rdlc";
        private string _reportPath2 = "Report/PurchaseInvoicePerSuppSummaryProduct.rdlc";
        private string _reportPath3 = "Report/PurchaseInvoicePerSuppDetailTrans.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseInvoicePerSupplier, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Invoice Per Supplier Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PurchaseInvoicePerSupp(_startDateTime, _endDateTime, _currCode, _suppCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), this.GroupByDropDownList.SelectedValue);
            ...
            _reportParam[5] = new ReportParameter("Str3", this.GroupByDropDownList.SelectedValue, false);
