...
{
    public partial class GiroCustTolakCustomer : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroInTolakCustomerSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroInTolakCustomerSummaryBankGiro.rdlc";
        private string _reportPath2 = "Report/GiroInTolakCustomerSummaryBankSetor.rdlc";
        private string _reportPath3 = "Report/GiroInTolakCustomerSummaryTolakDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroCustTolakCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Customer Tolak Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroCustTolakCust(_startDateTime, _endDateTime, _custCode, _bankGiro, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
