...
{
    public partial class PurchaseInvoicePerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseInvoicePerTransSummary.rdlc";
        private string _reportPath1 = "Report/PurchaseInvoicePerTransDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseInvoicePerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Invoice Per Transaction Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.FgReportDropDownList.SelectedValue == "0" && this.GroupByDropDownList.SelectedValue == "0")
            {
                _fgReport = 0;
            }
            else if (this.FgReportDropDownList.SelectedValue == "0" && this.GroupByDropDownList.SelectedValue == "1")
            {
                _fgReport = 1;
            }
            else if (this.FgReportDropDownList.SelectedValue == "1" && this.GroupByDropDownList.SelectedValue == "0")
            {
                _fgReport = 2;
            }
            else if (this.FgReportDropDownList.SelectedValue == "1" && this.GroupByDropDownList.SelectedValue == "1")
            {
                _fgReport = 3;
            }

            ReportDataSource _reportDataSource1 = this._reportBL.PurchaseInvoicePerTrans(_startDateTime, _endDateTime, _currCode, _suppCode, _fgReport);
