<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PaymentSummaryPerPaymentType.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.PaymentSummaryPerPaymentType" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="TypeDropDownList">
                                                ...
                                                <asp:ListItem Value="0">Sumary Payment Type</asp:ListItem>
