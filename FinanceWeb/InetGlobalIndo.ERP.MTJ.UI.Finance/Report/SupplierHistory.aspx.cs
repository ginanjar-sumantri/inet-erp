...
{
    public partial class SupplierHistory : ReportBase
    {
        ...
        private string _reportPath0 = "Report/SupplierHistory.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Supplier History Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.SupplierHistory(_startDateTime, _endDateTime, _suppCode, this.GroupByDropDownList.SelectedValue);
