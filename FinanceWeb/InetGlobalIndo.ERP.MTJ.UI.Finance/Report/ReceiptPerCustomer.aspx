<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReceiptPerCustomer.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.ReceiptPerCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="DefaultBodyContentPlaceHolder" runat="Server">
    <asp:Panel ID="Panel1" DefaultButton="ViewButton" runat="server">
        <table cellpadding="3" cellspacing="0" width="100%" border="0">
                                ...
                                <td>
                                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgTypeDropDownList">
                                                    <asp:ListItem Value="null" Text="[Choose One]"></asp:ListItem>
                                                    <asp:ListItem Value="0">Summary By Customer</asp:ListItem>
                                                    <asp:ListItem Value="1">Detail Customer - Invoice</asp:ListItem>
                                                    <asp:ListItem Value="2">Summary By Receipt Type</asp:ListItem>
                                                    <asp:ListItem Value="3">Detail Receipt Type</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:CustomValidator ID="FgTypeCustomValidator" runat="server" ErrorMessage="Type Must Be Choosed"
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5">
                                                <asp:CheckBoxList runat="server" ID="ReceiptTypeCheckBoxList" RepeatColumns="3">
                                                </asp:CheckBoxList>
                                            </td>
                                        </tr>
                                        <tr>
            ...
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer" Width="100%" ShowPrintButton="true" ShowZoomControl="true"
