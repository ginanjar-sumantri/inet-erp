...
{
    public partial class PPNListingPurchase : ReportBase
    {
        private ReportFinanceBL _reportBL = new ReportFinanceBL();
        private PermissionBL _permBL = new PermissionBL();

        private string _reportPath0 = "Report/PPNListingPurchaseSupp.rdlc";
        private string _reportPath1 = "Report/PPNListingPurchasePPNNo.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPPNListingPurchase, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "PPN Listing Purchase Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PPNListingPurchase(_startDateTime, _endDateTime, Convert.ToInt32(this.FgTypeDropDownList.SelectedValue));
