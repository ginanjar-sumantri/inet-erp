...
{
    public partial class PaymentAndReceiptAnalysisDetail : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PaymentAndReceiptAnalysisDetail.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Payment And Receipt Analysis Detail Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PaymentAndReceiptAnalysisDetail(_startDateTime, _endDateTime, _payType, "", "", Convert.ToInt32(0));
