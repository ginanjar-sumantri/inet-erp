...
{
    public partial class GiroSuppOutstanding : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroOutOutSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroOutOutSummarySupplier.rdlc";
        private string _reportPath2 = "Report/GiroOutOutSummaryBankPayment.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppOutstanding, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Outstanding Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSuppOutstanding(_startDateTime, _suppCode, _bankPayment, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
