...
{
    public partial class PaymentPerTransaction : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PaymentPerTransaction.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPaymentPerTransaction, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Payment Per Transaction";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PaymentPerTransaction(_startDateTime, _endDateTime, _payType, _suppCode, "", Convert.ToInt32(this.FilterDropDownList.SelectedValue), Convert.ToInt32(this.CurrencyTypeDropDownList.SelectedValue));
            ...
            _reportParam[6] = new ReportParameter("CurrType", this.CurrencyTypeDropDownList.SelectedValue, true);
