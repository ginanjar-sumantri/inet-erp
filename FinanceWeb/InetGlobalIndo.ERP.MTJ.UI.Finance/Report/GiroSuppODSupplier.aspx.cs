...
{
    public partial class GiroSuppODSupplier : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GiroOutODSuppSummaryGiro.rdlc";
        private string _reportPath1 = "Report/GiroOutODSuppSummaryBankGiro.rdlc";
        private string _reportPath2 = "Report/GiroOutODSuppSummaryDueDate.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGiroSuppODSupp, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Giro Supplier Over Due Per Supplier Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var hasilBankGiro = this._paymentBL.GetListDDLGiroPayment();
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.GiroSuppODSupplier(_startDateTime, _suppCode, _bankPayment, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
