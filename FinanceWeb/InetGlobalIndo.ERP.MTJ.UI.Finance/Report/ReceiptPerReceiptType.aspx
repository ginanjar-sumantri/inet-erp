<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReceiptPerReceiptType.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.Report.ReceiptPerReceiptType" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgTypeDropDownList">
                                                    ...
                                                    <asp:ListItem Value="0">Summary By Receipt</asp:ListItem>
                                                    <asp:ListItem Value="1">Detail Receipt - Invoice</asp:ListItem>
                                                    <asp:ListItem Value="2">Summary By Customer Type</asp:ListItem>
                                                    <asp:ListItem Value="3">Detail Customer</asp:ListItem>
                                                </asp:DropDownList>
