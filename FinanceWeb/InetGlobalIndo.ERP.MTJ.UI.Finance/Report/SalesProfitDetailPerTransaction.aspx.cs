...
{
    public partial class SalesProfitDetailPerTransaction : ReportBase
    {
        private ReportFinanceBL _report = new ReportFinanceBL();
        private CustomerBL _custBL = new CustomerBL();
        private PermissionBL _permBL = new PermissionBL();

        private string _reportPath0 = "Report/SalesProfitDetailPerTransaction.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDSalesProfitDetailPerTransaction, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Sales Profit Detail Per Transaction";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.SalesProfitDetailPerTransaction(_startDateTime, _endDateTime, _custCode, "", "", _fgReport);
