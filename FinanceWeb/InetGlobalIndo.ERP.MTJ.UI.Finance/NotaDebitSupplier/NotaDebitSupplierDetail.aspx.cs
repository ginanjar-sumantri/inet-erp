...
{
    public partial class NotaDebitSupplierDetail : NotaDebitSupplierBase
    {
        ...
        private string _reportPath1 = "NotaDebitSupplier/DebitNoteSupplier.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._notaDebitSupplierBL.RowsCountFINDNSuppDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitSuppDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitSuppDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitSuppDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitSuppDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        {
            _notaDebitSupplierBL = new NotaDebitSupplierBL();
            ...
            _decimalPlace = _currencyBL.GetDecimalPlace(_finDNSuppHd.CurrCode);
            ...
            this.StatusLabel.Text = NotaDebitSuppDataMapper.GetStatusText(_finDNSuppHd.Status);
            this.SuppTextBox.Text = _suppBL.GetSuppNameByCode(_finDNSuppHd.SuppCode);
            this.CurrCodeTextBox.Text = _finDNSuppHd.CurrCode;
            this.CurrRateTextBox.Text = (_finDNSuppHd.ForexRate == 0) ? "0" : HttpUtility.HtmlEncode(_finDNSuppHd.ForexRate.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace)));
            this.RemarkTextBox.Text = _finDNSuppHd.Remark;
            this.AttnTextBox.Text = _finDNSuppHd.Attn;
            this.TotalForexTextBox.Text = (_finDNSuppHd.TotalForex == 0) ? "0" : HttpUtility.HtmlEncode(_finDNSuppHd.TotalForex.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace)));
            this.TermTextBox.Text = _termBL.GetTermNameByCode(_finDNSuppHd.Term);
            this.CurrTextBox.Text = _finDNSuppHd.CurrCode;
            this.StatusHiddenField.Value = _finDNSuppHd.Status.ToString();

            if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitSuppDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        public void ShowDataDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._notaDebitSupplierBL.GetListFINDNSuppDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitSuppDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._notaDebitSupplierBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitSuppDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._notaDebitSupplierBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitSuppDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._notaDebitSupplierBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaDebitSuppDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._notaDebitSupplierBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._notaDebitSupplierBL.DeleteMultiFINDNSuppDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINDNSuppDt _temp = (FINDNSuppDt)e.Item.DataItem;
                ...
                _viewButton.PostBackUrl = this._viewDetailPage + "?" + this._codeItemKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(this.TransNoTextBox.Text, ApplicationConfig.EncryptionKey));
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportFinanceBL.DebitNoteSupplierPrintPreview(this.TransNoTextBox.Text);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.NotaDebitSupplier), this.TransNoTextBox.Text, this.FileNmbrTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.Label.Text = _result;
