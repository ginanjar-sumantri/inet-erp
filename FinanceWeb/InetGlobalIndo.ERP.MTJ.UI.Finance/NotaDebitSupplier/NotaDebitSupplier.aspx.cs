...
{
    public partial class NotaDebitSupplier : NotaDebitSupplierBase
    {
        private NotaDebitSupplierBL _notaDebitSupplier = new NotaDebitSupplierBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._notaDebitSupplier.RowsCountFINDNSuppHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._notaDebitSupplier.GetListFINDNSuppHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._notaDebitSupplier.GetSingleFINDNSuppHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._notaDebitSupplier.DeleteMultiFINDNSuppHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINDNSuppHd _temp = (FINDNSuppHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != NotaDebitSuppDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _status.Text = HttpUtility.HtmlEncode(NotaDebitSuppDataMapper.GetStatusText(_temp.Status));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._notaDebitSupplier.DeleteMultiApproveFINDNSuppHd(_tempSplit, AppModule.GetValue(TransactionType.NotaDebitSupplier), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
