...
namespace InetGlobalIndo.ERP.MTJ.UI.Finance.CashFlowGroup
{
    public partial class CashFlowGroup : CashFlowGroupBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._cashFlowBL.RowsCountCashFlowGroup(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            else
            {
                ...
                this.ListRepeater.DataSource = _cashFlowBL.GetListFINMsCashFlowGroup(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                Literal _cashFlowGroupCode = (Literal)e.Item.FindControl("CashFlowGroupCodeLiteral");
                _cashFlowGroupCode.Text = HttpUtility.HtmlEncode(_temp.CashFlowGroupCode);

                Literal _cashFlowGroupName = (Literal)e.Item.FindControl("CashFlowGroupNameLiteral");
                _cashFlowGroupName.Text = HttpUtility.HtmlEncode(_temp.CashFlowGroupName);
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._cashFlowBL.DeleteMultiFINMsCashFlowGroup(_tempsplit);
