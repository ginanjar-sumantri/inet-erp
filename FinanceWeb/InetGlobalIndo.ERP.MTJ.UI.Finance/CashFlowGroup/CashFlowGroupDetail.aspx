<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CashFlowGroupDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.CashFlowGroup.CashFlowGroupDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="CashFlowGroupNameTextBox" Width="500" MaxLength="100"
                                        BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
