<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SuppBeginningEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.SupplierBeginning.SuppBeginningEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="InvoiceNoTextBox" runat="server" Width="150" MaxLength="20" BackColor="#CCCCCC"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="SuppPONoTextBox" runat="server" Width="210" MaxLength="30"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <%--<input id="due_date" type="button" onclick="displayCalendar(ctl00_DefaultBodyContentPlaceHolder_DueDateTextBox,'yyyy-mm-dd',this)"
                                    value="..." />--%>
