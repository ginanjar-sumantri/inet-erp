...
{
    public partial class SuppBeginning : SupplierBeginningBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finBeginSIBL.RowsCountFINBeginSI(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finBeginSIBL.GetListFINBeginSI(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINBeginSI _temp = (FINBeginSI)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != SuppBeginningDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _status.Text = HttpUtility.HtmlEncode(SuppBeginningDataMapper.GetStatusText(_temp.Status));
                ...
                _term.Text = HttpUtility.HtmlEncode(_temp.Term.ToString());
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._finBeginSIBL.DeleteMultiFINBeginSI(_tempSplit);
