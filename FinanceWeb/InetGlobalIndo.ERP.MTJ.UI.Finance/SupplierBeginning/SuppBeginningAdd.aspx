<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SuppBeginningAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.SupplierBeginning.SuppBeginningAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="InvoiceNoTextBox" runat="server" Width="150" MaxLength="20"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="SuppPONoTextBox" runat="server" MaxLength="30" Width="210"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="SuppCustomValidator" runat="server" ClientValidationFunction="DropDownValidation"
                                    ErrorMessage="Supplier Must Be Filled" Text="*" ControlToValidate="SuppDropDownList"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <%--<input id="button2" type="button" onclick="displayCalendar(ctl00_DefaultBodyContentPlaceHolder_DueDateTextBox,'yyyy-mm-dd',this)"
                                    value="..." />--%>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td style="width: 110px" class="tahoma_11_white" align="center">
                                                    ...
                                                    <%--<input id="PPNDateButton" style="visibility: hidden; width: 20px;" type="button"
                                                        runat="server" onclick="displayCalendar(ctl00_DefaultBodyContentPlaceHolder_PPNDateTextBox,'yyyy-mm-dd',this)"
                                                        value="..." />--%>
