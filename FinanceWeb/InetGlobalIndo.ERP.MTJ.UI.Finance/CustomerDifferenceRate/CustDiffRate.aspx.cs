...
{
    public partial class CustDiffRate : CustomerDifferenceRateBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finARRateBL.RowsCountFINARRateHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finARRateBL.GetListFINARRateHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINARRateHd _temp = (FINARRateHd)e.Item.DataItem;
                ...
                if (_temp.Status != ARRateDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(ARRateDataMapper.GetStatusText(_temp.Status));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._finARRateBL.GetSingleFINARRateHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._finARRateBL.DeleteMultiFINARRateHd(_tempSplit);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._finARRateBL.DeleteMultiApproveFINARRateHd(_tempSplit, AppModule.GetValue(TransactionType.ARRate), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
