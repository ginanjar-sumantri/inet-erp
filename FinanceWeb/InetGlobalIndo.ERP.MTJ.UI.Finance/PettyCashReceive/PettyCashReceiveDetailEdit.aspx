<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PettyCashReceiveDetailEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.PettyCashReceive.PettyCashReceiveDetailEdit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="DefaultHeadContentPlaceHolder" runat="Server">

    <script type="text/javascript" language="javascript">
        function AmountForex_OnBlur (_prmAmountForex, _prmDecimalPlace)
        {
             _prmAmountForex.value = FormatCurrency2(_prmAmountForex.value, _prmDecimalPlace.value);
        }
    </script>
    ...
    <asp:Panel runat="server" ID="Panel1" DefaultButton="SaveButton">
        <table cellpadding="3" cellspacing="0" width="0" border="0">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="AmountTextbox" MaxLength="23"></asp:TextBox>
