...
{
    public partial class PettyCashReceive : PettyCashReceiveBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PrintPreviewButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/printpreview.jpg";
                this.PrintPreviewButton2.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/printpreview.jpg";
        ...
        private void SetButtonPermission()
        {
            ...
            if (this._permPrintPreview == PermissionLevel.NoAccess)
            {
                ...
                this.PrintPreviewButton2.Visible = false;
            }
        }
        ...
        private double RowCount()
        {
            ...
            _result = this._pettyBL.RowsCountFINPettyReceiveHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._pettyBL.GetListFINPettyReceiveHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                _status.Text = HttpUtility.HtmlEncode(PettyCashDataMapper.GetStatusText(_temp.Status).ToString());

                Literal _currency = (Literal)e.Item.FindControl("CurrencyLiteral");
                _currency.Text = HttpUtility.HtmlEncode(_temp.CurrencyName);

                byte _decimalPlace = this._currencyBL.GetDecimalPlace(_temp.CurrencyName);
                Literal _forex = (Literal)e.Item.FindControl("ForexRateLiteral");
                _forex.Text = HttpUtility.HtmlEncode((_temp.ForexRate).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace)));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._pettyBL.GetSingleFINPettyReceiveHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._pettyBL.DeleteMultiFINPettyReceiveHd(_tempSplit);
        ...
        protected void PrintPreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect(this._printPreviewPage);
        }
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._pettyBL.DeleteMultiApproveFINPettyReceiveHd(_tempSplit, AppModule.GetValue(TransactionType.PettyCashReceive), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
