<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PettyCashReceiveDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.PettyCashReceive.PettyCashReceiveDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="TransactionNoTextBox" Width="150" MaxLength="20"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="TypeTextBox" Width="200" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            ...
                            <tr runat="server" id="payment_tr">
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="PaymentTextBox" Width="200" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox runat="server" ID="RateTextBox" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
