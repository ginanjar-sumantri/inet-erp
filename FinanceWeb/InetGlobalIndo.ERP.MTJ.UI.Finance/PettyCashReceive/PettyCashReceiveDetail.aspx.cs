...
{
    public partial class PettyCashReceiveDetail : PettyCashReceiveBase
    {
        ...
        public void ShowData()
        {
            ...
            _codeTransaction = this.TransactionNoTextBox.Text = _finPettyReceiveHd.TransNmbr;
            ...
            if (_finPettyReceiveHd.FgType == PettyCashDataMapper.GetType(PettyCashReceiveType.Petty))
            {
                ...
                this.PettyTextBox.Text = this._pettyBL.GetPettyNameByCode(this._pettyBL.GetPettyCodeFINPettyReceive(_codeTransaction));
            }
            else if (_finPettyReceiveHd.FgType == PettyCashDataMapper.GetType(PettyCashReceiveType.Payment))
            {
                ...
                this.PaymentTextBox.Text = this._paymentBL.GetPaymentName(this._pettyBL.GetPayCodeFINPettyReceive(_codeTransaction));
            }
            ...
            byte _decimalPlace = this._currencyBL.GetDecimalPlace(this.CurrencyTextBox.Text);
        ...
        private double RowCount()
        {
            ...
            _result = this._pettyBL.RowsCountFINPettyReceiveDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        public void ShowDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._pettyBL.GetListFINPettyReceiveDt(this.TransactionNoTextBox.Text, _prmCurrentPage, _maxrow);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                _viewButton.PostBackUrl = this._viewDetailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)) + "&" + this._number + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_itemNo, ApplicationConfig.EncryptionKey));
                ...
                else
                {
                    ...
                    {
                        _editButton.PostBackUrl = this._editDetailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)) + "&" + this._number + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_itemNo, ApplicationConfig.EncryptionKey));
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._pettyBL.GetApprovalReceipt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._pettyBL.ApproveReceipt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._pettyBL.PostingReceipt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._pettyBL.UnPostingReceipt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (_result == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._reportFinanceBL.PettyCashReceivePrintPreview(_temp, this.DescriptionHiddenField.Value, HttpContext.Current.User.Identity.Name);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._pettyBL.DeleteMultiFINPettyReceiveDt(_tempSplit, this.TransactionNoTextBox.Text);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.PettyCashReceive), this.TransactionNoTextBox.Text, this.FileNmbrTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.Label.Text = _result;
