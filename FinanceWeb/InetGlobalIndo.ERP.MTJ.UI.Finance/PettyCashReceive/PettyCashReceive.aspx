<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PettyCashReceive.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.PettyCashReceive.PettyCashReceive" %>
                                ...
                                <table cellpadding="3" cellspacing="0" width="100%" border="0">
                                    <tr>
                                        <td>
                                            ...
                                            &nbsp;
                                            <asp:ImageButton ID="PrintPreviewButton" runat="server" OnClick="PrintPreviewButton_Click" />
                                        </td>
                                        <td align="right">
                            ...
                            <td>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 50px" style="width: 100px" class="tahoma_11_white" align="center">
                                            <b>Currency</b>
                                        </td>
                                        <td style="width: 100px" class="tahoma_11_white" align="center">
                                            <b>Forex Rate</b>
                                ...
                                <table cellpadding="3" cellspacing="0" width="100%" border="0">
                                    <tr>
                                        <td>
                                            ...
                                            &nbsp;
                                            <asp:ImageButton ID="PrintPreviewButton2" runat="server" OnClick="PrintPreviewButton_Click" />
                                        </td>
                                        <td align="right">
