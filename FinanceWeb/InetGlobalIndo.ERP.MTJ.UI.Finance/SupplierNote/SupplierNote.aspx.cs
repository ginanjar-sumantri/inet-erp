...
{
    public partial class SupplierNote : SupplierNoteBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._supplierNoteBL.RowsCountFINSuppInvHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._supplierNoteBL.GetListFINSuppInvHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._supplierNoteBL.GetSingleFINSuppInvHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._supplierNoteBL.DeleteMultiFINSuppInvHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINSuppInvHd _temp = (FINSuppInvHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != SupplierNoteDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _status.Text = HttpUtility.HtmlEncode(SupplierNoteDataMapper.GetStatusText(_temp.Status));

                Literal _suppName = (Literal)e.Item.FindControl("SuppLiteral");
                _suppName.Text = HttpUtility.HtmlEncode(_temp.SuppName);

                Literal _suppInv = (Literal)e.Item.FindControl("SuppInvoiceLiteral");
                _suppInv.Text = HttpUtility.HtmlEncode(_temp.SuppInvoice);

                //Literal _term = (Literal)e.Item.FindControl("TermLiteral");
                //_term.Text = HttpUtility.HtmlEncode(_temp.TermName);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._supplierNoteBL.DeleteMultiApproveFINSuppInvHd(_tempSplit, AppModule.GetValue(TransactionType.SupplierNote), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
