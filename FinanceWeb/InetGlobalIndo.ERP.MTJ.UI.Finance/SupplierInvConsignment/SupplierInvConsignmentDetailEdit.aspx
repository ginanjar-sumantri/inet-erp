<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SupplierInvConsignmentDetailEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.SupplierInvConsignment.SupplierInvConsignmentDetailEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="SJTypeTextBox" runat="server" BackColor="#CCCCCC" ReadOnly="true" Width ="100" ></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="SJNoTextBox" runat="server" Width="200" BackColor="#CCCCCC" ReadOnly="true">
                                </asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="ProductCodeTextBox" runat="server" BackColor="#CCCCCC" ReadOnly="true" Width="100"></asp:TextBox>
                                <asp:TextBox ID="ProductNameTextBox" runat="server" BackColor="#CCCCCC" ReadOnly="true" Width="250"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <ContentTemplate>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:CustomValidator ID="SubledCustomValidator" runat="server" ClientValidationFunction="DropDownValidation"
                                            ErrorMessage="Subled Must Be Filled" Text="*" ControlToValidate="SubledDropDownList">
                                        </asp:CustomValidator>
                                    </td>
                                </tr>
                            </ContentTemplate>
