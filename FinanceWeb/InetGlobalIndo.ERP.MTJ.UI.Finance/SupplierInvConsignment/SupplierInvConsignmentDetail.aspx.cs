...
{
    public partial class SupplierInvConsignmentDetail : SupplierInvConsignmentBase
    {
        private CurrencyRateBL _currencyRateBL = new CurrencyRateBL();
        //private NotaCreditSupplierBL _notaCreditSupplierBL = new NotaCreditSupplierBL();
        private SupplierInvConsignmentBL _finSuppInvConsignBL = new SupplierInvConsignmentBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._finSuppInvConsignBL.RowsCountSuppInvConsignDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            _finSuppInvConsignBL = new SupplierInvConsignmentBL();
            FINSuppInvConsignmentHd _finSuppInvConsignHd = this._finSuppInvConsignBL.GetSingleSuppInvConsignHdView(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));

            this._decimalPlace = _currencyBL.GetDecimalPlace(_finSuppInvConsignHd.CurrCode);
            this.SuppCodeHiddenField.Value = _finSuppInvConsignHd.SuppCode;
            ...
            //this.StatusLabel.Text = SupplierInvoiceDataMapper.GetStatusText(_finSuppInvConsignHd.Status);
            this.SuppTextBox.Text = _finSuppInvConsignHd.SuppName;
            this.CurrCodeTextBox.Text = _finSuppInvConsignHd.CurrCode;
            ...
            this.TermTextBox.Text = _finSuppInvConsignHd.TermName;
            this.CurrTextBox.Text = _finSuppInvConsignHd.CurrCode;
            this.StatusLabel.Text = SupplierInvoiceDataMapper.GetStatusText(_finSuppInvConsignHd.Status);
            this.StatusHiddenField.Value = _finSuppInvConsignHd.Status.ToString();
            //this.AttnTextBox.Text = _finSuppInvConsignHd.Attn;
            ...
            if (_finSuppInvConsignHd.PPN != null)
            {
                int _ppn = Convert.ToInt32(_finSuppInvConsignHd.PPN);
            ...
            {
                this.PPNDateTextBox.Text = DateFormMapper.GetValue((DateTime)_finSuppInvConsignHd.PPNDate);
            }
            else
            {
            ...
            //this.SuppPONoTextBox.Text = _finSuppInvConsignHd.SuppPONo;
        ...
        public void ShowDataDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finSuppInvConsignBL.GetListSuppInvConsignDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == SupplierInvoiceDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._finSuppInvConsignBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == SupplierInvoiceDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._finSuppInvConsignBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == SupplierInvoiceDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._finSuppInvConsignBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._finSuppInvConsignBL.DeleteMultiSuppInvConsignDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINSuppInvConsignmentDt _temp = (FINSuppInvConsignmentDt)e.Item.DataItem;
                ...
                String _allCode = _temp.TransNmbr.ToString() + "|" + _temp.SJType.ToString() + "|" + _temp.SJNo.ToString() + "|" + _temp.ProductCode.ToString();

                if (this.TempHidden.Value == "")
                {
                    this.TempHidden.Value = _allCode;
                }
                else
                {
                    this.TempHidden.Value += "," + _allCode;
                ...
                //_accName.Text = HttpUtility.HtmlEncode(_accountBL.GetAccountNameByCode(_temp.Account));

                Literal _sjType = (Literal)e.Item.FindControl("SJTypeLiteral");
                _sjType.Text = HttpUtility.HtmlEncode(_temp.SJType);

                Literal _sjNo = (Literal)e.Item.FindControl("SJNoLiteral");
                _sjNo.Text = HttpUtility.HtmlEncode(_temp.SJNo);
