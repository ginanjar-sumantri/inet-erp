...
{
    public partial class SupplierInvConsignment : SupplierInvConsignmentBase
    {
        //private NotaCreditSupplierBL _notaCreditSupplierBL = new NotaCreditSupplierBL();
        private SupplierInvConsignmentBL _prmSupplierInvConsignmentBL = new SupplierInvConsignmentBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._prmSupplierInvConsignmentBL.RowsCountSuppInvConsignHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._prmSupplierInvConsignmentBL.GetListSuppInvConsignHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._prmSupplierInvConsignmentBL.GetSingleSuppInvConsignHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._prmSupplierInvConsignmentBL.DeleteMultiSuppInvConsignHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINSuppInvConsignmentHd _temp = (FINSuppInvConsignmentHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != SupplierInvoiceDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _status.Text = FINSuppInvConsignDataMapper.GetStatusText(_temp.Status);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._prmSupplierInvConsignmentBL.DeleteMultiApproveSuppInvConsignHd(_tempSplit, AppModule.GetValue(TransactionType.SuppInvConsignment), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
