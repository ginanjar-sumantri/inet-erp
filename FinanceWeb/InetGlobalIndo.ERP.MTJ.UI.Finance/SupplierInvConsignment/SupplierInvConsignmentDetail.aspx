<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SupplierInvConsignmentDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.SupplierInvConsignment.SupplierInvConsignmentDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="SuppTextBox" ReadOnly="true" BackColor="#CCCCCC">
                                    </asp:TextBox>
                            ...
                            <%--<tr>
                                ...
                                <td>
                                    <asp:TextBox ID="AttnTextBox" runat="server" Width="150" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                            </tr>--%>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="SuppInvNoTextBox" runat="server" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                            </tr>
                            <%--<tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="SuppPONoTextBox" runat="server" ReadOnly="true" BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                            </tr>--%>
                            <tr>
                                <td>
                                        ...
                                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="center">
                                                        <asp:Literal runat="server" ID="SJTypeLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="center">
