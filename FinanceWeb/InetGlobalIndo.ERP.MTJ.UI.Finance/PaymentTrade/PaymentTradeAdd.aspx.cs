...
{
    public partial class PaymentTradeAdd : PaymentTradeBase
    {
        ...
        {
            FINPayTradeHd _finPayTradeHd = new FINPayTradeHd();
            ...
            _finPayTradeHd.Status = PaymentTradeDataMapper.GetStatus(TransStatus.OnHold);
            ...
            string _result = this._paymentTradeBL.AddFINPayTradeHd(_finPayTradeHd);
