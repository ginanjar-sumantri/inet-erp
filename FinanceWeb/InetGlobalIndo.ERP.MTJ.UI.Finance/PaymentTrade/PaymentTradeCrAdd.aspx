<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PaymentTradeCrAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.PaymentTrade.PaymentTradeCrAdd" %>
                    ...
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="BankPaymentCustomValidator" runat="server" ClientValidationFunction="DropDownValidation"
                                    ControlToValidate="BankPaymentDropDownList" Text="*" ErrorMessage="Bank Payment must be filled"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="BankExpenseTextBox" Width="150" BackColor="#CCCCCC"></asp:TextBox>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td>
