<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PaymentTradeDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.PaymentTrade.PaymentTradeDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="TransNoTextBox" Width="160" MaxLength="20" BackColor="#CCCCCC"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="SuppTextBox" Width="500" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td>
                                        ...
                                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="left">
                                                        <asp:Literal runat="server" ID="SuppInvoiceLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="center">
                                                        <asp:Literal runat="server" ID="CurrCodeLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="right">
                                                        <asp:Literal runat="server" ID="APPaidLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="right">
                                                        <asp:Literal runat="server" ID="PPNPaidLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="right">
                                        ...
                                        <asp:Repeater runat="server" ID="ListRepeater2" OnItemDataBound="ListRepeater2_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="left">
                                                        <asp:Literal runat="server" ID="PayTypeLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="center">
                                                        <asp:Literal runat="server" ID="DocumentNoLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="right">
                                                        <asp:Literal runat="server" ID="AmountHomeLiteral2"></asp:Literal>
                                                    </td>
                                                    <td align="left">
            ...
            <tr align="right">
                <td>
                    <table cellpadding="3" cellspacing="1">
                        ...
                        <tr style="height: 100">
                            <td align="right">
                                <asp:Label runat="server" ID="TotalInvoiceLabel"></asp:Label>
                            </td>
                            <td align="right">
