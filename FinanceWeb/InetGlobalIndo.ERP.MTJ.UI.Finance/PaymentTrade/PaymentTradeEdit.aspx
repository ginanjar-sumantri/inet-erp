<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PaymentTradeEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.PaymentTrade.PaymentTradeEdit" %>
                    ...
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator runat="server" ID="SuppCustomValidator" ControlToValidate="SuppDropDownList"
                                    ClientValidationFunction="DropDownValidation" Text="*"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td>
