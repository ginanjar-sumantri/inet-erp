...
{
    public partial class PaymentTrade : PaymentTradeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._paymentTradeBL.RowsCountPaymentTrade(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._paymentTradeBL.GetListFINPayTradeHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINPayTradeHd _temp = (FINPayTradeHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != PaymentTradeDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _statusLiteral.Text = HttpUtility.HtmlEncode(PaymentTradeDataMapper.GetStatusText(_temp.Status));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._paymentTradeBL.GetSingleFINPayTradeHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._paymentTradeBL.DeleteMultiFINPayTradeHd(_tempSplit);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._paymentTradeBL.DeleteMultiApproveFINPayTradeHd(_tempSplit, AppModule.GetValue(TransactionType.PaymentTrade), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
