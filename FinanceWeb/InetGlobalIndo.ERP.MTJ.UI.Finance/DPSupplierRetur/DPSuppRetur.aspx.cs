...
{
    public partial class DPSuppRetur : DPSupplierReturBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finDPSuppReturBL.RowsCountFINDPSuppReturHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finDPSuppReturBL.GetListFINDPSuppReturHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINDPSuppReturHd _temp = (FINDPSuppReturHd)e.Item.DataItem;
                ...
                if (_temp.Status.ToString().ToLower() == DPSupplierReturDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                {
                    _editButton.Visible = false;
                }
                else
                ...
                _statusLiteral.Text = DPCustomerReturDataMapper.GetStatusText(_temp.Status);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._finDPSuppReturBL.GetSingleFINDPSuppReturHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._finDPSuppReturBL.DeleteMultiFINDPSuppReturHd(_tempSplit);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._finDPSuppReturBL.DeleteMultiApproveFINDPSuppReturHd(_tempSplit, AppModule.GetValue(TransactionType.DPSuppPay), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
