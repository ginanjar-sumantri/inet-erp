...
{
    public partial class DPSuppReturPaymentEdit : DPSupplierReturBase
    {
        ...
        public void ShowData()
        {
            ...
            char _fgMode = this._paymentBL.GetFgMode(_finDPSuppReturPay.ReceiptType);

            this.ReceiptTypeDropDownList.SelectedValue = _finDPSuppReturPay.ReceiptType;
            this.FgGiroHiddenField.Value = _finDPSuppReturPay.FgGiro.ToString();
            ...
            if (_fgMode == PaymentDataMapper.GetModePaymentType(ModePaymentType.Giro))
            {
                ...
                this.ShowBankGiro();
                this.BankGiroDropDownList.SelectedValue = _finDPSuppReturPay.BankGiro;
            ...
            else
            {
                ...
                {
                    decimal _tempBankExpense = Convert.ToDecimal(_finDPSuppReturPay.BankExpense);
            ...
            if (this.ReceiptTypeDropDownList.SelectedValue != "null")
            {
                ...
                else
                {
                    ...
                    if (_fgMode == PaymentDataMapper.GetModePaymentType(ModePaymentType.Bank))
                    {
                        this.BankExpenseTextBox.Attributes.Remove("ReadOnly");
                        this.BankExpenseTextBox.Attributes.Add("style", "background-color:#ffffff");
                        this.BankExpenseTextBox.Attributes.Add("OnBlur", "ChangeFormat(" + this.BankExpenseTextBox.ClientID + "," + this.DecimalPlaceHiddenFieldHome.ClientID + "  );");
                    }
                    else
                    {
                        this.BankExpenseTextBox.Text = "";
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._finDPSuppReturBL.EditFINDPSuppReturPay(_finDPSuppReturPay);
