<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DPCustomerReturDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.DPCustomerRetur.DPCustomerReturDetail" %>
            ...
            <tr align="right">
                <td>
                    <table cellpadding="3" cellspacing="1">
                        ...
                        <tr style="height: 100">
                            <td>
                                <asp:Label runat="server" ID="TotalDPLabel"></asp:Label>
                            </td>
                            <td>
