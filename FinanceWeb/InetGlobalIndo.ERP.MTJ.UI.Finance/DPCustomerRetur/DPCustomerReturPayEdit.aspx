<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DPCustomerReturPayEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.DPCustomerRetur.DPCustomerReturPayEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="DocumentNoTextBox" Width="150"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <%--<asp:TextBox runat="server" ID="BankPaymentTextBox" Width="150"></asp:TextBox>--%><asp:DropDownList
                                    runat="server" ID="BankPaymentDropDownList">
                                </asp:DropDownList>
