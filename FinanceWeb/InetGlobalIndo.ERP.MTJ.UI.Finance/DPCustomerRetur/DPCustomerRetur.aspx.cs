...
{
    public partial class DPCustomerRetur : DPCustomerReturBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finDPCustomerReturBL.RowsCountFINDPCustReturHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finDPCustomerReturBL.GetListFINDPCustReturHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINDPCustReturHd _temp = (FINDPCustReturHd)e.Item.DataItem;
                ...
                if (_temp.Status != DPCustomerReturDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = DPCustomerReturDataMapper.GetStatusText(_temp.Status);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._finDPCustomerReturBL.GetSingleFINDPCustReturHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._finDPCustomerReturBL.DeleteMultiFINDPCustReturHd(_tempSplit);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._finDPCustomerReturBL.DeleteMultiApproveFINDPCustReturHd(_tempSplit, AppModule.GetValue(TransactionType.NotaDebitSupplier), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
