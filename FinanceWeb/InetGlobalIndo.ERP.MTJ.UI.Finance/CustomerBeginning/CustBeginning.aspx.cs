...
{
    public partial class CustBeginning : CustomerBeginningBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finBeginCIBL.RowsCountFINBeginCI(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        //{
        //    double q = this._finBeginCIBL.RowsCountFINBeginCI(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finBeginCIBL.GetListFINBeginCI(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //bool _ex = this._finBeginCIBL.GetSingleMKTReqReturHdForStatus(_tempSplit);
            //if (_ex == true)
            //{
            //    bool _result = this._finBeginCIBL.DeleteMultiFINBeginCI(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINBeginCI _temp = (FINBeginCI)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != CustBeginningDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _transNo.Text = HttpUtility.HtmlEncode(_temp.InvoiceNo);
                ...
                _status.Text = HttpUtility.HtmlEncode(CustBeginningDataMapper.GetStatusText(_temp.Status));

                Literal _custName = (Literal)e.Item.FindControl("CustLiteral");
                _custName.Text = HttpUtility.HtmlEncode(_temp.CustName);
        ...
        //    bool _result = this._finBeginCIBL.DeleteMultiApproveMMKTReqReturHd(_tempSplit, AppModule.GetValue(TransactionType.RequestSalesRetur), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
        //    if (_result == true)
        //    {
