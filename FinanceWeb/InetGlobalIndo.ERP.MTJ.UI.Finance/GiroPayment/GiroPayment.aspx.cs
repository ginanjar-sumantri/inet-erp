...
{
    public partial class GiroPayment : GiroPaymentBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finGiroOutBL.RowsCountFINGiroOut(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finGiroOutBL.GetListFINGiroOut(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINGiroOut _temp = (FINGiroOut)e.Item.DataItem;
                ...
                _status.Text = GiroPaymentDataMapper.GetStatusText(_temp.Status);

                Literal _paymentNo = (Literal)e.Item.FindControl("PaymentNoLiteral");
                _paymentNo.Text = HttpUtility.HtmlEncode(_temp.FileNmbr);

                Literal _paymentDate = (Literal)e.Item.FindControl("PaymentDateLiteral");
                _paymentDate.Text = DateFormMapper.GetValue(_temp.PaymentDate);
