...
{
    public partial class PaymentNonPurchase : PaymentNonPurchaseBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._paymentNonPurchase.RowsCountPaymentNonPurchase(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._paymentNonPurchase.GetListFINPayNonTradeHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINPayNonTradeHd _temp = (FINPayNonTradeHd)e.Item.DataItem;
                ...
                else
                {
                    ...
                    if (_tempStatus.ToLower() == PaymentNonPurchaseDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                    {
                        _editButton.Visible = false;
                    }
                    else
                ...
                Literal _paymentNo = (Literal)e.Item.FindControl("PaymentNoLiteral");
                _paymentNo.Text = HttpUtility.HtmlEncode(_temp.TransNmbr);
                ...
                Literal _paymentDate = (Literal)e.Item.FindControl("PaymentDateLiteral");
                _paymentDate.Text = DateFormMapper.GetValue(_temp.TransDate);

                Literal _statusLiteral = (Literal)e.Item.FindControl("StatusLiteral");
                _statusLiteral.Text = HttpUtility.HtmlEncode(PaymentNonPurchaseDataMapper.GetStatusText(_temp.Status));

                Literal _supplierName = (Literal)e.Item.FindControl("SupplierNameLiteral");
                _supplierName.Text = HttpUtility.HtmlEncode(_temp.SuppName);
                ...
                _rate.Text = HttpUtility.HtmlEncode((_temp.ForexRate == 0) ? "0" : _temp.ForexRate.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace)));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._paymentNonPurchase.GetSingleFINPayNonTradeHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._paymentNonPurchase.DeleteMultiFINPayNonTradeHd(_tempSplit);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._paymentNonPurchase.DeleteMultiApproveFINPayNonTradeHd(_tempSplit, AppModule.GetValue(TransactionType.PaymentNonPurchase), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
