...
{
    public partial class CustomerRetur : CustomerReturBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._customerReturBL.RowsCountFINCustReturHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._customerReturBL.GetListFINCustReturHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._customerReturBL.GetSingleFINCustReturHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._customerReturBL.DeleteMultiFINCustReturHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINCustReturHd _temp = (FINCustReturHd)e.Item.DataItem;
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._customerReturBL.DeleteMultiApproveFINCustReturHd(_tempSplit, AppModule.GetValue(TransactionType.CustomerRetur), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
