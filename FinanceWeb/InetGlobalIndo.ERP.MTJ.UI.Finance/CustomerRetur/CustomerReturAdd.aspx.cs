...
{
    public partial class CustomerReturAdd : CustomerReturBase
    {
        ...
        {
            FINCustReturHd _finDNCustHd = new FINCustReturHd();
            ...
            _finDNCustHd.Status = CustomerReturDataMapper.GetStatus(TransStatus.OnHold);
            ...
            string _result = this._customerReturBL.AddFINCustReturHd(_finDNCustHd);
