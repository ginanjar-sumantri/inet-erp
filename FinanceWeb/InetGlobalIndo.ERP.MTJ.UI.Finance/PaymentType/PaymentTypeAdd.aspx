<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PaymentTypeAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.PaymentType.PaymentTypeAdd" %>
    ...
    <asp:Panel runat="server" ID="Panel1" DefaultButton="SaveButton">
        <table cellpadding="3" cellspacing="0" width="0" border="0">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="PaymentCodeTextBox" Width="70" MaxLength="10"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="PaymentCodeRequiredFieldValidator" runat="server"
                        ErrorMessage="Payment Code Must Be Filled" Text="*" ControlToValidate="PaymentCodeTextBox"
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RadioButtonList ID="FgBankChargeRadioButtonList" runat="server" RepeatDirection="Horizontal">
