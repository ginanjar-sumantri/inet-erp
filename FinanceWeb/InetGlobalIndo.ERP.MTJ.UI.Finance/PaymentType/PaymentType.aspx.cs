...
namespace InetGlobalIndo.ERP.MTJ.UI.Finance.PaymentType
{
    public partial class PaymentType : PaymentTypeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._paymentBL.RowsCountPaymentType(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._paymentBL.GetListPaymentType(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsPayType _temp = (MsPayType)e.Item.DataItem;

                string _code = _temp.PayCode.ToString();
                ...
                _paymentCode.Text = HttpUtility.HtmlEncode(_temp.PayCode);

                Literal _paymentName = (Literal)e.Item.FindControl("PaymentNameLiteral");
                _paymentName.Text = HttpUtility.HtmlEncode(_temp.PayName);

                Literal _accountCode = (Literal)e.Item.FindControl("AccountCodeLiteral");
                _accountCode.Text = HttpUtility.HtmlEncode(_temp.Account);
                ...
                Literal _bankLiteral = (Literal)e.Item.FindControl("BankLiteral");
                _bankLiteral.Text = HttpUtility.HtmlEncode(_temp.BankName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._paymentBL.DeleteMultiPaymentType(_tempSplit);
