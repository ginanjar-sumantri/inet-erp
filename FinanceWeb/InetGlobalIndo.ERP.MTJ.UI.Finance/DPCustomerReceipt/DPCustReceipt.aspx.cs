...
{
    public partial class DPCustReceipt : DPCustomerReceiptBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finDPCustBL.RowsCountFINDPCustHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finDPCustBL.GetListFINDPCustHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._finDPCustBL.GetSingleFINDPCustHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._finDPCustBL.DeleteMultiFINDPCustHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINDPCustHd _temp = (FINDPCustHd)e.Item.DataItem;
                ...
                if (_temp.Status != DPCustomerDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(DPCustomerDataMapper.GetStatusText(_temp.Status));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._finDPCustBL.DeleteMultiApproveFINDPCustHd(_tempSplit, AppModule.GetValue(TransactionType.DPCustomer), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
