<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DPCustReceiptAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.DPCustomerReceipt.DPCustReceiptAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DPListNoDropDownList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DPListNoDropDownList_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:CustomValidator ID="DPListCustomValidator" runat="server" ClientValidationFunction="DropDownValidation"
                                    ControlToValidate="DPListNoDropDownList" Text="*" ErrorMessage="DP List No. Must Be Filled"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="CurrRateTextBox" runat="server" BackColor="#CCCCCC" Width="100">
                                </asp:TextBox>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td style="width: 110px" class="tahoma_11_white" align="center">
                                            ...
                                            <%--<input id="ppn_date_start" style="visibility: hidden;" type="button" onclick="displayCalendar(ctl00_DefaultBodyContentPlaceHolder_PPNDateTextBox,'yyyy-mm-dd',this)"
                                                value="..." runat="server" />--%>
