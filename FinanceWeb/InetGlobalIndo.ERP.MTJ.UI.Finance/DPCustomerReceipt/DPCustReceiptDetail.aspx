<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DPCustReceiptDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.DPCustomerReceipt.DPCustReceiptDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TransNoTextBox" runat="server" BackColor="#CCCCCC" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="DPListNoTextBox" runat="server" ReadOnly="true" BackColor="#CCCCCC">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="SONoTextBox" runat="server" BackColor="#CCCCCC" ReadOnly="true">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
