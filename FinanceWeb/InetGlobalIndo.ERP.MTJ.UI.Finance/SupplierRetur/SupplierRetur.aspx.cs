...
{
    public partial class SupplierRetur : SupplierReturBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._supplierReturBL.RowsCountFINSuppReturHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._supplierReturBL.GetListFINSuppReturHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._supplierReturBL.GetSingleFINSuppReturHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._supplierReturBL.DeleteMultiFINSuppReturHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINSuppReturHd _temp = (FINSuppReturHd)e.Item.DataItem;
                ...
                if (_temp.Status != CustomerNoteDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(CustomerNoteDataMapper.GetStatusText(_temp.Status));

                Literal _custName = (Literal)e.Item.FindControl("SuppLiteral");
                _custName.Text = HttpUtility.HtmlEncode(_temp.SuppName);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._supplierReturBL.DeleteMultiApproveFINSuppReturHd(_tempSplit, AppModule.GetValue(TransactionType.CustomerRetur), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
