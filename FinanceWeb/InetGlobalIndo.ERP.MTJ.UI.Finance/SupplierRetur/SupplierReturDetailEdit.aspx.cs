...
{
    public partial class SupplierReturDetailEdit : SupplierReturBase
    {
        ...
        public void ShowData()
        {
            ...
            FINSuppReturDt _FINSuppReturDt = this._supplierReturBL.GetSingleFINSuppReturDt(_tempSplit[0], _tempSplit[1], _tempSplit[2]);

            string _currHeader = this._supplierReturBL.GetSingleFINSuppReturHd(_tempSplit[0]).CurrCode;
            ...
            //this.AccountDropDownList.SelectedValue = (_FINSuppReturDt.Account == "" ? "null" : _FINSuppReturDt.Account);
            //this.FgSubledHiddenField.Value = _FINSuppReturDt.FgSubLed.ToString();
            //this.SubledDropDownList.SelectedValue = (_FINSuppReturDt.FgSubLed.ToString() == "" ? "null" : _FINSuppReturDt.FgSubLed.ToString());
            this.TransNmbrHiddenField.Value = _tempSplit[0];
            //this.SJTypeTextBox.Text = _finSuppInvConsignDt.SJType;
            this.SJNoTextBox.Text = _FINSuppReturDt.SJNo;
            this.ProductCodeTextBox.Text = _FINSuppReturDt.ProductCode;
            this.ProductNameTextBox.Text = this._productBL.GetProductNameByCode(_FINSuppReturDt.ProductCode);
            this.RemarkTextBox.Text = _FINSuppReturDt.Remark;
            this.PriceTextBox.Text = Convert.ToDecimal(_FINSuppReturDt.PriceForex).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.AmountTextBox.Text = Convert.ToDecimal(_FINSuppReturDt.AmountForex).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.QtyTextBox.Text = _FINSuppReturDt.Qty.ToString("#,###.##");
            this.UnitDropDownList.SelectedValue = (_FINSuppReturDt.Unit == "" ? "null" : _FINSuppReturDt.Unit);
        ...
        {
            FINSuppReturDt _finSuppInvConsignDt = this._supplierReturBL.GetSingleFINSuppReturDt(this.TransNmbrHiddenField.Value, this.SJNoTextBox.Text, this.ProductCodeTextBox.Text);
            ...
            bool _result = this._supplierReturBL.EditFINSuppReturDt(_finSuppInvConsignDt, Convert.ToDecimal(this.AmountTextBox.Text));
