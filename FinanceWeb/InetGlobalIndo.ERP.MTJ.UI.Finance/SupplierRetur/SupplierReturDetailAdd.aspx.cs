...
{
    public partial class SupplierReturDetailAdd : SupplierReturBase
    {
        ...
        {
            this.SJNoDropDownList.Items.Clear();
            this.SJNoDropDownList.DataTextField = "SuppCode";
            this.SJNoDropDownList.DataValueField = "SuppCode";
            this.SJNoDropDownList.DataSource = this._stockRejectOutBL.GetListSJnoForDDL(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._suppCode), ApplicationConfig.EncryptionKey));
        ...
        {
            String _retun = _supplierReturBL.SaveFINSuppReturDt(this.SJNoDropDownList.SelectedValue, this.TransNmbrHiddenField.Value);
