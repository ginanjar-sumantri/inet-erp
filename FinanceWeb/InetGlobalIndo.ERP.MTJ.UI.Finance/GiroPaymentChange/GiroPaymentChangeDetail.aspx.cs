...
{
    public partial class GiroPaymentChangeDetail : GiroPaymentChangeBase
    {
        ...
        private string _reportPath1 = "GiroPaymentChange/FNChangeGiroOutPrintPreview.rdlc";
        ...
        public void ShowDataDetail1()
        {
            ...
            {
                this.ListRepeater.DataSource = this._finChangeGiroOutBL.GetListFINChangeGiroOutDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINChangeGiroOutDt _temp = (FINChangeGiroOutDt)e.Item.DataItem;
                ...
                _viewButton.PostBackUrl = this._viewDetailPage + "?" + this._codeItem + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey));
                ...
                Literal _oldGiroLiteral = (Literal)e.Item.FindControl("OldGiroLiteral");
                _oldGiroLiteral.Text = HttpUtility.HtmlEncode(_temp.OldGiro);

                Literal _paymentDateLiteral = (Literal)e.Item.FindControl("PaymentDateLiteral");
                _paymentDateLiteral.Text = DateFormMapper.GetValue(_temp.PaymentDate);
                ...
                Literal _bankPaymentLiteral = (Literal)e.Item.FindControl("BankPaymentLiteral");
                _bankPaymentLiteral.Text = _bankBL.GetBankPaymentNameByCode(_temp.BankPayment);
                ...
                _rateLiteral.Text = (_temp.ForexRate == 0) ? "0" : HttpUtility.HtmlEncode(_temp.ForexRate.ToString("#,###.##"));

                Literal _amountLiteral = (Literal)e.Item.FindControl("AmountLiteral");
                _amountLiteral.Text = (_temp.AmountForex == 0) ? "0" : HttpUtility.HtmlEncode(_temp.AmountForex.ToString("#,###.##"));
        ...
        public void ShowDataDetail2()
        {
            ...
            {
                this.ListRepeater2.DataSource = this._finChangeGiroOutBL.GetListFINChangeGiroOutPay(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        protected void ListRepeater2_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                FINChangeGiroOutPay _temp = (FINChangeGiroOutPay)e.Item.DataItem;
                ...
                _viewButton.PostBackUrl = this._viewDetailPage2 + "?" + this._codeItem + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey));
                _viewButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/view.jpg";
                ...
                else
                {
                    ...
                    if (_tempStatus.ToLower() == GiroPaymentChangeDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                    {
                        _editButton.Visible = false;
                    }
                    else
                    {
                        _editButton.PostBackUrl = this._editDetailPage2 + "?" + this._codeItem + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey));
                ...
                Literal _paymentTypeLiteral = (Literal)e.Item.FindControl("PaymentTypeLiteral");
                _paymentTypeLiteral.Text = _paymentBL.GetPaymentName(_temp.PayType);
                ...
                Literal _amountLiteral = (Literal)e.Item.FindControl("AmountLiteral");
                _amountLiteral.Text = (_temp.AmountForex == 0) ? "0" : HttpUtility.HtmlEncode(_temp.AmountForex.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace)));
        ...
        public void ShowData()
        {
            ...
            _finChangeGiroOutBL = new FINChangeGiroOutBL();
            ...
            {
                this.CodeTextBox.Text = "Supplier"; //_finChangeGiroOutHd.SuppCode;
                this.NameTextBox.Text = _suppBL.GetSuppNameByCode(_finChangeGiroOutHd.SuppCode);
            }
            else if (_finChangeGiroOutHd.CustCode != null && _finChangeGiroOutHd.CustCode.Trim() != "")
            {
                this.CodeTextBox.Text = "Customer";//_finChangeGiroOutHd.CustCode;
                this.NameTextBox.Text = _custBL.GetNameByCode(_finChangeGiroOutHd.CustCode);
            }

            this.RemarkTextBox.Text = _finChangeGiroOutHd.Remark;
            this.StatusLabel.Text = GiroPaymentChangeDataMapper.GetStatusText(_finChangeGiroOutHd.Status);
            this.StatusHiddenField.Value = _finChangeGiroOutHd.Status.ToString();

            if (this.StatusHiddenField.Value.Trim().ToLower() == GiroPaymentChangeDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.AddButton2.Visible = false;
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == GiroPaymentChangeDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == GiroPaymentChangeDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == GiroPaymentChangeDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == GiroPaymentChangeDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == GiroPaymentChangeDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._finChangeGiroOutBL.GetApproval(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == GiroPaymentChangeDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._finChangeGiroOutBL.Approve(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == GiroPaymentChangeDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._finChangeGiroOutBL.Posting(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == GiroPaymentChangeDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._finChangeGiroOutBL.UnPosting(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportFinanceBL.FNChangeGiroOutPrintPreview(this.TransNoTextBox.Text);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._finChangeGiroOutBL.DeleteMultiFINChangeGiroOutDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void DeleteButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._finChangeGiroOutBL.DeleteMultiFINChangeGiroOutPay(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.ChangeGiroPayment), this.TransNoTextBox.Text, this.FileNmbrTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.Label.Text = _result;
