...
{
    public partial class GiroPaymentChange : GiroPaymentChangeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finChangeGiroOutBL.RowsCountFINChangeGiroOutHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finChangeGiroOutBL.GetListFINChangeGiroOutHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINChangeGiroOutHd _temp = (FINChangeGiroOutHd)e.Item.DataItem;
                ...
                Literal _custCode = (Literal)e.Item.FindControl("CustLiteral");
                _custCode.Text = HttpUtility.HtmlEncode(_custBL.GetNameByCode(_temp.CustCode));

                Literal _status = (Literal)e.Item.FindControl("StatusLiteral");
                _status.Text = HttpUtility.HtmlEncode(GiroPaymentChangeDataMapper.GetStatusText(_temp.Status));

                Literal _suppCode = (Literal)e.Item.FindControl("SuppLiteral");
                _suppCode.Text = HttpUtility.HtmlEncode(_suppBL.GetSuppNameByCode(_temp.SuppCode));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._finChangeGiroOutBL.GetSingleFINChangeGiroOutHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._finChangeGiroOutBL.DeleteMultiFINChangeGiroOutHd(_tempSplit);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._finChangeGiroOutBL.DeleteMultiApproveFINChangeGiroOutHd(_tempSplit, AppModule.GetValue(TransactionType.ChangeGiroPayment), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
