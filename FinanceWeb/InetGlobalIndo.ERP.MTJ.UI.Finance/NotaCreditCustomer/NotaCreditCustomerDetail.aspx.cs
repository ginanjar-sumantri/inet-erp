...
{
    public partial class NotaCreditCustomerDetail : NotaCreditCustomerBase
    {
        ...
        private string _reportPath1 = "NotaCreditCustomer/CreditNoteCustomer.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._notaCreditCustomerBL.RowsCountFINCNCustDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == NotaCreditCustDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaCreditCustDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaCreditCustDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaCreditCustDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        {
            _notaCreditCustomerBL = new NotaCreditCustomerBL();
            FINCNCustHd _finCNCustHd = this._notaCreditCustomerBL.GetSingleFINCNCustHdView(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            ...
            this.StatusLabel.Text = NotaCreditCustDataMapper.GetStatusText(_finCNCustHd.Status);
            this.CustTextBox.Text = _finCNCustHd.CustName;
            this.CNCustNoTextBox.Text = _finCNCustHd.CNCustNo;
            this.CurrCodeTextBox.Text = _finCNCustHd.CurrCode;
            this.CurrRateTextBox.Text = (_finCNCustHd.ForexRate == 0) ? "0" : _finCNCustHd.ForexRate.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.TermTextBox.Text = _finCNCustHd.TermName;
            this.CurrTextBox.Text = _finCNCustHd.CurrCode;
            this.StatusLabel.Text = NotaCreditCustDataMapper.GetStatusText(_finCNCustHd.Status);
            this.StatusHiddenField.Value = _finCNCustHd.Status.ToString();
            this.AttnTextBox.Text = _finCNCustHd.Attn;
            //this.InvoiceNoTextBox.Text = _finCNCustHd.InvoiceNo;
            this.RemarkTextBox.Text = _finCNCustHd.Remark;
            if (_finCNCustHd.TotalForex != null)
            {
                decimal _totalForex = Convert.ToDecimal(_finCNCustHd.TotalForex);
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == NotaCreditCustDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        public void ShowDataDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._notaCreditCustomerBL.GetListFINCNCustDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == NotaCreditCustDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._notaCreditCustomerBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaCreditCustDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._notaCreditCustomerBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaCreditCustDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._notaCreditCustomerBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == NotaCreditCustDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._notaCreditCustomerBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._notaCreditCustomerBL.DeleteMultiFINCNCustDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINCNCustDt _temp = (FINCNCustDt)e.Item.DataItem;
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportFinanceBL.CreditNoteCustomerPrintPreview(this.TransNoTextBox.Text);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.NotaCreditCustomer), this.TransNoTextBox.Text, this.FileNmbrTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.Label.Text = _result;
