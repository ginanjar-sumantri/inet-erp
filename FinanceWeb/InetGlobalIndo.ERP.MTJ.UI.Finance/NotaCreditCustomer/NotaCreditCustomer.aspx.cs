...
{
    public partial class NotaCreditCustomer : NotaCreditCustomerBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._notaCreditCustomerBL.RowsCountFINCNCustHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._notaCreditCustomerBL.GetListFINCNCustHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._notaCreditCustomerBL.GetSingleFINCNCustHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._notaCreditCustomerBL.DeleteMultiFINCNCustHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINCNCustHd _temp = (FINCNCustHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != NotaCreditCustDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _status.Text = NotaCreditCustDataMapper.GetStatusText(_temp.Status);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._notaCreditCustomerBL.DeleteMultiApproveFINCNCustHd(_tempSplit, AppModule.GetValue(TransactionType.NotaCreditCustomer), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
