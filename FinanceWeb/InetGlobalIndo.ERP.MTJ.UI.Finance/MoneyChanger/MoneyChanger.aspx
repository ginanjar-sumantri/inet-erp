<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="MoneyChanger.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.MoneyChanger.MoneyChanger" %>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="TypeExchangeLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="CurrExchangeLiteral"></asp:Literal>
                                                </td>
                                                <td align="right">
                                                    <asp:Literal runat="server" ID="AmountExchangeLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
