...
{
    public partial class CashFlowFileAdd : CashFlowBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._cashFlowFileBL.RowsCountNotAssign();
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = _cashFlowFileBL.GetListNotAssign(_prmCurrentPage, _maxrow);
            }
        ...
        private void Simpan()
        {
            ...
            {
                _result = _cashFlowFileBL.AddTransTypeAccount("CashFlow");
            }
            else
            {
                string _temp = this.CheckHidden.Value;
                _result = this._cashFlowFileBL.Add(_temp, "CashFlow");
            }
        }
