...
{
    public partial class CashFlowFile : CashFlowBase
    {
        private CashFlowFileBL _cashFlowBL = new CashFlowFileBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._cashFlowBL.RowsCountMsAccGroupDt();
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            else
            {
                ...
                this.ListRepeater.DataSource = _cashFlowBL.GetListMsAccGroupDt(_prmCurrentPage, _maxrow);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                _accountCode.Text = HttpUtility.HtmlEncode(_temp.Account.ToString());
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._cashFlowBL.DeleteMulti(_tempsplit);
