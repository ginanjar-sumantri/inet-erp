...
{
    public partial class GiroReceipt : GiroReceiptBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._finGiroInBL.RowsCountFINGiroIn(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._finGiroInBL.GetListFINGiroIn(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        {
            Response.Redirect(_depositedAllPage);
        }
    }
}