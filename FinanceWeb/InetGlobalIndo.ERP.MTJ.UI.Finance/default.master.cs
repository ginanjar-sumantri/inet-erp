...
public partial class _default : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.Page.IsPostBack == true)
        {
            ...
            //this.Menu1.Items.Add(_quickLaunchNavMenu.RenderItem(17, new AppModule().GetValue(ERPModule.Finance), "administrators", null));
            //_quickLaunchNavMenu.Dispose();

            //string _imageUrl = ApplicationConfig.HomeWebAppURL + "images/finance_small.jpg";
            //string _titleTree = "&nbsp;Finance";
            //QuickLaunchNavigationMenu _quickLaunchNavNode = new QuickLaunchNavigationMenu();
            //this.TreeView1.ShowLines = true;
            //this.TreeView1.Nodes.Add(_quickLaunchNavNode.RenderNode(17, AppModule.GetValue(ERPModule.Finance), "administrators", null, _imageUrl, _titleTree));
            //_quickLaunchNavNode.Dispose();

            //string _dir = Request.ServerVariables["APPL_PHYSICAL_PATH"];
            //string _title = "Finance";
            //QuickLaunchNavigationMenu _quickLaunchSiteMapPath = new QuickLaunchNavigationMenu();
            //_quickLaunchSiteMapPath.GenerateSiteMapPath(17, AppModule.GetValue(ERPModule.Finance), "administrators", null, _dir, _title, 17);
            ...
            //_topNavigationMenu.RenderItem(0, _roles, ERPModule.Finance, this.Menu2, new UserBL().GetCompanyId(HttpContext.Current.User.Identity.Name));
