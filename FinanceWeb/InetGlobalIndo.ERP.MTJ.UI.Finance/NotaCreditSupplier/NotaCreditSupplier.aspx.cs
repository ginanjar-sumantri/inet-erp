...
{
    public partial class NotaCreditSupplier : NotaCreditSupplierBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._notaCreditSupplierBL.RowsCountFINCNSuppHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._notaCreditSupplierBL.GetListFINCNSuppHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._notaCreditSupplierBL.GetSingleFINCNSuppHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._notaCreditSupplierBL.DeleteMultiFINCNSuppHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINCNSuppHd _temp = (FINCNSuppHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != NotaCreditSuppDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _status.Text = HttpUtility.HtmlEncode(NotaCreditSuppDataMapper.GetStatusText(_temp.Status));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._notaCreditSupplierBL.DeleteMultiApproveFINCNSuppHd(_tempSplit, AppModule.GetValue(TransactionType.NotaCreditSupplier), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
