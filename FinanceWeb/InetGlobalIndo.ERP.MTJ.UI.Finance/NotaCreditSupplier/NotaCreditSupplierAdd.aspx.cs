...
{
    public partial class NotaCreditSupplierAdd : NotaCreditSupplierBase
    {
        ...
        protected void NextButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            _finCNSuppHd.Status = NotaCreditSuppDataMapper.GetStatus(TransStatus.OnHold);
            ...
            {
                _finCNSuppHd.PPNDate = DateFormMapper.GetValue(this.PPNDateTextBox.Text);
            }
            ...
            string _result = this._notaCreditSupplierBL.AddFINCNSuppHd(_finCNSuppHd);
