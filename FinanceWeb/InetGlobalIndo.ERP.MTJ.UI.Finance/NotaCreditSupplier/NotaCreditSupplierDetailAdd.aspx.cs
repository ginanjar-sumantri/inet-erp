...
{
    public partial class NotaCreditSupplierDetailAdd : NotaCreditSupplierBase
    {
        ...
        public void ShowAccount()
        {
            ...
            this.AccountDropDownList.DataSource = this._accountBL.GetListAccountByTransType(_currHeader, _userEmpBL.GetEmployeeIDByUserName(HttpContext.Current.User.Identity.Name), AppModule.GetValue(TransactionType.NotaCreditSupplier));
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            int _maxItemNo = this._notaCreditSupplierBL.GetMaxNoItemFINCNSuppDt(_transNo);

            FINCNSuppDt _finCNSuppDt = new FINCNSuppDt();
            _finCNSuppDt.TransNmbr = _transNo;
            _finCNSuppDt.ItemNo = _maxItemNo + 1;
            ...
            _finCNSuppDt.Qty = Convert.ToInt32(this.QtyTextBox.Text);
            _finCNSuppDt.Unit = this.UnitDropDownList.SelectedValue;

            bool _result = this._notaCreditSupplierBL.AddFINCNSuppDt(_finCNSuppDt);
