...
{
    public partial class PettyCashDetail : PettyCashBase
    {
        ...
        private string _reportPath2 = "PettyCash/JournalEntryPrintPreview.rdlc";
        private string _reportPath3 = "PettyCash/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._pettyBL.RowsCountCashDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                ...
                {
                    if (this._pettyBL.CheckLimitAuthorization(AppModule.GetValue(TransactionType.PettyCash), HttpContext.Current.User.Identity.Name, _amount) == true)
                    {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        public void ShowData()
        {
            ...
            _codeTransaction = this.TransactionNoTextBox.Text = _finPettyHd.TransNmbr;
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.Posted).ToString().Trim().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        public void ShowDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._pettyBL.GetListDt(this.TransactionNoTextBox.Text, _prmCurrentPage, _maxrow);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                _listCheckbox.Attributes.Add("OnClick", "CheckBox_Click(" + this.CheckHidden.ClientID + ", " + _listCheckbox.ClientID + ", '" + _itemNo + "', '" + _awal + "', '" + _akhir + "', '" + _cbox + "', 'false')");
                _listCheckbox.Checked = this.IsChecked(_itemNo);

                ImageButton _viewButton = (ImageButton)e.Item.FindControl("ViewButton");
                _viewButton.PostBackUrl = this._viewDetailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)) + "&" + this._numberKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_itemNo, ApplicationConfig.EncryptionKey));
                ...
                else
                {
                    ...
                    {
                        _editButton.PostBackUrl = this._editDetailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)) + "&" + this._numberKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_itemNo, ApplicationConfig.EncryptionKey));
                ...
                Literal _accName = (Literal)e.Item.FindControl("AccountNameLiteral");
                ...
                _forex.Text = HttpUtility.HtmlEncode((_temp.AmountForex == 0) ? "0" : _temp.AmountForex.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace)));
            ...
            if (e.Item.ItemType == ListItemType.Footer)
            {
                ...
                _amountLabel.Text = HttpUtility.HtmlEncode((_amount == 0) ? "0" : _amount.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace)));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._pettyBL.DeleteMultiCashDt(_tempSplit, this.TransactionNoTextBox.Text);
            ...
            Response.Redirect(this._detailPage + "?" + ApplicationConfig.RequestPageKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_page, ApplicationConfig.EncryptionKey)) + "&" + ApplicationConfig.ActionResult + "=" + _error + "&" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)));
        }
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._pettyBL.GetApproval(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._pettyBL.Approve(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._pettyBL.Posting(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PettyCashDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._pettyBL.UnPosting(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), HttpContext.Current.User.Identity.Name);
        ...
        {
            string _temp = this.TransactionNoTextBox.Text;
            string[] _tempSplit = _temp.Split(',');

            bool _result = this._pettyBL.AddMultiFINPettyPrintHistory(_tempSplit, this.DescriptionHiddenField.Value, HttpContext.Current.User.Identity.Name);
            ...
            if (_result == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._reportFinanceBL.PettyCashPrintPreview(_temp, this.DescriptionHiddenField.Value, HttpContext.Current.User.Identity.Name);
                ...
                _reportParam[3] = new ReportParameter("Type", PettyDataMapper.GetType(Common.Enum.PettyType.Payment).ToString(), true);
                _reportParam[4] = new ReportParameter("JobTitleStatus", _jobTitleStatus, false);
                this.ReportViewer1.LocalReport.SetParameters(_reportParam);
                this.ReportViewer1.LocalReport.Refresh();
            }
            else
            {
                this.Label.Text = "You Failed Preview";
            }
        }
        ...
        protected void CreateJurnalImageButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.CreateJurnalDDL.SelectedValue == "1")
            {
                ...
                ReportDataSource _reportDataSource1 = this._reportTourBL.JournalTicketingPrintPreview(this.TransactionNoTextBox.Text);
                ...
                _reportParam[0] = new ReportParameter("Nmbr", this.TransactionNoTextBox.Text, true);
            ...
            else if (this.CreateJurnalDDL.SelectedValue == "2")
            {
                ...
                ReportDataSource _reportDataSource2 = this._reportTourBL.JournalTicketingPrintPreview(this.TransactionNoTextBox.Text);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.PettyCash), this.TransactionNoTextBox.Text, this.FileNmbrTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.Label.Text = _result;
