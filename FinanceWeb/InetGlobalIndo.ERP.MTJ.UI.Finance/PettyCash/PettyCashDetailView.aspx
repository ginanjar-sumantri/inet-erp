<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PettyCashDetailView.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Finance.PettyCash.PettyCashDetailView" %>
    ...
    <asp:Panel runat="server" ID="Panel1" DefaultButton="EditButton">
        <table cellpadding="3" cellspacing="0" width="0" border="0">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="SubledgerTextBox" ReadOnly="false" BackColor="#CCCCCC"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="AmountTextbox" MaxLength="20" ReadOnly="false" BackColor="#CCCCCC"></asp:TextBox>
                </td>
            </tr>
            <tr valign="top">
                <td>
