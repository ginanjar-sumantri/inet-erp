...
{
    public partial class PettyCash : PettyCashBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._pettyBL.RowsCountCashHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._pettyBL.GetListHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINPettyHd _temp = (FINPettyHd)e.Item.DataItem;
                ...
                _transactionDate.Text = DateFormMapper.GetValue(_temp.TransDate);

                Literal _petty = (Literal)e.Item.FindControl("PettyLiteral");
                _petty.Text = HttpUtility.HtmlEncode(_temp.Petty);

                Literal _status = (Literal)e.Item.FindControl("StatusLiteral");
                _status.Text = HttpUtility.HtmlEncode(PettyCashDataMapper.GetStatusText(_temp.Status));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._pettyBL.GetSingleFINPettyCashHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._pettyBL.DeleteMultiCashHd(_tempSplit);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._pettyBL.DeleteMultiApproveFINPettyCashHd(_tempSplit, AppModule.GetValue(TransactionType.PettyCash), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
