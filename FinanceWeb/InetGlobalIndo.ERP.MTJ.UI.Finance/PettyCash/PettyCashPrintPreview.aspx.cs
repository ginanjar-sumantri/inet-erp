...
{
    public partial class PettyCashPrintPreview : PettyCashBase
    {
        ...
        private void ShowPage(Int32 _prmCurrentPage)
        {
            ...
            Double q = this._pettyBL.RowsCountPettyCashHdPrintPreview(DateFormMapper.GetValue(this.BeginDateTextBox.Text), DateFormMapper.GetValue(this.EndDateTextBox.Text));
        ...
        public void ShowData(Int32 _prmReqPage)
        {
            ...
            this.ListRepeater.DataSource = this._pettyBL.GetListPettyCashHdPrintPreview(_prmReqPage, _maxrow, DateFormMapper.GetValue(this.BeginDateTextBox.Text), DateFormMapper.GetValue(this.EndDateTextBox.Text));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                int _tempReqPrint = this._pettyBL.GetReqPrint(_temp.TransNmbr);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (_result == true)
            {
                for (int i = 0; i < _tempSplit.Length; i++)
                {
                    ...
                    ReportDataSource _reportDataSource1 = this._reportFinanceBL.PettyCashPrintPreview(_tempSplit[i], this.DescriptionHiddenField.Value, HttpContext.Current.User.Identity.Name);
                    ...
                    _reportParam[0] = new ReportParameter("TransNmbr", _tempSplit[i], true);
