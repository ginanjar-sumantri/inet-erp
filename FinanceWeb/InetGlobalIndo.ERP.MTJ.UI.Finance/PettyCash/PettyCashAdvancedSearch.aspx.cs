...
{
    public partial class PettyCashAdvancedSearch : PettyCashBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Petty Cash Out : Advanced Search";
        ...
        private double RowCount()
        {
            ...
            _result = this._pettyBL.RowsCountAdvancedSearch(this.TransactionNoTextBox.Text, this.FileNoTextBox.Text, DateFormMapper.GetValue(this.DateFromTextBox.Text), DateFormMapper.GetValue(this.DateToTextBox.Text), this.PettyDDL.SelectedValue, this.PayToText.Text, this.StatusRadioButtonList.SelectedValue);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._pettyBL.GetListAdvancedSearch(_prmCurrentPage, _maxrow, this.TransactionNoTextBox.Text, this.FileNoTextBox.Text, DateFormMapper.GetValue(this.DateFromTextBox.Text), DateFormMapper.GetValue(this.DateToTextBox.Text), this.PettyDDL.SelectedValue, this.PayToText.Text, this.StatusRadioButtonList.SelectedValue);
