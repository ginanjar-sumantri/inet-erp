<%@ page language="C#" masterpagefile="~/default.master" autoeventwireup="true" inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.CustBillingAccountBase.BillTrRadiusActivate, App_Web_cajrmfjr" title="Untitled Page" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="CustomerBillingCode" Text="Customer Billing Code"></asp:ListItem>
                    ...
                    <table cellpadding="3" cellspacing="1" border="0">
                        <tr class="bgcolor_gray">
                            ...
                            <td style="width: 130px" class="tahoma_11_white" align="center">
                                <b>Customer Billing Name</b>
                            </td>
                            <td style="width: 130px" class="tahoma_11_white" align="center">
                                <b>Customer Billing Code</b>
                            </td>
                            ...
                            <ItemTemplate>
                                <tr id="RepeaterItemTemplate" runat="server">
                                    ...
                                    <td align="center">
                                      ...
                                      <td align="center">
                                        <asp:Literal runat="server" ID="CustBillNametLiteral"></asp:Literal>
                                    </td>
                                    <td align="center">
                                        <asp:Literal runat="server" ID="CustBillCodetLiteral"></asp:Literal>
                                    </td>
                                    <td align="center">
                                    ...
                                    <td align="center">
                                        <asp:Literal runat="server" ID="BillingAmountLiteral"></asp:Literal>
                                    </td>
                                    <td align="center">
                                    ...
                                    <td align="center">
                                        <asp:Literal runat="server" ID="PaidAmountLiteral"></asp:Literal>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
