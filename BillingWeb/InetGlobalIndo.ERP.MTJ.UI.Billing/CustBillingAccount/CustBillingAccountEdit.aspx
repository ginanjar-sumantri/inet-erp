<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustBillingAccountEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.CustBillingAccountBase.CustBillingAccountEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="CustBillAccountTextBox" Width="350" MaxLength="50"
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox runat="server" ID="AmountTextBox" MaxLength="23" Width="200"></asp:TextBox>
                                    </td>
                                </tr>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Literal ID="ActivateDateLiteral" runat="server"></asp:Literal>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Literal ID="ExpireDateLiteral" runat="server"></asp:Literal>
