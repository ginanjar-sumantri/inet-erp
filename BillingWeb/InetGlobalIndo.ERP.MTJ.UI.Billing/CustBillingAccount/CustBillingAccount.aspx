<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustBillingAccount.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.CustBillingAccountBase.CustBillingAccount" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="CustomerBillingAccount" Text="Customer Billing Account"></asp:ListItem>
                        ...
                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                            <ItemTemplate>
                                <tr id="RepeaterItemTemplate" runat="server">
                                    ...
                                    <td align="left">
                                        <asp:Literal runat="server" ID="DescLiteral"></asp:Literal>
                                    </td>
                                    <td align="center">
