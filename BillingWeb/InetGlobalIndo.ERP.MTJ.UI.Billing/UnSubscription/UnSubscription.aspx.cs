...
{
    public partial class UnSubscription : UnSubscriptionBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._unSubscriptionBL.RowsCountUnSub(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._unSubscriptionBL.GetListUnSub(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                BILTrUnSubscriptionHd _temp = (BILTrUnSubscriptionHd)e.Item.DataItem;
                ...
                if (_tempStatus.ToLower() == UnSubDataMapper.GetStatusByte(TransStatus.Approved).ToString().ToLower())
                {
                ...
                _statusLiteral.Text = HttpUtility.HtmlEncode(UnSubDataMapper.GetStatusText(Convert.ToByte(_temp.Status)));

                Literal _companyNameLiteral = (Literal)e.Item.FindControl("CompanyNameLiteral");
                _companyNameLiteral.Text = HttpUtility.HtmlEncode(_temp.CompanyName);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._unSubscriptionBL.DeleteMultiUnSub(_tempSplit);
