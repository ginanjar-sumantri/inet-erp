...
{
    public partial class BeritaAcara : BillingBeritaAcaraBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._beritaAcaraBL.RowCountBeritaAcara(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._beritaAcaraBL.GetListBeritaAcara(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                BILTrBeritaAcara _bilTrBeritaAcara = (BILTrBeritaAcara)e.Item.DataItem;
                string _code = _bilTrBeritaAcara.TransNmbr.ToString();
                ...
                _statusLiteral.Text = HttpUtility.HtmlEncode(BeritaAcaraDataMapper.GetStatusText(Convert.ToByte(_bilTrBeritaAcara.Status)));
                
                Literal _transDateLiteral = (Literal)e.Item.FindControl("TransDateLiteral");
                _transDateLiteral.Text = HttpUtility.HtmlEncode(Convert.ToDateTime( _bilTrBeritaAcara.TransDate) .ToString("dd/MM/yy"));

                Literal _fileLiteral = (Literal)e.Item.FindControl("FileLiteral");
                _fileLiteral.Text = HttpUtility.HtmlEncode(_bilTrBeritaAcara.FileNmbr);
                
                Literal _salesConfirmationNoRefLiteral = (Literal)e.Item.FindControl("SalesConfirmationNoRefLiteral");
                _salesConfirmationNoRefLiteral.Text = HttpUtility.HtmlEncode(_beritaAcaraBL.GetSalesConfirmationFileNumber ( _bilTrBeritaAcara.SalesConfirmationNoRef ) );

                Literal _customerNameLiteral = (Literal)e.Item.FindControl("CustomerNameLiteral");
                _customerNameLiteral.Text = HttpUtility.HtmlEncode(_bilTrBeritaAcara.ApprovedByCustomerName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._beritaAcaraBL.DeleteMultiBeritaAcara(_tempsplit);
