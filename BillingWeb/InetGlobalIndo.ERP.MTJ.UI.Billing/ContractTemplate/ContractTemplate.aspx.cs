...
namespace InetGlobalIndo.ERP.MTJ.UI.Billing.ContractTemplate
{
    public partial class ContractTemplate : ContractTemplateBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._contractBL.RowsCountContractTemplateHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._contractBL.GetListContractTemplateHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                BILMsContractTemplateHd _temp = (BILMsContractTemplateHd)e.Item.DataItem;
                string _code = _temp.TemplateID.ToString(); 
                ...
                Literal _download = (Literal)e.Item.FindControl("DownloadLiteral");
                _download.Text = "<a href='" + ApplicationConfig.ContractTemplateVirDirPath + _temp.TemplateFileName + "'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download.jpg" + "' border='0'>" + "</a>";
                ...
                Literal _templateNameLiteral = (Literal)e.Item.FindControl("TemplateNameLiteral");
                _templateNameLiteral.Text = HttpUtility.HtmlEncode(_temp.TemplateName);

                Literal _fgActiveLiteral = (Literal)e.Item.FindControl("ActiveLiteral");
                _fgActiveLiteral.Text = HttpUtility.HtmlEncode(ContractTemplateDataMapper.GetFgActiveText(_temp.FgActive));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._contractBL.DeleteMultiContractTemplateHd(_tempSplit);
