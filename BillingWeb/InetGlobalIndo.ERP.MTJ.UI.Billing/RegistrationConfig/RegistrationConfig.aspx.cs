...
{
    public partial class RegistrationConfig : RegistrationConfigBase
    {
        private RegistrationConfigBL _registrationConfigBL = new RegistrationConfigBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._registrationConfigBL.RowsCountRegistrationConfig(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._registrationConfigBL.GetListRegistrationConfig(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                BILMsRegistrationConfig _temp = (BILMsRegistrationConfig)e.Item.DataItem;

                string _code = _temp.RegCode;
                ...
                Literal _regCode = (Literal)e.Item.FindControl("RegCodeLiteral");
                _regCode.Text = HttpUtility.HtmlEncode(_temp.RegCode);

                Literal _regName = (Literal)e.Item.FindControl("RegNameLiteral");
                _regName.Text = HttpUtility.HtmlEncode(_temp.RegName);

                Literal _regFee = (Literal)e.Item.FindControl("RegFeeLiteral");
                _regFee.Text = HttpUtility.HtmlEncode(Convert.ToDecimal(_temp.RegistrationFee).ToString("#,##0.##"));

                Literal _installationFee = (Literal)e.Item.FindControl("InstallationFeeLiteral");
                _installationFee.Text = HttpUtility.HtmlEncode(Convert.ToDecimal(_temp.InstalationFee).ToString("#,##0.##"));

                Literal _deposit = (Literal)e.Item.FindControl("DepositLiteral");
                _deposit.Text = HttpUtility.HtmlEncode(Convert.ToDecimal(_temp.Deposit).ToString("#,##0.##"));

                Literal _recurringFirstCharge = (Literal)e.Item.FindControl("RecurringFirstChargeLiteral");
                _recurringFirstCharge.Text = HttpUtility.HtmlEncode(_temp.RecurringFirstCharge.ToString());

                Literal _description = (Literal)e.Item.FindControl("DescriptionLiteral");
                _description.Text = HttpUtility.HtmlEncode(_temp.Description);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._registrationConfigBL.DeleteMultiRegistrationConfig(_tempSplit);
