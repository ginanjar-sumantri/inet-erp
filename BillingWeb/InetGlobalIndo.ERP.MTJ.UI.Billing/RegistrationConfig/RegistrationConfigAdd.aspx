<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="RegistrationConfigAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.RegistrationConfig.RegistrationConfigAdd" %>

<%@ Register Src="../ProductPickerIgnoreStock.ascx" TagName="ProductPicker1" TagPrefix="uc1" %>
<%@ Register Src="../ProductPickerIgnoreStock.ascx" TagName="ProductPicker2" TagPrefix="uc2" %>
<%@ Register Src="../ProductPickerIgnoreStock.ascx" TagName="ProductPicker3" TagPrefix="uc3" %>
    ...
    <asp:Panel runat="server" ID="Panel1" DefaultButton="SaveButton">
        <table cellpadding="3" cellspacing="0" width="0" border="0">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="RegistrationCodeTextBox" Width="200" MaxLength="20"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RegistrationCodeRequiredFieldValidator" runat="server"
                        ErrorMessage="Registration Code Must Be Filled" Text="*" ControlToValidate="RegistrationCodeTextBox"
