...
{
    public partial class RegistrationConfigAdd : RegistrationConfigBase
    {
        ...
        public void ClearData()
        {
            ...
            this.RegistrationNameTextBox.Text = "";
            this.PaymentStatusRadioButtonList.SelectedIndex = 0;
            this.RegProductCodeTextBox.Text = "";
            this.RegProductNameTextBox.Text = "";
            this.RegFeeTextBox.Text = "0";
            this.InstallationProductCodeTextBox.Text = "";
            this.InstallationProductNameTextBox.Text = "";
            this.InstalationFeeTextBox.Text = "0";
            this.DepositProductCodeTextBox.Text = "";
            this.DepositProductNameTextBox.Text = "";
            this.DepositTextBox.Text = "0";
            this.RemarkTextBox.Text = "";
            this.RecurringFirstChargeTextBox.Text = "0";
        }

        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            BILMsRegistrationConfig _config = new BILMsRegistrationConfig();

            _config.RegCode = this.RegistrationCodeTextBox.Text;
            ...
            _config.CreatedBy = HttpContext.Current.User.Identity.Name;
            _config.CreatedDate = DateTime.Now;
            _config.EditBy = HttpContext.Current.User.Identity.Name;
            _config.EditDate = DateTime.Now;

            bool _result = this._regConfigBL.AddRegistrationConfig(_config);
