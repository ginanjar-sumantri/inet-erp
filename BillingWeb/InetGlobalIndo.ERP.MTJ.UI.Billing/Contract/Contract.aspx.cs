...
namespace InetGlobalIndo.ERP.MTJ.UI.Billing.Contract
{
    public partial class Contract : ContractBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._contractBL.RowsCountContract(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._contractBL.GetListContract(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                BILTrContract _temp = (BILTrContract)e.Item.DataItem;
                ...
                if (_tempStatus.ToLower() == ContractDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
                {
                ...
                _statusLiteral.Text = HttpUtility.HtmlEncode(ContractDataMapper.GetStatusText(Convert.ToByte(_temp.Status)));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._contractBL.DeleteMultiContract(_tempSplit);
