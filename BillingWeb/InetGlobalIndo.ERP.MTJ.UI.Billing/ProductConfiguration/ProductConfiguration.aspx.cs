...
namespace InetGlobalIndo.ERP.MTJ.UI.Billing.ProductConfiguration
{
    public partial class ProductConfiguration : ProductConfigurationBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.PageTitleLiteral.Text = "Product Configuration";
        ...
        private double RowCount()
        {
            ...
            _result = this._productConfigurationBL.RowsCountProductExtension(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._productConfigurationBL.GetListProductExtension(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                Master_ProductExtension _masterProductExtension = (Master_ProductExtension)e.Item.DataItem;
                string _code = _masterProductExtension.ProductCode.ToString();
                ...
                _productCodeLiteral.Text = HttpUtility.HtmlEncode(_masterProductExtension.ProductCode);

                Literal _productNameLiteral = (Literal)e.Item.FindControl("ProductNameLiteral");
                _productNameLiteral.Text = HttpUtility.HtmlEncode(_masterProductExtension.ProductName);

                Literal _isPostponeLiteral = (Literal)e.Item.FindControl("IsPostponeLiteral");
                _isPostponeLiteral.Text = HttpUtility.HtmlEncode(_masterProductExtension.IsPostponeAllowed.ToString());

                Literal _isChangePriceLiteral = (Literal)e.Item.FindControl("IsChangePriceLiteral");
                _isChangePriceLiteral.Text = HttpUtility.HtmlEncode(_masterProductExtension.IsChangePriceAllowed.ToString());

                Literal IsMRCLiteral = (Literal)e.Item.FindControl("IsMRCLiteral");
                IsMRCLiteral.Text = HttpUtility.HtmlEncode(_masterProductExtension.IsMRC.ToString());

                Literal _contractMonthLiteral = (Literal)e.Item.FindControl("ContractMonthLiteral");
                _contractMonthLiteral.Text = (_masterProductExtension.MinContractMonth == 0 ? "0" : HttpUtility.HtmlEncode(_masterProductExtension.MinContractMonth.ToString()));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._productConfigurationBL.DeleteMultiProductExtension(_tempsplit);
