...
{
    public partial class SalesConfirmation : SalesConfirmationBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._salesConfirmationBL.RowsCountSalesConfirmation(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        {
            //this.GetFormatExcelLiteral.Text = "<a href='" + ApplicationConfig.BillingFormatVirDirPath + "SalesConfirmation.xls'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download_excel.jpg" + "' border='0'>" + "</a>";
            ...
            {
                this.ListRepeater.DataSource = this._salesConfirmationBL.GetListSalesConfirmation(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (_temp.Status != SalesConfirmationDataMapper.GetStatusByte(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(SalesConfirmationDataMapper.GetStatusText(_temp.Status));

                Literal _formulirID = (Literal)e.Item.FindControl("FormulirIDLiteral");
                _formulirID.Text = HttpUtility.HtmlEncode(_temp.FormulirID);

                Literal _custName = (Literal)e.Item.FindControl("CustLiteral");
                _custName.Text = HttpUtility.HtmlEncode(_temp.CompanyName);

                Literal _custBillAcc = (Literal)e.Item.FindControl("CustBillAccLiteral");
                _custBillAcc.Text = HttpUtility.HtmlEncode((_temp.CustBillAccount == "null") ? "" : _temp.CustBillAccount);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._salesConfirmationBL.DeleteMultiSalesConfirmation(_tempSplit);
