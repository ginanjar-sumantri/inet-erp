<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SalesConfirmationEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.SalesConfirmation.SalesConfirmationEdit" %>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="CustomValidator6" runat="server" ClientValidationFunction="DropDownValidation"
                                    ErrorMessage="Sales Must Be Chosen" Text="*" ControlToValidate="SalesDropDownList">
                                </asp:CustomValidator>
                            </td>
                            <td>
                            </td>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="CustomerCustomValidator" runat="server" ClientValidationFunction="DropDownValidation"
                                    ErrorMessage="Bank Payment Code Must Be Chosen" Text="*" ControlToValidate="BankPaymentCodeDropDownList">
                                </asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
