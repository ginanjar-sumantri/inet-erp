<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="BillingInvoiceEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.BillingInvoice.BillingInvoiceEdit" %>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td style="width: 110px" align="center">
                                            <asp:TextBox ID="AmountBaseTextBox" runat="server" MaxLength="23" Width="100" BackColor="#CCCCCC">
                                            </asp:TextBox>
                                        </td>
                                        <td style="width: 110px" align="center">
                                        ...
                                        <td style="width: 110px" align="center">
                                            <asp:TextBox ID="PPNForexTextBox" runat="server" MaxLength="23" Width="100" BackColor="#CCCCCC">
                                            </asp:TextBox>
                                        </td>
                                        <td style="width: 110px" align="center">
                                        ...
                                        <td style="width: 110px" align="center">
                                            <asp:TextBox ID="TotalForexTextBox" runat="server" MaxLength="23" Width="100px" BackColor="#CCCCCC">
                                            </asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
