<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="BillingInvoiceDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.BillingInvoice.BillingInvoiceDetail" %>
                                ...
                                <td>
                                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="PeriodTextBox" Width="50" BackColor="#CCCCCC" ReadOnly="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="left">
                                                        <asp:Literal runat="server" ID="CustBillDescLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="left">
