...
{
    public partial class BillingInvoiceDetailAdd : BillingInvoiceBase
    {
        ...
        protected void ClearData()
        {
            ...
            //this.SubledDropDownList.Items.Clear();
            //this.SubledDropDownList.Items.Insert(0, new ListItem("[Choose One]", "null"));
            this.CustomerBillAccountDropDownList.SelectedValue = "null";
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Billing_InvoiceDt _invoiceDt = new Billing_InvoiceDt();
            Master_CustBillAccount _custBillAccount = this._custBillAccountBL.GetSingleCustBillAccount(new Guid(this.CustomerBillAccountDropDownList.SelectedValue));

            _invoiceDt.InvoiceDt = Guid.NewGuid();
            _invoiceDt.InvoiceHd = new Guid(_invoiceHd);
            ...
            bool _result = this._billingInvoiceBL.AddBillingInvoiceDt(_invoiceDt);
