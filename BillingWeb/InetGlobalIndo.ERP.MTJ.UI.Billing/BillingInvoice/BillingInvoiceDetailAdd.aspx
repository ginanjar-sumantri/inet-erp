<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="BillingInvoiceDetailAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.BillingInvoice.BillingInvoiceDetailAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="CustomerBillDescriptionTextBox" MaxLength="200" Width="560"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
