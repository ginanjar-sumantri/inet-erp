<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustomerInvoiceAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.CustomerInvoice.CustomerInvoiceAdd" %>
                    ...
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="TypeCustomValidator" runat="server" ClientValidationFunction="DropDownValidation"
                                    ErrorMessage="Type Must Be Filled" Text="*" ControlToValidate="TypeDropDownList">
                                </asp:CustomValidator>
                            </td>
                        </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                <td style="width: 110px" align="center">
                                                    <asp:TextBox ID="CurrTextBox" runat="server" Width="100" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                                </td>
                                                <td style="width: 110px" align="center">
