...
namespace InetGlobalIndo.ERP.MTJ.UI.Billing.CustomerInvoice
{
    public partial class CustomerInvoice : CustomerInvoiceBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._customerInvoiceBL.RowsCountCustomerInvoiceHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._customerInvoiceBL.GetListCustomerInvoiceHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Billing_CustomerInvoiceHd _temp = (Billing_CustomerInvoiceHd)e.Item.DataItem;
                string _code = _temp.CustomerInvoiceHdCode.ToString();
                ...
                var _tempCommissionExpense = Convert.ToDecimal((_temp.CommissionExpense == null) ? 0 : _temp.CommissionExpense);
                Literal _commissionLiteral = (Literal)e.Item.FindControl("CommissionLiteral");
                _commissionLiteral.Text = (_tempCommissionExpense == 0) ? "0" : _tempCommissionExpense.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._customerInvoiceBL.DeleteMultiCustomerInvoiceHd(_tempSplit);
