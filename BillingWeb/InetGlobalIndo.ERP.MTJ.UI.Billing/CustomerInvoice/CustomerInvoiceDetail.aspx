<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustomerInvoiceDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.CustomerInvoice.CustomerInvoiceDetail" %>
                                ...
                                <td>
                                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="PeriodTextBox" Width="100" BackColor="#CCCCCC" ReadOnly="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="YearTextBox" Width="50" BackColor="#CCCCCC" ReadOnly="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="AttnTextBox" Width="280" MaxLength="40" BackColor="#CCCCCC"
                                                    ReadOnly="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td style="width: 110px" align="center">
                                                            <asp:TextBox ID="CommissionExpenseTextBox" runat="server" Width="100" BackColor="#CCCCCC"
                                                                ReadOnly="true">
                                                            </asp:TextBox>
                                                        </td>
                                                        <td style="width: 110px" align="center">
                                    ...
                                    <table cellpadding="3" cellspacing="0" border="0" width="0">
                                        <tr>
                                            <td>
                                                ...
                                                <%--</td>
                                                <td>--%>
                                                &nbsp;<asp:ImageButton ID="TaxPreviewButton" runat="server" OnClick="TaxPreviewButton_Click" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:DropDownList ID="PrintPreviewDropDownList" runat="server">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="left">
                                                        <asp:Literal runat="server" ID="CustInvoiceDescLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="right">
