<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="GenerateBillingInvoice.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.GenerateBillingInvoice.GenerateBillingInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="DefaultBodyContentPlaceHolder" runat="Server">
    <asp:Panel runat="server" ID="Panel1" DefaultButton="GenerateButton">
            ...
            <tr>
                <td>
                    <table cellpadding="3" cellspacing="0" border="0" width="0">
                        <tr>
                            <td>
                                <asp:ImageButton ID="GenerateButton" runat="server" OnClick="GenerateButton_Click" />
                            </td>
                            <td>
