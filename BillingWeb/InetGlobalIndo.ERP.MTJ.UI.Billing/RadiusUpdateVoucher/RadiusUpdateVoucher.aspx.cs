...
{
    public partial class RadiusUpdateVoucher : RadiusUpdateVoucherBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._radiusUpdateVoucherBL.RowsCountRadiusUpdateVoucher(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        {
            //this.GetFormatExcelLiteral.Text = "<a href='" + ApplicationConfig.BillingFormatVirDirPath + "RadiusUpdateVoucher.xls'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download_excel.jpg" + "' border='0'>" + "</a>";
            ...
            {
                this.ListRepeater.DataSource = this._radiusUpdateVoucherBL.GetListRadiusUpdateVoucher(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                BILTrRadiusUpdateVoucher _temp = (BILTrRadiusUpdateVoucher)e.Item.DataItem;
                ...
                if (_temp.Status != RadiusUpdateVoucherDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(RadiusUpdateVoucherDataMapper.GetStatusText(_temp.Status));

                Literal _radiusLiteral = (Literal)e.Item.FindControl("RadiusLiteral");
                _radiusLiteral.Text = HttpUtility.HtmlEncode(this._radiusBL.GetRadiusNameByCode(_temp.RadiusCode));

                Literal _seriesNoFromLiteral = (Literal)e.Item.FindControl("SeriesNoFromLiteral");
                _seriesNoFromLiteral.Text = HttpUtility.HtmlEncode(_temp.SerialNoFrom);

                Literal _seriesNoToLiteral = (Literal)e.Item.FindControl("SeriesNoToLiteral");
                _seriesNoToLiteral.Text = HttpUtility.HtmlEncode(_temp.SerialNoTo);

                Literal _sellAmountLiteral = (Literal)e.Item.FindControl("SellingAmountLiteral");
                _sellAmountLiteral.Text = HttpUtility.HtmlEncode((_temp.SellingAmount == null) ? "0" : Convert.ToDecimal(_temp.SellingAmount).ToString("#,##0"));

                Literal _expTimeLiteral = (Literal)e.Item.FindControl("ExpiredTimeLiteral");
                _expTimeLiteral.Text = HttpUtility.HtmlEncode((_temp.ExpireTime == null) ? "0" : Convert.ToInt32(_temp.ExpireTime).ToString("#,##0"));

                Literal _sellAmountUnitLiteral = (Literal)e.Item.FindControl("ExpiredTimeUnitLiteral");
                _sellAmountUnitLiteral.Text = HttpUtility.HtmlEncode(RadiusUpdateVoucherDataMapper.GetExpiredTimeUnitText(Convert.ToInt32(_temp.ExpireTimeUnit)));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._radiusUpdateVoucherBL.DeleteMultiRadiusUpdateVoucher(_tempSplit);
