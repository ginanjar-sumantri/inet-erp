<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PreviewTaxBillingInvoice.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.PreviewTaxBillingInvoice.PreviewTaxBillingInvoice" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="CurrencyDropDownList">
                                    ...
                                    <asp:ListItem Text="HomeCurrency" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="ForexCurrency" Value="1"></asp:ListItem>
                                </asp:DropDownList>
