...
{
    public partial class PreviewTaxBillingInvoice : PreviewTaxBillingInvoiceBase
    {
        ...
        private string _reportPath1 = "PreviewTaxBillingInvoice/PreviewTaxBillingInvoice.rdlc";
        private string _reportPath2 = "PreviewTaxBillingInvoice/PreviewTaxBillingInvoiceForexCurrency.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PreviewButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/tax_preview.jpg";
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            int _statusCurrency = Convert.ToInt16(this.CurrencyDropDownList.SelectedValue);
            ...
            ReportDataSource _reportDataSource1 = this._reportBillingBL.PreviewTaxBillingInvoice(Convert.ToInt32(this.PeriodTextBox.Text), Convert.ToInt32(this.YearTextBox.Text), _tempCustomerGroup, _tempCustomerType, _tempCustomer, _statusCurrency);

            this.ReportViewer1.LocalReport.DataSources.Clear();
            this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);
            if (_statusCurrency == 0)
            {
                this.ReportViewer1.LocalReport.ReportPath = Request.ServerVariables["APPL_PHYSICAL_PATH"] + _reportPath1;
            }
            else if (_statusCurrency == 1)
            {
            ...
            _reportParam[5] = new ReportParameter("StatusCurrCode", this.CurrencyDropDownList.SelectedValue, true);
            _reportParam[6] = new ReportParameter("CompanyName", new UserBL().ConnectionCompany(HttpContext.Current.User.Identity.Name));
            _reportParam[7] = new ReportParameter("CompanyAddress", new UserBL().CompanyAddress(HttpContext.Current.User.Identity.Name));
            _reportParam[8] = new ReportParameter("NPWP", _companyConfig.SetValue, true);
