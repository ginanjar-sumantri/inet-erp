...
{
    public partial class GenerateVoucher : GenerateVoucherBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._generateVoucherBL.RowCountVoucherGenerator(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._generateVoucherBL.GetListTrGenerateCard(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                BILTrGenerateCard _temp = (BILTrGenerateCard)e.Item.DataItem;
                ...
                Literal _seriesLiteral = (Literal)e.Item.FindControl("SeriesLiteral");
                _seriesLiteral.Text = HttpUtility.HtmlEncode(_temp.Series);
                ...
                _transDateLiteral.Text = HttpUtility.HtmlEncode(_temp.TransDate.ToString());

                Literal _expireDateLiteral = (Literal)e.Item.FindControl("ExpireDateLiteral");
                _expireDateLiteral.Text = HttpUtility.HtmlEncode(_temp.ExpiredDate.ToString());

                Literal _cardValueLiteral = (Literal)e.Item.FindControl("CardValueLiteral");
                _cardValueLiteral.Text = _temp.CardValue.ToString();

                Literal _produceQtyLiteral = (Literal)e.Item.FindControl("ProduceQtyLiteral");
                _produceQtyLiteral.Text = _temp.ProduceQty.ToString();
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._generateVoucherBL.DeleteMultiBilTrGenerateCard(_tempSplit);
