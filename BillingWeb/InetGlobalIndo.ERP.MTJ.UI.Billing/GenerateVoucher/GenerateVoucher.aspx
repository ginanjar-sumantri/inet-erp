<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="GenerateVoucher.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.GenerateVoucher.GenerateVoucher" %>
                        ...
                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                            <ItemTemplate>
                                <tr id="RepeaterItemTemplate" runat="server">
                                    ...
                                    <td align="left">
                                        <asp:Literal runat="server" ID="SeriesLiteral"></asp:Literal>
                                    </td>
                                    <td align="center">
                                    ...
                                    <td align="center">
                                        <asp:Literal runat="server" ID="CardValueLiteral"></asp:Literal>
                                    </td>
                                    <td align="center">
                                        <asp:Literal runat="server" ID="ProduceQtyLiteral"></asp:Literal>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
