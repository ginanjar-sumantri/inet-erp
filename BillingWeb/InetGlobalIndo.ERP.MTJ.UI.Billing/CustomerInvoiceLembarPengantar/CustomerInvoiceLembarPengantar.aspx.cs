...
{
    public partial class CustomerInvoiceLembarPengantar : CustomerInvoiceLembarPengantarBase
    {
        private CustomerBL _customerBL = new CustomerBL();
        private ReportBillingBL _reportBillingBL = new ReportBillingBL();
        private PermissionBL _permBL = new PermissionBL();

        private string _reportPath1 = "CustomerInvoiceLembarPengantar/CustomerInvoiceLembarPengantar.rdlc";
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBillingBL.CustomerInvoiceLembarPengantar(Convert.ToInt32(this.PeriodTextBox.Text), Convert.ToInt32(this.YearTextBox.Text), _tempCustomerGroup, _tempCustomerType, _tempCustomer);
