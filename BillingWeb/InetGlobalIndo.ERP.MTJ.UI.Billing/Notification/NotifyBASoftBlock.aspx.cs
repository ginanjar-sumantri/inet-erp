...
{
    public partial class BASoftBlock : NotifyBase
    {
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDBASoftBlock, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PageTitleLiteral.Text = this._pageTitleBASoftBlockLiteral;
        ...
        private double RowCount()
        {
            ...
            _result = this._notificationBL.RowsCountBASoftBlock(DateFormMapper.GetValue(this.DateTextBox.Text), this.BlockStatusDropDownList.SelectedValue);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this._permView = this._permBL.PermissionValidation1(this._menuIDBASoftBlock, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.View);
            ...
            {
                this.ListRepeater.DataSource = this._notificationBL.GetListBASoftBlock(_prmCurrentPage, _maxrow, DateFormMapper.GetValue(this.DateTextBox.Text), this.BlockStatusDropDownList.SelectedValue);
            }
            this.ListRepeater.DataBind();

            this.AllHidden.Value = this._notificationBL.GetListBASoftBlock(DateFormMapper.GetValue(this.DateTextBox.Text), this.BlockStatusDropDownList.SelectedValue);
        ...
        protected void SendEmailImageButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                _result = _notificationBL.SendEmail(this.CheckHidden.Value, EmailNotificationID.BASoftBlock);
            }
            else
            {
                _result = _notificationBL.SendEmail(this.AllHidden.Value, EmailNotificationID.BASoftBlock);
            }
