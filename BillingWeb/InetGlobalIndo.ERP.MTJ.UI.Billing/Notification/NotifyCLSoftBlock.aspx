<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="NotifyCLSoftBlock.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.Notification.CLSoftBlock" %>
    ...
    <asp:Panel runat="server" ID="Panel1">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <asp:UpdatePanel ID="BlockStatusUpdatePanel" runat="server">
                                                            <ContentTemplate>
                                                                <asp:DropDownList ID="BlockStatusDropDownList" runat="server" AutoPostBack="true"
                                                                    OnSelectedIndexChanged="BlockStatusDropDownList_SelectedIndexChanged">
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <table cellpadding="3" cellspacing="1" width="0" border="0">
                                                        <tr class="bgcolor_gray">
                                                            ...
                                                            <td style="width: 220px" class="tahoma_11_white" align="center">
                                                                <b>Remark</b>
                                                            </td>
        ...
        <asp:UpdatePanel runat="server" ID="TriggerUpdatePanel">
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="BlockStatusDropDownList" EventName="SelectedIndexChanged" />
            </Triggers>
        </asp:UpdatePanel>
    </asp:Panel>
</asp:Content>
