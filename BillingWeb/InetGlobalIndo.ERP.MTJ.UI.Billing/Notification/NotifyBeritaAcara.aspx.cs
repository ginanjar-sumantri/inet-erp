...
{
    public partial class NotifyBeritaAcara : NotifyBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.PageTitleLiteral.Text = this._pageTitleNotifyBeritaAcaraNotApprovedLiteral;
        ...
        private double RowCount()
        {
            ...
            _result = this._notificationBL.RowsCountBANotYetApproved(DateFormMapper.GetValue(this.DateTextBox.Text), this.PendingStatusDropDownList.SelectedValue);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this._permView = this._permBL.PermissionValidation1(this._menuIDBeritaAcara, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.View);
            ...
            {
                this.ListRepeater.DataSource = this._notificationBL.GetListBANotYetApproved(_prmCurrentPage, _maxrow, DateFormMapper.GetValue(this.DateTextBox.Text), this.PendingStatusDropDownList.SelectedValue);
            }
            this.ListRepeater.DataBind();

            this.AllHidden.Value = this._notificationBL.GetListBANotYetApproved(DateFormMapper.GetValue(this.DateTextBox.Text), this.PendingStatusDropDownList.SelectedValue);
