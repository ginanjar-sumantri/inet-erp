<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="NotifyPembayaranOpenSoftBlock.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.Notification.NotifyPembayaranOpenSoftBlock" %>
                                                    ...
                                                    <table cellpadding="3" cellspacing="1" width="0" border="0">
                                                        ...
                                                        <asp:Repeater ID="ListRepeater" runat="server" OnItemDataBound="ListRepeater_ItemDataBound">
                                                            <ItemTemplate>
                                                                <tr id="RepeaterItemTemplate" runat="server">
                                                                    ...
                                                                    <td align="left">
                                                                        <asp:Literal ID="CustomerEmailLiteral" runat="server"></asp:Literal>
                                                                    </td>
                                                                    <td align="left">
                                                        ...
                                                        <tr>
                                                            <td colspan="9">
                                                                ...
                                                                &nbsp;
                                                                <asp:ImageButton ID="SendEmailInternalImageButton" runat="server" OnClick="SendEmailInternalImageButton_Click" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ContentTemplate>
