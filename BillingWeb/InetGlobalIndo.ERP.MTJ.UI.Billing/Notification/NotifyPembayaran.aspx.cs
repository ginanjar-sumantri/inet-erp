...
{
    public partial class NotifyPembayaran : NotifyBase
    {
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPayment, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PageTitleLiteral.Text = this._pageTitlePembayaranLiteral;
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this._permView = this._permBL.PermissionValidation1(this._menuIDPayment, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.View);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                Literal _contactEmailLiteral = (Literal)e.Item.FindControl("EmailLiteral");
                _contactEmailLiteral.Text = HttpUtility.HtmlEncode(_temp.Email);
        ...
        protected void SendEmailImageButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                _result = _notificationBL.SendEmail(this.CheckHidden.Value, EmailNotificationID.NotPay, DateFormMapper.GetValue(this.DateTextBox.Text));
            }
            else
            {
                _result = _notificationBL.SendEmail(this.AllHidden.Value, EmailNotificationID.NotPay, DateFormMapper.GetValue(this.DateTextBox.Text));
            }
