...
{
    public partial class CLSoftBlock : NotifyBase
    {
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDCLSoftBlock, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PageTitleLiteral.Text = this._pageTitleContractSoftBlockLiteral;
        ...
        private double RowCount()
        {
            ...
            _result = this._notificationBL.RowsCountCLSoftBlock(DateFormMapper.GetValue(this.DateTextBox.Text), this.BlockStatusDropDownList.SelectedValue);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                Literal _notifyLiteral = (Literal)e.Item.FindControl("FgNotifyLiteral");
                _notifyLiteral.Text = HttpUtility.HtmlEncode(SalesConfirmationDataMapper.GetTrueFalse(_temp.FgNotify));
            }
        }
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this._permView = this._permBL.PermissionValidation1(this._menuIDCLSoftBlock, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.View);
            ...
            {
                this.ListRepeater.DataSource = this._notificationBL.GetListCLSoftBlock(_prmCurrentPage, _maxrow, DateFormMapper.GetValue(this.DateTextBox.Text), this.BlockStatusDropDownList.SelectedValue);
            }
            this.ListRepeater.DataBind();

            this.AllHidden.Value = this._notificationBL.GetListCLSoftBlock(DateFormMapper.GetValue(this.DateTextBox.Text), this.BlockStatusDropDownList.SelectedValue);
        ...
        protected void BlockStatusDropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.ShowData(0);
        }
        ...
        protected void SendEmailImageButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                _result = _notificationBL.SendEmail(this.CheckHidden.Value, EmailNotificationID.CLSoftBlock);
            }
            else
            {
                _result = _notificationBL.SendEmail(this.AllHidden.Value, EmailNotificationID.CLSoftBlock);
            }
