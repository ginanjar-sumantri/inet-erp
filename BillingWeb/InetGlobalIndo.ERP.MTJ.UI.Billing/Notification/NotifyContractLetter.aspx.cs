...
{
    public partial class NotifyContractLetter : NotifyBase
    {
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDCL, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PageTitleLiteral.Text = this._pageTitleNotifyContractLetterLiteral;
        ...
        private double RowCount()
        {
            ...
            _result = this._notificationBL.RowsCountCLNotYetApproved(DateFormMapper.GetValue(this.DateTextBox.Text), this.PendingStatusDropDownList.SelectedValue, EmailNotificationID.ContractLetterNotYetApproved);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this._permView = this._permBL.PermissionValidation1(this._menuIDCL, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.View);
            ...
            {
                this.ListRepeater.DataSource = this._notificationBL.GetListCLNotYetApproved(_prmCurrentPage, _maxrow, DateFormMapper.GetValue(this.DateTextBox.Text), this.PendingStatusDropDownList.SelectedValue, EmailNotificationID.ContractLetterNotYetApproved);
            }
            this.ListRepeater.DataBind();

            this.AllHidden.Value = this._notificationBL.GetListCLNotYetApproved(DateFormMapper.GetValue(this.DateTextBox.Text), this.PendingStatusDropDownList.SelectedValue, EmailNotificationID.ContractLetterNotYetApproved);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                _notifyLiteral.Text = HttpUtility.HtmlEncode(SalesConfirmationDataMapper.GetTrueFalse(_temp.FgNotifiedCL));
            }
        }
