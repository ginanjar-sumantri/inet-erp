<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SalesConfirmation.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.Report.SalesConfirmation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="DefaultBodyContentPlaceHolder" runat="Server">
    <table cellpadding="3" cellspacing="0" width="100%" border="0">
                            ...
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    <tr valign="top">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="SalesConfirmationDDL" runat="server">
                                                <asp:ListItem Value="0" Text="Sales Confirmation Posting"></asp:ListItem>
                                                <asp:ListItem Value="1" Text="Sales Confirmation group by sales"></asp:ListItem>
                                                <asp:ListItem Value="2" Text="Sales Confirmation Have Not Contract"></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
        ...
        <tr id="ReportTr" runat ="server" visible ="false" style="background-color :White">
            <td>
                <%--  <asp:Panel ID="Panel3" runat="server" BackColor="White" Visible="false">
                    <table cellpadding="3" cellspacing="0" width="100%" border="0">
                        <tr>
                            <td>--%>
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" ShowPrintButton="true"
                    ShowZoomControl="true" ZoomMode="Percent" Visible ="false" ZoomPercent="100" BackColor="White">
                </rsweb:ReportViewer>
                <%--</td>
                        </tr>
                    </table>
