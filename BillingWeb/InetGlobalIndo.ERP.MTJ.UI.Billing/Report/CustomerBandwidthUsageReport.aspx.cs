...
namespace InetGlobalIndo.ERP.MTJ.UI.Billing.Report
{
    public partial class CustomerBillingAccountReport : ReportBillingBase
    {
        ...
        private string _reportPath0 = "Report/CustomerBandwidthUsageReport.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDCustomerBandwidthUsage, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PageTitleLiteral.Text = "Customer Bandwidth Usage Report";
        ...
        {
            this._permView = this._permBL.PermissionValidation1(this._menuIDCustomerBandwidthUsage, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.View);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBillingBL.CustomerBandwitdhUsage(_custGroupCode, _custTypeCode);
            ...
            _reportParam[1] = new ReportParameter("CustGroup", _custGroupCode, false);
            _reportParam[2] = new ReportParameter("CustType", _custTypeCode, false);
            _reportParam[3] = new ReportParameter("Type", this.TypeDDL.SelectedValue, false);
