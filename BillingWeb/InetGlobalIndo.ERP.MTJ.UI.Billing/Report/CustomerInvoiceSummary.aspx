<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustomerInvoiceSummary.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.Report.CustomerInvoiceSummary" %>
                            ...
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td>
                                            <asp:CheckBoxList ID="CustTypeCheckBoxList" runat="server" RepeatDirection="Horizontal"
                                                RepeatColumns="3">
                                            </asp:CheckBoxList>
                                        </td>
                                    </tr>
                                    <tr valign="top">
                                        ...
                                        <td>
                                            <asp:CheckBoxList ID="CustGroupCheckBoxList" runat="server" RepeatDirection="Horizontal"
                                                RepeatColumns="3">
                                            </asp:CheckBoxList>
                                        </td>
                                    </tr>
