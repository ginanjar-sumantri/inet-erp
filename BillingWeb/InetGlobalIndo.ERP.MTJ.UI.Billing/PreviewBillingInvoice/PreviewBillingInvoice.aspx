<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PreviewBillingInvoice.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.PreviewBillingInvoice.PreviewBillingInvoice" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="TypeDropDownList">
                                    <asp:ListItem Text="Indonesia" Value="0"></asp:ListItem>
