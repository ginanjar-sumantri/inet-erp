<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SupplierInvoiceEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.SupplierInvoice.SupplierInvoiceEdit" %>
...
//            var year = currentTime.getFullYear();
            ...
            if(_tempPPNPercent > 0)
            {
                ...
                //_prmPPNDate.value = ( year + "-" + month + "-" + day );
                    ...
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="TransactionNoRequiredFieldValidator" runat="server"
                                    ControlToValidate="TransactionNoTextBox" Display="Dynamic" ErrorMessage="Transaction No Must Be Filled"
                                    Text="*">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="SupplierDropDownList">
                                </asp:DropDownList>
                            ...
                            <ContentTemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox runat="server" ID="ForexRateTextBox" Width="150" MaxLength="23"></asp:TextBox>
                                        ...
                                        <table>
                                            <tr>
                                                <td style="width: 110px" align="center">
                                                    <asp:TextBox ID="PPNPercentTextBox" runat="server" MaxLength="23" Width="100">
                                                    </asp:TextBox>
                                                </td>
                                                <td style="width: 110px" align="center">
                                                ...
                                                <td style="width: 110px" align="center">
                                                    ...
                                                    <input id="ppn_date_start" type="button" style="visibility: hidden;" onclick="displayCalendar(ctl00_DefaultBodyContentPlaceHolder_PPNDateTextBox,'yyyy-mm-dd',this)"
                                                        value="..." />
                                                </td>
                                                <td style="width: 110px" align="center">
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                ...
                                                <td style="width: 110px" align="center">
                                                    <asp:TextBox ID="DiscForexTextBox" runat="server" MaxLength="23" Width="100">
                                                    </asp:TextBox>
                                                </td>
                                                <td style="width: 110px" align="center">
