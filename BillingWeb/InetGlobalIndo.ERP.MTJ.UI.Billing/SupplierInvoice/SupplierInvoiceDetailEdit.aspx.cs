...
{
    public partial class SupplierInvoiceDetailEdit : SupplierInvoiceBase
    {
        ...
        protected void ShowData()
        {
            ...
            this.AccountTextBox.Text = _supplierInvoiceDt.Account;
            this.AccountDropDownList.SelectedValue = _supplierInvoiceDt.Account;
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._supplierInvoiceBL.EditSupplierInvoiceDt(_supplierInvoiceDt);
