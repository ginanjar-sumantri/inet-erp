<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SupplierInvoiceAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Billing.SupplierInvoice.SupplierInvoiceAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="TransactionNoTextBox" Width="200" MaxLength="20"></asp:TextBox>
