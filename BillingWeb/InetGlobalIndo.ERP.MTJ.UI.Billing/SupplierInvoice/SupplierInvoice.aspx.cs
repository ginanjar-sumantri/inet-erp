...
{
    public partial class SupplierInvoice : SupplierInvoiceBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._supplierInvoiceBL.RowsCountSupplierInvoiceHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        //{
        //    double q = this._supplierInvoiceBL.RowsCountSupplierInvoiceHd;
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._supplierInvoiceBL.GetListSupplierInvoiceHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Billing_SupplierInvoiceHd _temp = (Billing_SupplierInvoiceHd)e.Item.DataItem;
                string _code = _temp.SupplierInvoiceHdCode.ToString();
                ...
                _supplierLiteral.Text = HttpUtility.HtmlEncode(_temp.SuppName);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._supplierInvoiceBL.DeleteMultiSupplierInvoiceHd(_tempSplit);
