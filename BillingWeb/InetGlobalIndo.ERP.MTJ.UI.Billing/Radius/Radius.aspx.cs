...
{
    public partial class Radius : RadiusBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._radiusBL.RowsCountBILMsRadius(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._radiusBL.GetListRadius(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                BILMsRadius _msRadius = (BILMsRadius)e.Item.DataItem;
                string _code = _msRadius.RadiusCode.ToString();
                ...
                Literal _radiusNameLiteral = (Literal)e.Item.FindControl("RadiusNameLiteral");
                _radiusNameLiteral.Text = HttpUtility.HtmlEncode(_msRadius.RadiusName);

                Literal _custNameLiteral = (Literal)e.Item.FindControl("CustomerLiteral");
                _custNameLiteral.Text = HttpUtility.HtmlEncode(_msRadius.CustName);

                Literal _custIPLiteral = (Literal)e.Item.FindControl("RadiusIPLiteral");
                _custIPLiteral.Text = HttpUtility.HtmlEncode(_msRadius.RadiusIP);

                Literal _radiusUserNameLiteral = (Literal)e.Item.FindControl("RadiusUserNameLiteral");
                _radiusUserNameLiteral.Text = HttpUtility.HtmlEncode(_msRadius.RadiusUserName);

                Literal _radiusDBNameLiteral = (Literal)e.Item.FindControl("RadiusDBNameLiteral");
                _radiusDBNameLiteral.Text = HttpUtility.HtmlEncode(_msRadius.RadiusDbName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._radiusBL.DeleteMultiRadius(_tempsplit);
