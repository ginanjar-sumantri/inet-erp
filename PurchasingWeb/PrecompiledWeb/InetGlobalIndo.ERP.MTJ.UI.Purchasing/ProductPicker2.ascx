<%@ control language="C#" autoeventwireup="true" inherits="ProductPicker2, App_Web_3ejdezsv" %>
...
<asp:HiddenField ID="productPickerMode" Value="productNonFgConsignment" runat="server" />
<%-- ini untuk MsProduct FgConsignment = false--%>