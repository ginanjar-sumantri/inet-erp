...
{
    public partial class DirectPurchase : DirectPurchaseBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._directPurchaseBL.RowsCountPRCTrDirectPurchaseHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._directPurchaseBL.GetListPRCTrDirectPurchaseHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._directPurchaseBL.GetSinglePRCTrDirectPurchaseHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._directPurchaseBL.DeleteMultiPRCTrDirectPurchaseHd(_tempSplit);
                if (_result == true)
                {
            ...
            //else 
            //{
            //    this.WarningLabel.Text = "Centang yang mau di hapus";
            //}
        }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                PRCTrDirectPurchaseHd _temp = (PRCTrDirectPurchaseHd)e.Item.DataItem;
                ...
                if (_temp.Status != DirectPurchaseDataMapper.GetStatusByte(TransStatus.Posted))
                {
                ...
                _status.Text = DirectPurchaseDataMapper.GetStatusText(_temp.Status);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._directPurchaseBL.DeleteMultiApprovePRCTrDirectPurchaseHd(_tempSplit, AppModule.GetValue(TransactionType.FixedAssetPurchaseOrder), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
