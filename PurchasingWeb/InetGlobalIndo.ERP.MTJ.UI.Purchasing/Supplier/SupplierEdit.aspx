<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SupplierEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.Supplier.SupplierEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="SupplierGroupDropDownList" Width="150" AutoPostBack="True"
                                    OnSelectedIndexChanged="SupplierGroupDropDownList_SelectedIndexChanged">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="RemarkTextBox" Width="300" TextMode="MultiLine" Height="80"></asp:TextBox>
