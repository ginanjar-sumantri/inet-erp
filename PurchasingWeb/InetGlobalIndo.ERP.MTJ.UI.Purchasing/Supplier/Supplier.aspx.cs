    ...
    public partial class Supplier : SupplierBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.GetFormatExcelLiteral.Text = "<a href='" + ApplicationConfig.PurchasingFormatVirDirPath + "Supplier.xls'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download_excel.jpg" + "' border='0'>" + "</a>";
        ...
        private double RowCount()
        {
            ...
            _result = this._supplier.RowsCountSupp(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._supplier.GetListSupp(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        {
            MsSupplier _temp = (MsSupplier)e.Item.DataItem;
            string _code = _temp.SuppCode.ToString();
            ...
            Literal _suppCode = (Literal)e.Item.FindControl("SuppCodeLiteral");
            _suppCode.Text = HttpUtility.HtmlEncode(_temp.SuppCode);

            Literal _suppName = (Literal)e.Item.FindControl("SuppNameLiteral");
            _suppName.Text = HttpUtility.HtmlEncode(_temp.SuppName);

            Literal _suppType = (Literal)e.Item.FindControl("SuppTypeLiteral");
            _suppType.Text = HttpUtility.HtmlEncode(_temp.SuppTypeName);

            Literal _suppGroup = (Literal)e.Item.FindControl("SuppGroupLiteral");
            _suppGroup.Text = HttpUtility.HtmlEncode(_temp.SuppGroupName);

            Literal _fgActive = (Literal)e.Item.FindControl("FgActiveLiteral");
            _fgActive.Text = HttpUtility.HtmlEncode(SupplierDataMapper.SuppStatusText(_temp.FgActive));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._supplier.DeleteMultiSupp(_tempSplit);
