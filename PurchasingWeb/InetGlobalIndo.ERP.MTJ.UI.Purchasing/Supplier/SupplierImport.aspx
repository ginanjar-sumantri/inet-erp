<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SupplierImport.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.Supplier.SupplierImport" %>
    ...
    <asp:Panel runat="server" ID="LogPanel">
        <table>
            ...
            <tr>
                <td>
                    <fieldset>
                        <legend>Supplier Import Log</legend>
