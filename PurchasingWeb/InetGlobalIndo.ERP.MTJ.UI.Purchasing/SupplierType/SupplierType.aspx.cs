...
namespace InetGlobalIndo.ERP.MTJ.UI.Purchasing.SupplierType
{
    public partial class SupplierType : SupplierTypeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._supplierBL.RowsCountSuppType(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._supplierBL.GetListSuppType(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        {
            MsSuppType _temp = (MsSuppType)e.Item.DataItem;

            string _code = _temp.SuppTypeCode.ToString();
            ...
            Literal _suppTypeCode = (Literal)e.Item.FindControl("SuppTypeCodeLiteral");
            _suppTypeCode.Text = HttpUtility.HtmlEncode(_temp.SuppTypeCode);

            Literal _suppTypeName = (Literal)e.Item.FindControl("SuppTypeNameLiteral");
            _suppTypeName.Text = HttpUtility.HtmlEncode(_temp.SuppTypeName);
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._supplierBL.DeleteMultiSuppType(_tempSplit);
