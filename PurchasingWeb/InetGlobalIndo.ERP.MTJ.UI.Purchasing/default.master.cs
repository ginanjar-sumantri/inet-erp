...
public partial class _default : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.Page.IsPostBack == true)
        {
            ...
            //this.Menu1.Items.Add(_quickLaunchNavMenu.RenderItem(21, AppModule.GetValue(ERPModule.Purchasing), "administrators", null));
            //_quickLaunchNavMenu.Dispose();

            //string _imageUrl = ApplicationConfig.HomeWebAppURL + "images/purchasing_small.jpg";
            //string _titleTree = "&nbsp;Purchasing";
            //QuickLaunchNavigationMenu _quickLaunchNavNode = new QuickLaunchNavigationMenu();
            //this.TreeView1.ShowLines = true;
            //this.TreeView1.Nodes.Add(_quickLaunchNavNode.RenderNode(21, AppModule.GetValue(ERPModule.Purchasing), "administrators", null, _imageUrl, _titleTree));
            //_quickLaunchNavNode.Dispose();

            //string _dir = Request.ServerVariables["APPL_PHYSICAL_PATH"];
            //string _title = "Purchasing";
            //QuickLaunchNavigationMenu _quickLaunchSiteMapPath = new QuickLaunchNavigationMenu();
            //_quickLaunchSiteMapPath.GenerateSiteMapPath(21, AppModule.GetValue(ERPModule.Purchasing), "administrators", null, _dir, _title, 21);
