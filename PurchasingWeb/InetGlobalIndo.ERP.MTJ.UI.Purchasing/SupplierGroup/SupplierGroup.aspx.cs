...
{
    public partial class SupplierGroup : SupplierGroupBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._supplierBL.RowsCountSuppGroup(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._supplierBL.GetListSuppGroup(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        {
            MsSuppGroup _temp = (MsSuppGroup)e.Item.DataItem;

            string _code = _temp.SuppGroupCode.ToString();
            ...
            Literal _suppGroupCode = (Literal)e.Item.FindControl("SuppGroupCodeLiteral");
            _suppGroupCode.Text = HttpUtility.HtmlEncode(_temp.SuppGroupCode);

            Literal _suppGroupName = (Literal)e.Item.FindControl("SuppGroupNameLiteral");
            _suppGroupName.Text = HttpUtility.HtmlEncode(_temp.SuppGroupName);

            Literal _suppGroupAcc = (Literal)e.Item.FindControl("SetSuppGroupAccLiteral");
            _suppGroupAcc.Text = (HttpUtility.HtmlEncode(_temp.SubGroup) == null) ? "False" : "True";
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._supplierBL.DeleteMultiSuppGroup(_tempSplit);
