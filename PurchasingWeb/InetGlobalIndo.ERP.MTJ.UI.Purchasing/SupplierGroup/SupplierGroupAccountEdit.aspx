<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SupplierGroupAccountEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.SupplierGroup.SupplierGroupAccountEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="CurrencyTextBox" runat="server" BackColor="#CCCCCC" 
