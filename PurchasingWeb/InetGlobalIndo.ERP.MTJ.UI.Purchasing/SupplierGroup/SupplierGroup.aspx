<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SupplierGroup.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.SupplierGroup.SupplierGroup" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Supplier Group Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Supplier Group Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 150px" class="tahoma_11_white" align="center">
                                            <b>Supplier Group Code</b>
                                        </td>
                                        <td style="width: 200px" class="tahoma_11_white" align="center">
                                            <b>Supplier Group Name</b>
                                        </td>
                                        <td style="width: 200px" class="tahoma_11_white" align="center">
                                            <b>Set Supplier Group Account</b>
                                        </td>
                                    </tr>
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="SuppGroupCodeLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="SuppGroupNameLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="SetSuppGroupAccLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
