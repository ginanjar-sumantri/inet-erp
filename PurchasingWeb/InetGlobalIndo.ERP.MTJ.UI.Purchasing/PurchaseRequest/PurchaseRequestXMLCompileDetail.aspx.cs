...
{
    public partial class PurchaseRequestXMLCompileDetail : PurchaseRequestBase
    {
        ...
        public void ShowData()
        {
            ...
            PRCPRCompilerHd _prcPRCompilerHd = this._purchaseRequestBL.GetSinglePRCPRCompileHd(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));

            _currCode = this._purchaseRequestBL.GetSinglePRCRequestHd(_prcPRCompilerHd.TransNmbr).CurrCode;
            _decimalPlace = this._currencyBL.GetDecimalPlace(_currCode);

            this.TransNoTextBox.Text = _prcPRCompilerHd.TransNmbr;
            this.FileNmbrTextBox.Text = _prcPRCompilerHd.FileNmbr;
            this.DateTextBox.Text = DateFormMapper.GetValue(_prcPRCompilerHd.TransDate);
            this.OrgUnitTextBox.Text = this._organizationStructureBL.GetDescriptionByCode(_prcPRCompilerHd.OrgUnit);
            this.RemarkTextBox.Text = _prcPRCompilerHd.Remark;
            this.StatusLabel.Text = PurchaseRequestDataMapper.GetStatusText(_prcPRCompilerHd.Status);
            this.StatusHiddenField.Value = _prcPRCompilerHd.Status.ToString();
        ...
        //    else
        //    {
        //        if (this.StatusHiddenField.Value.Trim().ToLower() == PurchaseRequestDataMapper.GetNumericStatus(PurchaseRequestStatus.OnHold).ToString().ToLower())
        //        {
        //            this.PreviewButton.Visible = false;
        //        }
        //        else if (this.StatusHiddenField.Value.Trim().ToLower() == PurchaseRequestDataMapper.GetNumericStatus(PurchaseRequestStatus.WaitingForApproval).ToString().ToLower())
        //        {
        //            this.PreviewButton.Visible = false;
        //        }
        //        else if (this.StatusHiddenField.Value.Trim().ToLower() == PurchaseRequestDataMapper.GetNumericStatus(PurchaseRequestStatus.Approved).ToString().ToLower())
        //        {
        //            this.PreviewButton.Visible = true;
        //        }
        //        else if (this.StatusHiddenField.Value.Trim().ToLower() == PurchaseRequestDataMapper.GetNumericStatus(PurchaseRequestStatus.Posted).ToString().ToLower())
        //        {
        //            this.PreviewButton.Visible = true;
        //        }
        //    }
        ...
        private double RowCount()
        {
            ...
            _result = this._purchaseRequestBL.RowsCountPRCPRCompileDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        public void ShowDetail(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._purchaseRequestBL.GetListPRCPRCompileDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                PRCPRCompilerDt _temp = (PRCPRCompilerDt)e.Item.DataItem;
                ...
                Literal _productCodeLiteral = (Literal)e.Item.FindControl("FileNameLiteral");
                _productCodeLiteral.Text = _temp.XMLFileName;

                Literal _productNameLiteral = (Literal)e.Item.FindControl("CustCodeLiteral");
                _productNameLiteral.Text = _temp.CustCode;
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == PurchaseRequestDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._purchaseRequestBL.GetApprovalCompile(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PurchaseRequestDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._purchaseRequestBL.ApproveCompile(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PurchaseRequestDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._purchaseRequestBL.PostingCompile(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == PurchaseRequestDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                string _result = this._purchaseRequestBL.UnPostingCompile(this.TransNoTextBox.Text, HttpContext.Current.User.Identity.Name);
        ...
        {
            Response.Redirect(this._editCompilePage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)));
        }
        ...
        {
            Response.Redirect(this._addCompileDetailPage + "?" + _codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)));
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._purchaseRequestBL.DeleteMultiPRCPRCompileDt(_tempsplit, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
