<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PurchaseRequest.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.PurchaseRequest.PurchaseRequest" %>
                            ...
                            <td>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 80px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Organization Unit" ID="field5" class="SortLinkButton" runat="server"
                                                    OnClick="field5_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 50px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Currency" ID="field6" class="SortLinkButton" runat="server"
                                                    OnClick="field6_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 80px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Request By." ID="field7" class="SortLinkButton" runat="server"
                                                    OnClick="field7_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 100px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Remark" ID="field8" class="SortLinkButton" runat="server" OnClick="field8_Click"></asp:LinkButton></b>
                                        </td>
                                    </tr>
