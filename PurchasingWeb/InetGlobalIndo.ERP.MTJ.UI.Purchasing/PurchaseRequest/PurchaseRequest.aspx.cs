...
{
    public partial class PurchaseRequest : PurchaseRequestBase
    {
        ...
        #region code_by_oyaman
            ...
            {
                if (this.sortField.Value == "Organization Unit")
                {
                    if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                        this.ascDesc.Value = "true";
                    else
                ...
                {
                    this.sortField.Value = "Organization Unit";
                    this.ascDesc.Value = "true";
                }
                this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
            }
            ...
            {
                if (this.sortField.Value == "Request By.")
                {
                    if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                        this.ascDesc.Value = "true";
                    else
                ...
                {
                    this.sortField.Value = "Request By.";
                    this.ascDesc.Value = "true";
                }
                this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
            }
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._purchaseRequestBL.GetListPRCRequestHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                else
                {
                    ...
                    if (_tempStatus.ToLower() == PurchaseRequestDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
                    {
                        _editButton.Visible = false;
                    }
                    else
                ...
                _orgUnitDescLiteral.Text = HttpUtility.HtmlEncode(_temp.OrgUnit);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._purchaseRequestBL.GetSinglePRCRequestHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._purchaseRequestBL.DeleteMultiPRCRequestHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._purchaseRequestBL.DeleteMultiApprovePRCRequestHd(_tempSplit, AppModule.GetValue(TransactionType.PurchaseRequest), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
