...
{
    public partial class PurchaseRequestPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseRequestPerProductSummary.rdlc";
        private string _reportPath1 = "Report/PurchaseRequestPerProductDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseRequestPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Request Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PurchaseRequestPerProduct(_startDateTime, _endDateTime, _productSubGroupCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
