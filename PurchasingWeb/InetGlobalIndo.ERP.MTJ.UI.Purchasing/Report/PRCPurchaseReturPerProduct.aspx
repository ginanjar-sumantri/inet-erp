<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PRCPurchaseReturPerProduct.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.Report.PRCPurchaseReturPerProduct" %>
                ...
                <asp:Panel runat="server" ID="MenuPanel">
                    <table cellpadding="3" cellspacing="0" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                    ...
                                    <asp:ListItem Value="0">Summary Product</asp:ListItem>
                                    <asp:ListItem Value="1">Summary Supplier</asp:ListItem>
                                    <asp:ListItem Value="2">Summary Transaction</asp:ListItem>
                                    <asp:ListItem Value="3">Detail Supplier</asp:ListItem>
                                    <asp:ListItem Value="4">Detail Warehouse</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr>
                            <td colspan="3">
                                <fieldset>
                                    <legend>Filter Criteria by Warehouse</legend>
                                    <table>
                                        <tr>
                                            <td width="112px">
                                                Warehouse Group
