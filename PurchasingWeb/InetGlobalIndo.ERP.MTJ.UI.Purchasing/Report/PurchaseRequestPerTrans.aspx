<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PurchaseRequestPerTrans.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.Report.PurchaseRequestPerTrans" %>
                    ...
                    <asp:Panel runat="server" ID="MenuPanel">
                        <table cellpadding="3" cellspacing="0" width="100%" border="0">
                            ...
                            <%--<tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ParentOrgUnitDDL" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ParentOrgUnitDDL_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                            </tr>--%>
                            <tr>
                                <td colspan="3">
                                    <fieldset>
                                        <legend>Filter Criteria by Organization Unit</legend>
                                        <table>
                                            <tr>
                                                <td width="112px">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:CheckBoxList ID="OrgUnitCheckBoxList" runat="server" RepeatColumns="3">
                                                    </asp:CheckBoxList>
                                                </td>
                                            </tr>
                                        </table>
