...
{
    public partial class PurchaseCostPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseCostPerTransSummary.rdlc";
        private string _reportPath1 = "Report/PurchaseCostPerTransDetail.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Cost Per Transaction Report";
