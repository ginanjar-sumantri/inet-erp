<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PurchaseOrderPerTrans.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.Report.PurchaseOrderPerTrans" %>
                    ...
                    <asp:Panel runat="server" ID="MenuPanel">
                        <table cellpadding="3" cellspacing="0" width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="SelectDropDownList" runat="server" AutoPostBack ="true"
                                        onselectedindexchanged="SelectDropDownList_SelectedIndexChanged">
