...
{
    public partial class PurchaseCostSummaryPerSupplier : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseCostSummaryPerSupplier.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseCostSummaryPerSupp, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Cost Summary Per Supplier Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.PurchaseCostSummaryPerSupp(_start, _end, _suppCode, Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
