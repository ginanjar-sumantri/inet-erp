...
{
    public partial class ProgressRequestReceiveDetail : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ProgressRequestReceiveDetail.rdlc";
        private string _reportPath1 = "Report/ProgressRequestReceiveDetailPerProduct.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDProgressRequestReceiveDetail, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Progress Request - Receive Detail Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ProgressRequestReceiveDetail(_startDateTime, _endDateTime, _productSubGroupCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
