...
{
    public partial class ClosingPurchaseRequest : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ClosingPurchaseRequestPerTrans.rdlc";
        private string _reportPath1 = "Report/ClosingPurchaseRequestPerProduct.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDClosingPurchaseRequest, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Closing Purchase Request Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ClosingPurchaseRequest(_startDateTime, _endDateTime, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
