...
{
    public partial class ClosingPurchaseOrder : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ClosingPurchaseOrderPerTrans.rdlc";
        private string _reportPath1 = "Report/ClosingPurchaseOrderPerProduct.rdlc";
        private string _reportPath2 = "Report/ClosingPurchaseOrderPerSupp.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDClosingPurchaseOrder, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Closing Purchase Order Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ClosingPurchaseOrder(_startDateTime, _endDateTime, _suppCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
