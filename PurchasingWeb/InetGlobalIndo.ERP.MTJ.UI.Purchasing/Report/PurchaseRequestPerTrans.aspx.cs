...
{
    public partial class PurchaseRequestPerTrans : ReportBase
    {
        ...
        private string _awal = "ctl00_DefaultBodyContentPlaceHolder_OrgUnitCheckBoxList_";
        private string _akhir = "";
        private string _cbox = "ctl00_DefaultBodyContentPlaceHolder_AllCheckBox";
        private string _tempHidden = "ctl00$DefaultBodyContentPlaceHolder$TempHidden";

        private string _reportPath0 = "Report/PurchaseRequestPerTransSummary.rdlc";
        private string _reportPath1 = "Report/PurchaseRequestPerTransDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseRequestPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Request Per Transaction Report";
        ...
        //private void ShowParentOrgUnit()
        //{
        //    this.ParentOrgUnitDDL.Items.Clear();
        //    this.ParentOrgUnitDDL.DataValueField = "OrgUnit";
        //    this.ParentOrgUnitDDL.DataTextField = "Description";
        //    this.ParentOrgUnitDDL.DataSource = this._orgBL.GetListParentOrganizationUnitForDDL();
        //    this.ParentOrgUnitDDL.DataBind();
        //    this.ParentOrgUnitDDL.Items.Insert(0, new ListItem("[Choose One]", "null"));
        //}

        protected void ShowOrgUnit(Int32 _prmCurrentPage)
        {
            // string _tempParent = (this.ParentOrgUnitDDL.SelectedValue == "null") ? "" : this.ParentOrgUnitDDL.SelectedValue;

            this.OrgUnitCheckBoxList.ClearSelection();
            this.OrgUnitCheckBoxList.Items.Clear();
            //this.OrgUnitCheckBoxList.DataSource = this._orgBL.GetListOrganizationUnitForDDL(_tempParent, _prmCurrentPage, _maxrow);
            this.OrgUnitCheckBoxList.DataSource = this._orgBL.GetListOrganizationUnitForDDL(_prmCurrentPage, _maxrow);
            this.OrgUnitCheckBoxList.DataValueField = "OrgUnit";
            this.OrgUnitCheckBoxList.DataTextField = "Description";
            this.OrgUnitCheckBoxList.DataBind();
            ...
            int i = 0;
            foreach (ListItem _item in this.OrgUnitCheckBoxList.Items)
            {
        ...
        //protected void ParentOrgUnitDDL_SelectedIndexChanged(object sender, EventArgs e)
        //{
        ...
        public void ClearData()
        {
            ...
            //this.ParentOrgUnitDDL.SelectedValue = "null";
            this.OrgUnitCheckBoxList.ClearSelection();
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string _orgUnit = "";
            Int32 _prmCurrentPage = 0;

            //string _tempParent = (this.ParentOrgUnitDDL.SelectedValue == "null") ? "" : this.ParentOrgUnitDDL.SelectedValue;

            //var _hasilOrgUnit = this._orgBL.GetListOrganizationUnitForDDL(_tempParent, _prmCurrentPage, _maxrow);
            var _hasilOrgUnit = this._orgBL.GetListOrganizationUnitForDDL(_prmCurrentPage, _maxrow);

            for (var i = 0; i < _hasilOrgUnit.Count(); i++)
            {
                if (this.OrgUnitCheckBoxList.Items[i].Selected == true)
                {
                    if (_orgUnit == "")
                    {
                        _orgUnit += this.OrgUnitCheckBoxList.Items[i].Value;
                    }
                    else
                    {
                        _orgUnit += "," + this.OrgUnitCheckBoxList.Items[i].Value;
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PurchaseRequestPerTrans(_startDateTime, _endDateTime, _orgUnit, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
            ...
            _reportParam[3] = new ReportParameter("Str1", _orgUnit, true);
        ...
        private double RowCountOrganizationUnit()
        {
            double _result1 = 0;
            //string _tempParent = (this.ParentOrgUnitDDL.SelectedValue == "null") ? "" : this.ParentOrgUnitDDL.SelectedValue;

            //_result1 = this._orgBL.RowsCountOrgUnitReport(_tempParent);
            _result1 = this._orgBL.RowsCountOrgUnitReport();
        ...
        private void ShowPage(Int32 _prmCurrentPage)
        {
            ...
            int i = 0;
            decimal min = 0, max = 0;
            double q = this.RowCountOrganizationUnit();
        ...
        protected void DataPagerTopRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "DataPager")
            {
                ...
                this.ShowOrgUnit(Convert.ToInt32(e.CommandArgument));
                this.SetCheckBox();
            }
        }
        ...
        protected void DataPagerButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (Control _item in this.DataPagerTopRepeater.Controls)
            {
                if (((TextBox)_item.Controls[3]).Text != "")
                {
                    ...
                    if (_reqPage > this.RowCountOrganizationUnit())
                    {
                        ((TextBox)_item.Controls[3]).Text = this.RowCountOrganizationUnit().ToString();
                        _reqPage = Convert.ToInt32(this.RowCountOrganizationUnit()) - 1;
                        break;
                    }
                    else if (_reqPage < 0)
                    {
        ...
        protected void SetCheckAllCheckBox()
        {
            ...
            if (this.OrgUnitCheckBoxList.Items.Count < 1)
            {
                this.AllCheckBox.Checked = false;
            }
        }
