...
{
    public partial class OutstandingPurchaseRequestPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/OutstandingPurchaseRequestPerTrans.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDOutstandingPurchaseRequestPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Outstanding Purchase Request Per Transaction Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.OutstandingPurchaseRequestPerTrans(_startDateTime, _productSubGroupCode, _productCode);
