...
{
    public partial class PurchaseRequestPerProductSubGroup : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseRequestPerProductSubGroupSummary.rdlc";
        private string _reportPath1 = "Report/PurchaseRequestPerProductSubGroupDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseRequestPerProductGroup, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Request Per Product Sub Group Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PurchaseRequestPerProductSubGroup(_startDateTime, _endDateTime, _productSubGroupCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
            ...
            _reportParam[3] = new ReportParameter("Str1", _productSubGroupCode, true);
