<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="OutstandingPurchaseOrderPerSupp.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.Report.OutstandingPurchaseOrderPerSupp" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                        ...
                                        <asp:ListItem Value="1">Detail Product</asp:ListItem>
                                        <asp:ListItem Value="2">Detail Transaction</asp:ListItem>
                                    </asp:DropDownList>
