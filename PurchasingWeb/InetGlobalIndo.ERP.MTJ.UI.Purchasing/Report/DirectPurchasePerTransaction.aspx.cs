...
{
    public partial class DirectPurchasePerTransaction : ReportBase
    {
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDDirectPurchasePerTransaction, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Direct Purchase Report Per Transaction";
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "DPPerTrans";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (_from.Length <= _to.Length)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.DirectPurchaseReportListPerTransaction(_startDateTime, _endDateTime, Convert.ToInt32(this.HeaderReportList1.SelectedIndex), _supplier, _from, _to);
