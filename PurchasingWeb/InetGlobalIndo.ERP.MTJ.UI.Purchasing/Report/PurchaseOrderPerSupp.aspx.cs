...
{
    public partial class PurchaseOrderPerSupp : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseOrderPerSuppSummary.rdlc";
        private string _reportPath1 = "Report/PurchaseOrderPerSuppDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseOrderPerSupp, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Order Per Supplier Report";
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "POPerSupp";
        }
