...
{
    public partial class PurchaseCostPerSupp : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseCostPerSuppSummarySupp.rdlc";
        private string _reportPath1 = "Report/PurchaseCostPerSuppSummaryTrans.rdlc";
        private string _reportPath2 = "Report/PurchaseCostPerSuppDetailTrans.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseCostPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Cost Per Supplier Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PurchaseCostPerTrans(_startDateTime, _endDateTime, _suppCode, _currCode, Convert.ToInt32(this.FgTypeDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
            ...
            _reportParam[4] = new ReportParameter("Str2", _currCode, false);
            _reportParam[5] = new ReportParameter("Str3", "", false);
            _reportParam[6] = new ReportParameter("FgReport", this.FgTypeDropDownList.SelectedValue, true);
