<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PRCPurchaseReturPerWrhs.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.Report.PRCPurchaseReturPerWrhs" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                    ...
                                    <asp:ListItem Value="0">Summary Warehouse</asp:ListItem>
                                    <asp:ListItem Value="1">Summary Product</asp:ListItem>
                                    <asp:ListItem Value="2">Summary Transaction</asp:ListItem>
                                    <asp:ListItem Value="3">Detail Product</asp:ListItem>
                                    <asp:ListItem Value="4">Detail Transaction</asp:ListItem>
                                </asp:DropDownList>
