...
{
    public partial class DirectPurchasePerSupplier : ReportBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Direct Purchase Report Per Spplier";
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "DPPerSupp";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (_from.Length <= _to.Length)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.DirectPurchaseReportListPerSupplier(_startDateTime, _endDateTime, Convert.ToInt32(this.HeaderReportList1.SelectedIndex), _supplier, _from, _to);
