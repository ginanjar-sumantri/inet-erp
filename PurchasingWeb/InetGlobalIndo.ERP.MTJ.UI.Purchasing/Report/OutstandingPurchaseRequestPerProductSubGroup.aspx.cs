...
{
    public partial class OutstandingPurchaseRequestPerProductSubGroup : ReportBase
    {
        ...
        private string _reportPath0 = "Report/OutstandingPurchaseRequestPerProductSubGroupSummary.rdlc";
        private string _reportPath1 = "Report/OutstandingPurchaseRequestPerProductSubGroupDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDOutstandingPurchaseRequestPerProductGroup, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Outstanding Purchase Request Per Product Sub Group Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.OutstandingPurchaseRequestPerProductSubGroup(_startDateTime, _productSubGroupCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
