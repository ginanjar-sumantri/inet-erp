...
{
    public partial class OutstandingPurchaseOrderPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/OutstandingPurchaseOrderPerProductSummary.rdlc";
        private string _reportPath1 = "Report/OutstandingPurchaseOrderPerProductDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDOutstandingPurchaseOrderPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Outstanding Purchase Order Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.OutstandingPurchaseOrderPerProduct(_startDateTime, _suppCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
