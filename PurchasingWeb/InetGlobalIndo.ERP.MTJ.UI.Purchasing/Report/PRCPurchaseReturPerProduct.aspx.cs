...
{
    public partial class PRCPurchaseReturPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PRCPurchaseReturPerProductSummaryProduct.rdlc";
        private string _reportPath1 = "Report/PRCPurchaseReturPerProductSummarySupp.rdlc";
        private string _reportPath2 = "Report/PRCPurchaseReturPerProductSummaryTrans.rdlc";
        private string _reportPath3 = "Report/PRCPurchaseReturPerProductDetailSupp.rdlc";
        private string _reportPath4 = "Report/PRCPurchaseReturPerProductDetailWrhs.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseReturPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Retur Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.PurchaseReturPerProduct(_startDateTime, _endDateTime, _suppCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
