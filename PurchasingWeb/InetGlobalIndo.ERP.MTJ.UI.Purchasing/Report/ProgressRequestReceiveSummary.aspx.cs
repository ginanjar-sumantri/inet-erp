...
{
    public partial class ProgressRequestReceiveSummary : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ProgressRequestReceiveSummaryPerTrans.rdlc";
        private string _reportPath1 = "Report/ProgressRequestReceiveSummaryPerProduct.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDProgressRequestReceiveSummary, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Progress Request - Receive Summary Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ProgressRequestReceiveSummary(_startDateTime, _endDateTime, _productSubGroupCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
            ...
            _reportParam[4] = new ReportParameter("Str2", _productSubGroupCode, true);
