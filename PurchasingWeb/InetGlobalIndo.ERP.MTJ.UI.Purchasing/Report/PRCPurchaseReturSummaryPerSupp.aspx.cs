...
{
    public partial class PRCPurchaseReturSummaryPerSupp : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PRCPurchaseReturSummaryPerSupplierPerSupp.rdlc";
        private string _reportPath1 = "Report/PRCPurchaseReturSummaryPerSupplierPerSuppProd.rdlc";
        private string _reportPath2 = "Report/PRCPurchaseReturSummaryPerSupplierPerProdSupp.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseReturSummaryPerSupp, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                ReportDataSource _reportDataSource1 = this._report.PurchaseReturSummaryPerSupp(_start, _end, _productSubGrpCode, _suppCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
