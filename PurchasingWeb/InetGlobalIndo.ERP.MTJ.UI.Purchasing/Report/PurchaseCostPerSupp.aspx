<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PurchaseCostPerSupp.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.Report.PurchaseCostPerSupp" %>
                    ...
                    <asp:Panel runat="server" ID="MenuPanel">
                        <table cellpadding="3" cellspacing="0" width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="FgTypeDropDownList" runat="server">
                                        ...
                                        <asp:ListItem Text="Summary Supplier" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Summary Transaction" Value="1"></asp:ListItem>
                            ...
                            <tr>
                                <td colspan="3">
                                    <fieldset>
                                        <legend>Filter Criteria by Currency</legend>
                                        <table>
                                            <tr>
