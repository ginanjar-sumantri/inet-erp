...
{
    public partial class PRCPurchaseReturPerSupp : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PRCPurchaseReturPerSuppSummarySupp.rdlc";
        private string _reportPath1 = "Report/PRCPurchaseReturPerSuppSummaryProduct.rdlc";
        private string _reportPath2 = "Report/PRCPurchaseReturPerSuppSummaryTrans.rdlc";
        private string _reportPath3 = "Report/PRCPurchaseReturPerSuppDetailProduct.rdlc";
        private string _reportPath4 = "Report/PRCPurchaseReturPerSuppDetailTrans.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseReturPerSupp, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Retur Per Supplier Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.PurchaseReturPerSupp(_startDateTime, _endDateTime, _suppCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
