...
{
    public partial class PurchaseOrderPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseOrderPerTransSummary.rdlc";
        private string _reportPath1 = "Report/PurchaseOrderPerTransDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseOrderPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Order Per Transaction Report";
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "POPerTrans";
        }
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.PurchaseOrderPerTrans(_startDateTime, _endDateTime, _suppCode, Convert.ToInt32(this.HeaderReportList1.SelectedIndex), Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.SelectDropDownList.SelectedValue), this.SuppCodeFromTextBox.Text, this.SuppCodeToTextBox.Text);
