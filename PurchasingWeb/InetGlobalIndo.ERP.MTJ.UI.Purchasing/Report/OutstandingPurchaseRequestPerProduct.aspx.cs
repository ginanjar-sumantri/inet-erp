...
{
    public partial class OutstandingPurchaseRequestPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/OutstandingPurchaseRequestPerProductSummary.rdlc";
        private string _reportPath1 = "Report/OutstandingPurchaseRequestPerProductDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDOutstandingPurchaseRequestPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Outstanding Purchase Request Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.OutstandingPurchaseRequestPerProduct(_startDateTime, _productSubGroupCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
