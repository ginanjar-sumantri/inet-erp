...
{
    public partial class PRCPurchaseReturPerWrhs : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PRCPurchaseReturPerWrhsSummaryWrhs.rdlc";
        private string _reportPath1 = "Report/PRCPurchaseReturPerWrhsSummaryProduct.rdlc";
        private string _reportPath2 = "Report/PRCPurchaseReturPerWrhsSummaryTrans.rdlc";
        private string _reportPath3 = "Report/PRCPurchaseReturPerWrhsDetailProduct.rdlc";
        private string _reportPath4 = "Report/PRCPurchaseReturPerWrhsDetailTrans.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseReturPerWrhs, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Retur Per Warehouse Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.PurchaseReturPerWrhs(_startDateTime, _endDateTime, _suppCode, _wrhsCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
