...
{
    public partial class PurchaseOrderSummaryPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/PurchaseOrderSummaryPerProductProdQty.rdlc";
        private string _reportPath1 = "Report/PurchaseOrderSummaryPerProductProdGroupQty.rdlc";
        private string _reportPath2 = "Report/PurchaseOrderSummaryPerProductProdSubGroupQty.rdlc";
        private string _reportPath3 = "Report/PurchaseOrderSummaryPerProductProdTypeQty.rdlc";

        private string _reportPath4 = "Report/PurchaseOrderSummaryPerProductProdAmount.rdlc";
        private string _reportPath5 = "Report/PurchaseOrderSummaryPerProductProdGroupAmount.rdlc";
        private string _reportPath6 = "Report/PurchaseOrderSummaryPerProductProdSubGroupAmount.rdlc";
        private string _reportPath7 = "Report/PurchaseOrderSummaryPerProductProdTypeAmount.rdlc";

        private string _reportPath8 = "Report/PurchaseOrderSummaryPerProductProdAmountQty.rdlc";
        private string _reportPath9 = "Report/PurchaseOrderSummaryPerProductProdGroupAmountQty.rdlc";
        private string _reportPath10 = "Report/PurchaseOrderSummaryPerProductProdSubGroupAmountQty.rdlc";
        private string _reportPath11 = "Report/PurchaseOrderSummaryPerProductProdTypeAmountQty.rdlc";
        ...
        private string _awal1 = "ctl00_DefaultBodyContentPlaceHolder_ProductSubGrpCheckBoxList_";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPurchaseOrderSummaryPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Purchase Order Summary Per Product Report";
                ...
                this.SearchImageButton1.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/go.jpg";
            ...
            if (this.HeaderReportList1.SelectedIndex == "-1" || this.HeaderReportList1.SelectedIndex == "0" || this.HeaderReportList1.SelectedIndex == "3" || this.HeaderReportList1.SelectedIndex == "6" || this.HeaderReportList1.SelectedIndex == "9" || this.HeaderReportList1.SelectedIndex == "12")
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "POSummPerProd";
        }

        private void ShowProductSubGrp(Int32 _prmCurrentPage)
        {
            ...
            this.ProductSubGrpCheckBoxList.DataSource = this._productBL.GetListProductSubGroupForDDL(this.CategoryDropDownList1.SelectedValue, this.KeywordTextBox1.Text, _prmCurrentPage, _maxrow);
            this.ProductSubGrpCheckBoxList.DataBind();

            this.AllCheckBox.Attributes.Add("OnClick", "CheckBox_ClickAll(" + this.AllCheckBox1.ClientID + ", " + this.CheckHidden1.ClientID + ", '" + _awal1 + "', '" + _akhir1 + "', '" + _tempHidden1 + "', 'true');");
        ...
        private void ShowSupplier(Int32 _prmCurrentPage)
        {
            ...
            this.SuppCodeCheckBoxList.DataSource = this._suppBL.GetListSuppForReport(_prmCurrentPage, _maxrow, _tempSuppGroup, _tempSuppType, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                //var _hasilProductSubGrp = this._productBL.GetListProductSubGroupForDDL(this.CategoryDropDownList1.SelectedValue, this.KeywordTextBox1.Text, _prmCurrentPage, _maxrow);
                ...
                ReportDataSource _reportDataSource1 = this._report.PurchaseOrderSummaryPerProduct(_start, _end, _productSubGrpCode, _suppCode, Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.HeaderReportList1.SelectedIndex), Convert.ToInt32(this.SelectionDropDownList.SelectedValue), this.SuppCodeFromTextBox.Text, this.SuppCodeToTextBox.Text, this.ProductSubGroupFromTextBox.Text, this.ProductSubGroupToTextBox.Text);
                ...
                _reportParam[2] = new ReportParameter("Str1", _productSubGrpCode, true);
                _reportParam[3] = new ReportParameter("Str2", _suppCode, false);
                ...
                _reportParam[6] = new ReportParameter("Str5", "", false);
                _reportParam[7] = new ReportParameter("FgReport", this.HeaderReportList1.SelectedIndex, true);
                ...
                _reportParam[10] = new ReportParameter("FromProduct", this.SuppCodeFromTextBox.Text, true);
                _reportParam[11] = new ReportParameter("ToProduct", this.SuppCodeToTextBox.Text, true);
                _reportParam[12] = new ReportParameter("FromSuppCode", this.ProductSubGroupFromTextBox.Text, true);
                _reportParam[13] = new ReportParameter("ToSuppCode", this.ProductSubGroupToTextBox.Text, true);
        ...
        private double RowCountSupplier()
        {
            ...
            _result1 = this._suppBL.RowsCountSupplierReport(_tempSuppGroup, _tempSuppType, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private double RowCountProductSubGroup()
        {
            ...
            _result1 = this._productBL.RowsCountProductSubGroup( this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            _result1 = System.Math.Ceiling(_result1 / (double)_maxrow);
