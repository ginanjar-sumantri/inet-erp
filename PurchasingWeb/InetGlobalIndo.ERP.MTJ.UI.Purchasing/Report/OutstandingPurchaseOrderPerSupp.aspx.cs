...
{
    public partial class OutstandingPurchaseOrderPerSupp : ReportBase
    {
        ...
        private string _reportPath0 = "Report/OutstandingPurchaseOrderPerSuppSummaryProduct.rdlc";
        private string _reportPath1 = "Report/OutstandingPurchaseOrderPerSuppDetailProduct.rdlc";
        private string _reportPath2 = "Report/OutstandingPurchaseOrderPerSuppDetailTrans.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDOutstandingPurchaseOrderPerSupp, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Outstanding Purchase Order Per Supplier Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.OutstandingPurchaseOrderPerSupp(_startDateTime, _suppCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
