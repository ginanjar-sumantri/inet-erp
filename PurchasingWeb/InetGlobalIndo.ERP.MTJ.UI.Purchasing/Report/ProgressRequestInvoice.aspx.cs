...
{
    public partial class ProgressRequestInvoice : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ProgressRequestInvoiceQty.rdlc";
        private string _reportPath1 = "Report/ProgressRequestInvoiceAmount.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Progress Request - Invoice Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ProgressRequestInvoice(_startDateTime, _endDateTime, _suppCode);
