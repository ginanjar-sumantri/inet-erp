<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ProgressRequestReceiveSummary.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.Report.ProgressRequestReceiveSummary" %>
                    ...
                    <asp:Panel runat="server" ID="MenuPanel">
                        <table cellpadding="3" cellspacing="0" width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                        ...
                                        <asp:ListItem Value="0">Per Transaction</asp:ListItem>
                                        <asp:ListItem Value="1">Per Product</asp:ListItem>
                                    </asp:DropDownList>
                                    ...
                                    <fieldset>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:CheckBoxList ID="ProductSubGroupCheckBoxList" runat="server" RepeatColumns="3">
                                                    </asp:CheckBoxList>
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <tr>
                                <td colspan="3">
                                    <fieldset>
                                        <legend>Filter Criteria by Product</legend>
                                        <table>
                                            <tr>
                                                <td width="112px">
                                                    Product Sub Group
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:CheckBoxList runat="server" ID="ProductCheckBoxList" RepeatColumns="3">
                                                    </asp:CheckBoxList>
                                                </td>
                                            </tr>
                                        </table>
