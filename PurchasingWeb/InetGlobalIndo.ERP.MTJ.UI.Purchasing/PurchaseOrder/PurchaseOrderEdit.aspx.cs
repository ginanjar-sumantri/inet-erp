...
{
    public partial class PurchaseOrderEdit : PurchaseOrderBase
    {
        ...
        {
            PRCPOHd _prcPOHd = this._purchaseOrderBL.GetSinglePRCPOHd(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), Convert.ToInt32(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeRevisi), ApplicationConfig.EncryptionKey)));
            ...
            this.SupplierTextBox.Text = _prcPOHd.SuppCode;
            this.SupplierLabel.Text = _supplierBL.GetSuppNameByCode(_prcPOHd.SuppCode);
            ...
            this.TermDropDownList.SelectedValue = _prcPOHd.Term;
            this.ShipmentDropDownList.SelectedValue = _prcPOHd.ShipmentType;
            this.ShipmentNameTextBox.Text = _prcPOHd.ShipmentName;
            this.DeliveryDropDownList.SelectedValue = _prcPOHd.Delivery;
            ...
            this.CurrCodeDropDownList.SelectedValue = _prcPOHd.CurrCode;
            ...
            else
            {
                this.ForexRateTextBox.Attributes.Remove("ReadOnly");
                this.ForexRateTextBox.Attributes.Add("style", "background-color:#FFFFFF");
                this.ForexRateTextBox.Text = (_prcPOHd.ForexRate == 0) ? "1" : _prcPOHd.ForexRate.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            }
            ...
            {
                this.ShippingCurrCodeDropDownList.SelectedValue = _prcPOHd.ShippingCurr;
            }
            else
            {
                this.ShippingCurrCodeDropDownList.SelectedValue = "null";
            ...
            decimal _tempShippingForex = Convert.ToDecimal((_prcPOHd.ShippingForex == null) ? 0 : _prcPOHd.ShippingForex);
            decimal _tempShippingRate = Convert.ToDecimal((_prcPOHd.ShippingRate == null) ? 0 : _prcPOHd.ShippingRate);
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._purchaseOrderBL.EditPRCPOHd(_prcPOHd);
