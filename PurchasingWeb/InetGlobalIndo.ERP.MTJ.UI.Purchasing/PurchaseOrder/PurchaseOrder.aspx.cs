...
namespace InetGlobalIndo.ERP.MTJ.UI.Purchasing.PurchaseOrder
{
    public partial class PurchaseOrder : PurchaseOrderBase
    {
        ...
        {
            if (this.sortField.Value == "Total Forex")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Total Forex";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        private double RowCount()
        {
            ...
            _result = this._purchaseOrderBL.RowsCountPRCPOHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._purchaseOrderBL.GetListPRCPOHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                PRCPOHd _temp = (PRCPOHd)e.Item.DataItem;
                ...
                _viewButton.PostBackUrl = this._detailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._codeRevisi + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code2, ApplicationConfig.EncryptionKey));
                ...
                if (_temp.Status != PurchaseOrderDataMapper.GetStatus(TransStatus.Posted))
                {
                    _editButton.PostBackUrl = this._editPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._codeRevisi + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code2, ApplicationConfig.EncryptionKey));
                ...
                //Literal _revisiLiteral = (Literal)e.Item.FindControl("RevisiLiteral");
                //_revisiLiteral.Text = HttpUtility.HtmlEncode(_temp.Revisi.ToString());
                ...
                _statusLiteral.Text = PurchaseOrderDataMapper.GetStatusText(_temp.Status);
                ...
                Literal _supplierLiteral = (Literal)e.Item.FindControl("SupplierLiteral");
                _supplierLiteral.Text = HttpUtility.HtmlEncode(_temp.SupplierName);

                Literal _totalForexLiteral = (Literal)e.Item.FindControl("TotalForexLiteral");
                _totalForexLiteral.Text = (_temp.TotalForex == 0) ? "0" : _temp.TotalForex.ToString("#,###.##");
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._purchaseOrderBL.GetSinglePRCPOHdApprove(_tempSplit);
            if (_ex == true)
            {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._purchaseOrderBL.DeleteMultiApprovePRCPOHd(_tempSplit, AppModule.GetValue(TransactionType.PurchaseOrder), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
