<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PurchaseOrder.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.PurchaseOrder.PurchaseOrder" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    ...
                                                    <asp:ListItem Value="SuppName" Text="Supplier"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 150px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Supplier" ID="field6" class="SortLinkButton" runat="server"
                                                    OnClick="field6_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 80px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Total Forex" ID="field7" class="SortLinkButton" runat="server"
