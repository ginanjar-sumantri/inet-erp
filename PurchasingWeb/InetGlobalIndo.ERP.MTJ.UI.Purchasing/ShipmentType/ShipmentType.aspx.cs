...
{
    public partial class ShipmentType : ShipmentTypeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._shipmentBL.RowsCount;
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._shipmentBL.GetListMasterShipment(_prmCurrentPage, _maxrow);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsShipment _temp = (MsShipment)e.Item.DataItem;

                string _code = _temp.ShipmentCode.ToString();
                ...
                Literal _shipmenCode = (Literal)e.Item.FindControl("ShipmentCodeLiteral");
                _shipmenCode.Text = HttpUtility.HtmlEncode(_temp.ShipmentCode);

                Literal _shipmenName = (Literal)e.Item.FindControl("ShipmentNameLiteral");
                _shipmenName.Text = HttpUtility.HtmlEncode(_temp.ShipmentName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._shipmentBL.DeleteMulti(_tempSplit);
