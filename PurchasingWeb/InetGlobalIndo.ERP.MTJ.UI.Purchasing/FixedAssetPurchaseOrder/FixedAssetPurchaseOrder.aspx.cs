...
{
    public partial class FixedAssetPurchaseOrder : FixedAssetPurchaseOrderBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._faPOBL.RowsCountPRCFAPOHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._faPOBL.GetListPRCFAPOHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                PRCFAPOHd _temp = (PRCFAPOHd)e.Item.DataItem;
                ...
                if (_temp.Status != FixedAssetPurchaseOrderDataMapper.GetStatus(TransStatus.Posted))
                {
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._faPOBL.GetSinglePRCFAPOHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._faPOBL.DeleteMultiPRCFAPOHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._faPOBL.DeleteMultiApprovePRCFAPOHd(_tempSplit, AppModule.GetValue(TransactionType.FixedAssetPurchaseOrder), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
