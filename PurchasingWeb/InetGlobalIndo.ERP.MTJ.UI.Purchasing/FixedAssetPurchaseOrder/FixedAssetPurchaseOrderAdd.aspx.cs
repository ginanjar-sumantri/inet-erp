...
{
    public partial class FixedAssetPurchaseOrderAdd : FixedAssetPurchaseOrderBase
    {
        ...
        {
            PRCFAPOHd _prcFAPOHd = new PRCFAPOHd();
            ...
            _prcFAPOHd.Status = FixedAssetPurchaseOrderDataMapper.GetStatus(TransStatus.OnHold);
            ...
            _prcFAPOHd.CreatedBy = HttpContext.Current.User.Identity.Name;
            _prcFAPOHd.CreatedDate = DateTime.Now;
            ...
            _prcFAPOHd.POType = AppModule.GetValue(TransactionType.PurchaseOrder);
            _prcFAPOHd.DoneInvoice = YesNoDataMapper.GetYesNo(YesNo.No);


            string _result = this._faPOBL.AddPRCFAPOHd(_prcFAPOHd);
