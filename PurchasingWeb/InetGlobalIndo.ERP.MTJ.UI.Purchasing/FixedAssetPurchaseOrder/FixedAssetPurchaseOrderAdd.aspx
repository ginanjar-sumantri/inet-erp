<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FixedAssetPurchaseOrderAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.FixedAssetPurchaseOrder.FixedAssetPurchaseOrderAdd" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <tr>
                                    ...
                                    <td valign="top" rowspan="2">
                                        <asp:TextBox runat="server" ID="RemarkTextBox" Width="300" Height="50" TextMode="MultiLine"></asp:TextBox>
