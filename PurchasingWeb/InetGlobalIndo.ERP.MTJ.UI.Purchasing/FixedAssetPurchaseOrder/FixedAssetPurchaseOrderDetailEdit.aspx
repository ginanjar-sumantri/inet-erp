<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FixedAssetPurchaseOrderDetailEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.FixedAssetPurchaseOrder.FixedAssetPurchaseOrderDetailEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="DefaultHeadContentPlaceHolder" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Calculate(_prmQtyConvertionTextBox, _prmPriceTextBox, _prmAmountTextBox) {
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="FANameTextBox" runat="server" Width="500" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td>
