...
{
    public partial class Delivery : DeliveryTypeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._deliveryBL.RowsCountDelivery;
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._deliveryBL.GetListDelivery(_prmCurrentPage, _maxrow);
            }
        ...
        {
            MsDelivery _temp = (MsDelivery)e.Item.DataItem;

            string _code = _temp.DeliveryCode.ToString();
            ...
            Literal _deliveryCode = (Literal)e.Item.FindControl("DeliveryCodeLiteral");
            _deliveryCode.Text = HttpUtility.HtmlEncode(_temp.DeliveryCode);

            Literal _deliveryName = (Literal)e.Item.FindControl("DeliveryNameLiteral");
            _deliveryName.Text = HttpUtility.HtmlEncode(_temp.DeliveryName);

            Literal _address1 = (Literal)e.Item.FindControl("AddressLiteral");
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._deliveryBL.DeleteMultiDelivery(_tempSplit);
