<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DeliveryType.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Purchasing.DeliveryType.Delivery" %>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="DeliveryCodeLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="DeliveryNameLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
