...
{
    public partial class DeliveryView : DeliveryTypeBase
    {
        private DeliveryBL _delivery = new DeliveryBL();
        ...
        {
            MsDelivery _msDelivery = this._delivery.GetSingleDelivery(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
