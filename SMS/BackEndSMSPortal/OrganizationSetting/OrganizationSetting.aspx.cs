...
{
    public partial class OrganizationSetting : OrganizationSettingBase
    {
        private OrganizationSettingBL _organizationSettingBL = new OrganizationSettingBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._organizationSettingBL.rowCountOrganization(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._organizationSettingBL.getListOrganization(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                Literal _UserLimitLiteral = (Literal)e.Item.FindControl("UserLimitLiteral");
                _UserLimitLiteral.Text = HttpUtility.HtmlEncode(_temp.UserLimit.ToString());

                Literal _MaskingSDLiteral = (Literal)e.Item.FindControl("MaskingSDLiteral");
                _MaskingSDLiteral.Text = HttpUtility.HtmlEncode(_temp.MaskingSD.ToString());
            }
        }
