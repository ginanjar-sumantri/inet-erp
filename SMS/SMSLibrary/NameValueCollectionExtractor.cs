...
{
    public sealed class NameValueCollectionExtractor
    {
        ...
        //public NameValueCollectionExtractor(string _prmKey, NameValueCollection _prmNameValueCollection)
        //{
        //    this._value = this.Find(_prmKey, _prmNameValueCollection);
        //}
