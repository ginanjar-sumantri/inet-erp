...
namespace SMS.SMSWeb.ManageUser
{
    public partial class ManageUserEdit : ManageUserBase//System.Web.UI.Page
    {
        ...
        protected void ShowPage()
        {
            ...
            bool _user = this._manageUserBL.CekhaveUser(Convert.ToInt16(HttpContext.Current.Session["Organization"].ToString()), Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
