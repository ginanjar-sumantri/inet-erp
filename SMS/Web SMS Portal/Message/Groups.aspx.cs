...
{
    public partial class Groups : MessageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.SubPageTitleLiteral.Text = "Group";
        ...
        private double RowCount()
        {
            ...
            _result = this._smsMessageBL.RowsCountPhoneGroup(Session["Organization"].ToString(), Session["UserID"].ToString(), Session["FgWebAdmin"].ToString());
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._smsMessageBL.GetListPhoneGroup(Session["Organization"].ToString(), Session["UserID"].ToString(), Session["FgWebAdmin"].ToString());
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                string _code = _temp.PhoneBookGroup.ToString();
                ...
                _viewButton.PostBackUrl = this._phoneGroupViewPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                _viewButton.ImageUrl = "../images/view.jpg";

                ImageButton _editButton = (ImageButton)e.Item.FindControl("EditButton");
                _editButton.PostBackUrl = this._phoneGroupEditPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                ...
                Literal _phoneGroupLiteral = (Literal)e.Item.FindControl("PhoneBookGroupLiteral");
                _phoneGroupLiteral.Text = HttpUtility.HtmlEncode(_temp.PhoneBookGroup.ToString());
            }
        }

        protected void AddButton_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect(this._phoneGroupAddPage);
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._smsMessageBL.DeleteMultiPhoneGroup(_tempsplit);
            ...
            Response.Redirect(this._phoneGroupPage + "?" + ApplicationConfig.RequestPageKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_page, ApplicationConfig.EncryptionKey)) + "&" + ApplicationConfig.ActionResult + "=" + _error);
        }
    }
}