...
namespace SMS.SMSWeb.Message
{
    public partial class ContactsView : MessageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.SubPageTitleLiteral.Text = "Group View";
        ...
        public void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._smsMessageBL.GetListPhoneGroupByGroupName(_prmCurrentPage, _maxrow, _groupName,_orgID,_userID,_fgAdmin );
        ...
        private double RowCount()
        {
            ...
            _result = this._smsMessageBL.RowCountPhoneGroupByGroupName(this.GroupNameTextBox.Text,_orgID,_userID,_fgAdmin);
        ...
        {
            Response.Redirect(this._phoneGroupEditPage + "?" + _codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)));
        }
