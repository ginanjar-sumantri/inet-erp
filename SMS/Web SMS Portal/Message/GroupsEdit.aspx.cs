...
namespace SMS.SMSWeb.Message
{
    public partial class ContactsEdit : MessageBase
    {
        ...
        private void ShowContactList(Int32 _prmCurrentPage)
        {
            ...
            //List<MsPhoneBook> _listTempMsPhoneBook = this._smsMessageBL.GetListContactListNotYetAssigned(this.ContactFilterDropDownList.SelectedValue, this.KeywordTextBox.Text, _prmCurrentPage, _maxrow, Session["Organization"].ToString(), Session["UserID"].ToString(),Session["FgWebAdmin"].ToString());
            List<MsPhoneBook> _listTempMsPhoneBook = this._smsMessageBL.GetListContactListNotYetAssigned(this.ContactFilterDropDownList.SelectedValue, this.KeywordTextBox.Text, Session["Organization"].ToString(), Session["UserID"].ToString(), Session["FgWebAdmin"].ToString());
