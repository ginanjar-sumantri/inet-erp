...
{
    public partial class AutoReply_AutoReply : AutoReplyBase
    {
        AutoReplyBL _autoReplyBL = new AutoReplyBL();
        ...
        {
            double _result = 0;
            _result = this._autoReplyBL.RowsCountAutoReply(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, Session["Organization"].ToString());
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._autoReplyBL.GetListAutoReply(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, Session["Organization"].ToString());
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                TrAutoReply _temp = (TrAutoReply)e.Item.DataItem;
                ...
                Literal _senderLiteral = (Literal)e.Item.FindControl("SenderPhoneLiteral");
                _senderLiteral.Text = HttpUtility.HtmlEncode(_temp.PhoneNumber.ToString());

                Literal _KeyWordLiteral = (Literal)e.Item.FindControl("KeyWordLiteral");
                _KeyWordLiteral.Text = HttpUtility.HtmlEncode(_temp.KeyWord);

                Literal _ReplyMessageLiteral = (Literal)e.Item.FindControl("ReplyMessageLiteral");
                String _replyMessageShort = (_temp.ReplyMessage.Length < 20) ? _temp.ReplyMessage: (_temp.ReplyMessage.Substring(0, 20) + "...");
                _ReplyMessageLiteral.Text = HttpUtility.HtmlEncode(_replyMessageShort);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (_temp != "")
            {
                ...
                bool _result = this._autoReplyBL.DeleteMultiAutoReply(_tempsplit);
