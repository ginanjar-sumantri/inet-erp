...
{
    public partial class BlockPhoneNumber : BlockPhoneNumberBase
    {
        BlockPhoneNumberBL _blockPhoneNumberBL = new BlockPhoneNumberBL();
        ...
        {
            double _result = 0;
            _result = this._blockPhoneNumberBL.RowsCountBlockPhoneNumber(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, Session["Organization"].ToString(), Session["UserID"].ToString());
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._blockPhoneNumberBL.GetListBlockPhoneNumber(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text,Session["Organization"].ToString(),Session["UserID"].ToString());
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                MsBlockPhoneBook _temp = (MsBlockPhoneBook)e.Item.DataItem;
                String _code = _temp.BlockID.ToString();
                ...
                Literal _BlockedPhoneLiteral = (Literal)e.Item.FindControl("BlockedPhoneLiteral");
                _BlockedPhoneLiteral.Text = HttpUtility.HtmlEncode(_temp.phoneNumber.ToString());
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (_temp != "")
            {
                ...
                bool _result = this._blockPhoneNumberBL.DeleteMultiBlockPhoneNumber(_tempsplit);
