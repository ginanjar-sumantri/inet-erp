...
namespace SMS.SMSWeb.Message
{
    public partial class Groups : MessageBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._smsMessageBL.RowsCountPhoneGroup(Session["Organization"].ToString(), Session["UserID"].ToString(),Session["FgAdmin"].ToString());
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._smsMessageBL.GetListPhoneGroup(Session["Organization"].ToString(), Session["UserID"].ToString(),Session["FgAdmin"].ToString());
