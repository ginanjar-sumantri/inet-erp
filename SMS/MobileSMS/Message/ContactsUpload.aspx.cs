...
namespace SMS.SMSWeb.Message
{
    public partial class ContactsUpload : MessageBase
    {
        ...
        protected Int32 _OrganizationID;
        protected Boolean _FgAdmin;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this._OrganizationID = Convert.ToInt32(Session["Organization"]);
                this._FgAdmin = Convert.ToBoolean(Session["FgAdmin"]);
            ...
            if (UploadFile.HasFile)
            {
                try
                {
                    ...
                    while (myRange.Cells.Value2 != null)
                    {
                        ...
                        _newData.OrganizationID = this._OrganizationID;
