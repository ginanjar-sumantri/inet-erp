...
{
    public partial class Junk : MessageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.SubPageTitleLiteral.Text = "Junk";
        ...
        private double RowCount()
        {
            ...
            _result = this._smsMessageBL.RowsCountSMSGatewayJunk(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.CategoryDDL.SelectedValue, this.ReadDropDownList.SelectedValue, _userID, Convert.ToInt32(_organization), _fgAdmin);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._smsMessageBL.GetListSMSGatewayJunk(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.CategoryDDL.SelectedValue, this.ReadDropDownList.SelectedValue, _userID, Convert.ToInt32(_organization), _fgAdmin);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                _viewButton.PostBackUrl = this._junkViewPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                ...
                _senderLiteral.Text = HttpUtility.HtmlEncode(_smsReceive.SenderPhoneNo.ToString());

                Literal _MessageLiteral = (Literal)e.Item.FindControl("MessageLiteral");
                String _shortMessage = (_smsReceive.Message.Length > 20)?(_smsReceive.Message.Substring(0,20)+"..."):_smsReceive.Message;
                _MessageLiteral.Text = _shortMessage;
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect(this._junkPage + "?" + ApplicationConfig.RequestPageKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_page, ApplicationConfig.EncryptionKey)) + "&" + ApplicationConfig.ActionResult + "=" + _error);
        }
