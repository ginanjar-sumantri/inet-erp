<%@ page language="C#" masterpagefile="~/SMSMasterPage.master" autoeventwireup="true" inherits="SMS.SMSWeb.Message.SentItems, App_Web_gbqxtdk2" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderContent" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td runat="server" id="SMSLeft">
                SMS Left :
                <asp:Label ID="SMSLeftLabel" runat="server"></asp:Label>
                / today
            </td>
        </tr>
    </table>
