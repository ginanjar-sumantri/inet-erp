<%@ page language="C#" masterpagefile="~/SMSMasterPage.master" autoeventwireup="true" inherits="SMS.SMSWeb.Message.Inbox, App_Web_gbqxtdk2" %>
    ...
    <asp:Panel runat="server" ID="Panel1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="CategoryDropDownList" runat="server">
                            <asp:ListItem Value="SenderNo" Text="Sender Phone No"></asp:ListItem>
        ...
        <table cellpadding="3px" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ReadDropDownList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ReadDropDownList_SelectedIndexChanged">
                        <asp:ListItem Value="0" Text="ALL"></asp:ListItem>
                        <asp:ListItem Value="1" Text="Read"></asp:ListItem>
                        <asp:ListItem Value="2" Text="Unread"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
            ...
            <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                <ItemTemplate>
                    <tr id="RepeaterItemTemplate" runat="server">
                            ...
                            <table cellpadding="0" cellspacing="0" width="0" border="0">
                                <tr>
                                    ...
                                    <%--<td style="padding-left: 4px">
                                        <asp:ImageButton ID="ReplyButton" runat="server" />
                                    </td>
                                    <td style="padding-left: 4px">
                                        <asp:ImageButton ID="ViewReplyButton" runat="server" />
                                    </td>--%>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td align="left">
                            <asp:Literal runat="server" ID="SenderLiteral"></asp:Literal>
                        </td>
                        <td align="center">
                            <asp:Literal runat="server" ID="RepliedLiteral"></asp:Literal>
                        </td>
                         <td align="center">
                            <asp:Literal runat="server" ID="DateReceiveLiteral"></asp:Literal>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
