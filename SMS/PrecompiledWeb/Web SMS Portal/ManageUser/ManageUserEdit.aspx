<%@ page title="" language="C#" masterpagefile="~/SMSMasterPage.master" autoeventwireup="true" inherits="SMS.SMSWeb.ManageUser.ManageUserEdit, App_Web__eq3z4mv" %>
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="UserIDTextBox" runat="server" ReadOnly ="true" >
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
