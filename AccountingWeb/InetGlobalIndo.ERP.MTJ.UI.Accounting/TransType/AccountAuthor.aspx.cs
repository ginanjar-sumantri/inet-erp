...
{
    public partial class AccountAuthor : TransTypeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._transType.RowsCountAuthor(Rijndael.Decrypt(_nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            MsTransType _msTransType = _transType.GetSingle(Rijndael.Decrypt(_nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            this.LabelCode.Text = _msTransType.TransTypeCode;
            this.LabelName.Text = _msTransType.TransTypeName;
            this.ActiveCheckBox.Checked = TransTypeDataMapper.IsActive(_msTransType.FgAccount);
            ...
            else
            {
                ...
                this.ListRepeater.DataSource = _transType.GetListAuthor(_prmCurrentPage, _maxrow, _msTransType.TransTypeCode, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._transType.DeleteAuthor(_tempsplit, this.LabelCode.Text);
            ...
            {
                string _page = "0";
                Response.Redirect(this._homePage + "?" + ApplicationConfig.RequestPageKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_page, ApplicationConfig.EncryptionKey)) + "&" + ApplicationConfig.ActionResult + "=" + _error + "&" + _codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(this.LabelCode.Text, ApplicationConfig.EncryptionKey)));
            }
            else
            {
                this.ViewState[this._currPageKey] = 0;
        ...
        {
            Response.Redirect(_transEditPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(this.LabelCode.Text, ApplicationConfig.EncryptionKey)));
        }

        protected void AddButton_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect(_addPage + "?" + _codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(this.LabelCode.Text, ApplicationConfig.EncryptionKey)));
        }
