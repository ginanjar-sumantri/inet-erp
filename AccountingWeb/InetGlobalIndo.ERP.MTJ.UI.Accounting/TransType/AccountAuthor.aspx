<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="AccountAuthor.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.TransType.AccountAuthor" %>
                                        ...
                                        <asp:Repeater ID="ListRepeater" runat="server" OnItemDataBound="ListRepeater_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="center">
                                                        <%# DataBinder.Eval(Container.DataItem, "FgSubled")%>
                                                    </td>
                                                    <td align="center">
                                                        <%# DataBinder.Eval(Container.DataItem, "FgNormal")%>
                                                    </td>
                                                    <td align="center">
