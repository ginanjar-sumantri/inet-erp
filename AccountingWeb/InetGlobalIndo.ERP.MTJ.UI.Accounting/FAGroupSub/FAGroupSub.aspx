<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FAGroupSub.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FASubGroup.FAGroupSub" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Fixed Asset Sub Group Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Fixed Asset Sub Group Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 180px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Fixed Asset Sub Group Code" ID="field1" class="SortLinkButton" runat="server" OnClick="field1_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 200px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Fixed Asset Sub Group Name" ID="field2" class="SortLinkButton" runat="server" OnClick="field2_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 150px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Fixed Asset Group" ID="field3" class="SortLinkButton" runat="server" OnClick="field3_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 50px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Moving" ID="field4" class="SortLinkButton" runat="server" OnClick="field4_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 50px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Process" ID="field5" class="SortLinkButton" runat="server" OnClick="field5_Click"></asp:LinkButton>
                                        </td>
                                    </tr>
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="FAGroupSubCodeLiteral"></asp:Literal>
                                                </td>
                                                <td>
                                                    <asp:Literal runat="server" ID="FAGroupSubNameLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="FAGroupLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="MovingLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="ProcessLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
