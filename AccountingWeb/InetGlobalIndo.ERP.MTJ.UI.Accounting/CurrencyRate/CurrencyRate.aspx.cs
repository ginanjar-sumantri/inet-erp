...
namespace InetGlobalIndo.ERP.MTJ.UI.Accounting.CurrencyRate
{
    public partial class CurrencyRate : CurrencyRateBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._currRateBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._currRateBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Literal _noLiteral;
                _noLiteral = (Literal)e.Item.FindControl("NoLiteral");
                _no = _page * _maxrow;
                _no += 1;
                _no = _nomor + _no;
                ...
                _viewButton.PostBackUrl = _viewPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                ...
                _editButton.PostBackUrl = _editPage + "?" + this._codeDate + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(DateFormMapper.GetValue(_temp.CurrDate), ApplicationConfig.EncryptionKey)) + "&" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
