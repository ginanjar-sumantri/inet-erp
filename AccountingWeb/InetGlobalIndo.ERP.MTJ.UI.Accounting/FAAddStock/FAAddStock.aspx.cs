...
{
    public partial class FAAddStock : FAAddStockBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._faAddStockBL.RowsCountFAAddStockHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._faAddStockBL.GetListFAAddStockHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                GLFAAddStockHd _temp = (GLFAAddStockHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != FAAddStockDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                _statusLiteral.Text = FAAddStockDataMapper.GetStatusText(_temp.Status);

                Literal _wisNoLiteral = (Literal)e.Item.FindControl("WISNoLiteral");
                _wisNoLiteral.Text = HttpUtility.HtmlEncode(_temp.FileNoWIS);

                Literal _receivedByLiteral = (Literal)e.Item.FindControl("ReceivedByLiteral");
                _receivedByLiteral.Text = HttpUtility.HtmlEncode(_temp.ReceiveBy);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._faAddStockBL.GetSingleGLFAAddStockHdForAccounting(_tempsplit);
            if (_ex == true)
            {
                bool _result = this._faAddStockBL.DeleteMultiFAAddStockHd(_tempsplit);
                if (_result == true)
                {
        ...
        {
            if (this.sortField.Value == "WIS No.")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
        ...
        {
            if (this.sortField.Value == "Received By")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Received By";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._faAddStockBL.DeleteMultiApproveFAAddStockHd(_tempSplit, AppModule.GetValue(TransactionType.FAAddStock), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
