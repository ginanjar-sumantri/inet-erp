<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FAAddStock.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FAAddStock.FAAddStock" %>
                            ...
                            <td>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 160px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="WIS No." ID="field5" class="SortLinkButton" runat="server"
                                                OnClick="field5_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 150px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Received By" ID="field6" class="SortLinkButton" runat="server"
                                    ...
                                    <asp:Repeater ID="ListRepeater" runat="server" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterListTemplate" runat="server">
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="WISNoLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="ReceivedByLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
