<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FACondition.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FACondition.FACondition" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Fixed Asset Condition Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Fixed Asset Condition Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 150px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Fixed Asset Condition Code" ID="field1" class="SortLinkButton" runat="server" OnClick="field1_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 200px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Fixed Asset Condition Name" ID="field2" class="SortLinkButton" runat="server" OnClick="field2_Click"></asp:LinkButton>
                                        </td>
                                    </tr>
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="FAStatusCodeLiteral"></asp:Literal>
                                                </td>
                                                <td>
