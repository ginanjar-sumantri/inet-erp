...
{
    public partial class FACondition : FAConditionBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._faStatusBL.RowsCountFAStatus(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._faStatusBL.GetListFAStatus(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsFAStatus _temp = (MsFAStatus)e.Item.DataItem;
                string _code = _temp.FAStatusCode.ToString();
                ...
                Literal _faStatusCode = (Literal)e.Item.FindControl("FAStatusCodeLiteral");
                _faStatusCode.Text = HttpUtility.HtmlEncode(_temp.FAStatusCode.ToString());

                Literal _faStatusName = (Literal)e.Item.FindControl("FAStatusNameLiteral");
                _faStatusName.Text = HttpUtility.HtmlEncode(_temp.FAStatusName);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._faStatusBL.DeleteMultiFAStatus(_tempsplit);
        ...
        {
            if (this.sortField.Value == "Fixed Asset Condition Code")
            {
            ...
            {
                this.sortField.Value = "Fixed Asset Condition Code";
                this.ascDesc.Value = "true";
            }
        ...
        {
            if (this.sortField.Value == "Fixed Asset Condition Name")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Fixed Asset Condition Name";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
