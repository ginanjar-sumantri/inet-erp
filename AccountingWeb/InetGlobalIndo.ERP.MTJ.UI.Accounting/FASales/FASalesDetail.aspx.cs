...
{
    public partial class FASalesDetail : FASalesBase
    {
        ...
        private string _reportPath1 = "FASales/FASalesPrintPreview.rdlc";
        private string _reportPath2 = "FASales/JournalEntryPrintPreview.rdlc";
        private string _reportPath3 = "FASales/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        {
            this._faSalesBL = new FASalesBL();
            GLFASalesHd _glFASalesHd = this._faSalesBL.GetSingleFASalesHdView(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));

            _decimalPlace = _currencyBL.GetDecimalPlace(_glFASalesHd.CurrCode);
            ...
            this.StatusLabel.Text = FixedAssetStatus.GetStatusText(_glFASalesHd.Status);
            this.CustTextBox.Text = _glFASalesHd.CustName;
            ...
            this.CurrencyTextBox.Text = _glFASalesHd.CurrCode;
            ...
            this.TermTextBox.Text = _glFASalesHd.TermName;
            ...
            this.StatusHiddenField.Value = _glFASalesHd.Status.ToString();
            ...
            {
                this.ListRepeater.DataSource = this._faSalesBL.GetListFASalesDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteAllButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._faSalesBL.DeleteAllFASalesDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        private double RowCount()
        {
            ...
            _result = this._faSalesBL.RowsCountFASalesDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                GLFASalesDt _temp = (GLFASalesDt)e.Item.DataItem;
                ...
                _viewButton.PostBackUrl = this._viewDetailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)) + "&" + this._codeFA + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                ...
                else
                {
                    ...
                    {
                        _editButton.PostBackUrl = this._editDetailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)) + "&" + this._codeFA + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                ...
                _salesIDR.Text = (_temp.AmountHome == 0 ? "0" : HttpUtility.HtmlEncode(_temp.AmountHome.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace))));

                Literal _salesAmount = (Literal)e.Item.FindControl("SalesAmountLiteral");
                _salesAmount.Text = (_temp.AmountForex == 0 ? "0" : HttpUtility.HtmlEncode(_temp.AmountForex.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace))));

                Literal _faIDR = (Literal)e.Item.FindControl("FixedAssetIDRLiteral");
                _faIDR.Text = (_temp.AmountCurrent == 0 ? "0" : HttpUtility.HtmlEncode(_temp.AmountCurrent.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace))));
            }
        }
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.FASalesPrintPreview(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == FixedAssetStatus.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._faSalesBL.GetAppr(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == FixedAssetStatus.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._faSalesBL.Approve(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == FixedAssetStatus.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._faSalesBL.Posting(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == FixedAssetStatus.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._faSalesBL.Unposting(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._faSalesBL.DeleteMultiFASalesDt(_tempsplit, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.FASales), this.TransNoTextBox.Text, this.FileNmbrTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
