<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FASalesEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FASales.FASalesEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="CurrDropDownList" runat="server" Enabled="false">
                                </asp:DropDownList>
                                <asp:TextBox ID="ForexRateTextBox" runat="server" Width="150" ReadOnly="true" BackColor="#CCCCCC">
                                </asp:TextBox>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Discount Forex Must Be Filled"
