...
{
    public partial class FABeginning : FABeginningBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._faBeginningBL.RowsCountFABeginning(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._faBeginningBL.GetListFABeginning(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Accounting_FABeginning _temp = (Accounting_FABeginning)e.Item.DataItem;

                string _code = _temp.FABeginningCode.ToString();
                ...
                Literal _transNmbrLiteral = (Literal)e.Item.FindControl("TransNumberLiteral");
                ...
                Literal _dateLiteral = (Literal)e.Item.FindControl("TransDateLiteral");
                ...
                _statusLiteral.Text = HttpUtility.HtmlEncode(FixedAssetBeginningDataMapper.GetStatusText(_temp.Status));
                ...
                {
                    if (_temp.Status != FixedAssetBeginningDataMapper.GetStatusByte(TransStatus.Posted))
                    {
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._faBeginningBL.GetSingleGLAccounting_FABeginning(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._faBeginningBL.DeleteMultiAccounting_FABeginning(_tempSplit);
                if (_result == true)
                {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._faBeginningBL.DeleteMultiApproveAccounting_FABeginning(_tempSplit, AppModule.GetValue(TransactionType.FABeginning), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
