...
namespace InetGlobalIndo.ERP.MTJ.UI.Accounting.Currency
{
    public partial class Currency : CurrencyBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._currencyBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._currencyBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsCurrency _temp = (MsCurrency)e.Item.DataItem;
                ...
                Literal _currNameLiteral = (Literal)e.Item.FindControl("CurrNameLiteral");
                _currNameLiteral.Text = HttpUtility.HtmlEncode(_temp.CurrName);

                Literal _fgHomeLiteral = (Literal)e.Item.FindControl("FgHomeLiteral");
                _fgHomeLiteral.Text = HttpUtility.HtmlEncode(Convert.ToString(_temp.FgHome));

                Literal _decimalPlaceLiteral = (Literal)e.Item.FindControl("DecimalPlaceLitaral");
                _decimalPlaceLiteral.Text = HttpUtility.HtmlEncode(Convert.ToString(_temp.DecimalPlace));
                ...
                Literal _valueToleranceLiteral = (Literal)e.Item.FindControl("ValueToleranceLiteral");
                _valueToleranceLiteral.Text = HttpUtility.HtmlEncode((_temp.ValueTolerance == 0) ? "0" : _temp.ValueTolerance.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace)));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._currencyBL.DeleteMulti(_tempsplit);
