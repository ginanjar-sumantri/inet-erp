<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FALocation.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FALocation.FALocation" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Fixed Asset Location Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Fixed Asset Location Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 150px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Fixed Asset Location Code" ID="field1" class="SortLinkButton" runat="server" OnClick="field1_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 200px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Fixed Asset Location Name" ID="field2" class="SortLinkButton" runat="server" OnClick="field2_Click"></asp:LinkButton>
                                        </td>
                                    </tr>
                                    <asp:Repeater ID="ListRepeater" runat="server" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterListTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="FALocationCode"></asp:Literal>
                                                </td>
                                                <td>
                                                    <asp:Literal runat="server" ID="FALocationName"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
