...
{
    public partial class FALocationView : FALocationBase
    {
        ...
        {
            Response.Redirect(this._editPage + "?" + _FALocationCodeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._FALocationCodeKey)));
        }
