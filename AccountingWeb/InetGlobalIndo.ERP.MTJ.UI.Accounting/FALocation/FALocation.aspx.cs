...
{
    public partial class FALocation : FALocationBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._FALocation.RowsCountFALocation(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._FALocation.GetListFALocation(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsFALocation _msFALocation = (MsFALocation)e.Item.DataItem;
                string _code = _msFALocation.FALocationCode.ToString();
                ...
                Literal _FALocationCode = (Literal)e.Item.FindControl("FALocationCode");
                _FALocationCode.Text = HttpUtility.HtmlEncode(_msFALocation.FALocationCode);

                Literal _FALocationName = (Literal)e.Item.FindControl("FALocationName");
                _FALocationName.Text = HttpUtility.HtmlEncode(_msFALocation.FALocationName);
                ...
                _viewButton.PostBackUrl = this._viewPage + "?" + this._FALocationCodeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                ...
                _editButton.PostBackUrl = this._editPage + "?" + this._FALocationCodeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._FALocation.DeleteMultiFALocation(_tempsplit);
        ...
        {
            if (this.sortField.Value == "Fixed Asset Location Code")
            {
            ...
            {
                this.sortField.Value = "Fixed Asset Location Code";
                this.ascDesc.Value = "true";
            }
        ...
        {
            if (this.sortField.Value == "Fixed Asset Location Name")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Fixed Asset Location Name";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
