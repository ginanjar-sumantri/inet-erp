<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="JournalEntryDetailEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.JournalEntry.JournalEntryDetailEdit" %>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                                            <tr>
                                                <td>
                                                    <asp:TextBox runat="server" ID="DebitForexTextBox" MaxLength="22" Width="150"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox runat="server" ID="DebitHomeTextBox" MaxLength="22" Width="150" BackColor="#CCCCCC"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                                            <tr>
                                                <td>
                                                    <asp:TextBox runat="server" ID="CreditForexTextBox" MaxLength="22" Width="150"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox runat="server" ID="CreditHomeTextBox" MaxLength="22" Width="150" BackColor="#CCCCCC"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
