...
{
    public partial class JournalEntry : JournalEntryBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._journalEntryBL.RowsCountGLJournalHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._journalEntryBL.GetListGLJournalHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                _referenceDate.Text = DateFormMapper.GetValue(_temp.TransDate);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Boolean _result = this._journalEntryBL.DeleteMultiGLJournalHd(_tempSplit);
        ...
        {
            if (this.sortField.Value == "Reference No.")
            {
            ...
            {
                this.sortField.Value = "Reference No.";
                this.ascDesc.Value = "true";
            }
        ...
        {
            if (this.sortField.Value == "Reference Date")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Reference Date";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
