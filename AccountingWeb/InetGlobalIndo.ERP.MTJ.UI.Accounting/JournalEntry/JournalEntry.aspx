<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="JournalEntry.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.JournalEntry.JournalEntry" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="RefNo" Text="Reference No."></asp:ListItem>
                                            ...
                                            <td>
                                                <asp:ImageButton ID="AdvanceSearchImageButton" runat="server" OnClick="AdvanceSearchImageButton_Click" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                            ...
                            <td>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 100px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Reference No." ID="field1" class="SortLinkButton" runat="server" OnClick="field1_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 100px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="File No." ID="field2" class="SortLinkButton" runat="server" OnClick="field2_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 100px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Reference Date" ID="field3" class="SortLinkButton" runat="server" OnClick="field3_Click"></asp:LinkButton>
                                        </td>
                                        ...
                                        <td style="width: 50px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Year" ID="field6" class="SortLinkButton" runat="server" OnClick="field6_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 50px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Period" ID="field7" class="SortLinkButton" runat="server" OnClick="field7_Click"></asp:LinkButton>
                                        </td>
                                    </tr>
