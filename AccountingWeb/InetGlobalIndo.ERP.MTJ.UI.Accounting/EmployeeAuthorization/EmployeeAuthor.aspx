<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="EmployeeAuthor.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.EmployeeAuthor.EmployeeAuthor" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Employee Number"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Employee Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterListTemplate" runat="server">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td style="padding-left: 4px">
                                                                <asp:ImageButton runat="server" ID="SetAccountButton" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="EmpNameLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
