...
{
    public partial class EmployeeAuthor : EmployeeAuthorBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._accountBL.RowsCountEmployeeAuthorization(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._accountBL.GetListEmployeeAuthorization(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ImageButton _setAccountButton = (ImageButton)e.Item.FindControl("SetAccountButton");
                _setAccountButton.PostBackUrl = this._editPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                _setAccountButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/set_detail_small.jpg";

                this._permEdit = this._permBL.PermissionValidation1(this._menuID, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Edit);

                if (this._permEdit == PermissionLevel.NoAccess)
                {
                    _setAccountButton.Visible = false;
                }
                ...
                Literal _empNumbLiteral = (Literal)e.Item.FindControl("EmployeeLiteral");
                _empNumbLiteral.Text = HttpUtility.HtmlEncode(_temp.EmpNumb);

                Literal _empNameLiteral = (Literal)e.Item.FindControl("EmpNameLiteral");
                _empNameLiteral.Text = HttpUtility.HtmlEncode(_temp.EmpName);
            }
        }

        protected void AddButton_Click(object sender, EventArgs e)
        {
            Response.Redirect(this._addPage + "?" + _transTypeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt("", ApplicationConfig.EncryptionKey)));
        }
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._accountBL.DeleteMultiEmployeeAuthorization(_tempsplit);
