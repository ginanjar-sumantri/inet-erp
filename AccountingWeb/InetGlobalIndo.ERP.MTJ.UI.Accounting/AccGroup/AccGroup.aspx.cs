...
{
    public partial class AccGroup : AccGroupBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._accGroupBL.RowsCountAccGroup(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._accGroupBL.GetListAccGroup(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object source, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                MsAccGroup _temp = (MsAccGroup)e.Item.DataItem;
                string _code = _temp.AccGroupCode.ToString();
                ...
                Literal _accGroupCodeLiteral = (Literal)e.Item.FindControl("AccGroupCodeLiteral");
                _accGroupCodeLiteral.Text = HttpUtility.HtmlEncode(_code);

                Literal _accGroupNameLiteral = (Literal)e.Item.FindControl("AccGroupNameLiteral");
                _accGroupNameLiteral.Text = HttpUtility.HtmlEncode(_temp.AccGroupName);
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._accGroupBL.DeleteMultiAccGroup(_tempsplit);
        ...
        {
            if (this.sortField.Value == "Account Group Code")
            {
            ...
            else
            {
                ...
                this.sortField.Value = "Account Group Code";
                this.ascDesc.Value = "true";
        ...
        {
            if (this.sortField.Value == "Account Group Name")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            else
            {
                ...
                this.sortField.Value = "Account Group Name";
                this.ascDesc.Value = "true";
        ...
        {
            if (this.sortField.Value == "Account Type")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Account Type";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
