...
{
    public partial class AccGroupView : AccGroupBase
    {
        ...
        private void ShowData()
        {
            ...
            this.CodeTextBox.Text = _msAccGroup.AccGroupCode;
            this.NameTextBox.Text = _msAccGroup.AccGroupName;
            this.AccTypeTextBox.Text = _accTypeBL.GetAccTypeNameByCode(_msAccGroup.AccType);
        }
