...
{
    public partial class FAGroup : FAGroupBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._FAGroupBL.RowsCountFAGroup(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._FAGroupBL.GetListFAGroup(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsFAGroup _temp = (MsFAGroup)e.Item.DataItem;
                string _code = _temp.FAGroupCode.ToString();
                ...
                Literal _FAGroupCode = (Literal)e.Item.FindControl("FAGroupCode");
                _FAGroupCode.Text = HttpUtility.HtmlEncode(_temp.FAGroupCode);

                Literal _FAGroupName = (Literal)e.Item.FindControl("FAGroupName");
                _FAGroupName.Text = HttpUtility.HtmlEncode(_temp.FAGroupName);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._FAGroupBL.DeleteMultiFAGroup(_tempsplit);
        ...
        {
            if (this.sortField.Value == "Fixed Asset Group Code")
            {
            ...
            {
                this.sortField.Value = "Fixed Asset Group Code";
                this.ascDesc.Value = "true";
            }
        ...
        {
            if (this.sortField.Value == "Fixed Asset Group Name")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Fixed Asset Group Name";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
