...
{
    public partial class TransactionClose : TransactionCloseBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._transCloseBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._transCloseBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Master_TransactionClose _temp = (Master_TransactionClose)e.Item.DataItem;

                string _code = _temp.TransCloseCode.ToString();
                ...
                Literal _startPeriodLiteral = (Literal)e.Item.FindControl("StartPeriodLiteral");
                _startPeriodLiteral.Text = HttpUtility.HtmlEncode(_temp.StartDate.Month.ToString());

                Literal _endPeriodLiteral = (Literal)e.Item.FindControl("EndPeriodLiteral");
                _endPeriodLiteral.Text = HttpUtility.HtmlEncode(_temp.EndDate.Month.ToString());

                Literal _startYearLiteral = (Literal)e.Item.FindControl("StartYearLiteral");
                _startYearLiteral.Text = HttpUtility.HtmlEncode(_temp.StartDate.Year.ToString());

                Literal _endYearLiteral = (Literal)e.Item.FindControl("EndYearLiteral");
                _endYearLiteral.Text = HttpUtility.HtmlEncode(_temp.EndDate.Year.ToString());

                Literal _descriptionLiteral = (Literal)e.Item.FindControl("DescriptionLiteral");
                _descriptionLiteral.Text = HttpUtility.HtmlEncode(_temp.Description);

                Literal _status = (Literal)e.Item.FindControl("StatusLiteral");
                _status.Text = HttpUtility.HtmlEncode(TransactionCloseDataMapper.GetStatusTransCloseStatus(_temp.Status));
