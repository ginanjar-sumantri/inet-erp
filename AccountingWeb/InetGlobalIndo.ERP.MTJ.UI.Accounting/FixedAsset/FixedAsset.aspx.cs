...
{
    public partial class FixedAsset : FixedAssetBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.SummaryButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/summary.jpg";
                this.SummaryButton2.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/summary.jpg";
                this.ImportButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/import_excel.jpg";

                this.GetFormatExcelLiteral.Text = "<a href='" + ApplicationConfig.AccountingFormatVirDirPath + "FA.xls'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download_excel.jpg" + "' border='0'>" + "</a>";
        ...
        private double RowCount()
        {
            ...
            _result = this._fixedAssetBL.RowsCountFixedAsset(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._fixedAssetBL.GetListFixedAsset(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ImageButton _changePhotoButton = (ImageButton)e.Item.FindControl("ChangePhotoButton");
                _changePhotoButton.PostBackUrl = this._changePhotoPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                _changePhotoButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/change_photo.jpg";
                ...
                Literal _faLocation = (Literal)e.Item.FindControl("FALocationLiteral");
                _faLocation.Text = HttpUtility.HtmlEncode(_temp.FALocationCode);

                Literal _faStatus = (Literal)e.Item.FindControl("FAStatusNameLiteral");
                _faStatus.Text = HttpUtility.HtmlEncode(_temp.FAStatusName);
                ...
                _forexRateLiteral.Text = (_temp.ForexRate == 0) ? "0" : _temp.ForexRate.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));

                Literal _buyPriceForexLiteral = (Literal)e.Item.FindControl("BuyPriceForexLiteral");
                _buyPriceForexLiteral.Text = (_temp.AmountForex == 0) ? "0" : _temp.AmountForex.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));

                Literal _buyPriceHomeLiteral = (Literal)e.Item.FindControl("BuyPriceHomeLiteral");
                _buyPriceHomeLiteral.Text = (_temp.AmountHome == 0) ? "0" : _temp.AmountHome.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlaceHome));

                Literal _createdFromLiteral = (Literal)e.Item.FindControl("CreatedFromLiteral");
                _createdFromLiteral.Text = HttpUtility.HtmlEncode(FixedAssetsDataMapper.CreatedFromText(_temp.CreatedFrom));

                //Literal _createJournalLiteral = (Literal)e.Item.FindControl("CreateJournalLiteral");
                //_createJournalLiteral.Text = HttpUtility.HtmlEncode(FixedAssetsDataMapper.CreateJournal(_temp.CreateJournal));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._fixedAssetBL.DeleteMultiFixedAsset(_tempSplit);
        ...
        protected void SummaryButton_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect(this._summaryPage);
        }
        ...
        {
            if (this.sortField.Value == "Condition")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Condition";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        {
            if (this.sortField.Value == "Buy Price Forex")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Buy Price Forex";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        {
            if (this.sortField.Value == "Buy Price Home")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Buy Price Home";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        {
            if (this.sortField.Value == "Created From")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Created From";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        {
            Response.Redirect(this._importPage);
        }
    }
}