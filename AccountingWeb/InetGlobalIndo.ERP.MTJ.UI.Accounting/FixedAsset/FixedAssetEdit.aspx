<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FixedAssetEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FixedAsset.FixedAssetEdit" %>
                            ...
                            <td>
                                <table cellpadding="3" cellspacing="0" width="0" border="0">
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            <asp:TextBox runat="server" ID="FACodeTextBox" Width="150" MaxLength="20" BackColor="#CCCCCC"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
