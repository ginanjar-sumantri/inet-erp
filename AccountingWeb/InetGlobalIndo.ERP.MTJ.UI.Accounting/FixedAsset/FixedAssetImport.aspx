<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FixedAssetImport.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FixedAsset.FixedAssetImport" %>
    ...
    <asp:Panel runat="server" ID="LogPanel">
        <table>
            ...
            <tr>
                <td>
                    <fieldset>
                        <legend>FixedAsset Import Log</legend>
