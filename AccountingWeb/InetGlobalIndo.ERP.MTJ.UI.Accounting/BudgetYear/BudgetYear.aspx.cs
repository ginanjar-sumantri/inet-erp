...
{
    public partial class BudgetYear : GLBudgetYearBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._glBudgetBL.RowsCountGLBudgetYearHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._glBudgetBL.GetListGLBudgetYearHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                GLBudgetYearHd _temp = (GLBudgetYearHd)e.Item.DataItem;

                string _code = _temp.Year.ToString() + "|" + _temp.Revisi.ToString();
                ...
                _yearLiteral.Text = _temp.Year.ToString();

                Literal _revisiLiteral = (Literal)e.Item.FindControl("RevisiLiteral");
                _revisiLiteral.Text = _temp.Revisi.ToString();

                Literal _statusLiteral = (Literal)e.Item.FindControl("StatusLiteral");
                _statusLiteral.Text = GLBudgetDataMapper.GetStatusText(Convert.ToByte(_temp.Status.ToString()));

                CheckBox _fgActiveCheckBox = (CheckBox)e.Item.FindControl("FgActiveCheckBox");
                _fgActiveCheckBox.Checked = _temp.FgActive == 'Y' ? true : false;
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._glBudgetBL.DeleteMultiGLBudgetYearHd(_tempSplit);
