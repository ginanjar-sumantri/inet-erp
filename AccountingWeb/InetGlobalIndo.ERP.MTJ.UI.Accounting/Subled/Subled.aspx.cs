...
{
    public partial class Subled : SubledBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._subledBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._subledBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsSubled _temp = (MsSubled)e.Item.DataItem;
                string _code = _temp.SubledCode.ToString();
                ...
                Literal _subledCode = (Literal)e.Item.FindControl("SubledCodeLiteral");
                _subledCode.Text = HttpUtility.HtmlEncode(_temp.SubledCode.ToString());
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._subledBL.DeleteMulti(_tempsplit);
