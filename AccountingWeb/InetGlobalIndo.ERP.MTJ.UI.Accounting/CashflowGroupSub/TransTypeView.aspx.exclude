<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="TransTypeView.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.TransType.TransTypeView" %>
