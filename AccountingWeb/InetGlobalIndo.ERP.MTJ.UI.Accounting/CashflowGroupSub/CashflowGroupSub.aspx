<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CashflowGroupSub.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.CashflowGroupSub.CashflowGroupSub" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Cashflow Group Sub Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Cashflow Group Sub Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                    ...
                                    <asp:Repeater ID="ListRepeater" runat="server" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="CFGroupSubCodeLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="CFGroupSubNameLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
