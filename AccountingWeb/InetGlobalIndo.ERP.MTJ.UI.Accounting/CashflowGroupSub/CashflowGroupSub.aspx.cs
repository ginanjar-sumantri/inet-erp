...
{
    public partial class CashflowGroupSub : CashflowGroupSubBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._cashflowGroupBL.RowsCountCFGroupSub(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._cashflowGroupBL.GetListCFGroupSub(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
            ...
            if (this.ListRepeater.Items.Count > 0)
                this.AllCheckBox.Checked = this._isCheckedAll;
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINMsCashFlowGroupSub _temp = (FINMsCashFlowGroupSub)e.Item.DataItem;
                string _code = _temp.CashFlowGroupSubCode.ToString();
                string _code2 = _temp.CashFlowType.ToString();
                ...
                Literal _cfGroupSubCode = (Literal)e.Item.FindControl("CFGroupSubCodeLiteral");
                _cfGroupSubCode.Text = HttpUtility.HtmlEncode(_temp.CashFlowGroupSubCode);

                Literal _cfGroupSubName = (Literal)e.Item.FindControl("CFGroupSubNameLiteral");
                _cfGroupSubName.Text = HttpUtility.HtmlEncode(_temp.CashFlowGroupSubName);

                Literal _cfType = (Literal)e.Item.FindControl("CFTypeLiteral");
                _cfType.Text = HttpUtility.HtmlEncode(_temp.CashFlowType);

                CheckBox _listCheckbox = (CheckBox)e.Item.FindControl("ListCheckBox");
                _listCheckbox.Attributes.Add("OnClick", "CheckBox_Click(" + this.CheckHidden.ClientID + "," + _listCheckbox.ClientID + ",'" + _codeAll + "', '" + awal + "' , '" + akhir + "', '" + cbox + "' )");
                ...
                _editButton.PostBackUrl = this._transEditPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._codeKey2 + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code2, ApplicationConfig.EncryptionKey));
        ...
        {
            Response.Redirect(_transAddPage);
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._cashflowGroupBL.DeleteMultiCFGroupSub(_tempsplit);
            ...
            Response.Redirect(this._transHomePage + "?" + ApplicationConfig.RequestPageKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_page, ApplicationConfig.EncryptionKey)) + "&" + ApplicationConfig.ActionResult + "=" + _error);
        }
