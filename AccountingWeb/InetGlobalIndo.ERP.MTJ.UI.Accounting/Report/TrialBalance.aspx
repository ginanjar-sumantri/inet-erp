<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="TrialBalance.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.Report.TrialBalance" %>
                                ...
                                <td>
                                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RadioButtonList ID="ReportRadioButtonList" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Value="SummaryRB" Selected="true">Summary</asp:ListItem>
                                                    <asp:ListItem Value="DetailRB">Detail</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                        </tr>
                                        <tr>
