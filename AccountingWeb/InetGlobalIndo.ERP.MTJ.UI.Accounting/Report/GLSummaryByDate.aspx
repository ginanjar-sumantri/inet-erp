<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="GLSummaryByDate.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.Report.GLSummaryByDate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="DefaultBodyContentPlaceHolder" runat="Server">
    <table cellpadding="3" cellspacing="0" width="100%" border="0">
                                    ...
                                    <asp:Panel ID="RangePanel" runat="server">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <%--<asp:Button ID="btnSearchAccountFrom" runat="server" Text="..." />--%>
                                            </td>
                                            <td>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <%--<asp:Button ID="btnSearchAccountTo" runat="server" Text="..." />--%>
                                            </td>
                                        </tr>
                                    </asp:Panel>
        ...
        <tr>
            <td>
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="1800px" ShowPrintButton="true"
