...
{
    public partial class GLSummary : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GLSummaryForex.rdlc";
        private string _reportPath1 = "Report/GLSummary.rdlc";
        ...
        private string _awal = "ctl00_DefaultBodyContentPlaceHolder_AccountCheckBoxList_";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "GL Summary By Period Report";
        ...
        private double RowCount()
        {
            ...
            _result = this._accountBL.RowsCountAccountForReport(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        {
            var hasil = this._accountBL.GetListForReport(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);

            this.AccountCheckBoxList.DataSource = hasil;
            this.AccountCheckBoxList.DataValueField = "Account";
            this.AccountCheckBoxList.DataTextField = "AccountName";
            this.AccountCheckBoxList.DataBind();
            ...
            int i = 0;
            foreach (ListItem _item in this.AccountCheckBoxList.Items)
            {
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.AllCheckBox.Checked == true)
            {
                if (this._isSearch == 0)
                {
                    _account = this.TempHidden.Value;
                }
                else
                {
                    _account = this.CheckHidden.Value;
                }
            }
            else
            {
            ...
            //ReportDataSource _reportDataSource1 = this._report.GLSummary(Convert.ToInt32(this.YearTextBox.Text), Convert.ToInt32(this.PeriodTextBox.Text), Convert.ToInt32(this.YearEndTextBox.Text), Convert.ToInt32(this.PeriodEndTextBox.Text), valueAccount, Convert.ToInt32(this.OrderByDDL.SelectedValue));
            ReportDataSource _reportDataSource1 = null;

            if (this.GroupByDropDownList.SelectedValue == "0")
            {
                _reportDataSource1 = this._report.GLSummaryForex(Convert.ToInt32(this.YearTextBox.Text), Convert.ToInt32(this.PeriodTextBox.Text), Convert.ToInt32(this.YearEndTextBox.Text), Convert.ToInt32(this.PeriodEndTextBox.Text), _account, Convert.ToInt32(this.OrderByDDL.SelectedValue), _from, _to);
            }
            else if (this.GroupByDropDownList.SelectedValue == "1")
            {
                _reportDataSource1 = this._report.GLSummary(Convert.ToInt32(this.YearTextBox.Text), Convert.ToInt32(this.PeriodTextBox.Text), Convert.ToInt32(this.YearEndTextBox.Text), Convert.ToInt32(this.PeriodEndTextBox.Text), _account, Convert.ToInt32(this.OrderByDDL.SelectedValue), _from, _to);
            }
            ...
            _reportParam[2] = new ReportParameter("StartPeriod", this.PeriodTextBox.Text, true);
            _reportParam[3] = new ReportParameter("EndPeriod", this.PeriodEndTextBox.Text, true);
            _reportParam[4] = new ReportParameter("PrmAccount", _account, true);
            _reportParam[5] = new ReportParameter("OrderBy", this.OrderByDDL.SelectedValue, true);
            _reportParam[6] = new ReportParameter("from", this.FromTextBox.Text, true);
            _reportParam[7] = new ReportParameter("To", this.ToTextBox.Text, true);
        ...
        protected void SetCheckBox()
        {
            ...
            foreach (ListItem _item in this.AccountCheckBoxList.Items)
            {
                _item.Attributes.Add("OnClick", "CheckBox_Click(" + this.CheckHidden.ClientID + ", " + "ctl00_DefaultBodyContentPlaceHolder_AccountCheckBoxList_" + i.ToString() + ", '" + _item.Value + "', '" + _awal + "', '" + _akhir + "', '" + _cbox + "', 'true');");
