...
{
    public partial class TrialBalance : ReportBase
    {
        private ReportBL _report = new ReportBL();
        private PermissionBL _permBL = new PermissionBL();

        private string _reportPath = "";
        private string _reportPath0 = "Report/TrialBalanceSummary.rdlc";
        private string _reportPath1 = "Report/TrialBalanceDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDTrialBalance, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Trial Balance Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.ReportRadioButtonList.SelectedIndex == 0)
            {
            ...
            ReportDataSource _reportDataSource1 = this._report.TrialBalanceSummary(Convert.ToInt32(this.YearTextBox.Text), Convert.ToInt32(this.PeriodTextBox.Text), this.ReportRadioButtonList.SelectedIndex);
            ...
            _reportParam[2] = new ReportParameter("FgReport", this.ReportRadioButtonList.SelectedIndex.ToString(), true);
