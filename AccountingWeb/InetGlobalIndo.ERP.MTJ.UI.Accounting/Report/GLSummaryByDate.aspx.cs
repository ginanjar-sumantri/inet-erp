...
{
    public partial class GLSummaryByDate : ReportBase
    {
        ...
        private string _reportPath0 = "Report/GLSummaryByDateForex.rdlc";
        private string _reportPath1 = "Report/GLSummaryByDate.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDGLSummaryByDate, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                //this.btnSearchAccountFrom.OnClientClick = "window.open('../Search/Search.aspx?valueCatcher=findAccountFrom&configCode=customer','_popSearch','width=500,height=300,toolbar=0,location=0,status=0,scrollbars=1')";
                //this.btnSearchAccountTo.OnClientClick = "window.open('../Search/Search.aspx?valueCatcher=findAccountTo&configCode=customer','_popSearch','width=500,height=300,toolbar=0,location=0,status=0,scrollbars=1')";
                ...
                this.PageTitleLiteral.Text = "GL Summary By Date Report";
        ...
        public void ClearData()
        {
            ...
            this.AccountCheckBoxList.ClearSelection();
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (_from.Length <= _to.Length)
            {
                ...
                {
                    _reportDataSource1 = this._report.GLSummaryByDateForex(_startDateTime, _endDateTime, _account, Convert.ToInt32(this.OrderByDDL.SelectedValue), _from, _to);
                }
                else if (this.GroupByDropDownList.SelectedValue == "1")
                {
                    _reportDataSource1 = this._report.GLSummaryByDate(_startDateTime, _endDateTime, _account, Convert.ToInt32(this.OrderByDDL.SelectedValue), _from, _to);
                }
            ...
            {
                this.WarningLabel.Text = "Account From must be less than Account To";
            }
        }
