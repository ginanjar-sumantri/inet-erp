<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="GLSubledger.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.Report.GLSubledger" %>
                            ...
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            <asp:DropDownList ID="FGSubledDDL" runat="server">
                                            </asp:DropDownList>
                                            <asp:CustomValidator ID="FGSubledValidator" runat="server" ErrorMessage="FgSubled Must Be Filled"
                                                Text="*" ClientValidationFunction="DropDownValidation" ControlToValidate="FGSubledDDL"></asp:CustomValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
