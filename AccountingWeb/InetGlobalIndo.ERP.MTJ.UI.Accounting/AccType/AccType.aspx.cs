...
{
    public partial class AccType : AccTypeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._accTypeBL.RowsCountAccType(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._accTypeBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsAccType _temp = (MsAccType)e.Item.DataItem;
                string _code = _temp.AccTypeCode.ToString();
                ...
                Literal _accTypeCodeLiteral = (Literal)e.Item.FindControl("AccTypeCodeLiteral");
                _accTypeCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.AccTypeCode.ToString());

                Literal _accTypeNameLiteral = (Literal)e.Item.FindControl("AccTypeNameLiteral");
                _accTypeNameLiteral.Text = HttpUtility.HtmlEncode(_temp.AccTypeName);

                Literal _fgTypeLiteral = (Literal)e.Item.FindControl("FgTypeLiteral");
                _fgTypeLiteral.Text = HttpUtility.HtmlEncode(_temp.FgType);
                ...
                _viewButton.PostBackUrl = this._viewPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code.ToString(), ApplicationConfig.EncryptionKey));
                ...
                _editButton.PostBackUrl = this._editPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code.ToString(), ApplicationConfig.EncryptionKey));
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._accTypeBL.DeleteMulti(_tempsplit);
