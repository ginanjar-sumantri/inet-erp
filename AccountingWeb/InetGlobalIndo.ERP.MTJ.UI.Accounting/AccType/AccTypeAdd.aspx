<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="AccTypeAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.AccType.AccTypeAdd" %>
                                ...
                                <asp:UpdatePanel ID="updatePanel1" runat="server">
                                    <ContentTemplate>
                                        <asp:RadioButtonList ID="AccTypeRBL" runat="server" RepeatColumns="2" AutoPostBack="true"
                                            ...
                                            <asp:ListItem Value="BS" Text="BS" Selected="True"></asp:ListItem>
