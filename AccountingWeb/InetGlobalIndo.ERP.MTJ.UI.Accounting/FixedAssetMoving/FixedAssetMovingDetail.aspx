<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FixedAssetMovingDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FixedAssetMoving.FixedAssetMovingDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="SourceTypeDropDownList" Enabled="False">
                                    ...
                                    <asp:TextBox runat="server" ID="SourceNameTextBox" ReadOnly="true" BackColor="#CCCCCC">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="DestinationTypeDropDownList" Enabled="False">
                                        <asp:ListItem Value="null">[Choose Item]</asp:ListItem>
                                        <asp:ListItem Value="GENERAL">GENERAL</asp:ListItem>
                                        <asp:ListItem Value="EMPLOYEE">EMPLOYEE</asp:ListItem>
                                        <asp:ListItem Value="CUSTOMER">CUSTOMER</asp:ListItem>
                                    ...
                                    <asp:TextBox runat="server" ID="DestinationNameTextBox" ReadOnly="true" BackColor="#CCCCCC">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table cellpadding="3" cellspacing="1" width="0" border="0">
                                        <tr class="bgcolor_gray">
                                            ...
                                            <td style="width: 200px" class="tahoma_11_white" align="center">
                                                <asp:LinkButton Text="Remark" ID="field3" class="SortLinkButton" runat="server" OnClick="field3_Click"></asp:LinkButton>
                                            </td>
                                        </tr>
