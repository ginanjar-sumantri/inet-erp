<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FixedAssetMovingAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FixedAssetMoving.FixedAssetMovingAdd" %>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="SourceCustomValidator" runat="server" ErrorMessage="Source Must Be Choosed"
                                    Text="*" ControlToValidate="SourceDropDownList" Display="Dynamic" ClientValidationFunction="DropDownValidation"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Destination Must Be Choosed"
                                    Text="*" ControlToValidate="DestinationDropDownList" Display="Dynamic" ClientValidationFunction="DropDownValidation"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
