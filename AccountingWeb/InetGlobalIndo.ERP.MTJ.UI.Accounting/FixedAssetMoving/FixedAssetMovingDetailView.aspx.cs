...
{
    public partial class FixedAssetMovingDetailView : FixedAssetMovingBase
    {
        ...
        {
            Response.Redirect(this._editDetailPage + "?" + _codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)) + "&" + this._codeTrans + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeTrans)));
        }
