...
{
    public partial class FixedAssetMoving : FixedAssetMovingBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._fixedAssetBL.RowsCountFixedAssetMoving(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._fixedAssetBL.GetListFixedAssetMoving(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                GLFAMoveHd _temp = (GLFAMoveHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status.ToString().Trim().ToLower() == FixedAssetMovingStatus.GetStatus(TransStatus.Posted).ToString().Trim().ToLower())
                    {
                        _editButton.Visible = false;
                    }
                    else
                ...
                Literal _movingNo = (Literal)e.Item.FindControl("MovingNoLiteral");
                _movingNo.Text = HttpUtility.HtmlEncode(_temp.TransNmbr);
                ...
                Literal _movingDate = (Literal)e.Item.FindControl("MovingDateLiteral");
                DateTime _tempDate = _temp.TransDate;
                _movingDate.Text = _tempDate.Day + "/" + _tempDate.Month + "/" + _tempDate.Year;

                Literal _status = (Literal)e.Item.FindControl("StatusLiteral");
                _status.Text = HttpUtility.HtmlEncode(FixedAssetMovingStatus.GetStatusText(_temp.Status));

                Literal _typeSource = (Literal)e.Item.FindControl("TypeSourceLiteral");
                _typeSource.Text = HttpUtility.HtmlEncode(_temp.FALocationTypeSrc);

                Literal _codeSource = (Literal)e.Item.FindControl("CodeSourceLiteral");
                _codeSource.Text = HttpUtility.HtmlEncode(_temp.FALocationCodeSrc);

                Literal _nameSource = (Literal)e.Item.FindControl("NameSourceLiteral");
                _nameSource.Text = HttpUtility.HtmlEncode(_temp.FALocationNameSrc);

                Literal _typeDest = (Literal)e.Item.FindControl("TypeDestLiteral");
                _typeDest.Text = HttpUtility.HtmlEncode(_temp.FALocationTypeDest);

                Literal _codeDest = (Literal)e.Item.FindControl("CodeDestLiteral");
                _codeDest.Text = HttpUtility.HtmlEncode(_temp.FALocationCodeDest);

                Literal _nameDest = (Literal)e.Item.FindControl("NameDestLiteral");
                _nameDest.Text = HttpUtility.HtmlEncode(_temp.FALocationNameDest);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._fixedAssetBL.GetSingleGLFAMoveHd(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._fixedAssetBL.DeleteMultiFixedAssetMoving(_tempSplit);
                if (_result == true)
                {
        ...
        {
            if (this.sortField.Value == "Type Source")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Type Source";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        {
            if (this.sortField.Value == "Code Source")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Code Source";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        {
            if (this.sortField.Value == "Name Source")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Name Source";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        {
            if (this.sortField.Value == "Type Dest")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Type Dest";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        {
            if (this.sortField.Value == "Code Dest")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Code Dest";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        {
            if (this.sortField.Value == "Name Dest")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Name Dest";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._fixedAssetBL.DeleteMultiApproveFixedAssetMoving(_tempSplit, AppModule.GetValue(TransactionType.FAMoving), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
