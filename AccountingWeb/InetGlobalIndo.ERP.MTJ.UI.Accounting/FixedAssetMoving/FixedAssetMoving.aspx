<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FixedAssetMoving.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FixedAssetMoving.FixedAssetMoving" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="RefNo" Text="Trans No."></asp:ListItem>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 70px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Type Source" ID="field5" class="SortLinkButton" runat="server"
                                                OnClick="field5_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 70px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Code Source" ID="field6" class="SortLinkButton" runat="server"
                                                OnClick="field6_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 120px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Name Source" ID="field7" class="SortLinkButton" runat="server"
                                                OnClick="field7_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 70px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Type Dest" ID="field8" class="SortLinkButton" runat="server"
                                                OnClick="field8_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 70px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Code Dest" ID="field9" class="SortLinkButton" runat="server"
                                                OnClick="field9_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 120px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Name Dest" ID="field10" class="SortLinkButton" runat="server"
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="MovingNoLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="FileNmbrLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="MovingDateLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="StatusLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="TypeSourceLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="CodeSourceLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="NameSourceLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="TypeDestLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="CodeDestLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="NameDestLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
