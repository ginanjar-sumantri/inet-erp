...
public partial class _default : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.Page.IsPostBack == true)
        {
            ...
            //this.SiteMapPath1.PathDirection = PathDirection.RootToCurrent;
            ...
            //this.Menu1.Items.Add(_quickLaunchNavMenu.RenderItem(15, AppModule.GetValue(ERPModule.Accounting), "administrators", null));
            //this.Menu1.Visible = false;
            //_quickLaunchNavMenu.Dispose();

            //string _imageUrl = ApplicationConfig.HomeWebAppURL + "images/accounting_small.jpg";
            //string _titleTree = "&nbsp;Accounting";
            //QuickLaunchNavigationMenu _quickLaunchNavNode = new QuickLaunchNavigationMenu();
            //this.TreeView1.ShowLines = true;
            //this.TreeView1.Nodes.Add(_quickLaunchNavNode.RenderNode(15, AppModule.GetValue(ERPModule.Accounting), "administrators", null, _imageUrl, _titleTree));
            //_quickLaunchNavNode.Dispose();

            //string _dir = Request.ServerVariables["APPL_PHYSICAL_PATH"];
            //string _title = "Accounting";
            //QuickLaunchNavigationMenu _quickLaunchSiteMapPath = new QuickLaunchNavigationMenu();
            //_quickLaunchSiteMapPath.GenerateSiteMapPath(15, AppModule.GetValue(ERPModule.Accounting), "administrators", null, _dir, _title, 15);
            ...
            //_topNavigationMenu.RenderItem(0, _roles, ERPModule.Accounting, this.Menu2, new UserBL().GetCompanyId(HttpContext.Current.User.Identity.Name));
