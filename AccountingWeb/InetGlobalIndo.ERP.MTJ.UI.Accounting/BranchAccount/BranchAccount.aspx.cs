...
{
    public partial class BranchAccount : BranchAccountBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._accountBL.RowsCountBranchAccount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._accountBL.GetListBranchAccount(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Master_BranchAccount _temp = (Master_BranchAccount)e.Item.DataItem;
                string _code = _temp.BranchAccCode.ToString();
                ...
                Literal _branchAccCodeLiteral = (Literal)e.Item.FindControl("BranchAccCodeLiteral");
                _branchAccCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.BranchAccID);

                Literal _branchAccNameLiteral = (Literal)e.Item.FindControl("BranchAccNameLiteral");
                _branchAccNameLiteral.Text = HttpUtility.HtmlEncode(_temp.BranchAccName);
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._accountBL.DeleteMultiBranchAccount(_tempsplit);
