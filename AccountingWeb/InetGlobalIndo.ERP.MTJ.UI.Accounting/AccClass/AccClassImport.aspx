<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="AccClassImport.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.AccClass.AccClassImport" %>
    ...
    <asp:Panel runat="server" ID="LogPanel">
        <table>
            ...
            <tr>
                <td>
                    <fieldset>
                        <legend>Account Class Import Log</legend>
