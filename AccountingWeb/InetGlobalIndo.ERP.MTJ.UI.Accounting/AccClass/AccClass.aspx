<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="AccClass.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.AccClass.AccClass" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Account Class Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Account Class Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <table cellpadding="3" cellspacing="1" border="0">
                                    <tr align="center" style="font-weight: bold" class="bgcolor_gray">
                                        ...
                                        <td style="width: 150px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Account Class Code" ID="field1" class="SortLinkButton" runat="server" OnClick="field1_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 200px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Account Class Name" ID="field2" class="SortLinkButton" runat="server" OnClick="field2_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 150px" class="tahoma_11_white" align="center">
                                            <asp:LinkButton Text="Account Sub Group" ID="field3" class="SortLinkButton" runat="server" OnClick="field3_Click"></asp:LinkButton>
                                        </td>
                                    </tr>
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="AccClassCodeLiteral"></asp:Literal>
                                                </td>
                                                <td>
                                                    <asp:Literal runat="server" ID="AccClassNameLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="AccSubGroupLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
