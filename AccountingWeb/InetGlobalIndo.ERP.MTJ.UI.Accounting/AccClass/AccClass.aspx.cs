...
{
    public partial class AccClass : AccClassBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.GetFormatExcelLiteral.Text = "<a href='" + ApplicationConfig.AccountingFormatVirDirPath + "Account Class.xls'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download_excel.jpg" + "' border='0'>" + "</a>";
        ...
        private double RowCount()
        {
            ...
            _result = this._accClassBL.RowsCountAccClass(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._accClassBL.GetListAccClass(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsAccClass _temp = (MsAccClass)e.Item.DataItem;
                string _code = _temp.AccClassCode.ToString();
                ...
                Literal _accClassCodeLiteral = (Literal)e.Item.FindControl("AccClassCodeLiteral");
                _accClassCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.AccClassCode);

                Literal _accClassNameLiteral = (Literal)e.Item.FindControl("AccClassNameLiteral");
                _accClassNameLiteral.Text = HttpUtility.HtmlEncode(_temp.AccClassName);

                Literal _accSubGroupLiteral = (Literal)e.Item.FindControl("AccSubGroupLiteral");
                _accSubGroupLiteral.Text = HttpUtility.HtmlEncode(_temp.AccSubGroup);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._accClassBL.DeleteMultiAccClass(_tempsplit);
        ...
        {
            if (this.sortField.Value == "Account Class Code")
            {
            ...
            else
            {
                ...
                this.sortField.Value = "Account Class Code";
                this.ascDesc.Value = "true";
        ...
        {
            if (this.sortField.Value == "Account Class Name")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            else
            {
                ...
                this.sortField.Value = "Account Class Name";
                this.ascDesc.Value = "true";
        ...
        {
            if (this.sortField.Value == "Account Sub Group")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            else
            {
                ...
                this.sortField.Value = "Account Sub Group";
                this.ascDesc.Value = "true";
