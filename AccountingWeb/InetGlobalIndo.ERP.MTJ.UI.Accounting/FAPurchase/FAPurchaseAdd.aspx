<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FAPurchaseAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FAPurchase.FAPurchaseAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="FAPONoDropDownList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="FAPONoDropDownList_SelectedIndexChanged">
                                </asp:DropDownList>
                            ...
                            <ContentTemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="ForexRateTextBox" runat="server" Width="100" MaxLength="18">
                                        </asp:TextBox>
                                        ...
                                        <table cellpadding="3" cellspacing="1" width="0" border="0">
                                            <tr>
                                                <td style="width: 110px" align="center">
                                                    <asp:TextBox ID="PPNPercentTextBox" runat="server" Width="100" MaxLength="18">
                                                    </asp:TextBox>
                                                </td>
                                                <td>
                                                ...
                                                <td style="width: 110px" align="left">
                                                    <asp:TextBox ID="PPNDateTextBox" runat="server" Width="70px" BackColor="#CCCCCC"></asp:TextBox>&nbsp;
                                                    <%--<input runat="server" id="ppn_date_start" style="visibility: hidden; width: 20px;"
                                                ...
                                                <td style="width: 110px" align="center">
                                                    <asp:TextBox ID="PPNRateTextBox" runat="server" MaxLength="18" Width="100" BackColor="#cccccc">
                                                    </asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td>
                                        <table cellpadding="3" cellspacing="1" width="0" border="0">
                                            <tr>
                                                ...
                                                <td style="width: 110px" align="center">
                                                    <asp:TextBox ID="AmountBaseTextBox" MaxLength="18" runat="server" Width="100" BackColor="#CCCCCC">
                                                    </asp:TextBox>
                                                </td>
                                                <td style="width: 110px" align="center">
                                                    <asp:TextBox ID="DiscForexTextBox" runat="server" MaxLength="18" Width="100">
                                                    </asp:TextBox>
                                                </td>
                                                <td>
                                                ...
                                                <td style="width: 110px" align="center">
                                                    <asp:TextBox ID="PPNForexTextBox" MaxLength="18" runat="server" Width="100" BackColor="#CCCCCC">
                                                    </asp:TextBox>
                                                </td>
                                                <td style="width: 110px" align="center">
                                                    <asp:TextBox ID="TotalForexTextBox" MaxLength="18" runat="server" Width="100px" BackColor="#CCCCCC">
                                                    </asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
