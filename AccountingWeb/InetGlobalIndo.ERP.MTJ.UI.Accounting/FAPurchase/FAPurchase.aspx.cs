...
{
    public partial class FAPurchase : FAPurchaseBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._faPurchaseBL.RowsCountFAPurchase(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._faPurchaseBL.GetListFAPurchaseHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                GLFAPurchaseHd _temp = (GLFAPurchaseHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != FAPurchaseDataMapper.GetStatus(TransStatus.Posted))
                    {
                ...
                Literal _purchaseNoLiteral = (Literal)e.Item.FindControl("PurchaseNoLiteral");
                _purchaseNoLiteral.Text = HttpUtility.HtmlEncode(_temp.TransNmbr);
                ...
                Literal _purchaseDateLiteral = (Literal)e.Item.FindControl("PurchaseDateLiteral");
                _purchaseDateLiteral.Text = DateFormMapper.GetValue(_temp.TransDate);

                Literal _statusLiteral = (Literal)e.Item.FindControl("StatusLiteral");
                _statusLiteral.Text = FAPurchaseDataMapper.GetStatusText(_temp.Status);

                Literal _supplierNameLiteral = (Literal)e.Item.FindControl("SupplierNameLiteral");
                _supplierNameLiteral.Text = this._supplierBL.GetSuppNameByCode(_temp.SuppCode);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._faPurchaseBL.GetSingleFAPurchaseHdpprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._faPurchaseBL.DeleteMultiFAPurchaseHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._faPurchaseBL.DeleteMultiApproveFAPurchaseHd(_tempSplit, AppModule.GetValue(TransactionType.FAPurchase), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
