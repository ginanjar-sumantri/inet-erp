<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FAPurchaseDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FAPurchase.FAPurchaseDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="SupplierTextBox" runat="server" Width="420" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="AttnTextBox" runat="server" Width="280" MaxLength="40" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="FAPONoTextBox" runat="server" Width="300" MaxLength="20" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="CurrencyTextBox" runat="server" Width="50" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                    <asp:TextBox ID="ForexRateTextBox" runat="server" Width="100" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TermTextBox" runat="server" Width="350" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <table cellpadding="3" cellspacing="1" width="0" border="0">
                                        <tr>
                                            ...
                                            <td style="width: 110px" align="center">
                                                <asp:TextBox ID="PPNDateTextBox" runat="server" Width="100" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td style="width: 110px" align="center">
                                                <asp:TextBox ID="PPNRateTextBox" runat="server" Width="100" BackColor="#cccccc" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="QtySeparateCheckBox" runat="server" Enabled="false" />
                                </td>
                            </tr>
                            <tr valign="top">
                                <td>
                                        ...
                                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="center">
                                                        <asp:Literal runat="server" ID="FALocationTypeLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="right">
