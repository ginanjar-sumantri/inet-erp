<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FAService.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FAService.FAService" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    ...
                                                    <asp:ListItem Value="FACode" Text="FA Code"></asp:ListItem>
                                                    <asp:ListItem Value="FAName" Text="FA Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
