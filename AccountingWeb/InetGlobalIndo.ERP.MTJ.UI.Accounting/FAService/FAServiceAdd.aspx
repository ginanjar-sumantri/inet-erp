<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FAServiceAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FAService.FAServiceAdd" %>
                    ...
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                ...
                                <%--<input id="TransDateButton" runat="server" type="button" onclick="displayCalendar(ctl00_DefaultBodyContentPlaceHolder_TransDateTextBox,'yyyy-mm-dd',this)"
                                    value="..." />--%>
                            ...
                            <ContentTemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="ForexRateTextBox" Width="100" runat="server" BackColor="#CCCCCC">
                                        </asp:TextBox>
