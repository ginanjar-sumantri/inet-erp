<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FAMaintenanceAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FAMaintanance.FAMaintenanceAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="FixAssetsCodeTextBox" Width="70" MaxLength="10"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="FixAssetsCodeRequiredFieldValidator" runat="server"
                                    ErrorMessage="Fixed Asset Maintenance Code Must Be Filled" Text="*" ControlToValidate="FixAssetsCodeTextBox"
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" border="0" width="0">
                        <tr>
                            ...
                            <td>
                                <asp:ImageButton runat="server" ID="SetUpButton" OnClick="SetUpButton_Click" />
                            </td>
                        </tr>
                    </table>
                </td>
