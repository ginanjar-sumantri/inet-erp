...
{
    public partial class FAMaintenance : FAMaintananceBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._fixed.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._fixed.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsFAMaintenance _faMaintenance = (MsFAMaintenance)e.Item.DataItem;
                string _code = _faMaintenance.FAMaintenanceCode;
                ...
                Literal _fixedCode = (Literal)e.Item.FindControl("FixAssetsCodeLiteral");
                _fixedCode.Text = HttpUtility.HtmlEncode(_faMaintenance.FAMaintenanceCode);

                Literal _fixedName = (Literal)e.Item.FindControl("FixAssetsNameLiteral");
                _fixedName.Text = HttpUtility.HtmlEncode(_faMaintenance.FAMaintenanceName);

                Literal _faAddValue = (Literal)e.Item.FindControl("FgAddValueLiteral");
                _faAddValue.Text = HttpUtility.HtmlEncode(_faMaintenance.FgAddValue.ToString());
                ...
                _viewButton.PostBackUrl = this._viewPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_faMaintenance.FAMaintenanceCode, ApplicationConfig.EncryptionKey));
                ...
                _editButton.PostBackUrl = this._editPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_faMaintenance.FAMaintenanceCode, ApplicationConfig.EncryptionKey));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._fixed.DeleteMulti(_tempsplit);
        ...
        {
            if (this.sortField.Value == "Fixed Asset Maintenance Code")
            {
            ...
            {
                this.sortField.Value = "Fixed Asset Maintenance Code";
                this.ascDesc.Value = "true";
            }
        ...
        {
            if (this.sortField.Value == "Fixed Asset Maintenance Name")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Fixed Asset Maintenance Name";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        {
            if (this.sortField.Value == "Add Value")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Add Value";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
