    ...
    public partial class Account : AccountBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.GetFormatExcelLiteral.Text = "<a href='" + ApplicationConfig.AccountingFormatVirDirPath + "COA.xls'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download_excel.jpg" + "' border='0'>" + "</a>";
        ...
        private double RowCount()
        {
            ...
            _result = this._accountBL.RowsCountAccount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        {
            //this.GridView1.DataSource = this._accountBL.GetListAccount(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            //////////////////
            ...
            {
                this.ListRepeater.DataSource = this._accountBL.GetListAccount(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                Literal _accClassLiteral = (Literal)e.Item.FindControl("AccClassLiteral");
                _accClassLiteral.Text = HttpUtility.HtmlEncode(_temp.AccClassName);

                Literal _fgNormalLiteral = (Literal)e.Item.FindControl("FgNormalLiteral");
                _fgNormalLiteral.Text = HttpUtility.HtmlEncode(_temp.FgNormal.ToString());

                Literal _fgSubledLiteral = (Literal)e.Item.FindControl("FgSubledLiteral");
                _fgSubledLiteral.Text = HttpUtility.HtmlEncode(_temp.FgSubLed.ToString());
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._accountBL.DeleteMultiAccount(_tempsplit);
            ...
            {
                _error = "this account file already assign in transaction type setting. please remove first the account from the transaction type setting";
            }
        ...
        {
            if (this.sortField.Value == "Account Code")
            {
            ...
            else
            {
                ...
                this.sortField.Value = "Account Code";
                this.ascDesc.Value = "true";
        ...
        {
            if (this.sortField.Value == "Class Account")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            else
            {
                ...
                this.sortField.Value = "Class Account";
                this.ascDesc.Value = "true";
        ...
        {
            if (this.sortField.Value == "Detail")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
        ...
        {
            if (this.sortField.Value == "Normal Balance")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            else
            {
                ...
                this.sortField.Value = "Normal Balance";
                this.ascDesc.Value = "true";
        ...
        {
            if (this.sortField.Value == "Active")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
