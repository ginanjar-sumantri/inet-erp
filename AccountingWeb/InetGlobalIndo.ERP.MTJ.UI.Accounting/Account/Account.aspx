<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="Account.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.Account.Account" %>
                    ...
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="InetGlobalIndo.ERP.MTJ.DBFactory.ERPManSys.MTJERPManSysDataContext"
                                    Select="new (Account, AccountName, AccClass, Detail, FgSubLed, FgNormal, CurrCode, FgActive)"
                                    TableName="MsAccounts">
                                </asp:LinqDataSource>--%>
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 80px" class="tahoma_11_white" align="center">
                                             <asp:LinkButton Text="Account Code" ID="field1" class="SortLinkButton" runat="server" OnClick="field1_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 250px" class="tahoma_11_white" align="center">
                                             <asp:LinkButton Text="Account Name" ID="field2" class="SortLinkButton" runat="server" OnClick="field2_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 200px" class="tahoma_11_white" align="center">
                                             <asp:LinkButton Text="Class Account" ID="field3" class="SortLinkButton" runat="server" OnClick="field3_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 50px" class="tahoma_11_white" align="center">
                                             <asp:LinkButton Text="Normal Balance" ID="field5" class="SortLinkButton" runat="server" OnClick="field5_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 50px" class="tahoma_11_white" align="center">
                                             <asp:LinkButton Text="Sub Ledger" ID="field6" class="SortLinkButton" runat="server" OnClick="field6_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 50px" class="tahoma_11_white" align="center">
                                             <asp:LinkButton Text="Currency" ID="field7" class="SortLinkButton" runat="server" OnClick="field7_Click"></asp:LinkButton>
                                        </td>
                                        <td style="width: 50px" class="tahoma_11_white" align="center">
                                             <asp:LinkButton Text="Active" ID="field8" class="SortLinkButton" runat="server" OnClick="field8_Click"></asp:LinkButton>
                                        </td>
                                    </tr>
                                    <asp:Repeater ID="ListRepeater" runat="server" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="AccClassLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="FgNormalLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
