<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="AccountImport.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.Account.AccountImport" %>
    ...
    <asp:Panel runat="server" ID="LogPanel">
        <table>
            ...
            <tr>
                <td>
                    <fieldset>
                        <legend>Account Import Log</legend>
