...
{
    public partial class CashflowGroup : CashflowGroupBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._cashflowGroupBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._cashflowGroupBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                FINMsCashFlowGroup _temp = (FINMsCashFlowGroup)e.Item.DataItem;
                string _code = _temp.CashFlowGroupCode.ToString();
                string _code2 = _temp.CashFlowType;
                ...
                Literal _CFTypeLiteral = (Literal)e.Item.FindControl("CFTypeLiteral");
                _CFTypeLiteral.Text = HttpUtility.HtmlEncode(_temp.CashFlowType);

                Literal _CFGrpCodeLiteral = (Literal)e.Item.FindControl("CFGroupCodeLiteral");
                _CFGrpCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.CashFlowGroupCode.ToString());

                Literal _CFGrpNameLiteral = (Literal)e.Item.FindControl("CFGroupNameLiteral");
                _CFGrpNameLiteral.Text = HttpUtility.HtmlEncode(_temp.CashFlowGroupName);
                ...
                _editButton.PostBackUrl = this._editPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code.ToString(), ApplicationConfig.EncryptionKey)) + "&" + this._codeKey2 + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code2.ToString(), ApplicationConfig.EncryptionKey));
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._cashflowGroupBL.DeleteMulti(_tempsplit);
        ...
        //{
        //    if (this.sortField.Value == "Account Type Code")
        //    {
        ...
        //        if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
        //        {
        //            this.sortField.Value = "Account Type Code";
        //            this.ascDesc.Value = "true";
        //        }
        //        else
        //        {
        ...
        //{
        //    if (this.sortField.Value == "Account Type Name")
        //    {
        //        if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
        //            this.ascDesc.Value = "true";
        //        else
        ...
        //        if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
        //        {
        //            this.sortField.Value = "Account Type Name";
        //            this.ascDesc.Value = "true";
        //        }
        //        else
        //        {
