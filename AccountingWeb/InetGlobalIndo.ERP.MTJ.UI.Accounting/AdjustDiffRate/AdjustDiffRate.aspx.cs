...
{
    public partial class AdjustDiffRate : AdjustDiffRateBase
    {
        private GLAdjustDiffRateBL _adjustDiffRateBL = new GLAdjustDiffRateBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._adjustDiffRateBL.RowsCountGLAdjustDiffRateHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._adjustDiffRateBL.GetListGLAdjustDiffRateHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                GLAdjustDiffRateHd _temp = (GLAdjustDiffRateHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != AdjustDiffRateDataMapper.GetStatus(AdjustDiffRateStatus.Posting))
                    {
                ...
                Literal _transactionDate = (Literal)e.Item.FindControl("TransDateLiteral");
                _transactionDate.Text = DateFormMapper.GetValue(_temp.TransDate);

                Literal _status = (Literal)e.Item.FindControl("StatusLiteral");
                _status.Text = HttpUtility.HtmlEncode(AdjustDiffRateDataMapper.GetStatusText(_temp.Status));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._adjustDiffRateBL.DeleteMultiGLAdjustDiffRateHd(_tempSplit);
