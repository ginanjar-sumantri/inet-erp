<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FAProcessDetailAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FAProcess.FAProcessDetailAdd" %>
                                ...
                                <td>
                                    ...
                                    <table border="0" cellpadding="3" cellspacing="1" width="0">
                                        <tr class="bgcolor_gray">
                                            ...
                                            <td align="center" class="tahoma_11_white" colspan="3" style="width: 300px">
                                                <b>Depreciation</b>
                                            </td>
                                        </tr>
                                        <tr class="bgcolor_gray">
                                        ...
                                        <asp:Repeater ID="ListRepeater" runat="server" OnItemDataBound="ListRepeater_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="right">
                                                        <asp:Literal ID="AdjustDeprLiteral" runat="server"></asp:Literal>
                                                    </td>
                                                    <td align="right">
                                                        <asp:Literal ID="TotalDeprLiteral" runat="server"></asp:Literal>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
