...
{
    public partial class FAProcess : FAProcessBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._faProcessBL.RowsCountFAProcessHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._faProcessBL.GetListFAProcessHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                GLFAProcessHd _glFAProcessHd = (GLFAProcessHd)e.Item.DataItem;

                string _code = _glFAProcessHd.Year.ToString();
                string _code2 = _glFAProcessHd.Period.ToString();
                ...
                _yearLiteral.Text = HttpUtility.HtmlEncode(Convert.ToString(_glFAProcessHd.Year));

                Literal _periodLiteral = (Literal)e.Item.FindControl("PeriodLiteral");
                _periodLiteral.Text = HttpUtility.HtmlEncode(_glFAProcessHd.Period.ToString());

                Literal _statusLiteral = (Literal)e.Item.FindControl("StatusLiteral");
                _statusLiteral.Text = HttpUtility.HtmlEncode(FAProcessDataMapper.GetStatusText(_glFAProcessHd.Status));

                Literal _remarkLiteral = (Literal)e.Item.FindControl("RemarkLiteral");
                _remarkLiteral.Text = HttpUtility.HtmlEncode(_glFAProcessHd.Remark);
                ...
                _viewButton.PostBackUrl = this._detailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._codePeriod + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code2, ApplicationConfig.EncryptionKey));
                ...
                {
                    if (_glFAProcessHd.Status != FAProcessDataMapper.GetStatus(TransStatus.Posted))
                    {
                        _editButton.PostBackUrl = this._editPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._codePeriod + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code2, ApplicationConfig.EncryptionKey));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._faProcessBL.DeleteMultiFAProcessHd(_temp);
        ...
        {
            if (this.sortField.Value == "Period")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
