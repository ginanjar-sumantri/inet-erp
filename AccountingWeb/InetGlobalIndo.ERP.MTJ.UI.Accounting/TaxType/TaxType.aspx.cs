...
{
    public partial class TaxType : TaxTypeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._taxTypeBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._taxTypeBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsTaxType _temp = (MsTaxType)e.Item.DataItem;
                string _code = _temp.TaxTypeCode.ToString();
                ...
                _listCheckbox.Attributes.Add("OnClick", "CheckBox_Click(" + this.CheckHidden.ClientID + ", " + _listCheckbox.ClientID + ", '" + _code.ToString() + "', '" + awal + "', '" + akhir + "', '" + cbox + "')");
                ...
                Literal _currCodeLiteral = (Literal)e.Item.FindControl("TaxTypeCodeLiteral");
                _currCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.TaxTypeCode);

                Literal _currNameLiteral = (Literal)e.Item.FindControl("TaxTypeNameLiteral");
                _currNameLiteral.Text = HttpUtility.HtmlEncode(_temp.TaxTypeName);

                Literal _fgHomeLiteral = (Literal)e.Item.FindControl("ValueLitaral");
                _fgHomeLiteral.Text = HttpUtility.HtmlEncode(Convert.ToDecimal(_temp.DefaultValue).ToString("##.##"));

                String _accountName = this._accountBL.GetAccountNameByCode(_temp.Account);

                Literal _decimalPlaceLiteral = (Literal)e.Item.FindControl("AccountLiteral");
                _decimalPlaceLiteral.Text = HttpUtility.HtmlEncode(Convert.ToString(_accountName));

                //Literal _decimalPlaceReportLiteral = (Literal)e.Item.FindControl("DecimalPlaceReportLiteral");
                //_decimalPlaceReportLiteral.Text = HttpUtility.HtmlEncode(Convert.ToString(_temp.DecimalPlaceReport));

                Literal _valueToleranceLiteral = (Literal)e.Item.FindControl("FgActiveLiteral");
                _valueToleranceLiteral.Text = HttpUtility.HtmlEncode((_temp.fgActive == true ) ? "Yes" : "No");
            }
        }
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._taxTypeBL.DeleteMulti(_tempsplit);
