...
{
    public partial class FATenancyDetail : FATenancyBase
    {
        ...
        private string _reportPath1 = "FATenancy/FATenancyPrintPreview.rdlc";
        private string _reportPath2 = "FATenancy/JournalEntryPrintPreview.rdlc";
        private string _reportPath3 = "FATenancy/JournalEntryPrintPreviewHomeCurr.rdlc";
        ...
        {
            this._faTenancyBL = new FATenancyBL();
            ...
            _decimalPlace = _currencyBL.GetDecimalPlace(_glFATenancyHd.CurrCode);
            ...
            this.StatusLabel.Text = FixedAssetStatus.GetStatusText(_glFATenancyHd.Status);
            this.StatusHiddenField.Value = _glFATenancyHd.Status.ToString();
            this.CustCodeTextBox.Text = _customerBL.GetNameByCode(_glFATenancyHd.CustCode);
            this.CurrencyTextBox.Text = _glFATenancyHd.CurrCode;
            this.CurrencyRateTextBox.Text = _glFATenancyHd.ForexRate.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace));
            this.TermNameTextBox.Text = _termBL.GetTermNameByCode(_glFATenancyHd.Term);
            ...
            decimal _ppnRate = Convert.ToDecimal((_glFATenancyHd.PPNRate == null) ? 0 : _glFATenancyHd.PPNRate);
            ...
            {
                this.ListRepeater.DataSource = this._faTenancyBL.GetListGLFATenancyDt(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        private double RowCount()
        {
            ...
            _result = this._faTenancyBL.RowsCountGLFATenancyDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            GLFATenancyDt _temp = (GLFATenancyDt)e.Item.DataItem;
            ...
            _qty.Text = (_temp.Qty == 0) ? "0" : HttpUtility.HtmlEncode(_temp.Qty.ToString("#,###.##"));
            ...
            _price.Text = (_temp.Price == 0) ? "0" : HttpUtility.HtmlEncode(_temp.Price.ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace)));

            Literal _amountForex = (Literal)e.Item.FindControl("AmountLiteral");
            ...
            Literal _startTenancy = (Literal)e.Item.FindControl("StartPeriodLiteral");
            _startTenancy.Text = HttpUtility.HtmlEncode(_temp.StartTenancy.Date.ToShortDateString());

            Literal _endTenancy = (Literal)e.Item.FindControl("EndPeriodLiteral");
            _endTenancy.Text = HttpUtility.HtmlEncode(_temp.EndTenancy.Date.ToShortDateString());
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.FATenancyPrintPreview(this.TransNumberTextBox.Text);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._faTenancyBL.DeleteMultiGLFATenancyDt(_tempSplit, this.TransNumberTextBox.Text);
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == FixedAssetStatus.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._faTenancyBL.GetApprDevalution(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == FixedAssetStatus.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._faTenancyBL.ApproveFATenancy(this.TransNumberTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.Label.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == FixedAssetStatus.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._faTenancyBL.PostingFATenancy(this.TransNumberTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == FixedAssetStatus.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                string _result = this._faTenancyBL.UnpostingFATenancy(this.TransNumberTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
