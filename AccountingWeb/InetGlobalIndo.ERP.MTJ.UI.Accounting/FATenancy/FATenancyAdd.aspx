<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FATenancyAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FATenancy.FATenancyAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:CustomValidator ID="CustDDLCustomValidator" runat="server" ClientValidationFunction="DropDownValidation"
                                    ErrorMessage="Customer Must Be Filled" Text="*" ControlToValidate="CustCodeDropDownList">
                                </asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="CurrRateRequiredFieldValidator" runat="server" ErrorMessage="Currency Rate Must Be Filled"
                                                        Text="*" ControlToValidate="CurrencyRateTextBox" Display="Dynamic">
                                        ...
                                        <table cellpadding="3" cellspacing="1">
                                            <tr>
                                                ...
                                                <td align="center" style="width: 110px">
                                                    ...
                                                    <%--<input runat="server" id="ppn_date_start" style="visibility: hidden; width:20px;" type="button"
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="RemarkTextBox" TextMode="MultiLine" Width="300" Height="80"></asp:TextBox>
