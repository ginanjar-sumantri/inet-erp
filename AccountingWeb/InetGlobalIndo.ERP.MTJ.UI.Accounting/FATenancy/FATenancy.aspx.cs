...
{
    public partial class FATenancy : FATenancyBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._faTenancyBL.RowsCountGLFATenancyHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._faTenancyBL.GetListGLFATenancyHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                GLFATenancyHd _temp = (GLFATenancyHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status.ToString().Trim().ToLower() == FixedAssetStatus.GetStatus(TransStatus.Posted).ToString().Trim().ToLower())
                    {
                        _editButton.Visible = false;
                    }
                    else
                ...
                Literal _transNumber = (Literal)e.Item.FindControl("TransNumberLiteral");
                _transNumber.Text = HttpUtility.HtmlEncode(_temp.TransNmbr);
                ...
                _transDate.Text = _tempDate.Day + "/" + _tempDate.Month + "/" + _tempDate.Year;

                Literal _custName = (Literal)e.Item.FindControl("CustNameLiteral");
                _custName.Text = HttpUtility.HtmlEncode(_temp.CustName);

                Literal _term = (Literal)e.Item.FindControl("TermLiteral");
                _term.Text = HttpUtility.HtmlEncode(_temp.Term);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._faTenancyBL.GetSingleFATenancyHdApprove(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._faTenancyBL.DeleteMultiGLTenancyHd(_tempSplit);
                if (_result == true)
                {
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._faTenancyBL.DeleteMultiApproveGLTenancyHd(_tempSplit, AppModule.GetValue(TransactionType.FATenancy), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
