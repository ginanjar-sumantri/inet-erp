<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FATenancyDetailEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FATenancy.FATenancyDetailEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="FixedAssetTextBox" Width="560" BackColor="#CCCCCC"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="QtyTextBox" MaxLength="18" Width="150"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="AmountTextBox" Width="150" MaxLength="18" BackColor="#CCCCCC"></asp:TextBox>
