<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="FATenancyDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FATenancy.FATenancyDetail" %>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="CustCodeTextBox" Width="420" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="AttnTextBox" Width="280" MaxLength="40" ReadOnly="true"
                            ...
                            <tr>
                                ...
                                <td>
                                    <table cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                <asp:TextBox runat="server" ID="CurrencyTextBox" Width="70" MaxLength="5" BackColor="#CCCCCC"
                                                    ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:TextBox runat="server" ID="CurrencyRateTextBox" Width="150" BackColor="#CCCCCC"
                                                    ReadOnly="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="TermNameTextBox" Width="350" MaxLength="50" BackColor="#CCCCCC"
                                        ReadOnly="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table cellpadding="3" cellspacing="1">
                                        <tr>
                                            <td align="center" style="width: 110px">
                                                <asp:TextBox runat="server" ID="PPNTextBox" Width="100" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td align="center" style="width: 110px">
                                                <asp:TextBox runat="server" ID="PPNNoTextBox" Width="100" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td align="center" style="width: 110px">
                                                <asp:TextBox runat="server" ID="PPNDateTextBox" BackColor="#CCCCCC" Width="100" ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td align="center" style="width: 110px">
                                                <asp:TextBox runat="server" ID="PPNRateTextBox" BackColor="#CCCCCC" Width="100" ReadOnly="True"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table cellpadding="3" cellspacing="1">
                                        <tr>
                                            <td align="center" class="tahoma_11_white" style="width: 110px">
                                                <asp:TextBox runat="server" ID="CurrencyForexTextBox" Width="100px" BackColor="#CCCCCC"
                                                    ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td align="center" class="tahoma_11_white" style="width: 110px">
                                                <asp:TextBox runat="server" ID="BaseForexTextBox" Width="100px" BackColor="#CCCCCC"
                                                    ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td align="center" class="tahoma_11_white" style="width: 110px">
                                                <asp:TextBox runat="server" ID="DiscountTextBox" Width="100px" BackColor="#CCCCCC"
                                                    ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td align="center" class="tahoma_11_white" style="width: 110px">
                                                <asp:TextBox runat="server" ID="PPNForexTextBox" Width="100px" BackColor="#CCCCCC"
                                                    ReadOnly="True"></asp:TextBox>
                                            </td>
                                            <td align="center" class="tahoma_11_white" style="width: 110px">
                                ...
                                <td>
                                    ...
                                    <table cellpadding="3" cellspacing="1" width="0" border="0">
                                        <tr class="bgcolor_gray">
                                            ...
                                            <td class="tahoma_11_white" align="center" rowspan="2">
                                                <b>Action</b>
                                            </td>
                                            ...
                                            <td style="width: 70px" class="tahoma_11_white" align="center" rowspan="2">
                                                <b>Qty</b>
                                            </td>
                                            <td style="width: 70px" class="tahoma_11_white" align="center" rowspan="2">
                                                <b>Unit</b>
                                        ...
                                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                            <ItemTemplate>
                                                <tr id="RepeaterItemTemplate" runat="server">
                                                    ...
                                                    <td align="center">
                                                        <asp:Literal runat="server" ID="StartPeriodLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="center">
                                                        <asp:Literal runat="server" ID="EndPeriodLiteral"></asp:Literal>
                                                    </td>
                                                    <td align="left">
