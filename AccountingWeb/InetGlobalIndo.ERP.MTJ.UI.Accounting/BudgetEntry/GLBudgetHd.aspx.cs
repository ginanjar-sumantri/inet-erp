...
{
    public partial class GLBudgetHd : GLBudgetBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._glBudgetBL.RowsCountGLBudget(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._glBudgetBL.GetListGLBudget(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                GLBudget _temp = (GLBudget)e.Item.DataItem;

                string _code = _temp.BudgetCode.ToString();
                ...
                else
                {
                    ...
                    if (_tempStatus.ToLower() == GLBudgetDataMapper.GetStatus(GLBudgetStatus.Approved).ToString().ToLower())
                    {
                        _editButton.Visible = false;
                    }
                    else
                ...
                _startDateLiteral.Text = DateFormMapper.GetValue(_temp.StartDate);

                Literal _endDateLiteral = (Literal)e.Item.FindControl("EndDateLiteral");
                _endDateLiteral.Text = DateFormMapper.GetValue(_temp.EndDate);

                Literal _orgUnitLiteral = (Literal)e.Item.FindControl("OrgUnitLiteral");
                _orgUnitLiteral.Text = HttpUtility.HtmlEncode(_temp.OrgUnitName);

                Literal _statusLiteral = (Literal)e.Item.FindControl("StatusLiteral");
                _statusLiteral.Text = GLBudgetDataMapper.GetStatusText(_temp.Status);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._glBudgetBL.DeleteMultiGLBudget(_tempSplit);
