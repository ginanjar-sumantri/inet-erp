<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="AccSubGroupImport.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.AccSubGroup.AccSubGroupImport" %>
    ...
    <asp:Panel runat="server" ID="LogPanel">
        <table>
            ...
            <tr>
                <td>
                    <fieldset>
                        <legend>Account Sub Group Import Log</legend>
