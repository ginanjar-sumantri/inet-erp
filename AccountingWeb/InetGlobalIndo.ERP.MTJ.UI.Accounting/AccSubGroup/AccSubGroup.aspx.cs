...
{
    public partial class AccSubGroup : AccSubGroupBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.GetFormatExcelLiteral.Text = "<a href='" + ApplicationConfig.AccountingFormatVirDirPath + "Account Sub Group.xls'>" + "<img src='" + ApplicationConfig.HomeWebAppURL + "images/download_excel.jpg" + "' border='0'>" + "</a>";
        ...
        private double RowCount()
        {
            ...
            _result = this._accSubGroupBL.RowsCountAccSubGroup(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._accSubGroupBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsAccSubGroup _temp = (MsAccSubGroup)e.Item.DataItem;
                string _code = _temp.AccSubGroupCode.ToString();
                ...
                Literal _accSubGroupCode = (Literal)e.Item.FindControl("AccSubGroupCodeLiteral");
                _accSubGroupCode.Text = HttpUtility.HtmlEncode(_temp.AccSubGroupCode);

                Literal _accSubGroupName = (Literal)e.Item.FindControl("AccSubGroupNameLiteral");
                _accSubGroupName.Text = HttpUtility.HtmlEncode(_temp.AccSubGroupName);

                Literal _accGroupName = (Literal)e.Item.FindControl("AccGroupNameLiteral");
                _accGroupName.Text = HttpUtility.HtmlEncode(_temp.AccGroup);

                CheckBox _listCheckbox = (CheckBox)e.Item.FindControl("ListCheckBox");
                //_cb.Attributes.Add("OnClick", "CheckBox_Click(" + this.CheckHidden.ClientID + "," + _cb.ClientID + ",'" + _code + "', '" + awal + "' , '" + akhir + "', '" + cbox + "','" + _tempHidden + "' )");
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._accSubGroupBL.DeleteMulti(_tempsplit);
        ...
        {
            if (this.sortField.Value == "Account Sub Group Code")
            {
            ...
            else
            {
                ...
                this.sortField.Value = "Account Sub Group Code";
                this.ascDesc.Value = "true";
        ...
        {
            if (this.sortField.Value == "Account Sub Group Name")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            else
            {
                ...
                this.sortField.Value = "Account Sub Group Name";
                this.ascDesc.Value = "true";
        ...
        {
            if (this.sortField.Value == "Account Group")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            else
            {
                ...
                this.sortField.Value = "Account Group";
                this.ascDesc.Value = "true";
