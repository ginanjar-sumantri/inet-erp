...
{
    public partial class DefaultAccountDetail : DefaultAccountBase
    {
        private SetupBL _setupBL = new SetupBL();
        private PermissionBL _permBL = new PermissionBL();
        private AccountBL _accountingBL = new AccountBL();
        ...
        public void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.SetupNameTextBox.Text = _msDefault.SetDescription;
            ...
            {
                this.ListRepeater.DataSource = this._setupBL.GetListMasterDefAcc(_prmCurrentPage, _maxrow, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
            }
        ...
        private double RowCount()
        {
            ...
            _result = this._setupBL.RowsCountMasterDefAcc(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Master_DefaultAcc _temp = (Master_DefaultAcc)e.Item.DataItem;
                ...
                //_editButton.PostBackUrl = this._editDetailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(this._nvcExtractor.GetValue(this._codeKey)) + "&" + this._codeValue + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                ...
                string _accName = this._accountingBL.GetAccountNameByCode(_temp.Account);
                Literal _accNameLiteral = (Literal)e.Item.FindControl("AccNameLiteral");
                _accNameLiteral.Text = _accName;

                string _curr = this._accountingBL.GetSingleAccount(_temp.Account).CurrCode;
                Literal _currLiteral = (Literal)e.Item.FindControl("CurrLiteral");
                _currLiteral.Text = _curr;
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._setupBL.DeleteMultiMasterDefAcc(_tempsplit, Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
