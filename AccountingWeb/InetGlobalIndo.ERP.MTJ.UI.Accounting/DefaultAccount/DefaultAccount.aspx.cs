...
{
    public partial class DefaultAccount : DefaultAccountBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._setupBL.RowsCountMasterDefault(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._setupBL.GetListMasterDefault(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Master_Default _temp = (Master_Default)e.Item.DataItem;
                string _code = _temp.SetCode;
                ...
                Literal _setCode = (Literal)e.Item.FindControl("SetCodeLiteral");
                _setCode.Text = HttpUtility.HtmlEncode(_temp.SetCode);

                Literal _setName = (Literal)e.Item.FindControl("SetupNameLiteral");
                _setName.Text = HttpUtility.HtmlEncode(_temp.SetDescription);
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            bool _result = this._setupBL.DeleteMultiMasterDefault(_tempsplit);
