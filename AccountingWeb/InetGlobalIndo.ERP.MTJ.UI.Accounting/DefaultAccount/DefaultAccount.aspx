<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DefaultAccount.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.DefaultAccount.DefaultAccount" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Setup Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Setup Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                                ...
                                                <td align="left">
                                                    <table cellpadding="0" cellspacing="0" width="0" border="0">
                                                        <tr>
                                                            ...
                                                            <%--<td style="padding-left: 4px">
                                                                <asp:ImageButton runat="server" ID="SetDetailButton" />
                                                            </td>--%>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="SetCodeLiteral"></asp:Literal>
                                                </td>
                                                <td>
                                                    <asp:Literal runat="server" ID="SetupNameLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
