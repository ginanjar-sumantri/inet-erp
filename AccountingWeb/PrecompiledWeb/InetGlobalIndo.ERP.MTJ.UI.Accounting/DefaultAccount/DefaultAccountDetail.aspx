<%@ page language="C#" masterpagefile="~/default.master" autoeventwireup="true" inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.DefaultAccount.DefaultAccountDetail, App_Web_b6fxii-d" %>
                    ...
                    <fieldset>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="SetupCodeTextBox" ReadOnly="true" Width="70" BackColor="#CCCCCC"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="SetupNameTextBox" runat="server" BackColor="#CCCCCC" ReadOnly="true"
