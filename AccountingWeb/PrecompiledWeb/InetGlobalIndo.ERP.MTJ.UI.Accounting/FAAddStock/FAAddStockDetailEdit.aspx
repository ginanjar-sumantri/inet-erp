<%@ page language="C#" masterpagefile="~/default.master" autoeventwireup="true" inherits="InetGlobalIndo.ERP.MTJ.UI.Accounting.FAAddStock.FAAddStockDetailEdit, App_Web_81lgxtde" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="FANameTextBox" runat="server" Width="420" MaxLength="80">
                                </asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="DropDownValidation"
                                            ErrorMessage="Currency Must Be Choosed" Text="*" ControlToValidate="CurrDropDownList">
                                        </asp:CustomValidator>
