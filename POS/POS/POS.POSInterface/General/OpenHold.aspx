<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OpenHold.aspx.cs" Inherits="General_Member" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>POS Open Hold</title>
...
<body id="bodyPosOpenHold">
    ...
    <div class="container">
        ...
        <div style="float: left; padding-left: 9px; width: 98%;">
                ...
                <div class="table-body table-container-scroll">
                    <table class="dragger">
                        <asp:Repeater ID="ListRepeater" runat="server" OnItemCommand="ListRepeater_ItemCommand"
                            ...
                            <ItemTemplate>
                                <tr id="RepeaterList" runat="server">
                                    <td class="number">
                                        <asp:Literal ID="NoLiteral" runat="server"></asp:Literal>
                                    </td>
                                    <td class="job-order">
                                        <asp:Literal ID="JobOrderLiteral" runat="server"></asp:Literal>
                                    </td>
                                    <td class="reference-no">
                                        <asp:Literal ID="RefNoLiteral" runat="server"></asp:Literal>
                                    </td>
                                    <td class="customer-name">
                                    ...
                                    <td class="action">
                                        <asp:ImageButton ID="CancelOrder" class="CancelOrder" runat="server" />
                                        <asp:ImageButton ID="OpenHold" class="OpenHold" runat="server" />
