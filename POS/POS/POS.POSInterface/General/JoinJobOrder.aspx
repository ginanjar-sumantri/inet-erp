<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JoinJobOrder.aspx.cs" Inherits="General_JoinJobOrder" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>POS Join Job Order</title>
    <style type="text/css">
        BODY
        {
            margin: 0px;
...
<body id="bodyPosJoinJobOrder">
    ...
    <div class="container">
        ...
        <div style="float: left; padding-left: 5px; width: 64%;">
            <div class="productListBoxLeft">
                <div class="productListBox">
                    <table cellpadding="3" cellspacing="1" width="0" border="0">
                        <tr class="bgproductListBox">
                            ...
                            <td class="job-order" align="center">
                                <b>Job Order</b>
                            </td>
                ...
                <div class="productListBoxRepeater table-container-scroll">
                    ...
                    <table class="dragger" cellpadding="3" cellspacing="1" width="0" border="0">
                        <asp:Repeater ID="JobOrderListRepeater" runat="server" OnItemDataBound="JobOrderListRepeater_ItemDataBound"
                            OnItemCommand="JobOrderListRepeater_ItemCommand">
                            <ItemTemplate>
                                <tr id="RepeaterTemplate" runat="server">
                                    ...
                                    <td class="action" align="center">
                                        ...
                                        <asp:ImageButton runat="server" ID="ViewJobOrderButton" class="ViewJobOrderButton" />
                                        <asp:ImageButton runat="server" ID="JoinJobOrderButton" class="JoinJobOrderButton" />
        ...
        <div style="float: left; padding-left: 5px; width: 35%;">
            ...
            <asp:Panel ID="PasswordPanel" runat="server">
                <div class="productDetailListBox">
                    <table cellpadding="3" cellspacing="1" width="0" border="0">
                        <tr class="bgproductListBox">
                            <td style="width: 190px; font-size: 16px; text-align: left" class="table-header">
