...
namespace POS.POSInterface.Printing
{
    public partial class POSPrinting : POSPrintingBase
    {
        private POSPrintingBL _posPrintingBL = new POSPrintingBL();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.Page.IsPostBack == true)
                {
                    ...
                    this.JoinJobOrderImageButton.OnClientClick = "window.open('../General/JoinJobOrder.aspx?valueCatcher=findTransNmbr&pos=printing','_popSearch','fullscreen=yes,toolbar=0,location=0,status=0,scrollbars=1')";
                    this.CheckStatusImageButton.OnClientClick = "window.open('../General/CheckStatus.aspx?pos=printing','_popSearch','fullscreen=yes,toolbar=0,location=0,status=0,scrollbars=1')";
                    ...
                    //0011|1|Product Test|5000.00|0|5000|
                    ...
                    //spawnJS += "function findProduct(x) {\n";
                    //spawnJS += "dataArray = x.split ('|') ;\n";
                    //spawnJS += "document.getElementById('" + this.BoughtItemHiddenField.ClientID + "').value = dataArray [0];\n";
                    //spawnJS += "document.forms[0].submit();\n";
                    //spawnJS += "}\n";
                    ...
                    spawnJS += "window.open('../General/KeyBoard.aspx?valueCatcher=findNotes&titleinput=Counter&textbox=x','_popSearch','fullscreen=yes,toolbar=0,location=0,status=0,scrollbars=1') \n";
                    spawnJS += "}\n";
                ...
                if (Rijndael.Decrypt(this._nvcExtractor.GetValue(this._referenceNo), ApplicationConfig.EncryptionKey) != "")
                {
                    ...
                    POSTrDeliveryOrderRef _pOSTrDeliveryOrderRef = this._customerDOBL.GetSingleTrDeliveryOrderRefByReferenceNoTransType(_splitCode[0], POSTransTypeDataMapper.GetTransType(POSTransType.Printing));
                ...
                this.NotesTextBox.Attributes.Add("OnKeyUp", "return formatangka(" + this.NotesTextBox.ClientID + ")");
                ...
                this.ProductGroupRepeater.DataSource = _posPrintingBL.GetListProductGroup(Convert.ToInt16(this.ProductGroupPageHiddenField.Value), 6);
            ...
            try
            {
                if (this.BoughtItemHiddenField.Value != "")
                {
                    ...
                    foreach (String _boughtItemRow in _boughtItemRows)
                    {
                        ...
                        {
                            POSTrPrintingHd _internetHd = this._posPrintingBL.GetSinglePOSTrPrintingHd(this.TransRefTextBox.Text);
                            ...
                            List<POSTrPrintingDt> _listPrintingDt = this._posPrintingBL.GetListPrintingDtByTransNmbr(this.TransRefTextBox.Text);
                            foreach (var _row in _listPrintingDt)
                            {
        ...
        protected void LoadHoldedData()
        {
            try
            {
                POSTrPrintingHd _printingHd = this._posPrintingBL.GetSinglePOSTrPrintingHd(this.TransRefTextBox.Text);
                if (_printingHd != null)
                {
                    if (this.MemberNameTextBox.Text == "")
                    {
                        this.ReferenceTextBox.Text = _printingHd.ReferenceNo;
                        this.MemberNoTextBox.Text = _printingHd.MemberID;
                        this.MemberNameTextBox.Text = ((_printingHd.MemberID == "") ? "" : this._memberBL.GetSingleByBarcode(_printingHd.MemberID).MemberName);
                        if (this.MemberNameTextBox.Text == "" && _printingHd.CustName != "")
                        {
                            this.MemberNameTextBox.Text = _printingHd.CustName;
                        }
                        this.CustPhoneTextBox.Text = _printingHd.CustPhone;
                    }
                    if (_printingHd.MemberID.ToString().Trim() != "")
                    {
                        this.MemberNameTextBox.Attributes.Add("ReadOnly", "True");
                        this.MemberNameTextBox.Attributes.Add("style", "color: #808080");
                        this.CustPhoneTextBox.Attributes.Add("ReadOnly", "True");
                ...
                foreach (var _row in _listPrintingDt)
                {
                    ...
                    {
                        Decimal _msProductPrice = this._productBL.GetProductSalesPriceForPOS(_row.ProductCode, _printingHd.CurrCode, _msProduct.Unit);
                        Decimal _tax = (_msProductType.TaxValue == null) ? 0 : Convert.ToDecimal(_msProductType.TaxValue);
            ...
            try
            {
                ...
                if (this.BoughtItemHiddenField.Value != "")
                {
                    ...
                    foreach (String _boughtItemRow in _boughtItemRows)
                    {
                        ...
                        MsProduct _msProduct = _posPrintingBL.GetSingleProduct(_boughtItemFields[0]);
        ...
        protected void ProductGroupButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.ProductSubGroupRepeater.DataSource = _posPrintingBL.GetListProductSubGroup(this.ProductGroupHiddenField.Value, Convert.ToInt16(this.ProductSubGroupPageHiddenField.Value), 2);
        ...
        protected void ProductSubGroupButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.ProductRepeater.DataSource = _posPrintingBL.GetListProduct(this.ProductSubGroupHiddenField.Value, Convert.ToInt16(this.ProductPageHiddenField.Value), 28);
                this.ProductRepeater.DataBind();
        ...
        protected void ProductButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Button _temp = (Button)sender;
                MsProduct _msProduct = _posPrintingBL.GetSingleProduct(_temp.ToolTip);
                this.ProductHiddenField.Value = _msProduct.ProductCode;
                Decimal _msProductPrice = this._productBL.GetProductSalesPriceForPOS(_msProduct.ProductCode, "IDR", _msProduct.Unit);
        ...
        protected void NextProductGroupButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                int _currPage = Convert.ToInt16(this.ProductGroupPageHiddenField.Value);
                if (_currPage < _posPrintingBL.GetProductGroupMaxPage(6)) _currPage++;
                this.ProductGroupPageHiddenField.Value = _currPage.ToString();
        ...
        protected void NextProductSubGroupButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                int _currPage = Convert.ToInt16(this.ProductSubGroupPageHiddenField.Value);
                if (_currPage < _posPrintingBL.GetProductSubGroupMaxPage(3, this.ProductGroupHiddenField.Value)) _currPage++;
                this.ProductSubGroupPageHiddenField.Value = _currPage.ToString();
        ...
        protected void ProductPrevButton_Click(object sender, EventArgs e)
        {
            ...
            {
                int _currPage = Convert.ToInt16(this.ProductPageHiddenField.Value);
                if (_currPage < _posPrintingBL.GetProductMaxPage(40, this.ProductSubGroupHiddenField.Value)) _currPage++;
                this.ProductPageHiddenField.Value = _currPage.ToString();
            ...
            try
            {
                if (this.ReferenceTextBox.Text != "")
                {
                    ...
                    if (this.BoughtItemHiddenField.Value != "")
                    {
                        if (this.TransRefTextBox.Text != "")
                        {
                            POSTrPrintingHd _posTrPrintingHd = this._posPrintingBL.GetSinglePOSTrPrintingHd(this.TransRefTextBox.Text);
                            if (_posTrPrintingHd == null)
                            {
                                _posTrPrintingHd = new POSTrPrintingHd();
                            }
                            _posTrPrintingHd.TransType = POSTransTypeDataMapper.GetTransType(POSTransType.Printing);
                            _posTrPrintingHd.TransDate = DateTime.Now;
                            _posTrPrintingHd.ReferenceNo = this.ReferenceTextBox.Text;
                            _posTrPrintingHd.MemberID = this.MemberNoTextBox.Text;
                            _posTrPrintingHd.CustName = this.MemberNameTextBox.Text;
                            _posTrPrintingHd.CustPhone = this.CustPhoneTextBox.Text;
                            if (this.ReferenceNoHiddenField.Value == "")
                            {
                                _posTrPrintingHd.Status = POSTrPrintingDataMapper.GetStatus(POSTrPrintingStatus.SendToCashier);
                            }
                            else
                            {
                                _posTrPrintingHd.Status = POSTrPrintingDataMapper.GetStatus(POSTrPrintingStatus.DeliveryOrder);
                                _posTrPrintingHd.DeliveryOrderReff = this.ReferenceTextBox.Text;
                            }

                            _posTrPrintingHd.IsVOID = false;
                            _posTrPrintingHd.CurrCode = "IDR";
                            _posTrPrintingHd.ForexRate = 1;
                            _posTrPrintingHd.SubTotalForex = Convert.ToDecimal(this.SubTotalLabel.Text);
                            _posTrPrintingHd.ServiceChargeAmount = Convert.ToDecimal(this.ServiceChargeLabel.Text);
                            _posTrPrintingHd.DiscPercentage = 0;
                            _posTrPrintingHd.DiscForex = Convert.ToDecimal(this.DiscountLabel.Text);
                            _posTrPrintingHd.PPNPercentage = 0;
                            _posTrPrintingHd.PPNForex = Convert.ToDecimal(this.TaxHiddenField.Value);//Convert.ToDecimal(this.TaxLabel.Text);
                            _posTrPrintingHd.PB1Forex = Convert.ToDecimal(this.PB1HiddenField.Value);
                            _posTrPrintingHd.OtherForex = 0;
                            _posTrPrintingHd.TotalForex = Convert.ToDecimal(this.TotalLabel.Text);
                            _posTrPrintingHd.Remark = this.NotesTextBox.Text;
                            _posTrPrintingHd.FakturPajakNmbr = "";
                            _posTrPrintingHd.FakturPajakDate = DateTime.Now;
                            _posTrPrintingHd.FakturPajakRate = 0;
                            _posTrPrintingHd.UserPrep = this.CashierLabel.Text;
                            _posTrPrintingHd.DatePrep = DateTime.Now;
                            _posTrPrintingHd.DoneSettlement = POSTrSettlementDataMapper.GetDoneSettlement(POSDoneSettlementStatus.NotYet);
                            _posTrPrintingHd.DeliveryStatus = POSTrSettlementDataMapper.GetDeliveryStatus(POSDeliveryStatus.NotYetDelivered);

                            String _resultSendToCashier = this._posPrintingBL.SendToCashier(_posTrPrintingHd, this.BoughtItemHiddenField.Value);
                        ...
                        else
                        {
                            if (this.ReferenceNoHiddenField.Value == "")
                            {
                                POSTrPrintingHd _posTrPrintingHd = new POSTrPrintingHd();
                                _posTrPrintingHd.TransType = POSTransTypeDataMapper.GetTransType(POSTransType.Printing);
                                _posTrPrintingHd.TransDate = DateTime.Now;
                                _posTrPrintingHd.ReferenceNo = this.ReferenceTextBox.Text;
                                _posTrPrintingHd.MemberID = this.MemberNoTextBox.Text;
                                _posTrPrintingHd.CustName = this.MemberNameTextBox.Text;
                                _posTrPrintingHd.CustPhone = this.CustPhoneTextBox.Text;
                                _posTrPrintingHd.OperatorID = this.CashierLabel.Text;
                                _posTrPrintingHd.Status = POSTrPrintingDataMapper.GetStatus(POSTrPrintingStatus.SendToCashier);
                                _posTrPrintingHd.IsVOID = false;
                                _posTrPrintingHd.CurrCode = "IDR";
                                _posTrPrintingHd.ForexRate = 1;
                            ...
                            else
                            {
                                ...
                                _posTrDeliveryOrderRef.TransType = POSTransTypeDataMapper.GetTransType(POSTransType.Printing);

                                String _resultSendToCashier = this._posPrintingBL.SendToCashierForDeliveryOrder(_posTrPrintingHd, this.BoughtItemHiddenField.Value, _posTrDeliveryOrderRef);
                                // if DO then back to Page DO
                                if (this.ReferenceNoHiddenField.Value != "" & _resultSendToCashier != "")
                                {
                                    Response.Redirect("../DeliveryOrder/ListDeliveryOrder.aspx" + "?" + "referenceNo=" + HttpUtility.UrlEncode(Rijndael.Encrypt(this.ReferenceNoHiddenField.Value, ApplicationConfig.EncryptionKey)));
        ...
        protected void ReasonListRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.ToString() == "PickButton")
                {
                    ...
                    _result = this._posPrintingBL.SetVOID(this.TransRefTextBox.Text, e.CommandArgument.ToString(), true);
                    if (_result == true)
                    {
                        if (this.ReferenceNoHiddenField.Value != "")
                        {
        ...
        protected void errorhandler(Exception ex)
        {
            ...
            String _errorCode = new ErrorLogBL().CreateErrorLog(ex.Message, ex.StackTrace, HttpContext.Current.User.Identity.Name, "POS", "PRINTING");
