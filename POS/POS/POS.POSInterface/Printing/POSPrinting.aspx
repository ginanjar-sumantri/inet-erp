<%@ Page Language="C#" AutoEventWireup="true" CodeFile="POSPrinting.aspx.cs" Inherits="POS.POSInterface.Printing.POSPrinting"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $('#bodyPrinting .container .header .right .date #tanggal').text(Hari[dateObject.getDay()] + ', ' + dateObject.getDate() + ' ' + Bulan[dateObject.getMonth()] + ' ' + (dateObject.getYear() + 1900));
        $('#bodyPrinting .container .header .right .date #jam').text(hour + ':' + minute + ':' + second);
        function updateJam() {
            var dateObject = new Date();
            var Hari = new Array("SUNDAY", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY");
            var Bulan = new Array("JANUARY", "FEBRUARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER");
            ...
            <div class="content">
                <div class="left">
                    <div class="table">
                        ...
                        <div class="input">
                            <asp:Button ID="NewMemberButton" ToolTip="NewMember" runat="server" OnClick="NewMemberButton_Click" />
                        </div>
                    </div>
                    <div class="order">
