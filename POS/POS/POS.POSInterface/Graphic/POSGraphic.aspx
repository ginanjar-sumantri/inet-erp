<%@ Page Language="C#" AutoEventWireup="true" CodeFile="POSGraphic.aspx.cs" Inherits="POS.POSInterface.Graphic.POSGraphic"
    EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>POS Graphic</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        $('#bodyGraphic .container .header .right .date #tanggal').text(Hari[dateObject.getDay()] + ', ' + dateObject.getDate() + ' ' + Bulan[dateObject.getMonth()] + ' ' + (dateObject.getYear() + 1900));
        $('#bodyGraphic .container .header .right .date #jam').text(hour + ':' + minute + ':' + second);
        function updateJam() {
            var dateObject = new Date();
            var Hari = new Array("SUNDAY", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY");
            var Bulan = new Array("JANUARY", "FEBRUARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER");
                ...
                <div class="right">
                    ...
                    <div class="navigator">
                        <div class="navigator-left">
                            ...
                            <asp:ImageButton runat="server" class="button-submit" ID="CashierButton" PostBackUrl="../General/Cashier.aspx" /></div>
