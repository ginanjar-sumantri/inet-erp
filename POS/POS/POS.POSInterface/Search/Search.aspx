<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="Search_Search" %>
        ...
        $('.table-container-scroll').dragscrollable({dragSelector: '.dragger td', acceptPropagatedEvent: false});
            ...
            $(".KeyboardDiv input").click(function() {
                if (this.value == "^^^^^") {
                    ...
                    $("#whereValue").val($("#whereValue").val() + " ");
                } else if (this.value == "BACKSPACE") {
                    if ($("#whereValue").val().length > 0)
                        $("#whereValue").val($("#whereValue").val().substr(0, $("#whereValue").val().length - 1));
                } else {
                    $("#whereValue").val($("#whereValue").val() + this.value);
                }
            });
        });
    </script>
...
<body id="bodySerachCriteria">
    ...
    <div class="container">
        ...
        <div class="containerBox">
                    ...
                    <tr>
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <asp:ImageButton ID="btnFilter" runat="server" OnClick="btnFilter_Click" CausesValidation="false" />
                                    </td>
                                    <td>
                                        <asp:ImageButton runat="server" ID="BackButton" />
                                    </td>
                                    <td>
                                        <asp:ImageButton runat="server" ID="ResetButton" OnClick="ResetButton_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <%--<div class="logoBox">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <asp:Image runat="server" ID="ImageLogo" />
                        </td>
                    </tr>
                </table>
            </div>--%>
        ...
        <%--   <br />--%>
        <div class="contentSearchList">
            <div class="criteriaSearchList2">
                <div class="table-body table-container-scroll">
                    <table border="0" cellspacing="0" cellpadding="3" width="960px" class="dragger">
                        <tr class="bgProductListSearch" align="center">
                            <td>
                            </td>
                        ...
                        <asp:Repeater ID="hasilPencarian" runat="server" OnItemDataBound="hasilPencarian_ItemDataBound">
                            <ItemTemplate>
                                <tr style="font-size: 14px; padding-bottom: 100px;">
                                    <td>
                                        <%--<asp:ImageButton ID="btnPilih" runat="server" Width="30px" Height="30px" />--%>
                                      
                                        <asp:Button ID="btnPilih" runat="server" Width="30px" Height="30px" class="btnPilih" />
                                    </td>
            ...
            <div class="criteriaSearchList3 table-navigation-scroll">
                <div class="up"></div>
                <div class="down"></div>
            </div>
        </div>
    ...
    <%--<table border="1" cellspacing="0" cellpadding="3">
            ...
            <asp:Repeater ID="hasilPencarian" runat="server" OnItemDataBound="hasilPencarian_ItemDataBound">
                <ItemTemplate>
                    <tr>
                        <td>
                            <asp:Button ID="btnPilih" runat="server" Width="50px" Height="50px" />
                        </td>
                        <asp:Literal ID="rowContent" runat="server"></asp:Literal>
                    </tr>
                </ItemTemplate>
