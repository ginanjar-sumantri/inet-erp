<%@ Page Language="C#" AutoEventWireup="true" CodeFile="POSCafeReservation.aspx.cs"
    Inherits="POS.POSInterface.Cafe.POSCafeReservation" EnableEventValidation="false" %>
                            ...
                            <table class="width">
                                <tr>
                                    ...
                                    <td style="width: 190px">
                                        <asp:TextBox runat="server" Width="120px" ID="MemberNoTextBox" OnTextChanged="MemberNoTextBox_TextChanged"
...
--%>                        </div>
                        <div style="clear: both; padding-left: 6px;">
                            <table>
                                <tr>
                                    <td>
                                        <asp:ImageButton ID="BackButton" runat="server" CausesValidation="false" OnClick="BackImageButton_Click" />
                                    </td>
                                    <td style="padding-left: 10px;">
                                        <asp:ImageButton runat="server" ID="SaveButton" OnClick="SaveImageButton_Click" />
                                    </td>
                                    <td style="padding-left: 10px;">
                                        <asp:ImageButton ID="SearchButton" runat="server" CausesValidation="false" OnClick="SearchImageButton_Click" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <div class="avialableTable">
                                ...
                                <div style="float: left; padding-left: 0px; width: 0px; clear: both;">
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:ImageButton ID="CancelAllImageButton" runat="server" CausesValidation="false"
                                                    ...
                                                    <tr style="height: 12px;" class="repeaterAvailableTable2">
                                                        ...
                                                        <td align="center" style="width: 260px" align="center">
                                                            ...
                                                            <div style="padding-left: 80px;">
                                                                <asp:ImageButton ID="OpenBookedButton" Class="OpenBookedButton" runat="server" CausesValidation="false" /></div>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
