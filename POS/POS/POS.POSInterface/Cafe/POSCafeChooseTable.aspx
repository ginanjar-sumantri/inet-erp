<%@ Page Language="C#" AutoEventWireup="true" CodeFile="POSCafeChooseTable.aspx.cs"
    Inherits="POS.POSInterface.Cafe.POSCafeChooseTable" EnableEventValidation="false" %>
                ...
                <div class="left">
                    <div class="table">
                        <div class="table-inner-left">
                            ...
                            <div class="input-form" id="pax">
                                <div class="label">
                                    Pax</div>
                                <div class="sep">
                                    :</div>
                                <div class="input">
                                    <asp:TextBox ID="PaxTextBox" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="clear">
                            </div>
