<%@ Page Language="C#" AutoEventWireup="true" CodeFile="POSInternet.aspx.cs" Inherits="POS.POSInterface.Internet.POSInternet"
            ...
            <div class="right">
                <div class="right-inner">
                    ...
                    <div class="time-setting">
                        ...
                        <div class="right-inner">
                            <asp:ImageButton runat="server" ID="ButtonStopInternet" OnClick="ButtonStopInternet_Click" />
                        </div>
                        <div class="left-inner">
                            <div class="to-table">
                                <div class="label">
                                    Time</div>
                                <div class="input">
                                    <asp:DropDownList runat="server" ID="TimeDropdownList">
                        ...
                        <div class="right-inner2">
                            <asp:ImageButton runat="server" ID="ButtonAddTimeInternet" OnClick="ButtonAddTimeInternet_Click" />
                        </div>
                        <div class="left-inner">
