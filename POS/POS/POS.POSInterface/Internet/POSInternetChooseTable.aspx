<%@ Page Language="C#" AutoEventWireup="true" CodeFile="POSInternetChooseTable.aspx.cs"
    Inherits="POS.POSInterface.Internet.POSInternetChooseTable" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $('#bodyChooseTable .container .header .right .date #tanggal').text(Hari[dateObject.getDay()] + ', ' + dateObject.getDate() + ' ' + Bulan[dateObject.getMonth()] + ' ' + (dateObject.getYear() + 1900));
        $('#bodyChooseTable .container .header .right .date #jam').text(hour + ':' + minute + ':' + second);
        function updateJam() {
            var dateObject = new Date();
            var Hari = new Array("SUNDAY", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY");
            var Bulan = new Array("JANUARY", "FEBRUARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER");
            ...
            <div class="left">
                <div class="table">
                    <div class="table-inner-left">
                        ...
                        <div class="input-form" id="register">
                            <div class="label">
                            </div>
                            <div class="sep">
                            </div>
                    ...
                    <div class="table-inner-right">
                        <asp:HiddenField runat="server" ID="TableIDPerRoomHiddenField" />
                        <asp:HiddenField runat="server" ID="FloorNumberHiddenField" />
                        <div class="label">
                            Table No.</div>
                        <div class="number">
                            <asp:Label runat="server" ID="TableNumberLabel"></asp:Label>
                        </div>
                    </div>
                </div>
                <div class="order">
            ...
            <div class="right">
                ...
                <div class="navigator">
                    <div class="navigator-left">
                        ...
                        <asp:ImageButton runat="server" class="button-submit" ID="LayoutMapImageButton" OnClick="LayoutMapImageButton_Click" />
        ...
        <asp:Panel runat="server" ID="ReasonListPanel">
            ...
            <div class="reasonback">
                <table cellpadding="3" cellspacing="0" width="0" border="0">
                    <tr>
                        <td>
                            <asp:ImageButton runat="server" ID="Back2ImageButton" text=""
                                onclick="Back2ImageButton_Click" />
                        </td>
                    </tr>
                </table>
            </div>
