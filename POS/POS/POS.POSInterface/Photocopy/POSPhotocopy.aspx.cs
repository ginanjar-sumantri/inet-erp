...
namespace POS.POSInterface.Photocopy
{
    public partial class POSPhotocopy : POSPhotocopyBase
    {
        private POSPhotocopyBL _posPhotocopyBL = new POSPhotocopyBL();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.Page.IsPostBack == true)
                {
                    ...
                    this.JoinJobOrderImageButton.OnClientClick = "window.open('../General/JoinJobOrder.aspx?valueCatcher=findTransNmbr&pos=photocopy','_popSearch','fullscreen=yes,toolbar=0,location=0,status=0,scrollbars=1')";
                    this.CheckStatusImageButton.OnClientClick = "window.open('../General/CheckStatus.aspx?pos=photocopy','_popSearch','fullscreen=yes,toolbar=0,location=0,status=0,scrollbars=1')";
                ...
                if (Rijndael.Decrypt(this._nvcExtractor.GetValue(this._referenceNo), ApplicationConfig.EncryptionKey) != "")
                {
                    ...
                    POSTrDeliveryOrderRef _pOSTrDeliveryOrderRef = this._customerDOBL.GetSingleTrDeliveryOrderRefByReferenceNoTransType(_splitCode[0], POSTransTypeDataMapper.GetTransType(POSTransType.Photocopy));
                ...
                this.ProductGroupRepeater.DataSource = _posPhotocopyBL.GetListProductGroup(Convert.ToInt16(this.ProductGroupPageHiddenField.Value), 6);
            ...
            try
            {
                if (this.BoughtItemHiddenField.Value != "")
                {
                    ...
                    foreach (String _boughtItemRow in _boughtItemRows)
                    {
                        ...
                        {
                            POSTrPhotocopyHd _internetHd = this._posPhotocopyBL.GetSinglePOSTrPhotocopyHd(this.TransRefTextBox.Text);
                            ...
                            List<POSTrPhotocopyDt> _listPhotocopyDt = this._posPhotocopyBL.GetListPhotocopyDtByTransNmbr(this.TransRefTextBox.Text);
                            foreach (var _row in _listPhotocopyDt)
                            {
        ...
        protected void LoadHoldedData()
        {
            try
            {
                POSTrPhotocopyHd _PhotocopyHd = this._posPhotocopyBL.GetSinglePOSTrPhotocopyHd(this.TransRefTextBox.Text);
                if (_PhotocopyHd != null)
                {
                    if (this.MemberNameTextBox.Text == "")
                    {
                        this.ReferenceTextBox.Text = _PhotocopyHd.ReferenceNo;
                        this.MemberNoTextBox.Text = _PhotocopyHd.MemberID;
                        this.MemberNameTextBox.Text = ((_PhotocopyHd.MemberID == "") ? "" : this._memberBL.GetSingleByBarcode(_PhotocopyHd.MemberID).MemberName);
                        if (this.MemberNameTextBox.Text == "" && _PhotocopyHd.CustName != "")
                        {
                            this.MemberNameTextBox.Text = _PhotocopyHd.CustName;
                        }
                        this.CustPhoneTextBox.Text = _PhotocopyHd.CustPhone;
                    }
                    if (_PhotocopyHd.MemberID.ToString().Trim() != "")
                    {
                        this.MemberNameTextBox.Attributes.Add("ReadOnly", "True");
                        this.MemberNameTextBox.Attributes.Add("style", "color: #808080");
                        this.CustPhoneTextBox.Attributes.Add("ReadOnly", "True");
                ...
                foreach (var _row in _listPhotocopyDt)
                {
                    ...
                    {
                        Decimal _msProductPrice = this._productBL.GetProductSalesPriceForPOS(_row.ProductCode, _PhotocopyHd.CurrCode, _msProduct.Unit);
                        Decimal _tax = (_msProductType.TaxValue == null) ? 0 : Convert.ToDecimal(_msProductType.TaxValue);
            ...
            try
            {
                ...
                if (this.BoughtItemHiddenField.Value != "")
                {
                    ...
                    foreach (String _boughtItemRow in _boughtItemRows)
                    {
                        ...
                        MsProduct _msProduct = _posPhotocopyBL.GetSingleProduct(_boughtItemFields[0]);
        ...
        protected void ProductGroupButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.ProductSubGroupRepeater.DataSource = _posPhotocopyBL.GetListProductSubGroup(this.ProductGroupHiddenField.Value, Convert.ToInt16(this.ProductSubGroupPageHiddenField.Value), 2);
        ...
        protected void ProductSubGroupButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.ProductRepeater.DataSource = _posPhotocopyBL.GetListProduct(this.ProductSubGroupHiddenField.Value, Convert.ToInt16(this.ProductPageHiddenField.Value), 28);
                this.ProductRepeater.DataBind();
        ...
        protected void ProductButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Button _temp = (Button)sender;
                MsProduct _msProduct = _posPhotocopyBL.GetSingleProduct(_temp.ToolTip);
                this.ProductHiddenField.Value = _msProduct.ProductCode;
                Decimal _msProductPrice = this._productBL.GetProductSalesPriceForPOS(_msProduct.ProductCode, "IDR", _msProduct.Unit);
        ...
        protected void NextProductGroupButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                int _currPage = Convert.ToInt16(this.ProductGroupPageHiddenField.Value);
                if (_currPage < _posPhotocopyBL.GetProductGroupMaxPage(6)) _currPage++;
                this.ProductGroupPageHiddenField.Value = _currPage.ToString();
        ...
        protected void NextProductSubGroupButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                int _currPage = Convert.ToInt16(this.ProductSubGroupPageHiddenField.Value);
                if (_currPage < _posPhotocopyBL.GetProductSubGroupMaxPage(3, this.ProductGroupHiddenField.Value)) _currPage++;
                this.ProductSubGroupPageHiddenField.Value = _currPage.ToString();
        ...
        protected void ProductPrevButton_Click(object sender, EventArgs e)
        {
            ...
            {
                int _currPage = Convert.ToInt16(this.ProductPageHiddenField.Value);
                if (_currPage < _posPhotocopyBL.GetProductMaxPage(40, this.ProductSubGroupHiddenField.Value)) _currPage++;
                this.ProductPageHiddenField.Value = _currPage.ToString();
            ...
            try
            {
                if (this.ReferenceTextBox.Text != "")
                {
                    ...
                    if (this.BoughtItemHiddenField.Value != "")
                    {
                        if (this.TransRefTextBox.Text != "")
                        {
                            POSTrPhotocopyHd _posTrPhotocopyHd = this._posPhotocopyBL.GetSinglePOSTrPhotocopyHd(this.TransRefTextBox.Text);
                            if (_posTrPhotocopyHd == null)
                            {
                                _posTrPhotocopyHd = new POSTrPhotocopyHd();
                            }
                            _posTrPhotocopyHd.TransType = POSTransTypeDataMapper.GetTransType(POSTransType.Photocopy);
                            _posTrPhotocopyHd.TransDate = DateTime.Now;
                            _posTrPhotocopyHd.ReferenceNo = this.ReferenceTextBox.Text;
                            _posTrPhotocopyHd.MemberID = this.MemberNoTextBox.Text;
                            _posTrPhotocopyHd.CustName = this.MemberNameTextBox.Text;
                            _posTrPhotocopyHd.CustPhone = this.CustPhoneTextBox.Text;
                            if (this.ReferenceNoHiddenField.Value == "")
                            {
                                _posTrPhotocopyHd.Status = POSTrPhotocopyDataMapper.GetStatus(POSTrPhotocopyStatus.SendToCashier);
                            }
                            else
                            {
                                _posTrPhotocopyHd.Status = POSTrPhotocopyDataMapper.GetStatus(POSTrPhotocopyStatus.DeliveryOrder);
                                _posTrPhotocopyHd.DeliveryOrderReff = this.ReferenceTextBox.Text;
                            }

                            _posTrPhotocopyHd.IsVOID = false;
                            _posTrPhotocopyHd.CurrCode = "IDR";
                            _posTrPhotocopyHd.ForexRate = 1;
                            _posTrPhotocopyHd.SubTotalForex = Convert.ToDecimal(this.SubTotalLabel.Text);
                            _posTrPhotocopyHd.ServiceChargeAmount = Convert.ToDecimal(this.ServiceChargeLabel.Text);
                            _posTrPhotocopyHd.DiscPercentage = 0;
                            _posTrPhotocopyHd.DiscForex = Convert.ToDecimal(this.DiscountLabel.Text);
                            _posTrPhotocopyHd.PPNPercentage = 0;
                            _posTrPhotocopyHd.PPNForex = Convert.ToDecimal(this.TaxHiddenField.Value);//Convert.ToDecimal(this.TaxLabel.Text);
                            _posTrPhotocopyHd.PB1Forex = Convert.ToDecimal(this.PB1HiddenField.Value);
                            _posTrPhotocopyHd.OtherForex = 0;
                            _posTrPhotocopyHd.TotalForex = Convert.ToDecimal(this.TotalLabel.Text);
                            _posTrPhotocopyHd.Remark = this.NotesTextBox.Text;
                            _posTrPhotocopyHd.FakturPajakNmbr = "";
                            _posTrPhotocopyHd.FakturPajakDate = DateTime.Now;
                            _posTrPhotocopyHd.FakturPajakRate = 0;
                            _posTrPhotocopyHd.UserPrep = this.CashierLabel.Text;
                            _posTrPhotocopyHd.DatePrep = DateTime.Now;
                            _posTrPhotocopyHd.DoneSettlement = POSTrSettlementDataMapper.GetDoneSettlement(POSDoneSettlementStatus.NotYet);
                            _posTrPhotocopyHd.DeliveryStatus = POSTrSettlementDataMapper.GetDeliveryStatus(POSDeliveryStatus.NotYetDelivered);

                            String _resultSendToCashier = this._posPhotocopyBL.SendToCashier(_posTrPhotocopyHd, this.BoughtItemHiddenField.Value);
                        ...
                        else
                        {
                            if (this.ReferenceNoHiddenField.Value == "")
                            {
                                POSTrPhotocopyHd _posTrPhotocopyHd = new POSTrPhotocopyHd();
                                _posTrPhotocopyHd.TransType = POSTransTypeDataMapper.GetTransType(POSTransType.Photocopy);
                                _posTrPhotocopyHd.TransDate = DateTime.Now;
                                _posTrPhotocopyHd.ReferenceNo = this.ReferenceTextBox.Text;
                                _posTrPhotocopyHd.MemberID = this.MemberNoTextBox.Text;
                                _posTrPhotocopyHd.CustName = this.MemberNameTextBox.Text;
                                _posTrPhotocopyHd.CustPhone = this.CustPhoneTextBox.Text;
                                _posTrPhotocopyHd.OperatorID = this.CashierLabel.Text;
                                _posTrPhotocopyHd.Status = POSTrPhotocopyDataMapper.GetStatus(POSTrPhotocopyStatus.SendToCashier);
                                _posTrPhotocopyHd.IsVOID = false;
                                _posTrPhotocopyHd.CurrCode = "IDR";
                                _posTrPhotocopyHd.ForexRate = 1;
                            ...
                            else
                            {
                                ...
                                _posTrDeliveryOrderRef.TransType = POSTransTypeDataMapper.GetTransType(POSTransType.Photocopy);

                                String _resultSendToCashier = this._posPhotocopyBL.SendToCashierForDeliveryOrder(_posTrPhotocopyHd, this.BoughtItemHiddenField.Value, _posTrDeliveryOrderRef);
                                // if DO then back to Page DO
                                if (this.ReferenceNoHiddenField.Value != "" & _resultSendToCashier != "")
                                {
                                    Response.Redirect("../DeliveryOrder/ListDeliveryOrder.aspx" + "?" + "referenceNo=" + HttpUtility.UrlEncode(Rijndael.Encrypt(this.ReferenceNoHiddenField.Value, ApplicationConfig.EncryptionKey)));
        ...
        protected void ReasonListRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.ToString() == "PickButton")
                {
                    ...
                    _result = this._posPhotocopyBL.SetVOID(this.TransRefTextBox.Text, e.CommandArgument.ToString(), true);
                    if (_result == true)
                    {
                        if (this.ReferenceNoHiddenField.Value != "")
                        {
        ...
        protected void errorhandler(Exception ex)
        {
            ...
            String _errorCode = new ErrorLogBL().CreateErrorLog(ex.Message, ex.StackTrace, HttpContext.Current.User.Identity.Name, "POS", "PHOTOCOPY");
