...
{
    public partial class Regional : RegionalBase
    {
        private RegionalBL _regional = new RegionalBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._regional.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._regional.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsRegional _temp = (MsRegional)e.Item.DataItem;
                string _code = _temp.RegionalCode.ToString();
                ...
                Literal _regionalCode = (Literal)e.Item.FindControl("RegionalCodeLiteral");
                _regionalCode.Text = HttpUtility.HtmlEncode(_temp.RegionalCode);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._regional.DeleteMulti(_tempSplit);
