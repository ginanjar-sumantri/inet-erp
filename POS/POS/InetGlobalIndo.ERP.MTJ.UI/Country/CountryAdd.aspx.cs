...
{
    public partial class CountryAdd : CountryBase
    {
        private CountryBL _country = new CountryBL();
        ...
        {
            MsCountry _msCountry = new MsCountry();

            _msCountry.CountryCode = this.CountryCodeTextBox.Text;
            ...
            bool _result = this._country.Add(_msCountry);
