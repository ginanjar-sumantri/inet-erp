...
{
    public sealed class InternetTableBL : Base
    {
        public InternetTableBL()
        {
        }
        ...
        public POSMsInternetTable GetSingle(string _prmCode)
        {
            ...
            {                
                 ...
                 _result = this.db.POSMsInternetTables.Single(_temp => _temp.FloorType.ToString() == _tempSplit[0].Trim().ToLower() && _temp.TableNmbr.ToString() == _tempSplit[1].Trim().ToLower() && _temp.FloorNmbr.ToString() == _tempSplit[2].Trim().ToLower());
