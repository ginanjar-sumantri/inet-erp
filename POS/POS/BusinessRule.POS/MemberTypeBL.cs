...
{
    public sealed class MemberTypeBL : Base
    {
        public MemberTypeBL()
        {
        }
        ...
        public MsMemberType GetSingle(string _prmCode)
        {
            MsMemberType _result = null;

            try
            {
                _result = this.db.MsMemberTypes.Single(_temp => _temp.MemberTypeCode == _prmCode);
            }
            catch (Exception ex)
            {
                ErrorHandler.Record(ex, EventLogEntryType.Error);
        ...
        public bool Add(MsMemberType _prmMsMemberType)
        {
            bool _result = false;

            try
            {
                this.db.MsMemberTypes.InsertOnSubmit(_prmMsMemberType);
                this.db.SubmitChanges();
        ...
        public bool Edit(MsMemberType _prmMsMemberType)
        {
            bool _result = false;
