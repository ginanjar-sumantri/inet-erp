...
namespace InetGlobalIndo.ERP.MTJ.UI.POS.CreditCardType
{
    public partial class CreditCardType : CreditCardTypeBase
    {
        CreditCardTypeBL _creditCardTypeBL = new CreditCardTypeBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._creditCardTypeBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._creditCardTypeBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string _code = _temp.CreditCardTypeCode.ToString();
                ...
                _creditCardTypeCode.Text = HttpUtility.HtmlEncode(_temp.CreditCardTypeCode);

                Literal _creditCardTypeName = (Literal)e.Item.FindControl("CreditCardTypeNameLiteral");
                _creditCardTypeName.Text = HttpUtility.HtmlEncode(_temp.CreditCardTypeName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._creditCardTypeBL.DeleteMulti(_tempSplit);
