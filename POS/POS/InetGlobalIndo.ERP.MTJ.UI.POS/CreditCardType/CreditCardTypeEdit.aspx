<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CreditCardTypeEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.CreditCardType.CreditCardTypeEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                       <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="CreditCardTypeCodeTextBox" Width="120" MaxLength="19" BackColor ="#CCCCCC"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
