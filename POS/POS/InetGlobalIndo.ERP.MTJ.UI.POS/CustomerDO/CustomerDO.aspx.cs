...
{
    public partial class CustomerDO : CustomerDOBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._customerDOBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._customerDOBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsCustomerDO _temp = (POSMsCustomerDO)e.Item.DataItem;

                string _code = _temp.CustDOCode.ToString();
                ...
                Literal _customerDOLiteral = (Literal)e.Item.FindControl("CustomerDOLiteral");
                _customerDOLiteral.Text = HttpUtility.HtmlEncode(_temp.CustDOCode);

                Literal _customerDOTypeNameLiteral = (Literal)e.Item.FindControl("CustomerNameLiteral");
                _customerDOTypeNameLiteral.Text = HttpUtility.HtmlEncode(_temp.Name);

                Literal _addressLiteral = (Literal)e.Item.FindControl("Address1Literal");
                _addressLiteral.Text = HttpUtility.HtmlEncode(_temp.Address1);
                ...
                _telephoneLiteral.Text = HttpUtility.HtmlEncode(_temp.Phone);

                Literal _handPhoneLiteral = (Literal)e.Item.FindControl("HandPhoneLiteral");
                _handPhoneLiteral.Text = HttpUtility.HtmlEncode(_temp.HP);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._customerDOBL.DeleteMulti(_tempSplit);
