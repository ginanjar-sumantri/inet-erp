<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustomerDOEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.CustomerDO.CustomerDOEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="CustomerDOCodeTextBox" ReadOnly="true" BackColor="#CCCCCC"
