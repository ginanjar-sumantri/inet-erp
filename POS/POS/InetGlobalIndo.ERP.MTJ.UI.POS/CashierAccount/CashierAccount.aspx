<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CashierAccount.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.CashierAccount.CashierAccount" Title="Untitled Page" %>
                            ...
                            <asp:Panel ID="Panel2" DefaultButton="GoImageButton" runat="server">
                                <table cellpadding="0" cellspacing="2" border="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="CashierAccountDDL" runat="server">
                                                <asp:ListItem Value="CashierEmpNmbr" Text="Cashier Name"></asp:ListItem>
                                                <asp:ListItem Value="Account" Text="Account Name"></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                ...
                                <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                    <ItemTemplate>
                                        <tr id="RepeaterItemTemplate" runat="server">
                                            ...
                                            <td align="left">
                                                <asp:Literal runat="server" ID="CashierNameLiteral"></asp:Literal>
                                            </td>
                                            <td align="left">
