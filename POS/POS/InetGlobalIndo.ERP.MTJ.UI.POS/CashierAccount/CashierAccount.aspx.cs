...
{
    public partial class CashierAccount : CashierAccountBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._cashierAcountBL.RowsCount(this.CashierAccountDDL.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._cashierAcountBL.GetList(_prmCurrentPage, _maxrow, this.CashierAccountDDL.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsCashierAccount _temp = (POSMsCashierAccount)e.Item.DataItem;

                string _code = _temp.CashierEmpNmbr.ToString();
                ...
                Literal _cashierName = (Literal)e.Item.FindControl("CashierNameLiteral");
                _cashierName.Text = HttpUtility.HtmlEncode(_employeeBL.GetEmpNameByCode(_temp.CashierEmpNmbr));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._cashierAcountBL.DeleteMulti(_tempSplit);
