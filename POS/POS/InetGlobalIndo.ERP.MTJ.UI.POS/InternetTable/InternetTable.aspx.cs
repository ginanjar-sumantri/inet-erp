...
{
    public partial class InternetTable : InternetTableBase
    {
        InternetTableBL _internetTableBL = new InternetTableBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._internetTableBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._internetTableBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string _code = _temp.FloorType + "-" + _temp.TableNmbr.ToString() + "-" +_temp.FloorNmbr.ToString();
                ...
                Literal _floorType = (Literal)e.Item.FindControl("FloorTypeLiteral");
                _floorType.Text = HttpUtility.HtmlEncode(_temp.FloorType);

                Literal _tableNmbr = (Literal)e.Item.FindControl("TableNmbrLiteral");
                _tableNmbr.Text = HttpUtility.HtmlEncode(_temp.TableNmbr.ToString());

                Literal _floorNmbr = (Literal)e.Item.FindControl("FloorNmbrLiteral");
                _floorNmbr.Text = HttpUtility.HtmlEncode(_temp.FloorNmbr.ToString());

                Literal _status = (Literal)e.Item.FindControl("StatusLiteral");
                _status.Text = HttpUtility.HtmlEncode(POSTrInternetDataMapper.GetStatusTableText(_temp.Status));

                Literal _fgActive = (Literal)e.Item.FindControl("fgActiveLiteral");
                _fgActive.Text = HttpUtility.HtmlEncode(_temp.fgActive.ToString());
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._internetTableBL.DeleteMulti(_tempSplit);
