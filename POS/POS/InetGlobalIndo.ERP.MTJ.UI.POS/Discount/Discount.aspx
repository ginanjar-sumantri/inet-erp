<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="Discount.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.Discount.Discount" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server" OnSelectedIndexChanged="CategoryDropDownList_SelectedIndexChanged" AutoPostBack="true">
                                                    <asp:ListItem Value="Code" Text="Discount Config Code"></asp:ListItem>
                                                    <asp:ListItem Value="AmountType" Text="Amount Type"></asp:ListItem>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="FgAllowChangeLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
