...
{
    public partial class Discount : DiscountBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                String _firstdate = firstDate.ToString("yyyy-MM-dd");
                ...
                this.CategoryDropDownList_SelectedIndexChanged(null, null);
                this.ClearLabel();
                this.ShowData(0);
            }
        }
        ...
        private double RowCount()
        {
            ...
            String _keyword = "";
            if (this.CategoryDropDownList.SelectedValue == "Code")
            {
                _keyword = this.KeywordTextBox.Text;
            }
            else if (this.CategoryDropDownList.SelectedValue == "AmountType" | this.CategoryDropDownList.SelectedValue == "Status")
            {
                _keyword = this.KeywordDropDownList.SelectedValue;
            }

            _result = this._posDiscountBL.RowsCount(this.CategoryDropDownList.SelectedValue, _keyword, this.StartDateTextBox.Text, this.EndDateTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            else
            {
                ...
                //this.ListRepeater.DataSource = this._posDiscountBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
                this.ListRepeater.DataSource = this._posDiscountBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, _keyword, this.StartDateTextBox.Text, this.EndDateTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsDiscountConfig _temp = (POSMsDiscountConfig)e.Item.DataItem;

                string _code = _temp.DiscountConfigCode.ToString();
                ...
                {
                    if (_temp.Status != POSDiscountDataMapper.GetStatus(POSDiscountStatus.Posting))
                    {
                        _editButton.PostBackUrl = this._editPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                        _editButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/edit.jpg";
                    }
                ...
                Literal _discountConfigCodeLiteral = (Literal)e.Item.FindControl("DiscountConfigCodeLiteral");
                _discountConfigCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.DiscountConfigCode);

                Literal _startDateLiteral = (Literal)e.Item.FindControl("StartDateLiteral");
                _startDateLiteral.Text = HttpUtility.HtmlEncode(Convert.ToDateTime(_temp.StartDate).ToString("dd/MM/yyyy"));

                Literal _endDateLiteral = (Literal)e.Item.FindControl("EndDateLiteral");
                _endDateLiteral.Text = HttpUtility.HtmlEncode(Convert.ToDateTime(_temp.EndDate).ToString("dd/MM/yyyy"));

                string _fgAllowChange = "";

                if (_temp.fgAllowChange == true)
                    _fgAllowChange = "Yes";
                else
                    _fgAllowChange = "No";

                Literal _fgAllowChangeLiteral = (Literal)e.Item.FindControl("FgAllowChangeLiteral");
                _fgAllowChangeLiteral.Text = HttpUtility.HtmlEncode(_fgAllowChange);

                Literal _amountTypeLiteral = (Literal)e.Item.FindControl("AmountTypeLiteral");
                if (HttpUtility.HtmlEncode(_temp.AmountType) == "A")
                {
                    _amountTypeLiteral.Text = "Amount";
                }
                else if (HttpUtility.HtmlEncode(_temp.AmountType) == "P")
                {
                    _amountTypeLiteral.Text = "Percentage";
                }
                Literal _statusLiteral = (Literal)e.Item.FindControl("StatusLiteral");
                _statusLiteral.Text = HttpUtility.HtmlEncode(POSDiscountDataMapper.GetStatusText(Convert.ToInt32((Byte)_temp.Status)));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._posDiscountBL.DeleteMulti(_tempSplit);
        ...
        protected void GoImageButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Msgbox", "javascript:alert('Check Your Date Please.');", true);
            }
        }
        ...
        protected void CategoryDropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (this.CategoryDropDownList.SelectedValue == "Code")
            {
                this.KeywordTextBox.Visible = true;
            }
            else if (this.CategoryDropDownList.SelectedValue == "AmountType")
            {
                this.KeywordDropDownList.Visible = true;
                this.KeywordDropDownList.Items.Clear();
                this.KeywordDropDownList.Items.Insert(0, new ListItem("Amount", "A"));
                this.KeywordDropDownList.Items.Insert(1, new ListItem("Percentage", "P"));
            }
            else if (this.CategoryDropDownList.SelectedValue == "Status")
            {
                this.KeywordDropDownList.Visible = true;
                this.KeywordDropDownList.Items.Clear();
                this.KeywordDropDownList.Items.Insert(0, new ListItem("On Hold", "0"));
                this.KeywordDropDownList.Items.Insert(1, new ListItem("Waiting For Approval", "1"));
                this.KeywordDropDownList.Items.Insert(2, new ListItem("Approved", "2"));
                this.KeywordDropDownList.Items.Insert(3, new ListItem("Posting", "3"));
            }
        }

        protected void HiddenKeyword()
        {
            this.KeywordTextBox.Visible = false;
            this.KeywordDropDownList.Visible = false;
        }
    }
}