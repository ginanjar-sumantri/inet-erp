<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="MemberAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.Member.MemberAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="MemberCodeTextBox" Width="150" MaxLength="50" onKeyPress="return event.keyCode!=13"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="MemberCodeRequiredFieldValidator" runat="server"
                                    ErrorMessage="Member Code Must Be Filled" Text="*" ControlToValidate="MemberCodeTextBox"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="BarcodeTextBox" runat="server" MaxLength="13" onKeyPress="return event.keyCode!=13"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="MemberBarcodeRequiredFieldValidator1" runat="server"
                                    ErrorMessage="Member Barcode Must Be Filled" Text="*" ControlToValidate="BarcodeTextBox"
                                    Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                Religion
                        ...
                        <tr>
                            ...
                            <td>
                               <%-- <asp:TextBox runat="server" ID="ReferenceTextBox" Width="210" MaxLength="50" onKeyPress="return event.keyCode!=13"></asp:TextBox>
                                <asp:HiddenField ID="ReferenceCodeHidden" runat="server" />--%>
                                <asp:TextBox ID="ReferenceTextBox" runat="server"  MaxLength="50"
