...
namespace InetGlobalIndo.ERP.MTJ.UI.POS.Member
{
    public partial class Member : MemberBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._memberBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._memberBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string _code = _temp.MemberCode.ToString();
                ...
                Literal _memberTypeNameLiteral = (Literal)e.Item.FindControl("MemberTypeNameLiteral");
                _memberTypeNameLiteral.Text = HttpUtility.HtmlEncode(_temp.MemberTypeName);

                Literal _genderLiteral = (Literal)e.Item.FindControl("GenderLiteral");
                _genderLiteral.Text = HttpUtility.HtmlEncode(GenderDataMapper.GetGender(_temp.Gender));

                Literal _telephoneLiteral = (Literal)e.Item.FindControl("Telephone1Literal");
                _telephoneLiteral.Text = HttpUtility.HtmlEncode(_temp.Telephone1);

                Literal _handphoneLiteral = (Literal)e.Item.FindControl("HandPhone1Literal");
                ...
                _statusLiteral.Text = HttpUtility.HtmlEncode(MemberDataMapper.GetMemberStatusText(_temp.Status));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._memberBL.DeleteMulti(_tempSplit);
