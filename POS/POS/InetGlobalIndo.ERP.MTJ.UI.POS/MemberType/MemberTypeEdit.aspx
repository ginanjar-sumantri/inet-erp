<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="MemberTypeEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.MemberType.MemberTypeEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="MemberTypeCodeTextBox" Width="120" MaxLength="49" BackColor="#CCCCCC"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
