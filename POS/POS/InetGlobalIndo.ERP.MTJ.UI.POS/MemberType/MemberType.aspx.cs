...
{
    public partial class MemberType : MemberTypeBase
    {
        MemberTypeBL _memberTypeBL = new MemberTypeBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._memberTypeBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._memberTypeBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsMemberType _temp = (MsMemberType)e.Item.DataItem;

                string _code = _temp.MemberTypeCode.ToString();
                ...
                Literal _memberTypeCode = (Literal)e.Item.FindControl("MemberTypeCodeLiteral");
                _memberTypeCode.Text = HttpUtility.HtmlEncode(_temp.MemberTypeCode);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._memberTypeBL.DeleteMulti(_tempSplit);
