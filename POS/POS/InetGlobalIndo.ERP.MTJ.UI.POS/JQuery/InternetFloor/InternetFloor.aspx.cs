...
{
    public partial class InternetFloor : InternetFloorBase
    {
        InternetFloorBL _internetFloorBL = new InternetFloorBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._internetFloorBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._internetFloorBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string _code = _temp.FloorType + "-" + _temp.FloorNmbr.ToString();
                ...
                Literal _floorName = (Literal)e.Item.FindControl("FloorNameLiteral");
                _floorName.Text = HttpUtility.HtmlEncode(_temp.FloorName);                
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._internetFloorBL.DeleteMulti(_tempSplit);
