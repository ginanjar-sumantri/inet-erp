<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CreditCardAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.CreditCard.CreditCardAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="CreditCardCodeTextBox" Width="120" MaxLength="49"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="CreditCardCodeRequiredFieldValidator" runat="server"
                                    ErrorMessage="Credit Card Code Must Be Filled" Text="*" ControlToValidate="CreditCardCodeTextBox"
