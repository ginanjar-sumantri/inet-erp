...
namespace InetGlobalIndo.ERP.MTJ.UI.POS.CreditCard
{
    ...
    {
        CreditCardBL _creditCardBL = new CreditCardBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._creditCardBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._creditCardBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string _code = _temp.CreditCardCode.ToString();
                ...
                Literal _creditCardCode = (Literal)e.Item.FindControl("CreditCardCodeLiteral");
                _creditCardCode.Text = HttpUtility.HtmlEncode(_temp.CreditCardCode);

                Literal _creditCardName = (Literal)e.Item.FindControl("CreditCardNameLiteral");
                _creditCardName.Text = HttpUtility.HtmlEncode(_temp.CreditCardName);

                Literal _creditCardTypeCode = (Literal)e.Item.FindControl("CreditCardTypeCodeLiteral");
                _creditCardTypeCode.Text = HttpUtility.HtmlEncode(_creditCardTypeBL.GetMemberNameByCode(_temp.CreditCardTypeCode));

                Literal _account = (Literal)e.Item.FindControl("AccountLiteral");
                _account.Text = HttpUtility.HtmlEncode(_accountBL.GetAccountNameByCode(_temp.Account));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._creditCardBL.DeleteMulti(_tempSplit);
