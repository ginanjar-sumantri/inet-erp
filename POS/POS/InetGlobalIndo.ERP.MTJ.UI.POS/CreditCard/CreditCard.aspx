<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CreditCard.aspx.cs" Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.CreditCard.CreditCard" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Credit Card Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Credit Card Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="CreditCardCodeLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="CreditCardNameLiteral"></asp:Literal>
                                                </td>
                                                 <td align="left">
                                                    <asp:Literal runat="server" ID="CreditCardTypeCodeLiteral"></asp:Literal>
                                                </td>
                                                 <td align="left">
