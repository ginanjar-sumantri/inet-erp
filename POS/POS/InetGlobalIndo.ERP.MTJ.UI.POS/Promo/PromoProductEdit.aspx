<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PromoProductEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.Promo.PromoProductEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="FgMinTypeRBL" runat="server" AutoPostBack="true" RepeatDirection="Horizontal"
                                    OnSelectedIndexChanged="FgMinTypeRBL_SelectedIndexChanged">
                                    <asp:ListItem Value="Q" Text="Qty"></asp:ListItem>
                                    <asp:ListItem Value="T" Text="SubTotal"></asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="PromoTypeRBL" runat="server" RepeatDirection="Horizontal"
                                    OnSelectedIndexChanged="PromoTypeRBL_SelectedIndexChanged" AutoPostBack="true">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="FreeProductCodeTextBox" Width="100" OnTextChanged="FreeProductCodeTextBox_TextChanged"
