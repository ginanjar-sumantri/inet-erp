...
{
    public partial class Promo : PromoBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._promoBL.RowsCount(this.CategoryDropDownList.SelectedValue, _keyword, this.StartDateTextBox.Text, this.EndDateTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            else
            {
                ...
                this.ListRepeater.DataSource = this._promoBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, _keyword, this.StartDateTextBox.Text, this.EndDateTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsPromo _temp = (POSMsPromo)e.Item.DataItem;

                string _code = _temp.PromoCode.ToString();
                ...
                {
                    if (_temp.Status != POSPromoDataMapper.GetStatus(POSPromoStatus.Posting))
                    {
                ...
                Literal _PromoCodeLiteral = (Literal)e.Item.FindControl("PromoCodeLiteral");
                _PromoCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.PromoCode);
                ...
                Literal _fgMemberLiteral = (Literal)e.Item.FindControl("FgMemberLiteral");
                _fgMemberLiteral.Text = (_temp.FgMember == false) ? "N" : "Y";

                Literal _intervalTypeLiteral = (Literal)e.Item.FindControl("IntervalTypeLiteral");
                _intervalTypeLiteral.Text = HttpUtility.HtmlEncode(_temp.PromoIntervalType);

                Literal _statusLiteral = (Literal)e.Item.FindControl("StatusLiteral");
                _statusLiteral.Text = HttpUtility.HtmlEncode(POSPromoDataMapper.GetStatusText(Convert.ToInt32((Byte)_temp.Status)));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._promoBL.DeleteMulti(_tempSplit);
