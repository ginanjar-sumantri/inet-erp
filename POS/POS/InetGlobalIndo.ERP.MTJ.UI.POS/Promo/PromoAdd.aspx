<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="PromoAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.Promo.PromoAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="PromoCodeTextBox" Width="100" MaxLength="50"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="PromoCodeRequiredFieldValidator" runat="server" ErrorMessage="Promo Config Code Must Be Filled"
                                    Text="*" ControlToValidate="PromoCodeTextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="width">
