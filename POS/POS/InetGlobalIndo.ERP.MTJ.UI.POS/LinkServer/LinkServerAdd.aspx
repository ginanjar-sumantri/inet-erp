<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="LinkServerAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.LinkServer.LinkServerAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="IPTextBox" Width="120" MaxLength="50"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="IPRequiredFieldValidator" runat="server" ErrorMessage="Internet Protocol Must Be Filled"
                                    Text="*" ControlToValidate="IPTextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
