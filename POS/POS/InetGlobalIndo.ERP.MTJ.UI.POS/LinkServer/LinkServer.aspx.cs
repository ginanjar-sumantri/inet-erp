...
{
    public partial class LinkServer : LinkServerBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._synchronizeBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._synchronizeBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsLinkServer _temp = (MsLinkServer)e.Item.DataItem;

                string _code = _temp.Server_IP.ToString();
                ...
                Literal _ipLiteral = (Literal)e.Item.FindControl("IPLiteral");
                _ipLiteral.Text = HttpUtility.HtmlEncode(_temp.Server_IP);

                Literal _nameLiteral = (Literal)e.Item.FindControl("NameLiteral");
                _nameLiteral.Text = HttpUtility.HtmlEncode(_temp.Server_Name);

                Literal _locationLiteral = (Literal)e.Item.FindControl("LocationLiteral");
                _locationLiteral.Text = HttpUtility.HtmlEncode(_temp.Server_Location);

                Literal _serverHOLiteral = (Literal)e.Item.FindControl("ServerHOLiteral");
                _serverHOLiteral.Text = HttpUtility.HtmlEncode(_temp.Server_HO.ToString());
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._synchronizeBL.DeleteMulti(_tempSplit);
