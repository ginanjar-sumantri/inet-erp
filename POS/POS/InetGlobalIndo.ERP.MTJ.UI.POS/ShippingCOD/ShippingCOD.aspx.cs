...
{
    public partial class ShippingCOD : ShippingCODBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._shippingBL.RowsCountPOSTrShippingHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._shippingBL.GetListPOSTrShippingHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                //string _code = _temp.TRSCode + "-" + _temp.TRSName;
                string _code = _temp.TransNmbr;
                //char _fgZone = _temp.FgZone == null ? 'N' : Convert.ToChar(_temp.FgZone);
                //string _code2 = _temp.VendorCode + "|" + _fgZone;
                ...
                //ImageButton _editPriceButton = (ImageButton)e.Item.FindControl("EditPriceButton");

                //if (_fgZone == 'N')
                //{
                //    _editPriceButton.PostBackUrl = this._editPricePage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code2, ApplicationConfig.EncryptionKey));
                //}
                //else
                //{
                //    _editPriceButton.PostBackUrl = this._editPriceZonePage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code2, ApplicationConfig.EncryptionKey));
                //}
                //_editPriceButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/editprice.jpg";
                ...
                _transDate.Text = HttpUtility.HtmlEncode(DateFormMapper.GetValue(_temp.TransDate));
                ...
                _referenceNo.Text = HttpUtility.HtmlEncode(_temp.ReferenceNo);

                Literal _customer = (Literal)e.Item.FindControl("CustomerLiteral");
                _customer.Text = HttpUtility.HtmlEncode(_temp.CustName);

                Literal _senderLocation = (Literal)e.Item.FindControl("SenderLocationLiteral");
                _senderLocation.Text = this._cityBL.GetCityNameByCode(HttpUtility.HtmlEncode(_temp.SenderCityCode));

                Literal _deliverLocation = (Literal)e.Item.FindControl("DeliverLocationLiteral");
                _deliverLocation.Text = this._countryBL.GetCountryNameByCode(HttpUtility.HtmlEncode(_temp.DeliveryCountryCode)) + "-" + this._cityBL.GetCityNameByCode(HttpUtility.HtmlEncode(_temp.DeliverCityCode));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //this.ClearLabel();
            //bool _result = false;
            //foreach (var item in _tempSplit)
            //{
            //    _result = this._shippingBL.SetVOID(item, this.ReasonTextBox.Text, true);
            //}
