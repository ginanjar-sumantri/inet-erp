...
{
    public partial class Kitchen : KitchenBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._kitchenBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._kitchenBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsKitchen _temp = (POSMsKitchen)e.Item.DataItem;

                string _code = _temp.KitchenCode.ToString();
                ...
                Literal _memberNameLiteral = (Literal)e.Item.FindControl("KitchenNameLiteral");
                _memberNameLiteral.Text = HttpUtility.HtmlEncode(_temp.KitchenName);

                Literal _chefLiteral = (Literal)e.Item.FindControl("ChefLiteral");
                _chefLiteral.Text = HttpUtility.HtmlEncode(_temp.Chef);
                ...
                Literal _kitchenPrinterIPAddressLiteral = (Literal)e.Item.FindControl("KitchenPrinterIPAddressLiteral");
                _kitchenPrinterIPAddressLiteral.Text = HttpUtility.HtmlEncode(_temp.KitchenPrinterIPAddress);

                Literal _kitchenPrinterNameLiteral = (Literal)e.Item.FindControl("KitchenPrinterNameLiteral");
                _kitchenPrinterNameLiteral.Text = HttpUtility.HtmlEncode(_temp.KitchenPrinterName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._kitchenBL.DeleteMulti(_tempSplit);
