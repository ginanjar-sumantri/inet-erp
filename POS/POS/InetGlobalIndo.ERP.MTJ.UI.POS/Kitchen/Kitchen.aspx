<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="Kitchen.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.Kitchen.Kitchen" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Kitchen Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Kitchen Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="KitchenNameLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="ChefLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="LocationLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="KitchenPrinterIPAddressLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="KitchenPrinterNameLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
