...
{
    public partial class MenuServiceType : MenuServiceTypeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._menuServiceTypeBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._menuServiceTypeBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsMenuServiceType _temp = (POSMsMenuServiceType)e.Item.DataItem;

                string _code = _temp.MenuServiceTypeCode.ToString();
                ...
                Literal _menuServiceTypeName= (Literal)e.Item.FindControl("MenuServiceTypeNameLiteral");
                _menuServiceTypeName.Text = HttpUtility.HtmlEncode(_temp.MenuServiceTypeName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._menuServiceTypeBL.DeleteMulti(_tempSplit);
