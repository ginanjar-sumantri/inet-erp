<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="MenuServiceType.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.MenuServiceType.MenuServiceType" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Type Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Type Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="MenuServiceTypeNameLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
