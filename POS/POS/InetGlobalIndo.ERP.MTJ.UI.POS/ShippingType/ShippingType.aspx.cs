...
{
    public partial class ShippingType : ShippingTypeBase
    {
        ShippingBL _shippingBL = new ShippingBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._shippingBL.RowsCountPOSMsShippingType(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._shippingBL.GetListPOSMsShippingType(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsShippingType _temp = (POSMsShippingType)e.Item.DataItem;

                //string _code = _temp.TRSCode + "-" + _temp.TRSName;
                string _code = _temp.ShippingTypeCode;
                ...
                _trsCode.Text = HttpUtility.HtmlEncode(_temp.ShippingTypeCode);

                Literal _trsName = (Literal)e.Item.FindControl("NameLiteral");
                _trsName.Text = HttpUtility.HtmlEncode(_temp.ShippingTypeName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._shippingBL.DeleteMultiPOSMsShippingType(_tempSplit);
