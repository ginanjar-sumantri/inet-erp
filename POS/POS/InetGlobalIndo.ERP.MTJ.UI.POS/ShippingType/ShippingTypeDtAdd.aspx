<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ShippingTypeDtAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.ShippingType.ShippingTypeDtAdd" %>
                    ...
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="Price2RequiredFieldValidator" runat="server" ErrorMessage="Price 2nd Must Be Filled"
                                    Text="*" ControlToValidate="Price2TextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
