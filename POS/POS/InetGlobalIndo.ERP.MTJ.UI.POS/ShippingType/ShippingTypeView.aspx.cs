...
{
    public partial class ShippingTypeView : ShippingTypeBase
    {
        ...
        public void ShowData()
        {
            ...
            this.FgActiveTextBox.Text = _posMsShippingType.FgActive.ToString();
            this.RemarkTextBox.Text = _posMsShippingType.Remark;
        ...
        private double RowCount()
        {
            ...
            _result = this._shippingBL.RowsCountPOSMsShippingTypeDt("", "");
        ...
        public void ShowDataDetail(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._shippingBL.GetListPOSMsShippingTypeDt(_prmCurrentPage, _maxrow, "Code", _tempSplit[0]);
            }
        ...
        {
            POSMsShippingTypeDt _temp = (POSMsShippingTypeDt)e.Item.DataItem;
            string _code = _temp.ShippingTypeCode.ToString() + "|" + _temp.CityCode.ToString() + "|" + _temp.ProductShape.ToString();
            ...
            if (HttpUtility.HtmlEncode(_temp.ProductShape) == "0")
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._shippingBL.DeleteMultiPOSMsShippingTypeDt(_tempSplit);
