<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DebitCardEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.DebitCard.DebitCardEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="AccountCodeTextBox" runat="server" Width="210px"></asp:TextBox>
                                <asp:DropDownList runat="server" ID="AccountDropDownList" Width="210" MaxLength="19">
                                </asp:DropDownList>
