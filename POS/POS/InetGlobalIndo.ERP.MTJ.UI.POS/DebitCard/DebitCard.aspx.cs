...
{
    public partial class DebitCard : DebitCardBase
    {
        DebitCardBL _debitCardBL = new DebitCardBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._debitCardBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._debitCardBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string _code = _temp.DebitCardCode.ToString();
                ...
                Literal _debitCardCode = (Literal)e.Item.FindControl("DebitCardCodeLiteral");
                _debitCardCode.Text = HttpUtility.HtmlEncode(_temp.DebitCardCode);

                Literal _debitCardName = (Literal)e.Item.FindControl("DebitCardNameLiteral");
                _debitCardName.Text = HttpUtility.HtmlEncode(_temp.DebitCardName);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._debitCardBL.DeleteMulti(_tempSplit);
