...
{
    public partial class POSPerTransaction : ReportBase
    {
        ...
        //private string _reportPath0 = "Report/ReportDirectPurchasePerTransactionSummary.rdlc";
        //private string _reportPath1 = "Report/ReportDirectPurchasePerTransactionDetail.rdlc";
        ...
        private string _awal = "ctl00_DefaultBodyContentPlaceHolder_CashierCheckBoxList_";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "POS Per Transaction";
        ...
        private double RowCount()
        {
            ...
            _result = this._reportBL.RowsCountTransactionReport(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        {
            var hasil = this._reportBL.GetListCashierForReport(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            ...
            {
                _item.Attributes.Add("OnClick", "CheckBox_Click(" + this.CheckHidden.ClientID + ", " + "ctl00_DefaultBodyContentPlaceHolder_CashierCheckBoxList_" + i.ToString() + ", '" + _item.Value + "', '" + _awal + "', '" + _akhir + "', '" + _cbox + "', 'true');");
                i++;
            }
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "POSPerTrans";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                _cashier = this.TempHidden.Value;
            }
            else
            {
                _cashier = this.CheckHidden.Value;
            }
            ...
            if (this.HeaderReportList1.SelectedValue == "Report/PosPerTransactionSummary.rdlc")
                _fgReport = 1;
            else if (this.HeaderReportList1.SelectedValue == "Report/PosPerTransactionProduct.rdlc")
                _fgReport = 2;
            else if (this.HeaderReportList1.SelectedValue == "Report/PosPerTransactionSummaryPerDivisi.rdlc")
                _fgReport = 1;
            else
                _fgReport = 0;


            ReportDataSource _reportDataSource1 = this._reportBL.POSReportListPerTransaction(_startDateTime, _endDateTime, _fgReport, _cashier);
            ...
            _reportParam[3] = new ReportParameter("PrmCashierId", _cashier, true);
