<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="POSPerProduct.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.Report.POSPerProduct" %>
                            ...
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RadioButtonList runat="server" ID="ReportTypeRadioButtonList">
                                                <asp:ListItem Value="0" Text="Report List Per Product" Selected="True"></asp:ListItem>
                                                <asp:ListItem Value="1" Text="Report List Per Product konsinyasi"></asp:ListItem>
                                                <asp:ListItem Value="2" Text="Report List Per All Product "></asp:ListItem>
                                            </asp:RadioButtonList>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <table>
                                                        ...
                                                        <%--         <tr valign="top">
                                                            ...
                                                            <td colspan="5">
                                                                <asp:CheckBoxList ID="CashierCheckBoxList" RepeatColumns="2" runat="server" RepeatDirection="Vertical">
                                                                </asp:CheckBoxList>
                                                            </td>
                                                        </tr>--%>
                                                    </table>
                                    ...
                                    <asp:Panel ID="PanelCashier" runat="server">
                                        <tr>
                                            <td colspan="7">
                                                <fieldset>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td colspan="5" align="right">
                                                                <asp:Panel DefaultButton="DataPagerButton" ID="DataPagerPanelCashier" runat="server">
                                                                    <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                                                        <tr>
                                                                            <td align="left">
                                                                                <table>
                                                                                    <tr>
                                                                                        <td align="left">
                                                                                            <asp:CheckBox runat="server" ID="AllCheckBoxCashier" Text="Check All" />
                                                                                        </td>
                                                                                        <td>
                                                                                            <asp:HiddenField ID="CheckHiddenCashier" runat="server" />
                                                                                            <asp:HiddenField ID="TempHiddenCashier" runat="server" />
                                                                                        </td>
                                                                                        <td>
                                                                                            <asp:Button ID="DataPagerButtonCashier" runat="server" CausesValidation="false" OnClick="DataPagerButton_ClickCashier" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                <table>
                                                                                    <tr>
                                                                                        ...
                                                                                        <asp:Repeater EnableViewState="true" ID="DataPagerTopRepeaterCashier" runat="server"
                                                                                            OnItemCommand="DataPagerTopRepeater_ItemCommandCashier" OnItemDataBound="DataPagerTopRepeater_ItemDataBoundCashier">
                                                                                            <ItemTemplate>
                                                                                                <td>
                                                                                                    <asp:LinkButton ID="PageNumberLinkButtonCashier" runat="server" CausesValidation="false"></asp:LinkButton>
                                                                                                    <asp:TextBox Visible="false" ID="PageNumberTextBoxCashier" runat="server" Width="30px"></asp:TextBox>
                                                                                                </td>
                                                                                            </ItemTemplate>
                                                                                        </asp:Repeater>
                                                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="7">
                                                                <asp:Panel ID="Panel4" DefaultButton="GoImageButtonCashier" runat="server">
                                                                    <table cellpadding="0" cellspacing="2" border="0">
                                                                        <tr>
                                                                            <td>
                                                                                <b>Quick Search :</b>
                                                                            ...
                                                                            <td>
                                                                                <asp:DropDownList ID="CategoryDropDownListCahsier" runat="server">
                                                                                    <%--<asp:ListItem Value="Code" Text="Supplier Code"></asp:ListItem>--%>
                                                                                    <asp:ListItem Value="Name" Text="Cashier Name"></asp:ListItem>
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="KeywordTextBoxCashier" runat="server"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <asp:ImageButton ID="GoImageButtonCashier" runat="server" OnClick="GoImageButton_ClickCashier" />
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </asp:Panel>
