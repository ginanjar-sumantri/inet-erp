<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ShippingZoneMultipleAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.ShippingZone.ShippingZoneMultipleAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="ProductShapeRBL" runat="server" RepeatDirection="Horizontal">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="Weight1TextBox" Width="120" MaxLength="13"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="Weight1RequiredFieldValidator" runat="server" ErrorMessage="Weight 1st Must Be Filled"
                                    Text="*" ControlToValidate="Weight1TextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="Weight2TextBox" Width="120" MaxLength="13"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="Weight2RequiredFieldValidator" runat="server" ErrorMessage="Weight 2nd Must Be Filled"
                                    Text="*" ControlToValidate="Weight2TextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
