<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ShippingZonePriceAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.ShippingZone.ShippingZonePriceAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="WeightTextBox" Width="120" MaxLength="13"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="WeightRequiredFieldValidator" runat="server" ErrorMessage="Weight Must Be Filled"
                                    Text="*" ControlToValidate="WeightTextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
