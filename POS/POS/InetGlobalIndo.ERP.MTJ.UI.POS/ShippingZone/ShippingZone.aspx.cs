...
namespace InetGlobalIndo.ERP.MTJ.UI.POS.ShippingZone
{
    public partial class ShippingZone : ShippingZoneBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._shippingBL.RowsCountPOSMsZone(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._shippingBL.GetListPOSMsZone(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsZone _temp = (POSMsZone)e.Item.DataItem;

                //string _code = _temp.TRSCode + "-" + _temp.TRSName;
                string _code = _temp.ZoneCode;
                ...
                _trsCode.Text = HttpUtility.HtmlEncode(_temp.ZoneCode);

                Literal _trsName = (Literal)e.Item.FindControl("NameLiteral");
                _trsName.Text = HttpUtility.HtmlEncode(_temp.ZoneName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._shippingBL.DeleteMultiPOSMsZone(_tempSplit);
