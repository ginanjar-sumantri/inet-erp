...
{
    public partial class OtherSurcharge : OtherSurchargeBase
    {
        OtherSurchargeBL _otherSurchargeBL = new OtherSurchargeBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._otherSurchargeBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._otherSurchargeBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsShippingO _temp = (POSMsShippingO)e.Item.DataItem;

                //string _code = _temp.TRSCode + "-" + _temp.TRSName;
                string _code = _temp.OtherSurchargeCode;
                ...
                _trsCode.Text = HttpUtility.HtmlEncode(_temp.OtherSurchargeCode);

                Literal _trsName = (Literal)e.Item.FindControl("NameLiteral");
                _trsName.Text = HttpUtility.HtmlEncode(_temp.OtherSurchargeName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._otherSurchargeBL.DeleteMulti(_tempSplit);
