...
{
    public partial class TransportationRS : TransportationRSBase
    {
        TransportationRSBL _transportationRSBL = new TransportationRSBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._transportationRSBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._transportationRSBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsShippingTR _temp = (POSMsShippingTR)e.Item.DataItem;

                //string _code = _temp.TRSCode + "-" + _temp.TRSName;
                string _code = _temp.TRSCode;
                ...
                _trsCode.Text = HttpUtility.HtmlEncode(_temp.TRSCode);

                Literal _trsName = (Literal)e.Item.FindControl("NameLiteral");
                _trsName.Text = HttpUtility.HtmlEncode(_temp.TRSName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._transportationRSBL.DeleteMulti(_tempSplit);
