...
{
    public partial class CashierPrinter : CashierPrinterBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._cashierPrinterBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._cashierPrinterBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsCashierPrinter _temp = (POSMsCashierPrinter)e.Item.DataItem;

                string _code = _temp.CashierPrinterCode.ToString();
                ...
                Literal _codeLiteral = (Literal)e.Item.FindControl("CodeLiteral");
                _codeLiteral.Text = HttpUtility.HtmlEncode(_temp.CashierPrinterCode);

                Literal _nameLiteral = (Literal)e.Item.FindControl("NameLiteral");
                _nameLiteral.Text = HttpUtility.HtmlEncode(_temp.CashierPrinterName);

                Literal _hostNameLiteral = (Literal)e.Item.FindControl("HostNameLiteral");
                _hostNameLiteral.Text = HttpUtility.HtmlEncode(_temp.HostName);

                Literal _locationLiteral = (Literal)e.Item.FindControl("LocationLiteral");
                _locationLiteral.Text = HttpUtility.HtmlEncode(_temp.Location);

                Literal _kitchenPrinterIPAddressLiteral = (Literal)e.Item.FindControl("PrinterIPAddressLiteral");
                _kitchenPrinterIPAddressLiteral.Text = HttpUtility.HtmlEncode(_temp.IPAddress);

                Literal _kitchenPrinterNameLiteral = (Literal)e.Item.FindControl("PrinterNameLiteral");
                _kitchenPrinterNameLiteral.Text = HttpUtility.HtmlEncode(_temp.PrinterName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._cashierPrinterBL.DeleteMulti(_tempSplit);
