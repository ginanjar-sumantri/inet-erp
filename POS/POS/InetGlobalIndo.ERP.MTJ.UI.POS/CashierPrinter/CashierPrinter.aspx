<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CashierPrinter.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.CashierPrinter.CashierPrinter" %>
                                        ...
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="left">
                                                 ...
                                                 <td align="left">
                                                    <asp:Literal runat="server" ID="CodeLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="PrinterIPAddressLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="PrinterNameLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
