<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DiscoverFSEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.DiscoverFS.DiscoverFSEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="VendorDropDownList" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
