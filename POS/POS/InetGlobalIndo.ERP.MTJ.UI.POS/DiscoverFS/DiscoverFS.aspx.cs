...
{
    public partial class DiscoverFS : DiscoverFSBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._discoverFSBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._discoverFSBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsShippingDF _temp = (POSMsShippingDF)e.Item.DataItem;

                //string _code = _temp.TRSCode + "-" + _temp.TRSName;
                string _code = _temp.DFSCode + "-" + _temp.VendorCode;
                ...
                _trsCode.Text = HttpUtility.HtmlEncode(_temp.DFSCode);

                Literal _trsName = (Literal)e.Item.FindControl("NameLiteral");
                _trsName.Text = HttpUtility.HtmlEncode(_temp.DFSName);

                Literal _trsVendor = (Literal)e.Item.FindControl("VendorLiteral");
                _trsVendor.Text = this._vendorBL.GetSingle(HttpUtility.HtmlEncode(_temp.VendorCode)).VendorName;
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._discoverFSBL.DeleteMulti(_tempSplit);
