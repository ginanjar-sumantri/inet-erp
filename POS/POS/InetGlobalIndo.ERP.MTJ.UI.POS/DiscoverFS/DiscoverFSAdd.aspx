<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DiscoverFSAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.DiscoverFS.DiscoverFSAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="CodeTextBox" Width="120" MaxLength="12"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="PercentageTextBox" Width="120" MaxLength="13"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
