...
public partial class index : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.ModuleTitleLiteral.Text = "POS";
        ...
        if (!this.Page.IsPostBack)
        {
            ...
            _topNavigationMenu.RenderItem(0, _roles, ERPModule.POS, this.Menu2, new UserBL().GetCompanyId(HttpContext.Current.User.Identity.Name));
