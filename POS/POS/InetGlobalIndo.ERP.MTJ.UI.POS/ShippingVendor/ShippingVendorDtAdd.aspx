<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ShippingVendorDtAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.ShippingVendor.ShippingVendorDtAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ShippingZoneTypeDropDownList" runat="server">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
