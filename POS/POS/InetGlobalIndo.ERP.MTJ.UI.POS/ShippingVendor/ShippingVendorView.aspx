<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ShippingVendorView.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.POS.ShippingVendor.ShippingVendorView" %>
                                ...
                                <td>
                                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="SupplierTextBox" Width="300" BackColor="#CCCCCC"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
