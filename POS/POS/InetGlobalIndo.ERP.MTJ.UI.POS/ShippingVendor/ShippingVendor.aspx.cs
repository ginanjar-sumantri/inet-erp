...
{
    public partial class ShippingVendor : ShippingVendorBase
    {
        VendorBL _vendorBL = new VendorBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._vendorBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._vendorBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                POSMsShippingVendor _temp = (POSMsShippingVendor)e.Item.DataItem;

                //string _code = _temp.TRSCode + "-" + _temp.TRSName;
                string _code = _temp.VendorCode;
                ...
                Literal _trsCode = (Literal)e.Item.FindControl("CodeLiteral");
                _trsCode.Text = HttpUtility.HtmlEncode(_temp.VendorCode);

                Literal _trsName = (Literal)e.Item.FindControl("NameLiteral");
                _trsName.Text = HttpUtility.HtmlEncode(_temp.VendorName);

                Literal _trsCity = (Literal)e.Item.FindControl("CityLiteral");
                _trsCity.Text = this._cityBL.GetCityNameByCode(HttpUtility.HtmlEncode(_temp.City));

                Literal _trsAddress = (Literal)e.Item.FindControl("AddressLiteral");
                _trsAddress.Text = HttpUtility.HtmlEncode(_temp.Address1);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._vendorBL.DeleteMulti(_tempSplit);
