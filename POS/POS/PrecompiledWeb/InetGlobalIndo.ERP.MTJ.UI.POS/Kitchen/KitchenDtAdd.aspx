<%@ page language="C#" masterpagefile="~/default.master" autoeventwireup="true" inherits="InetGlobalIndo.ERP.MTJ.UI.POS.Kitchen.KitchenDtAdd, App_Web_lyemwr9w" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ProductTypeDDL" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
