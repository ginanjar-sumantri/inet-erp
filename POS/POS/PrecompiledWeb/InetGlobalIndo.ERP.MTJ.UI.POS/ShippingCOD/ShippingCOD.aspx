<%@ page title="" language="C#" masterpagefile="~/default.master" autoeventwireup="true" inherits="InetGlobalIndo.ERP.MTJ.UI.POS.ShippingCOD.ShippingCOD, App_Web_fsg-jrvv" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="TransNmbr" Text="TransNmbr"></asp:ListItem>
                                                    <asp:ListItem Value="ReferenceNo" Text="Reference"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="left">
                                                    <table cellpadding="0" cellspacing="0" width="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td style="padding-left: 4px">
                                                                <asp:ImageButton runat="server" Text="EditPrice" ID="EditPriceButton" />
                                                            </td>--%>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="SenderLocationLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="DeliverLocationLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
