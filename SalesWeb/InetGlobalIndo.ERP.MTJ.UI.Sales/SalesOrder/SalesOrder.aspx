<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SalesOrder.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.SalesOrder.SalesOrder" %>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 160px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Trans No." ID="field1" class="SortLinkButton" runat="server"
                                                    OnClick="field1_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 160px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="File No." ID="field2" class="SortLinkButton" runat="server"
                                                    OnClick="field2_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 70px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Trans Date" ID="field3" class="SortLinkButton" runat="server"
                                                    OnClick="field3_Click"></asp:LinkButton></b>
                                        </td>
                                        ...
                                        <td style="width: 80px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Status" ID="field4" class="SortLinkButton" runat="server" OnClick="field4_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 50px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Currency" ID="field5" class="SortLinkButton" runat="server"
                                                    OnClick="field5_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 100px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Customer" ID="field6" class="SortLinkButton" runat="server"
                                                    OnClick="field6_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 115px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Term" ID="field7" class="SortLinkButton" runat="server" OnClick="field7_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 100px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Bill To" ID="field8" class="SortLinkButton" runat="server"
                                                    OnClick="field8_Click"></asp:LinkButton></b>
                                        </td>
                                    </tr>
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <%--<td align="center">
                                                    <asp:Literal runat="server" ID="RevisiLiteral"></asp:Literal>
                                                </td>--%>
                                                <td align="center">
                                                ...
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="CustLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="TermLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="BillToLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
