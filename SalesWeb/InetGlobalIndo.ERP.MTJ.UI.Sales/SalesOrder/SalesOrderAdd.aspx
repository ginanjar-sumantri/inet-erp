<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="SalesOrderAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.SalesOrder.SalesOrderAdd" %>
                            ...
                            <ContentTemplate>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <%--<input type="button" id="delivery_date" value="..." onclick="displayCalendar(ctl00_DefaultBodyContentPlaceHolder_DeliveryDateTextBox,'yyyy-mm-dd',this)" />--%>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <%--<input type="button" id="due_date" value="..." onclick="displayCalendar(ctl00_DefaultBodyContentPlaceHolder_DueDateTextBox,'yyyy-mm-dd',this)" />--%>
