<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustomerSellingPrice.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.CustomerSellingPrice.CustomerSellingPrice" %>
                            ...
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="CustomerTextBox" runat="server" MaxLength="30" Width="160" BackColor="#CCCCCC"></asp:TextBox>
                                            <asp:Button ID="btnSearchCustNo" runat="server" Text="..." />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                                ...
                                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                                    <tr class="bgcolor_gray">
                                                        ...
                                                        <td style="width: 100px" class="tahoma_11_white" align="center">
                                                            <asp:LinkButton Text="Customer Code" ID="field1" class="SortLinkButton" runat="server"
