...
{
    public partial class CustomerType : CustomerTypeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._customerBL.RowsCountCustType(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        //{
        //    double q = this._customerBL.RowsCountCustType(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._customerBL.GetListCustType(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsCustType _temp = (MsCustType)e.Item.DataItem;
                string _code = _temp.CustTypeCode.ToString();
                ...
                Literal _custTypeCode = (Literal)e.Item.FindControl("CustTypeCodeLiteral");
                _custTypeCode.Text = HttpUtility.HtmlEncode(_temp.CustTypeCode);

                Literal _custTypeName = (Literal)e.Item.FindControl("CustTypeNameLiteral");
                _custTypeName.Text = HttpUtility.HtmlEncode(_temp.CustTypeName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._customerBL.DeleteMultiCustType(_tempSplit);
