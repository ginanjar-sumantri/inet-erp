...
{
    public partial class RequestSalesReturDetail : RequestSalesReturBase
    {
        ...
        //private string _reportPath1 = "RequestSalesRetur/RequestSalesReturPrintPreview.rdlc";
        ...
        private double RowCount()
        {
            ...
            _result = this._requestSalesReturBL.RowsCountMKTReqReturDt(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey));
        ...
        {
            if (this.StatusHiddenField.Value.Trim().ToLower() == RequestSalesReturDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == RequestSalesReturDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == RequestSalesReturDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == RequestSalesReturDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
        ...
        {
            this._requestSalesReturBL = new RequestSalesReturBL();
            ...
            _decimalPlace = _currencyBL.GetDecimalPlace(_mktReqReturHd.CurrCode);
            ...
            if (_mktReqReturHd.UseReferense.ToString() == "Y")
            {
                ...
                this.SJNoTextBox.Text = _mktReqReturHd.SJNo;// _bolBL.GetFileNmbrFromSTCSJHd(_mktReqReturHd.SJNo);
            }
            else
            {
            ...
            this.CurrCodeTextBox.Text = _mktReqReturHd.CurrCode;
            ...
            this.StatusLabel.Text = RequestSalesReturDataMapper.GetStatusText(_mktReqReturHd.Status);
            this.AttnTextBox.Text = _mktReqReturHd.Attn;
            this.RemarkTextBox.Text = _mktReqReturHd.Remark;

            this.StatusHiddenField.Value = _mktReqReturHd.Status.ToString();
            ...
            {
                //if (_mktReqReturHd.TransType == "DS")
                //{
                //    this.ListRepeater.DataSource = this._directSalesBL.GetListDirectSalesDt(_prmCurrentPage, _maxrow, _mktReqReturHd.SJNo);
                //}
                //if (_mktReqReturHd.TransType == "POS")
                //{
                //    this.ListRepeater.DataSource = this._posBL.GetListPOSDt(_prmCurrentPage, _maxrow, _mktReqReturHd.SJNo);
                //}
                //if (_mktReqReturHd.TransType == "DO")
                //{
                this.ListRepeater.DataSource = this._requestSalesReturBL.GetListMKTReqReturDt(_prmCurrentPage, _maxrow, this.TransNoTextBox.Text);
                //}
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == RequestSalesReturDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                this.AddButton.Visible = false;
                this.DeleteButton.Visible = false;
                this.EditButton.Visible = false;
        ...
        protected void ActionButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (this.StatusHiddenField.Value.Trim().ToLower() == RequestSalesReturDataMapper.GetStatus(TransStatus.OnHold).ToString().ToLower())
            {
                string _result = this._requestSalesReturBL.GetAppr(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == RequestSalesReturDataMapper.GetStatus(TransStatus.WaitingForApproval).ToString().ToLower())
            {
                string _result = this._requestSalesReturBL.Approve(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);

                this.WarningLabel.Text = _result;
            }
            else if (this.StatusHiddenField.Value.Trim().ToLower() == RequestSalesReturDataMapper.GetStatus(TransStatus.Approved).ToString().ToLower())
            {
                string _result = this._requestSalesReturBL.Posting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
            ...
            else if (this.StatusHiddenField.Value.Trim().ToLower() == RequestSalesReturDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())
            {
                ...
                //string _result = this._requestSalesReturBL.Unposting(this.TransNoTextBox.Text, _year, _period, HttpContext.Current.User.Identity.Name);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._requestSalesReturBL.DeleteMultiMKTReqReturDt(_tempSplit, this.TransNoTextBox.Text);
        ...
        protected void PreviewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportSalesBL.RequestSalesReturPrintPreview(this.TransNoTextBox.Text);

            this.ReportViewer1.LocalReport.DataSources.Clear();
            this.ReportViewer1.LocalReport.DataSources.Add(_reportDataSource1);

            string _path = _reportListBL.GetPathPrintPreview(AppModule.GetValue(TransactionType.RequestSalesRetur), _userBL.GetCompanyId(HttpContext.Current.User.Identity.Name));
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                //if (this.TransTypeTextBox.Text == "DO")
                //{
                MKTReqReturDt _temp = (MKTReqReturDt)e.Item.DataItem;
                ...
                if ((this.StatusHiddenField.Value.Trim().ToLower() == RequestSalesReturDataMapper.GetStatus(TransStatus.Posted).ToString().ToLower())) //&& (_temp.DoneClosing.ToString().Trim().ToLower() == RequestSalesReturDataMapper.GetStatusDetail(SalesOrderStatusDt.Open).ToString().Trim().ToLower()) && _temp.Qty > (((_temp.QtyRetur == null) ? 0 : _temp.QtyRetur) + ((_temp.QtyClose == null) ? 0 : _temp.QtyClose)))
                {
                ...
                //_doneClosing.Text = HttpUtility.HtmlEncode(RequestSalesReturDataMapper.GetStatusTextDetail(_doneClose1));
                //}
                //if (this.TransTypeTextBox.Text == "DS")
                //{
                ...
                //    Literal _amount = (Literal)e.Item.FindControl("AmountLiteral");
                //    _amount.Text = (_temp.Amount == 0 ? "0" : HttpUtility.HtmlEncode(Convert.ToDecimal(_temp.Amount).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace))));

                //    Literal _price = (Literal)e.Item.FindControl("PriceLiteral");
                //    _price.Text = (_temp.Price == 0 ? "0" : HttpUtility.HtmlEncode(Convert.ToDecimal(_temp.Price).ToString(CurrencyDataMapper.GetFormatDecimal(_decimalPlace))));

                //    //Literal _doneClosing = (Literal)e.Item.FindControl("DoneClosingLiteral");
                //    //char _doneClose1 = (_temp.DoneClosing == null) ? ' ' : Convert.ToChar(_temp.DoneClosing);
                //    //_doneClosing.Text = HttpUtility.HtmlEncode(RequestSalesReturDataMapper.GetStatusTextDetail(_doneClose1));
                //}
                //if (this.TransTypeTextBox.Text == "POS")
                //{
        ...
        protected void ListRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "CloseButton")
            {
                ...
                string _result = this._requestSalesReturBL.Closing(Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey), e.CommandArgument.ToString(), this.DescriptionHiddenField.Value, HttpContext.Current.User.Identity.Name);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            {
                bool _result1 = _unpostingActivitiesBL.InsertUnpostingActivities(AppModule.GetValue(TransactionType.RequestSalesRetur), this.TransNoTextBox.Text, this.FileNoTextBox.Text, HttpContext.Current.User.Identity.Name, this.ReasonTextBox.Text, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.UnPosting)));
                if (_result1 == true)
                    this.WarningLabel.Text = _result;
