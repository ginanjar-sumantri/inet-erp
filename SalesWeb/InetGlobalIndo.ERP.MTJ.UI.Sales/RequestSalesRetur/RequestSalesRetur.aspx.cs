...
{
    public partial class RequestSalesRetur : RequestSalesReturBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._requestSalesReturBL.RowsCountMKTReqReturHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._requestSalesReturBL.GetListMKTReqReturHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _ex = this._requestSalesReturBL.GetSingleMKTReqReturHdForStatus(_tempSplit);
            if (_ex == true)
            {
                bool _result = this._requestSalesReturBL.DeleteMultiMKTReqReturHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MKTReqReturHd _temp = (MKTReqReturHd)e.Item.DataItem;
                ...
                if (_temp.Status != RequestSalesReturDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(RequestSalesReturDataMapper.GetStatusText(_temp.Status));
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._requestSalesReturBL.DeleteMultiApproveMMKTReqReturHd(_tempSplit, AppModule.GetValue(TransactionType.RequestSalesRetur), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
