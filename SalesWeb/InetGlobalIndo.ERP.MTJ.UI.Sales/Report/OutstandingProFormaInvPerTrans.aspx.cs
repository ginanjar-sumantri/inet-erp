...
{
    public partial class OutstandingProFormaInvPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/OutstandingProFormaInvPerTrans.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDOutstandingProFormaInvPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Outstanding Pro Forma Invoice Per Transaction Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.OutstandingProFormaInvPerTrans(_startDateTime, _custCode, _productCode, Convert.ToInt32(this.CustGroupTypeDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
            ...
            _reportParam[5] = new ReportParameter("FgReport", "0", false);
