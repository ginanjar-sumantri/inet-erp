...
{
    public partial class ProFormaInvSummaryPerCust : ReportBase
    {
        private ReportSalesBL _report = new ReportSalesBL();
        private PermissionBL _permBL = new PermissionBL();
        private CustomerBL _custBL = new CustomerBL();

        private string _reportPath0 = "Report/ProFormaInvSummaryPerCust.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDProFormaInvSummaryPerCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Pro Forma Invoice Summary Per Customer Report";
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "SOSumPerCust";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (_validate == true)
            {
                ...
                if (this.FilterReportRadioButtonList1.SelectedValue == "0")
                {
                    ...
                    _reportParam[8] = new ReportParameter("FgSelection", this.SelectionDropDownList.SelectedValue, true);
                    _reportParam[9] = new ReportParameter("From", this.CustCodeFromTextBox.Text, true);
                    _reportParam[10] = new ReportParameter("To", this.CustCodeToTextBox.Text, true);
                ...
                else if (this.FilterReportRadioButtonList1.SelectedValue == "1")
                {
                    ...
                    _reportDataSource1 = this._report.ProFormaInvSummaryPerCustByYear(_start, _end, _custCode, Convert.ToInt16(this.HeaderReportList1.SelectedIndex), Convert.ToInt32(this.CustGroupTypeDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.SelectionDropDownList.SelectedValue), this.CustCodeFromTextBox.Text, this.CustCodeToTextBox.Text);
                    ...
                    _reportParam[6] = new ReportParameter("FgExport", this.CustGroupTypeDropDownList.SelectedValue, true);
                    ...
                    _reportParam[10] = new ReportParameter("FromCust", this.CustCodeFromTextBox.Text, true);
                    _reportParam[11] = new ReportParameter("ToCust", this.CustCodeToTextBox.Text, true);
        ...
        protected void FilterReportRadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                this.HeaderReportList1.ReportGroup = "SOSumPerCustByYear";
                this.HeaderReportList1.Render();
