...
{
    public partial class RequestSalesReturPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ReqSalesReturPerTransSumReport.rdlc";
        private string _reportPath1 = "Report/ReqSalesReturPerTransDetailReport.rdlc";


        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDReqSalesReturTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Request Sales Retur Per Transaction Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.RequestSalesReturPerTrans(_startDateTime, _endDateTime, _custCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
