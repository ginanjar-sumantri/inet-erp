<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ProFormaInvPerProduct.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Report.ProFormaInvPerProduct" %>
                                        ...
                                        <%--<tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                    ...
                                                    <asp:ListItem Value="3">Detail Per Product, Customer</asp:ListItem>
                                                    <asp:ListItem Value="5">Detail Per Product</asp:ListItem>
                                                </asp:DropDownList>
