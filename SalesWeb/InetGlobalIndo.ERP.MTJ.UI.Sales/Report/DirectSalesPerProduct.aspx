<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DirectSalesPerProduct.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Report.DirectSalesPerProduct" %>
                                ...
                                <td>
                                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CustSubGroupDropDownList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="CustSubGroupDropDownList_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
