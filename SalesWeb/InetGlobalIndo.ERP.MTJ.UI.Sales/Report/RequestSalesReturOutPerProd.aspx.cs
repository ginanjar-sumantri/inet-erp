...
{
    public partial class RequestSalesReturOutPerProd : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ReqReturOutPerProdSummaryReport.rdlc";
        private string _reportPath1 = "Report/ReqReturOutPerProdDetailReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDReqSalesReturOutProd, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Request Sales Retur Outstanding Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.RequestSalesReturOutPerProd(_startDateTime, _custCode, _productCode, Convert.ToInt32(FgReportDropDownList.SelectedValue));
