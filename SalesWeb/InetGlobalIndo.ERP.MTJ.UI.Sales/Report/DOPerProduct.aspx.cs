...
{
    public partial class DOPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/DOPerProductSummaryProduct.rdlc";
        private string _reportPath1 = "Report/DOPerProductSummaryProductCust.rdlc";
        private string _reportPath2 = "Report/DOPerProductDetailProductCust.rdlc";
        private string _reportPath3 = "Report/DOPerProductSummary.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDDOPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Delivery Order Per Product Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.DOPerProduct(_startDateTime, _endDateTime, _custCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.CustGroupTypeDropDownList.SelectedValue));
