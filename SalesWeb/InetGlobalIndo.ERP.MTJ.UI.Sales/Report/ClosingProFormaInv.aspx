<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ClosingProFormaInv.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Report.ClosingProFormaInv" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                    ...
                                                    <asp:ListItem Value="2">Per Customer</asp:ListItem>
                                                </asp:DropDownList>
