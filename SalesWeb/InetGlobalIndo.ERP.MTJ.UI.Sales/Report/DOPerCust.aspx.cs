...
{
    public partial class DOPerCust : ReportBase
    {
        ...
        private string _reportPath0 = "Report/DOPerCustSummary.rdlc";
        private string _reportPath1 = "Report/DOPerCustDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDDOPerCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Delivery Order Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.DOPerCust(_startDateTime, _endDateTime, _custCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.CustGroupTypeDropDownList.SelectedValue));
