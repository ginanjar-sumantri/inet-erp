...
{
    public partial class ProFormaInvSummaryPerProduct : ReportBase
    {
        ...
        private String _headerReportIndex;

        private string _reportPath0 = "Report/ProFormaInvSummaryPerProductProdQty.rdlc";
        private string _reportPath1 = "Report/ProFormaInvSummaryPerProductProdGroupQty.rdlc";
        private string _reportPath2 = "Report/ProFormaInvSummaryPerProductProdSubGroupQty.rdlc";
        private string _reportPath3 = "Report/ProFormaInvSummaryPerProductProdTypeQty.rdlc";

        private string _reportPath4 = "Report/ProFormaInvSummaryPerProductProdAmount.rdlc";
        private string _reportPath5 = "Report/ProFormaInvSummaryPerProductProdGroupAmount.rdlc";
        private string _reportPath6 = "Report/ProFormaInvSummaryPerProductProdSubGroupAmount.rdlc";
        private string _reportPath7 = "Report/ProFormaInvSummaryPerProductProdTypeAmount.rdlc";

        private string _reportPath8 = "Report/ProFormaInvSummaryPerProductProdAmountQty.rdlc";
        private string _reportPath9 = "Report/ProFormaInvSummaryPerProductProdGroupAmountQty.rdlc";
        private string _reportPath10 = "Report/ProFormaInvSummaryPerProductProdSubGroupAmountQty.rdlc";
        private string _reportPath11 = "Report/ProFormaInvSummaryPerProductProdTypeAmountQty.rdlc";
        ...
        private string _awal2 = "ctl00_DefaultBodyContentPlaceHolder_ProductSubGrpCheckBoxList_";
        private string _akhir2 = "";
        private string _cbox2 = "ctl00_DefaultBodyContentPlaceHolder_AllCheckBox1";
        private string _tempHidden2 = "ctl00$DefaultBodyContentPlaceHolder$TempHidden1";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDProFormaInvSummaryPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Pro Forma Invoice Summary Per Product Report";
                ...
                this.ShowProductSubGrp(0);
                this.SetCheckBox1();
            }

            if (this.HeaderReportList1.SelectedIndex == "-1" || this.HeaderReportList1.SelectedIndex == "0" || this.HeaderReportList1.SelectedIndex == "3" || this.HeaderReportList1.SelectedIndex == "6" || this.HeaderReportList1.SelectedIndex == "9" || this.HeaderReportList1.SelectedIndex == "12" || this.HeaderReportList1.SelectedIndex == "15" || this.HeaderReportList1.SelectedIndex == "18" || this.HeaderReportList1.SelectedIndex == "21")
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "SOSumPerProd";
        ...
        private void ShowProductSubGrp(Int32 _prmCurrentPage2)
        {
            ...
            this.ProductSubGrpCheckBoxList.DataSource = this._productBL.GetListProductSubGroupForDDL(this.CategoryDropDownList1.SelectedValue, this.KeywordTextBox1.Text, _prmCurrentPage2, _maxrow2);
            this.ProductSubGrpCheckBoxList.DataBind();

            this.AllCheckBox1.Attributes.Add("OnClick", "CheckBox_ClickAll(" + this.AllCheckBox1.ClientID + ", " + this.CheckHidden1.ClientID + ", '" + _awal2 + "', '" + _akhir2 + "', '" + _tempHidden2 + "', 'true');");

            int i = 0;
            foreach (ListItem _item in this.ProductSubGrpCheckBoxList.Items)
            {
                _item.Attributes.Add("OnClick", "CheckBox_Click(" + this.CheckHidden1.ClientID + ", " + _awal2 + i.ToString() + ", '" + _item.Value + "', '" + _awal2 + "', '" + _akhir2 + "', '" + _cbox2 + "', 'true');");
                i++;
            }
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.ValidateDiffDate() == true)
            {
                ...
                {
                    _productSubGrpCode = this.AllHidden1.Value;
                }
                else
                {
                    if (this.AllCheckBox1.Checked == true)
                    {
                        _productSubGrpCode = this.TempHidden1.Value;
                    }
                    else
                    {
                        _productSubGrpCode = this.CheckHidden1.Value;
                    }
                }
                ...
                if (this.HeaderReportList1.SelectedText == "Sales Order Product - Qty" || this.HeaderReportList1.SelectedText == "Sales Order Product - Amount" || this.HeaderReportList1.SelectedText == "Sales Order Product - Amount Qty")
                    _headerReportIndex = "0";
                else if (this.HeaderReportList1.SelectedText == "Sales Order Product Group - Qty" || this.HeaderReportList1.SelectedText == "Sales Order Product Group - Amount" || this.HeaderReportList1.SelectedText == "Sales Order Product Group - Amount Qty")
                    _headerReportIndex = "1";
                else if (this.HeaderReportList1.SelectedText == "Sales Order Product Sub Group - Qty" || this.HeaderReportList1.SelectedText == "Sales Order Product Sub Group - Amount" || this.HeaderReportList1.SelectedText == "Sales Order Product Sub Group - Amount Qty")
                    _headerReportIndex = "2";
                else if (this.HeaderReportList1.SelectedText == "Sales Order Product Type - Qty" || this.HeaderReportList1.SelectedText == "Sales Order Product Type - Amount" || this.HeaderReportList1.SelectedText == "Sales Order Product Type - Amount Qty")
                    _headerReportIndex = "3";
                else if (this.HeaderReportList1.SelectedText == "Sales Order Customer Product - Qty" || this.HeaderReportList1.SelectedText == "Sales Order Customer Product - Amount" || this.HeaderReportList1.SelectedText == "Sales Order Customer Product - Amount Qty")
                    _headerReportIndex = "4";
                else if (this.HeaderReportList1.SelectedText == "Sales Order Customer Product Group - Qty" || this.HeaderReportList1.SelectedText == "Sales Order Customer Product Group - Amount" || this.HeaderReportList1.SelectedText == "Sales Order Customer Product Group - Amount Qty")
                    _headerReportIndex = "5";
                else if (this.HeaderReportList1.SelectedText == "Sales Order Customer Product Sub Group - Qty" || this.HeaderReportList1.SelectedText == "Sales Order Customer Product Sub Group - Amount" || this.HeaderReportList1.SelectedText == "Sales Order Customer Product Sub Group - Amount Qty")
                    _headerReportIndex = "6";
                else if (this.HeaderReportList1.SelectedText == "Sales Order Customer Product Type - Qty" || this.HeaderReportList1.SelectedText == "Sales Order Customer Product Type - Amount" || this.HeaderReportList1.SelectedText == "Sales Order Customer Product Type - Amount Qty")
                    _headerReportIndex = "7";


                ReportDataSource _reportDataSource1 = this._report.ProFormaInvSummaryPerProduct(_start, _end, _productSubGrpCode, _custCode, Convert.ToInt32(_headerReportIndex), Convert.ToInt32(this.CustGroupTypeDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.SelectionDropDownList.SelectedValue), this.CustCodeFromTextBox.Text, this.CustCodeToTextBox.Text, this.ProductSubGroupFromTextBox.Text, this.ProductSubGroupToTextBox.Text);
                ...
                _reportParam[5] = new ReportParameter("FgReport", _headerReportIndex, false);
                ...
                _reportParam[9] = new ReportParameter("FgSelection", this.SelectionDropDownList.SelectedValue, true);
                _reportParam[10] = new ReportParameter("From", this.CustCodeFromTextBox.Text, true);
                _reportParam[11] = new ReportParameter("To", this.CustCodeToTextBox.Text, true);
                _reportParam[12] = new ReportParameter("ProdFrom", this.ProductSubGroupFromTextBox.Text, true);
                _reportParam[13] = new ReportParameter("ProdTo", this.ProductSubGroupToTextBox.Text, true);
            ...
            {
                this.WarningLabel.Text = "Difference Between Start and End Period Must Not Greater Than 12 Months";
            }
        }
        ...
        private double RowCountCustomer()
        {
            ...
            _result1 = this._custBL.RowsCountCustReport(_tempCustGroup, _tempCustType, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowPage2(Int32 _prmCurrentPage)
        {
            ...
            int i = 0;
            decimal min = 0, max = 0;
            double q = this.RowCountCustomer2();
        ...
        protected void DataPagerTopRepeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "DataPager")
            {
                ...
                this.ShowProductSubGrp(Convert.ToInt32(e.CommandArgument));
                this.SetCheckBox1();
            }
        }
        ...
        protected void SetCheckAllCheckBox1()
        {
            ...
            if (this.ProductSubGrpCheckBoxList.Items.Count < 1)
            {
                this.AllCheckBox1.Checked = false;
            }
        }
        ...
        protected void DataPagerButton2_Click(object sender, EventArgs e)
        {
            ...
            foreach (Control _item in this.DataPagerTopRepeater.Controls)
            {
                if (((TextBox)_item.Controls[3]).Text != "")
                {
                    ...
                    if (_reqPage > this.RowCountCustomer2())
                    {
                        ((TextBox)_item.Controls[3]).Text = this.RowCountCustomer2().ToString();
                        _reqPage = Convert.ToInt32(this.RowCountCustomer2()) - 1;
                        break;
                    }
                    else if (_reqPage < 0)
                    {
            ...
            this.ShowProductSubGrp(_reqPage);
            this.SetCheckBox();
        }

        private double RowCountCustomer2()
        {
            double _result1 = 0;
