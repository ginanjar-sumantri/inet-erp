...
{
    public partial class DirectSalesPerTransaction : ReportBase
    {
        private ReportBL _report = new ReportBL();
        private PermissionBL _permBL = new PermissionBL();
        private CustomerBL _custBL = new CustomerBL();

        private string _reportPath0 = "Report/ReportDirectSalesSummaryPerTransaction.rdlc";
        private string _reportPath1 = "Report/ReportDirectSalesDetailPerTransaction.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDDirectSalesPerTransaction, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.HeaderReportList1.ReportGroup = "DSPerTrans";
                this.WarningLabel.Text = "";
                this.PageTitleLiteral.Text = "Direct Sales Per Transaction Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.DirectSalesPerTransaction(_startDateTime, _endDateTime, _user);
            ...
            _reportParam[2] = new ReportParameter("prmUser", _user, true);
