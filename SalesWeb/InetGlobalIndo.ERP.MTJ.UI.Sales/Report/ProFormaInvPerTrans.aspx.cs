...
{
    public partial class ProFormaInvPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ProFormaInvPerTransSummary.rdlc";
        private string _reportPath1 = "Report/ProFormaInvPerTransDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDProFormaInvPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PageTitleLiteral.Text = "Pro Forma Invoice Per Transaction Report";
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "SOPerTrans";
            this.ClearLabel();
            this.CheckHidden.Value = "";
            this.TempHidden.Value = "";
