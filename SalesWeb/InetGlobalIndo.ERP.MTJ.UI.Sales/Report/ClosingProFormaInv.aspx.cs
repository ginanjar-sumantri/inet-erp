...
{
    public partial class ClosingProFormaInv : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ClosingProFormaInvPerTrans.rdlc";
        private string _reportPath1 = "Report/ClosingProFormaInvPerProduct.rdlc";
        private string _reportPath2 = "Report/ClosingProFormaInvPerCust.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDClosingProFormaInv, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Closing Pro Forma Invoice Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ClosingProFormaInv(_startDateTime, _endDateTime, _custCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.CustGroupTypeDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
            ...
            _reportParam[7] = new ReportParameter("FgExport", this.CustGroupTypeDropDownList.SelectedValue, false);
            _reportParam[8] = new ReportParameter("FgCurr", this.GroupByDropDownList.SelectedValue, false);
