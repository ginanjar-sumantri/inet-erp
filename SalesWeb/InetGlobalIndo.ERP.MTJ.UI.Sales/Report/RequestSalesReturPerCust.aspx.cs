...
{
    public partial class RequestSalesReturPerCust : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ReqSalesReturPerCustSumReport.rdlc";
        private string _reportPath1 = "Report/ReqSalesReturPerCustDetailReport.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Request Sales Retur Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.RequestSalesReturPerCust(_startDateTime, _endDateTime, _custCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue));
