<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="RequestSalesReturOutPerCust.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Report.RequestSalesReturOutPerCust" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                ...
                                                <asp:ListItem Value="0">Summary By Product</asp:ListItem>
                                                <asp:ListItem Value="1">Detail By Product</asp:ListItem>
                                                <asp:ListItem Value="2">Summary By Transaction</asp:ListItem>
                                            </asp:DropDownList>
