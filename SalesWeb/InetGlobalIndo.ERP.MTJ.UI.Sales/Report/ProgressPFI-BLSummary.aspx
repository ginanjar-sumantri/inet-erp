<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ProgressPFI-BLSummary.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Report.ProgressPFI_BLSummary" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                ...
                                                <asp:ListItem Value="0">Summary Customer - Product</asp:ListItem>
                                                <asp:ListItem Value="2">Summary Product - Customer</asp:ListItem>
                                                <asp:ListItem Value="4">Detail </asp:ListItem>
                                                <asp:ListItem Value="7">Detail Product</asp:ListItem>
                                            </asp:DropDownList>
