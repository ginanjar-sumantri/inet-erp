...
{
    public partial class ProgressPFI_BLDetail : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ProgressDetailPFI-BLByCust-SO-ProdReport.rdlc";
        private string _reportPath1 = "Report/ProgressDetailPFI-BLByCust-Prod-SOReport.rdlc";
        private string _reportPath2 = "Report/ProgressDetailPFI-BLByProd-SOReport.rdlc";
        private string _reportPath3 = "Report/ProgressDetailPFI-BLBySO-ProdReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPFI_BLDetail, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Progress PFI - B/L Detail Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ProgressDetailPFI_BL(_startDateTime, _endDateTime, _custCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.FgExportTypeDropDownList.SelectedValue));
