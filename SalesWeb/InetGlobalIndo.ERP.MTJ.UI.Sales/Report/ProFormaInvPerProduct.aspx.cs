...
{
    public partial class ProFormaInvPerProduct : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ProFormaInvPerProductSummaryProduct.rdlc";    //Summary Per Product 0
        private string _reportPath1 = "Report/ProFormaInvPerProductSummaryProductCust.rdlc";//Summary Per Product, Customer 1
        private string _reportPath2 = "Report/ProFormaInvPerProductDetailProductCust.rdlc"; //Detail Per Product, Customer 3
        private string _reportPath3 = "Report/ProFormaInvPerProductDetailProduct.rdlc";     //Detail Per Product 5

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDProFormaInvPerProduct, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PageTitleLiteral.Text = "Pro Forma Invoice Per Product Report";
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "SOPerProd";
            this.CustTypeDropDownList.SelectedValue = "null";
            this.CustGroupDropDownList.SelectedValue = "null";
            this.CustGroupTypeDropDownList.SelectedValue = "0";
            this.CustCodeCheckBoxList.ClearSelection();
        }
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            String _HeaderReportList = this.HeaderReportList1.SelectedText;

            if (_HeaderReportList == "Summary Per Product")
                _HeaderReportList = "0";
            else if (_HeaderReportList == "Summary Per Product, Customer")
                _HeaderReportList = "1";
            else if (_HeaderReportList == "Detail Per Product, Customer")
                _HeaderReportList = "3";
            else if (_HeaderReportList == "Detail Per Product")
                _HeaderReportList = "5";
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ProFormaInvPerProduct(_startDateTime, _endDateTime, _custCode, Convert.ToInt32(_HeaderReportList), Convert.ToInt32(this.CustGroupTypeDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.SelectionDropDownList.SelectedValue), this.CustCodeFromTextBox.Text, this.CustCodeToTextBox.Text);
            ...
            _reportParam[6] = new ReportParameter("FgReport", _HeaderReportList, true);
            _reportParam[7] = new ReportParameter("FgExport", this.CustGroupTypeDropDownList.SelectedValue, true);
