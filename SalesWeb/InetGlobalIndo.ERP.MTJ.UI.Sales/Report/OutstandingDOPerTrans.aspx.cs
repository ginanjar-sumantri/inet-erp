...
{
    public partial class OutstandingDOPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/OutstandingDOPerTrans.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDOutstandingDOPerTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Outstanding Delivery Order Per Transaction Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.OutstandingDOPerTrans(_startDateTime, _custCode, _productCode, Convert.ToInt32(this.CustGroupTypeDropDownList.SelectedValue));
