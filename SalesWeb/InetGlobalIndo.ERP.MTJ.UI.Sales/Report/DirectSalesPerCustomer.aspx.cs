...
{
    public partial class DirectSalesPerCustomer : ReportBase
    {
        private ReportBL _report = new ReportBL();
        private PermissionBL _permBL = new PermissionBL();
        private CustomerBL _custBL = new CustomerBL();

        private string _reportPath0 = "Report/ReportDirectSalesSummaryPerCustomer.rdlc";
        private string _reportPath1 = "Report/ReportDirectSalesDetailPerCustomer.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDDirectSalesPerCustomer, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.HeaderReportList1.ReportGroup = "DSPerCust";
                this.WarningLabel.Text = "";
                this.PageTitleLiteral.Text = "Direct Sales Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._report.DirectSalesPerCustomer(_startDateTime, _endDateTime, _user);
            ...
            _reportParam[2] = new ReportParameter("prmCust", _user, true);
