...
{
    public partial class RequestSalesReturOutPerTrans : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ReqReturOutPerTransReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDReqSalesReturOutTrans, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Request Sales Retur Outstanding per Transaction Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.RequestSalesReturOutPerTrans(_startDateTime, _custCode, _productCode);
            ...
            _reportParam[4] = new ReportParameter("FgReport", "0", true);
