...
{
    public partial class ProgressPFI_BLSummary : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ProgressSumPFI-BLSumByCustProductReport.rdlc";
        private string _reportPath1 = "Report/ProgressSumPFI-BLSumByProdCustomerReport.rdlc";
        private string _reportPath2 = "Report/ProgressSumPFI-BLDetailReport.rdlc";
        private string _reportPath3 = "Report/ProgressSumPFI-BLDetailByProductReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDPFI_BLSUM, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Progress PFI - B/L Summary Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ProgressSumPFI_BL(_startDateTime, _endDateTime, _custCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.FgExportTypeDropDownList.SelectedValue));
            ...
            _reportParam[1] = new ReportParameter("End", _startDateTime.ToString(), true);
            ...
            _reportParam[6] = new ReportParameter("FgExport", this.FgExportTypeDropDownList.SelectedValue, true);
