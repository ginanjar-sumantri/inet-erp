<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="POSReport.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Report.POSReport" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="DefaultBodyContentPlaceHolder" runat="Server">
    <table cellpadding="3" cellspacing="0" width="100%" border="0">
        ...
        <tr>
            <td class="warning">
                <asp:Literal ID="Literal1" runat="server" Text="* This Report is Best Printed on Letter Size Paper" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Panel runat="server" ID="MenuPanel">
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            <td>
                                <uc1:HeaderReportList ID="HeaderReportList" runat="server" />
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="NoNota" runat="server"></asp:TextBox>
                                        </td>
                                        <td></td>
                                        <td>
                                            Customer Code
                                        ...
                                        <td>
                                            <asp:TextBox ID="CustomerCode" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="7">
