...
{
    public partial class ClosingDO : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ClosingDOPerTrans.rdlc";
        private string _reportPath1 = "Report/ClosingDOPerProduct.rdlc";
        private string _reportPath2 = "Report/ClosingDOPerCust.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDClosingDO, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Closing Delivery Order Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ClosingDO(_startDateTime, _endDateTime, _custCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue));
