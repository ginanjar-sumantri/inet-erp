...
{
    public partial class OutstandingDOPerCust : ReportBase
    {
        ...
        private string _reportPath0 = "Report/OutstandingDOPerCustSummaryProduct.rdlc";
        private string _reportPath1 = "Report/OutstandingDOPerCustDetailProduct.rdlc";
        private string _reportPath2 = "Report/OutstandingDOPerCustDetailTrans.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDOutstandingDOPerCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Outstanding Delivery Order Per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.OutstandingDOPerCust(_startDateTime, _custCode, _productCode, Convert.ToInt32(this.FgReportDropDownList.SelectedValue), Convert.ToInt32(this.CustGroupTypeDropDownList.SelectedValue));
