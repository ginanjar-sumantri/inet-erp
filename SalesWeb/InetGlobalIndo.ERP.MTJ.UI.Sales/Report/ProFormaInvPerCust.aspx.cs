...
{
    public partial class ProFormaInvPerCust : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ProFormaInvPerCustSummary.rdlc";
        private string _reportPath1 = "Report/ProFormaInvPerCustDetail.rdlc";

        protected void Page_Load(object sender, EventArgs e)
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDProFormaInvPerCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            {
                this.PageTitleLiteral.Text = "Pro Forma Invoice Per Customer Report";
                ...
                this.Literal2.Text = "<input id='button3' type='button' onclick='displayCalendar(" + this.TextBox1.ClientID + ",&#39" + DateFormMapper.GetFormat() + "&#39,this)' value='...' />";
                this.Literal3.Text = "<input id='button4' type='button' onclick='displayCalendar(" + this.TextBox2.ClientID + ",&#39" + DateFormMapper.GetFormat() + "&#39,this)' value='...' />";
        ...
        public void ClearData()
        {
            ...
            this.HeaderReportList1.ReportGroup = "SOPerCust";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.ProFormaInvPerCust(_startDateTime, _endDateTime, _custCode, Convert.ToInt32(this.HeaderReportList1.SelectedIndex), Convert.ToInt32(this.CustGroupTypeDropDownList.SelectedValue), Convert.ToInt32(this.GroupByDropDownList.SelectedValue), Convert.ToInt32(this.SelectionDropDownList.SelectedValue), this.CustCodeFromTextBox.Text, this.CustCodeToTextBox.Text);
            ...
            _reportParam[6] = new ReportParameter("FgReport", this.HeaderReportList1.SelectedIndex, true);
