...
{
    public partial class RequestSalesReturOutPerCust : ReportBase
    {
        ...
        private string _reportPath0 = "Report/ReqReturOutPerCustSumByProductReport.rdlc";
        private string _reportPath1 = "Report/ReqReturOutPerCustDetailByProductReport.rdlc";
        private string _reportPath2 = "Report/ReqReturOutPerCustSumByTransactionReport.rdlc";
        ...
        {
            this._permAccess = this._permBL.PermissionValidation1(this._menuIDReqSalesReturCust, HttpContext.Current.User.Identity.Name, InetGlobalIndo.ERP.MTJ.Common.Enum.Action.Access);
            ...
            if (!Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Request Sales Retur Outstanding per Customer Report";
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportBL.RequestSalesReturOutPerCust(_startDateTime, _custCode, _productCode, Convert.ToInt32(FgReportDropDownList.SelectedValue));
