<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ProgressPFI-BLDetail.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Report.ProgressPFI_BLDetail" %>
                            ...
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" width="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="FgReportDropDownList">
                                                ...
                                                <asp:ListItem Value="0">Customer - Sales Order - Product</asp:ListItem>
                                                <asp:ListItem Value="1">Customer - Product - Sales Order</asp:ListItem>
                                                <asp:ListItem Value="4">Product - Sales Order </asp:ListItem>
                                                <asp:ListItem Value="5">Sales Order - Product</asp:ListItem>
                                            </asp:DropDownList>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="FgExportTypeDropDownList">
                                                <asp:ListItem Value="null" Text="[Choose One]"></asp:ListItem>
                                                <asp:ListItem Value="0">Local</asp:ListItem>
                                                <asp:ListItem Value="1">Export</asp:ListItem>
                                                <asp:ListItem Value="2">All</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:CustomValidator ID="ExportCustomValidator" runat="server" ErrorMessage="Export Type Must Be Choosed"
                                                Text="*" ClientValidationFunction="DropDownValidation" ControlToValidate="FgExportTypeDropDownList"></asp:CustomValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <asp:Repeater EnableViewState="true" ID="DataPagerTopRepeater2" runat="server" OnItemCommand="DataPagerTopRepeater_ItemCommand"
