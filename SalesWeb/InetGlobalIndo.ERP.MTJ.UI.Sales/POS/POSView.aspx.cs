...
{
    public partial class POSView : POSBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._POSBL.RowsCountPOSHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._POSBL.GetListPOSHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._POSBL.DeleteMultiPOS(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                SAL_TrRetail _temp = (SAL_TrRetail)e.Item.DataItem;
                ...
                ImageButton _printPreviewButton = (ImageButton)e.Item.FindControl("PrintPreviewButton");
                _printPreviewButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/preview.jpg";
                _printPreviewButton.Height = 24;
                _printPreviewButton.OnClientClick = "window.open('POSPrint.aspx?datacount=" + _POSBL.GetDetailCount(_temp.TransNmbr).ToString() + "&transNmbr=" + _temp.TransNmbr + "' , '_printSetruk', 'width=700,height=600,toolbar=0,location=0,status=0,scrollbars=1');";
