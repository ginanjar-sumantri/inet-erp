...
{
    public partial class DirectSales : DirectSalesBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._directSalesBL.RowsCountSalTrDirectSalesHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._directSalesBL.GetListSalTrDirectSalesHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            if (this.CheckHidden.Value != "")
            {
                ...
                bool _ex = this._directSalesBL.GetSingleDirectSalesHdForStatus(_tempSplit);
                if (_ex == true)
                {
                    bool _result = this._directSalesBL.DeleteMultiSalTrDirectSalesHd(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                SALTrDirectSalesHd _temp = (SALTrDirectSalesHd)e.Item.DataItem;
                ...
                {
                    if (_temp.Status != DirectSalesDataMapper.GetStatusByte(TransStatus.Posted))
                    {
                ...
                _fileNmbrLiteral.Text = HttpUtility.HtmlEncode(_temp.FileNo);

                Literal _transDate = (Literal)e.Item.FindControl("TransDateLiteral");
                _transDate.Text = DateFormMapper.GetValue(_temp.Date).ToString();

                Literal _status = (Literal)e.Item.FindControl("StatusLiteral");
                _status.Text = DirectSalesDataMapper.GetStatusText(_temp.Status);
                ...
                _remark.Text = HttpUtility.HtmlEncode((_temp.Remark == null) ? "" : _temp.Remark);
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._directSalesBL.DeleteMultiApproveDirectSalesHd(_tempSplit, AppModule.GetValue(TransactionType.DirectSales), HttpContext.Current.User.Identity.Name, Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
