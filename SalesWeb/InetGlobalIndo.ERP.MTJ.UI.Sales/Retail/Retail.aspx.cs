...
{
    public partial class Retail : RetailBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._retailBL.RowsCountSAL_TrRetail(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._retailBL.GetListSAL_TrRetail(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._retailBL.DeleteMultiSAL_TrRetail(_tempSplit);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (_temp.Status != RetailDataMapper.GetStatusByte(TransStatus.Approved))
                {
                ...
                _status.Text = RetailDataMapper.GetStatusText(_temp.Status);
                ...
                Literal _empName = (Literal)e.Item.FindControl("EmployeeLiteral");
                _empName.Text = HttpUtility.HtmlEncode(_employeeBL.GetEmpNameByCode(_temp.EmpNumb));

                Literal _payType = (Literal)e.Item.FindControl("PayTypeLiteral");
                _payType.Text = HttpUtility.HtmlEncode(_temp.PaymentType);

                Literal _total = (Literal)e.Item.FindControl("TotalLiteral");
                _total.Text = HttpUtility.HtmlEncode(_temp.TotalAmount.ToString("#,##0.##"));
            }
        }
