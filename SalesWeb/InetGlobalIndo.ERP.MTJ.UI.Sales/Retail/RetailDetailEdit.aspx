<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="RetailDetailEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Retail.RetailDetailEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="AmountTextBox" runat="server" Width="230" BackColor="#CCCCCC"></asp:TextBox>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td>
