...
{
    public partial class CustomerGroup : CustomerGroupBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._customerBL.RowsCountCustGroup(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._customerBL.GetListCustGroup(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsCustGroup _temp = (MsCustGroup)e.Item.DataItem;
                string _code = _temp.CustGroupCode.ToString();
                ...
                Literal _custGroupCode = (Literal)e.Item.FindControl("CustGroupCodeLiteral");
                _custGroupCode.Text = HttpUtility.HtmlEncode(_temp.CustGroupCode);

                Literal _custGroupName = (Literal)e.Item.FindControl("CustGroupNameLiteral");
                _custGroupName.Text = HttpUtility.HtmlEncode(_temp.CustGroupName);

                Literal _type = (Literal)e.Item.FindControl("TypeLiteral");
                _type.Text = HttpUtility.HtmlEncode(_temp.CustGroupType);

                Literal _fgPKP = (Literal)e.Item.FindControl("FgPKPLiteral");
                _fgPKP.Text = HttpUtility.HtmlEncode(_temp.FgPKP.ToString());

                Literal _fgPPh = (Literal)e.Item.FindControl("FgPPhLiteral");
                _fgPPh.Text = HttpUtility.HtmlEncode(_temp.FgPPh.ToString());

                Literal _pph = (Literal)e.Item.FindControl("PPhLiteral");
                _pph.Text = HttpUtility.HtmlEncode((_temp.PPH == 0) ? "0" : _temp.PPH.ToString("#,###.##"));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._customerBL.DeleteMultiCustGroup(_tempSplit);
