<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DeliveryOrderDetailAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.DeliveryOrder.DeliveryOrderDetailAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="UnitTextBox" BackColor="#cccccc"></asp:TextBox>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td>
