...
{
    public partial class DeliveryOrder : DeliveryOrderBase
    {
        ...
        {
            if (this.sortField.Value == "Customer PO No.")
            {
                if (this.ascDesc.Value == "" || this.ascDesc.Value == "false")
                    this.ascDesc.Value = "true";
                else
            ...
            {
                this.sortField.Value = "Customer PO No.";
                this.ascDesc.Value = "true";
            }
            this.ShowData(Convert.ToInt32(this.ViewState[this._currPageKey]));
        }
        ...
        private double RowCount()
        {
            ...
            _result = this._deliveryOrderBL.RowsCountMKTDOHd(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._deliveryOrderBL.GetListMKTDOHd(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text, this.sortField.Value, Convert.ToBoolean(this.ascDesc.Value));
            }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //{
            bool _ex = this._deliveryOrderBL.GetSingleMKTDOHdForStatus(_tempSplit);
            if (_ex == true)
            {                
                bool _result = this._deliveryOrderBL.DeleteMultiMKTDOHd(_tempSplit);
                if (_result == true)
                {                    
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MKTDOHd _temp = (MKTDOHd)e.Item.DataItem;
                ...
                if (_temp.Status != DeliveryOrderDataMapper.GetStatus(TransStatus.Posted))
                {
                ...
                _status.Text = HttpUtility.HtmlEncode(DeliveryOrderDataMapper.GetStatusText(_temp.Status));
                ...
                _soNo.Text = HttpUtility.HtmlEncode(_salesOrderBL.GetFileNmbrMKTSOHd(_temp.SONo));

                Literal _poCustNo = (Literal)e.Item.FindControl("POCustNoLiteral");
                _poCustNo.Text = HttpUtility.HtmlEncode(_temp.POCustNo);
            }
        }
        ...
        protected void YesButton_OnClick(object sender, EventArgs e)
        {
            ...
            bool _result = this._deliveryOrderBL.DeleteMultiApproveMKTDOHd(_tempSplit, AppModule.GetValue(TransactionType.DeliveryOrder), HttpContext.Current.User.Identity.Name,  Convert.ToByte(ActivityTypeDataMapper.GetActivityType(ActivityType.Deleted)), this.ReasonTextBox.Text);
            if (_result == true)
            {
