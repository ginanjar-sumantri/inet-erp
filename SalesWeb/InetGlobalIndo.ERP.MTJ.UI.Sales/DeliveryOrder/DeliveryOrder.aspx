<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DeliveryOrder.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.DeliveryOrder.DeliveryOrder" %>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 150px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Customer" ID="field5" class="SortLinkButton" runat="server"
                                                    OnClick="field5_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 160px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="SO No." ID="field6" class="SortLinkButton" runat="server" OnClick="field6_Click"></asp:LinkButton></b>
                                        </td>
                                        <td style="width: 100px" class="tahoma_11_white" align="center">
                                            <b>
                                                <asp:LinkButton Text="Customer PO NO." ID="field7" class="SortLinkButton" runat="server"
                                                    OnClick="field7_Click"></asp:LinkButton></b>
                                        </td>
                                    </tr>
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="SONoLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="POCustNoLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
