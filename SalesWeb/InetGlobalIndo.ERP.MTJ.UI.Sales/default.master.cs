...
public partial class _default : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.Page.IsPostBack == true)
        {
            ...
            //this.Menu1.Items.Add(_quickLaunchNavMenu.RenderItem(22, AppModule.GetValue(ERPModule.Sales), "administrators", null));
            //_quickLaunchNavMenu.Dispose();

            //string _imageUrl = ApplicationConfig.HomeWebAppURL + "images/sales_small.jpg";
            //string _titleTree = "&nbsp;Sales";
            //QuickLaunchNavigationMenu _quickLaunchNavNode = new QuickLaunchNavigationMenu();
            //this.TreeView1.ShowLines = true;
            //this.TreeView1.Nodes.Add(_quickLaunchNavNode.RenderNode(22, AppModule.GetValue(ERPModule.Sales), "administrators", null, _imageUrl, _titleTree));
            ...
            //_quickLaunchSiteMapPath.GenerateSiteMapPath(22, AppModule.GetValue(ERPModule.Sales), "administrators", null, _dir, _title, 22);
            ...
            //_topNavigationMenu.RenderItem(0, _roles, ERPModule.Sales, this.Menu2, new UserBL().GetCompanyId(HttpContext.Current.User.Identity.Name));
