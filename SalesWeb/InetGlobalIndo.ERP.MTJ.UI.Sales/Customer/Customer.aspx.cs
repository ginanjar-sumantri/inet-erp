    ...
    public partial class Customer : CustomerBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.ViewState[this._currPageKey] = (HttpUtility.UrlEncode(this._nvcExtractor.GetValue(ApplicationConfig.RequestPageKey)) != "") ? Convert.ToInt32(Rijndael.Decrypt(this._nvcExtractor.GetValue(ApplicationConfig.RequestPageKey), ApplicationConfig.EncryptionKey)) : 0;
                ...
                this.ClearLabel();
                this.ShowData((HttpUtility.UrlEncode(this._nvcExtractor.GetValue(ApplicationConfig.RequestPageKey)) != "") ? Convert.ToInt32(Rijndael.Decrypt(this._nvcExtractor.GetValue(ApplicationConfig.RequestPageKey), ApplicationConfig.EncryptionKey)) : 0);
            }
        }
        ...
        private double RowCount()
        {
            ...
            _result = this._custBL.RowsCountCust(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._custBL.GetListCust(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsCustomer _msCustomer = (MsCustomer)e.Item.DataItem;
                string _code = _msCustomer.CustCode.ToString();
                ...
                _custCodeLiteral.Text = HttpUtility.HtmlEncode(_msCustomer.CustCode);

                Literal _custNameLiteral = (Literal)e.Item.FindControl("CustNameLiteral");
                _custNameLiteral.Text = HttpUtility.HtmlEncode(_msCustomer.CustName);

                Literal _addressLiteral = (Literal)e.Item.FindControl("AddressLiteral");
                _addressLiteral.Text = HttpUtility.HtmlEncode(_msCustomer.Address1);

                Literal _custGroupLiteral = (Literal)e.Item.FindControl("CustGroupLiteral");
                _custGroupLiteral.Text = HttpUtility.HtmlEncode(_msCustomer.CustGroup);

                Literal _custTypeLiteral = (Literal)e.Item.FindControl("CustTypeLiteral");
                _custTypeLiteral.Text = HttpUtility.HtmlEncode(_msCustomer.CustType);

                Literal _verificationLiteral = (Literal)e.Item.FindControl("VerificationCodeLiteral");
                _verificationLiteral.Text = HttpUtility.HtmlEncode(_msCustomer.CustVerificationCode);

                Literal _statusLiteral = (Literal)e.Item.FindControl("StatusLiteral");
                _statusLiteral.Text = HttpUtility.HtmlEncode(CustomerDataMapper.IsActiveText(_msCustomer.FgActive));
                ...
                _editButton.PostBackUrl = this._editPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + ApplicationConfig.RequestPageKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_page.ToString(), ApplicationConfig.EncryptionKey));
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._custBL.DeleteMultiCust(_tempsplit);
        ...
        {
            Int32 _reqPage = (HttpUtility.UrlEncode(this._nvcExtractor.GetValue(ApplicationConfig.RequestPageKey)) != "") ? Convert.ToInt32(Rijndael.Decrypt(this._nvcExtractor.GetValue(ApplicationConfig.RequestPageKey), ApplicationConfig.EncryptionKey)) : 0;
