<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustomerAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Customer.CustomerAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="CustCodeTextBox" runat="server" MaxLength="12" ToolTip="Customer Code"></asp:TextBox>
                                <asp:TextBox ID="CustNameTextBox" runat="server" MaxLength="60" Width="250" ToolTip="Customer Name"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="tooltip">&quot;Customer code&quot; will be automaticaly generated, if you
                                    leave it empty.</span>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <fieldset>
                        ...
                        <table cellpadding="3" cellspacing="0" width="0" border="0">
                            <tr>
                                ...
                                <td colspan="5">
                                    <asp:TextBox ID="Addr1TextBox" runat="server" Width="250" TextMode="MultiLine" MaxLength="5000"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="5">
                                    <asp:TextBox ID="Addr2TextBox" runat="server" Width="250" TextMode="MultiLine" MaxLength="5000"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <asp:TextBox ID="NPWPTextBox" runat="server" Width="150" BackColor="#CCCCCC"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <asp:TextBox ID="NPWPAddressTextBox" runat="server" Width="250" TextMode="MultiLine"
                                        BackColor="#CCCCCC" MaxLength="5000"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="NPWPAddressRequiredFieldValidator" runat="server"
                                        ErrorMessage="NPWP Address Must Be Filled" Text="*" ControlToValidate="NPWPAddressTextBox"
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <asp:TextBox ID="NPPKPTextBox" runat="server" Width="150" BackColor="#CCCCCC"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <asp:DropDownList ID="SalesPersonDropDownList" runat="server" MaxLength="10">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <asp:CheckBox ID="FgPPNCheckBox" runat="server" AutoPostBack="true" Checked="false"
                                        OnCheckedChanged="FgPPNCheckBox_CheckedChanged" />
                                </td>
                            </tr>
                            <tr>
                                <td>
