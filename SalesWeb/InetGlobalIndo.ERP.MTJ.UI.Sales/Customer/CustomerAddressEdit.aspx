<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustomerAddressEdit.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Customer.CustomerAddressEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="DeliveryCodeTextBox" runat="server" Width="100" MaxLength="12" ReadOnly="true"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="PostalCodeTextBox" runat="server" Width="100" MaxLength="10"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
