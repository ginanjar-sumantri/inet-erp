<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="CustomerContactAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Customer.CustomerContactAdd" %>
                    ...
                    <table width="0" border="0" cellpadding="3" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <%--<input type="button" value="..." id="birth_date_start" onclick="displayCalendar(ctl00_DefaultBodyContentPlaceHolder_BirthDateTextBox,'yyyy-mm-dd',this)" />--%>
