<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="Customer.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Sales.Customer.Customer" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    ...
                                                    <asp:ListItem Value="Customer Group" Text="Customer Group"></asp:ListItem>
                                                    <asp:ListItem Value="Customer Address" Text="Address #1"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                    ...
                                    <asp:Repeater ID="ListRepeater" runat="server" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterListTemplate" runat="server">
                                                ...
                                                <td>
                                                    <asp:Literal ID="CustGroupLiteral" runat="server"></asp:Literal>
                                                </td>
                                                <td>
                                                    <asp:Literal ID="CustTypeLiteral" runat="server"></asp:Literal>
                                                </td>
                                                <td>
                                                    <asp:Literal ID="VerificationCodeLiteral" runat="server"></asp:Literal>
                                                </td>
                                                <td align="center">
