...
{
    public partial class UnpostingLogAdvancedSearch : UnpostingLogBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack == true)
            {
                ...
                this.PageTitleLiteral.Text = "Unposting Log : Advanced Search";
        ...
        private double RowCount()
        {
            ...
            _result = this._transActivityBL.RowsCountAdvancedSearch(this.TransTypeTextBox.Text, this.TransNmbrTextBox.Text, DateFormMapper.GetValue(this.DateFromTextBox.Text), DateFormMapper.GetValue(this.DateToTextBox.Text), this.UnpostingByTextBox.Text);
        ...
        {
            this.ListRepeater.DataSource = this._transActivityBL.GetListAdvancedSearch(_prmCurrentPage, _maxrow, this.TransTypeTextBox.Text, this.TransNmbrTextBox.Text, DateFormMapper.GetValue(this.DateFromTextBox.Text), DateFormMapper.GetValue(this.DateToTextBox.Text), this.UnpostingByTextBox.Text);
