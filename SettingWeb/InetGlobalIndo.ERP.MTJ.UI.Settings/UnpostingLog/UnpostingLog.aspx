<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="UnpostingLog.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Settings.UnpostingLog.UnpostingLog" %>
                                ...
                                <asp:Panel ID="Panel2" DefaultButton="GoImageButton" runat="server">
                                    <table cellpadding="0" cellspacing="2" border="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:ImageButton ID="AdvanceSearchImageButton" runat="server" 
                                                    onclick="AdvanceSearchImageButton_Click" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
