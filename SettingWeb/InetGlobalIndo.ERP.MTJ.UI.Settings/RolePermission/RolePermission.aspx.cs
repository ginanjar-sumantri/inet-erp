...
{
    public partial class RolePermission : RolePermissionBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._permissionBL.RowsCountRolePermission(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._permissionBL.GetListRolePermission(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                master_RolePermission _temp = (master_RolePermission)e.Item.DataItem;
                string _roleID = _temp.RoleID.ToString();
                //string _menuID = _temp.MenuID.ToString();
                //string _code = _temp.MenuID.ToString() + "&" + _temp.RoleID.ToString();
                ...
                _editButton.PostBackUrl = this._editPage + "?" + this._userKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_roleID, ApplicationConfig.EncryptionKey));
                ...
                Literal _roleName = (Literal)e.Item.FindControl("RoleLiteral");
                _roleName.Text = HttpUtility.HtmlEncode(_temp.RoleName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._permissionBL.DeleteMultiRolePermission(_tempSplit);
