...
public partial class _default : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.Page.IsPostBack == true)
        {
            ...
            //this.Menu1.Items.Add(_quickLaunchNavMenu.RenderItem(23, new AppModule().GetValue(ERPModule.Settings), "administrators", null));
            //_quickLaunchNavMenu.Dispose();

            //string _imageUrl = ApplicationConfig.HomeWebAppURL + "images/settings_small.jpg";
            //string _titleTree = "&nbsp;Settings";
            //QuickLaunchNavigationMenu _quickLaunchNavNode = new QuickLaunchNavigationMenu();
            //this.TreeView1.ShowLines = true;
            //this.TreeView1.Nodes.Add(_quickLaunchNavNode.RenderNode(23, AppModule.GetValue(ERPModule.Settings), "administrators", null, _imageUrl, _titleTree));
            ...
            //_quickLaunchSiteMapPath.GenerateSiteMapPath(23, AppModule.GetValue(ERPModule.Settings), "administrators", null, _dir, _title, 23);
            ...
            //_topNavigationMenu.RenderItem(0, _roles, ERPModule.Settings, this.Menu2, new UserBL().GetCompanyId(HttpContext.Current.User.Identity.Name));
