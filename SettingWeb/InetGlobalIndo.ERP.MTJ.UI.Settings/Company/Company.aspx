<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="Company.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Settings.Company.Company" %>
                        ...
                        <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                            <ItemTemplate>
                                <tr id="RepeaterItemTemplate" runat="server">
                                    ...
                                    <td align="left">
                                        <asp:Literal runat="server" ID="CompanyLiteral"></asp:Literal>
                                    </td>
                                    <td align="left">
