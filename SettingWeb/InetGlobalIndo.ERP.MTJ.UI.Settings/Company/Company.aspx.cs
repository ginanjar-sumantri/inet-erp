...
namespace InetGlobalIndo.ERP.MTJ.UI.Settings.Company
{
    public partial class Company : CompanyBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._companyBL.RowsCount;
        ...
        //{
        //    double q = this._companyBL.RowsCount;
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._companyBL.GetList(_prmCurrentPage, _maxrow);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                master_Company _temp = (master_Company)e.Item.DataItem;
                string _code = _temp.CompanyID.ToString();
                ...
                _viewButton.PostBackUrl = this._viewPage + "?" + this._compKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                ...
                _editButton.PostBackUrl = this._editPage + "?" + this._compKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                ...
                Literal _name = (Literal)e.Item.FindControl("CompanyLiteral");
                _name.Text = HttpUtility.HtmlEncode(_temp.Name);

                Literal _address = (Literal)e.Item.FindControl("AddressLiteral");
                _address.Text = HttpUtility.HtmlEncode(_temp.PrimaryAddress);

                CheckBox _defaultCheckbox;
                _defaultCheckbox = (CheckBox)e.Item.FindControl("DefaultCheckBox");
                _defaultCheckbox.Checked = _temp.@default == null ? false : Convert.ToBoolean(_temp.@default);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._companyBL.DeleteMulti(_tempSplit);
