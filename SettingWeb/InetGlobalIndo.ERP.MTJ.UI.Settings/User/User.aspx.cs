...
namespace InetGlobalIndo.ERP.MTJ.UI.Settings.User
{
    public partial class User : UserBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._userBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._userBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                aspnet_User _temp = (aspnet_User)e.Item.DataItem;
                ...
                ImageButton _changePassButton = (ImageButton)e.Item.FindControl("ChangePasswordButton");
                _changePassButton.PostBackUrl = this._changePassPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                _changePassButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/change_password.jpg";

                ImageButton _qAndAButton = (ImageButton)e.Item.FindControl("QAndAButton");
                _qAndAButton.PostBackUrl = this._qAndAPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey));
                _qAndAButton.ImageUrl = ApplicationConfig.HomeWebAppURL + "images/question_and_answer.jpg";
                ...
                Literal _isLockedOutLiteral = (Literal)e.Item.FindControl("IsLockedOutLiteral");
                _isLockedOutLiteral.Text = HttpUtility.HtmlEncode(YesNoDataMapper.GetYesNo(_temp.IsLockedOut));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._userBL.DeleteMulti(_tempSplit);
