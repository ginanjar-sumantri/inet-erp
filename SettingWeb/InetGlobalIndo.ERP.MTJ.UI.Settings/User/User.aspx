<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="User.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Settings.User.User" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Name" Text="Username"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                            ...
                            <td>
                                ...
                                <table cellpadding="3" cellspacing="1" width="0" border="0">
                                    <tr class="bgcolor_gray">
                                        ...
                                        <td style="width: 230px" class="tahoma_11_white" align="center">
                                            <b>Email</b>
                                        </td>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <table cellpadding="0" cellspacing="0" width="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td style="padding-left: 4px">
                                                                <asp:ImageButton runat="server" ID="ChangePasswordButton" />
                                                            </td>
                                                            <td style="padding-left: 4px">
                                                                <asp:ImageButton runat="server" ID="QAndAButton" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="LastLoginLiteral"></asp:Literal>
                                                </td>
                                                <td align="center">
