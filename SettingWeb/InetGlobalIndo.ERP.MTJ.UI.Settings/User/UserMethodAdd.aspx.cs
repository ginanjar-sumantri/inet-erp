...
{
    public partial class UserMethodAdd : UserBase
    {
        ...
        private double RowCount()
        {
            ...
            String _userID = Rijndael.Decrypt(this._nvcExtractor.GetValue(this._codeKey), ApplicationConfig.EncryptionKey);
            String _userName = _userBL.GetUserNameByCode(_userID);

            _result = this._methodSalaryBL.RowsCountMethodSalary(_userName);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._methodSalaryBL.GetListMethodSalary(_prmCurrentPage, _maxrow, _userName);
            ...
            List<PAYMsMethodSalary> _msMethodUserPermission = new List<PAYMsMethodSalary>();
            _msMethodUserPermission = this._methodSalaryBL.GetListMethodSalaryForDDL();
            this.AllHidden.Value = "";
            foreach (PAYMsMethodSalary _item in _msMethodUserPermission)
            {
                if (this.AllHidden.Value == "")
                {
                    this.AllHidden.Value = _item.MethodCode;
                }
                else
                {
                    this.AllHidden.Value += "," + _item.MethodCode;
        ...
        protected void SaveButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                _result = this._methodSalaryBL.AddMethodUserPermission(_userName, this.CheckHidden.Value);
            }
            else
            {
                _result = this._methodSalaryBL.AddMethodUserPermission(_userName, this.AllHidden.Value);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                PAYMsMethodSalary _temp = (PAYMsMethodSalary)e.Item.DataItem;
                ...
                Literal _methodSalaryCodeLiteral = (Literal)e.Item.FindControl("MethodSalaryCodeLiteral");
                _methodSalaryCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.MethodCode);

                Literal _methodSalaryNameLiteral = (Literal)e.Item.FindControl("MethodSalaryNameLiteral");
                _methodSalaryNameLiteral.Text = HttpUtility.HtmlEncode(_temp.MethodName);

                Literal _methodRangeLiteral = (Literal)e.Item.FindControl("MethodRangeLiteral");
                _methodRangeLiteral.Text = HttpUtility.HtmlEncode(MethodRangeTypeDataMapper.GetMethodRangeText(_temp.MethodRange));

                Literal _rangeDayLiteral = (Literal)e.Item.FindControl("RangeDayLiteral");
                _rangeDayLiteral.Text = HttpUtility.HtmlEncode(_temp.RangeDay.ToString());
            }
        }
