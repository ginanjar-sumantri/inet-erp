...
namespace InetGlobalIndo.ERP.MTJ.UI.Settings.Role
{
    public partial class Role : RoleBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._roleBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._roleBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                aspnet_Role _temp = (aspnet_Role)e.Item.DataItem;

                master_Role _masterRole = this._roleBL.GetSingleMasterRole(_temp.RoleId);
                ...
                //bool _systemRole2 = (_masterRole. == null ? false : _masterRole.SystemRole);
                ...
                if (_masterRole != null)
                {
                    ...
                    Literal _systemRole = (Literal)e.Item.FindControl("SystemRoleLiteral");
                    _systemRole.Text = HttpUtility.HtmlEncode(_masterRole.SystemRole.ToString());
                }
                else
                {
                    _editButton.Visible = false;
                    ...
                    Literal _systemRole = (Literal)e.Item.FindControl("SystemRoleLiteral");
                    _systemRole.Text = HttpUtility.HtmlEncode("System Roll Not Seeting");
                ...
                Literal _roleName = (Literal)e.Item.FindControl("RoleNameLiteral");
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string _result = this._roleBL.DeleteMulti(_tempSplit);
