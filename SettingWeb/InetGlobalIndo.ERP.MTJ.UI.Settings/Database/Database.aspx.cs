...
namespace InetGlobalIndo.ERP.MTJ.UI.Settings.Database
{
    public partial class Database : DatabaseBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._databaseBL.RowsCount;
        ...
        //{
        //    double q = this._databaseBL.RowsCount;
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._databaseBL.GetList(_prmCurrentPage, _maxrow);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                master_Database _temp = (master_Database)e.Item.DataItem;
                ...
                Literal _server = (Literal)e.Item.FindControl("ServerLiteral");
                _server.Text = HttpUtility.HtmlEncode(_temp.Server);

                Literal _uid = (Literal)e.Item.FindControl("UIDLiteral");
                _uid.Text = HttpUtility.HtmlEncode(_temp.UID);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._databaseBL.DeleteMulti(_tempSplit);
