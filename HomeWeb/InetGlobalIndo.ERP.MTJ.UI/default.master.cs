...
///////////////////////////////////////////////////////////
            ...
            this.TabJScriptLiteral.Text = "<script src=\"" + ApplicationConfig.HomeWebAppURL + "tabber.js" + "\" type=\"text/javascript\"></script>";
            ...
            //this.Menu1.Items.Add(_quickLaunchNavMenu.RenderItem(1, new AppModule().GetValue(ERPModule.Home), "administrators", null));
            //this.Menu1.Visible = false;
            //_quickLaunchNavMenu.Dispose();

            //string _imageUrl = ApplicationConfig.HomeWebAppURL + "images/home_small.jpg";
            //string _titleTree = "&nbsp;Home";
            //QuickLaunchNavigationMenu _quickLaunchNavNode = new QuickLaunchNavigationMenu();
            //this.TreeView1.ShowLines = true;
            //this.TreeView1.Nodes.Add(_quickLaunchNavNode.RenderNode(1, AppModule.GetValue(ERPModule.Home), "administrators", null, _imageUrl, _titleTree));
            ...
            //_quickLaunchSiteMapPath.GenerateSiteMapPath(1, AppModule.GetValue(ERPModule.Home), "administrators", null, _dir, _title, 1);
            ...
            //_topNavigationMenu.RenderItem(0, _roles, ERPModule.Home, this.Menu2, new UserBL().GetCompanyId(HttpContext.Current.User.Identity.Name));
