...
namespace InetGlobalIndo.ERP.MTJ.UI.Home.Country
{
    public partial class Country : CountryBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._countryBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsCountry _temp = (MsCountry)e.Item.DataItem;

                string _code = _temp.CountryCode.ToString();
                ...
                Literal _countryCode = (Literal)e.Item.FindControl("CountryCodeLiteral");
                _countryCode.Text = HttpUtility.HtmlEncode(_temp.CountryCode);
                ...
                if (_temp.FgHome == 'Y')
                {
                    Literal _fgHome = (Literal)e.Item.FindControl("FgHomeLiteral");
                    _fgHome.Text = HttpUtility.HtmlEncode(_temp.FgHome.ToString());
                }
            }
        }
