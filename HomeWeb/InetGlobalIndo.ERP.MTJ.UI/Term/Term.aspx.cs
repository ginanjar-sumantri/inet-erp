...
{
    public partial class Term : TermBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._termBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._termBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsTerm _msTerm = (MsTerm)e.Item.DataItem;
                string _code = _msTerm.TermCode.ToString();
                ...
                Literal _termCode = (Literal)e.Item.FindControl("TermCode");
                _termCode.Text = HttpUtility.HtmlEncode(_msTerm.TermCode);

                Literal _termName = (Literal)e.Item.FindControl("TermName");
                _termName.Text = HttpUtility.HtmlEncode(_msTerm.TermName);

                Literal _xPeriod = (Literal)e.Item.FindControl("XPeriod");
                _xPeriod.Text = HttpUtility.HtmlEncode(_msTerm.XPeriod.ToString());

                Literal _typeRange = (Literal)e.Item.FindControl("TypeRange");
                _typeRange.Text = HttpUtility.HtmlEncode(_msTerm.TypeRange.ToString());

                Literal _xRange = (Literal)e.Item.FindControl("XRange");
                _xRange.Text = HttpUtility.HtmlEncode(_msTerm.XRange.ToString());
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._termBL.DeleteMulti(_tempsplit);
