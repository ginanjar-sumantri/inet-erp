<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="Regional.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Home.Regional.Regional" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="CategoryDropDownList" runat="server">
                                                    <asp:ListItem Value="Code" Text="Regional Code"></asp:ListItem>
                                                    <asp:ListItem Value="Name" Text="Regional Name"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td>
                                                    <asp:Literal runat="server" ID="RegionalCodeLiteral"></asp:Literal>
                                                </td>
                                                <td>
