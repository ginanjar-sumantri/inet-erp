...
namespace InetGlobalIndo.ERP.MTJ.UI.Home.Religion
{
    public partial class Religion : ReligionBase
    {
        ...
        private void ShowData()
        {
            ...
            {
                this.ListRepeater.DataSource = this._rlgBL.GetList();
            }
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsReligion _rlg = (MsReligion)e.Item.DataItem;
        ...
        {
            string _error = "";
            string temp = this.CheckHidden.Value;
            string[] tempsplit = temp.Split(',');
            string _page = "0";

            this.ClearLabel();

            bool _result = this._rlgBL.DeleteMulti(tempsplit);
