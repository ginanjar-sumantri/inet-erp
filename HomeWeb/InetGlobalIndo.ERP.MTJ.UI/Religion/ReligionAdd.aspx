<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReligionAdd.aspx.cs"
    Inherits="InetGlobalIndo.ERP.MTJ.UI.Home.Religion.ReligionAdd" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="RlgCodeTextBox" Width="70" MaxLength="10"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RlgCodeRequiredFieldValidator" runat="server" ErrorMessage="Religion Code Must Be Filled"
                                    Text="*" ControlToValidate="RlgCodeTextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
