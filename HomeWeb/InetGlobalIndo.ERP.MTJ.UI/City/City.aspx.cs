...
namespace InetGlobalIndo.ERP.MTJ.UI.Home.City
{
    public partial class City : CityBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = _cityBL.RowsCount(this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            {
                this.ListRepeater.DataSource = this._cityBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
            }
            //this.ListRepeater.DataSource = this._cityBL.GetList(_prmCurrentPage, _maxrow, this.CategoryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsCity _temp = (MsCity)e.Item.DataItem;

                string _code = _temp.CityCode.ToString();
                ...
                Literal _cityCode = (Literal)e.Item.FindControl("CityCodeLiteral");
                _cityCode.Text = HttpUtility.HtmlEncode(_temp.CityCode);

                Literal _cityName = (Literal)e.Item.FindControl("CityNameLiteral");
                _cityName.Text = HttpUtility.HtmlEncode(_temp.CityName);

                Literal _regionalName = (Literal)e.Item.FindControl("RegionalNameLiteral");
                _regionalName.Text = HttpUtility.HtmlEncode(_temp.RegionalName);

                Literal _countryName = (Literal)e.Item.FindControl("CountryNameLiteral");
                _countryName.Text = HttpUtility.HtmlEncode(_temp.CountryName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._cityBL.DeleteMulti(_tempSplit);
