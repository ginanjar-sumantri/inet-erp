<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="ReportCustomerVisitorCard.aspx.cs" Inherits="VTSWeb.UI.ReportCustomerVisitorCard" %>
    ...
    <table>
        ...
        <tr align="center">
            <td align="center" class="style1">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="250%" ShowPrintButton="true"
