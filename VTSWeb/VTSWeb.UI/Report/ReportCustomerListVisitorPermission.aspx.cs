...
//using VTSWeb.UI.Website.TaskList;

namespace VTSWeb.UI
{
    public partial class ReportCustomerListVisitorPermission : ReportBase
    {
        ...
        private String _reportPath0 = "Report/CustomerPermission.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.PageTitleLiteral.Text = this._pageTitleLiteralCustomerPermission;
        ...
        protected void ViewImageButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportClearanceBL.ReportCustomerListVisitorPermission((this.CustomerDDL.SelectedValue == "All") ? "" : this.CustomerDDL.SelectedValue);
            ...
            _reportParam[2] = new ReportParameter("ParamTitle", "Customer List Visitor Permission", true);
