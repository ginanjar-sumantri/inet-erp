...
namespace VTSWeb.UI
{
    public partial class Country : CountryBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._CountryBL.RowsCount(this.CountryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._CountryBL.GetList(_prmCurrentPage, _maxrow, this.CountryDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Literal _countryCodeLiteral = (Literal)e.Item.FindControl("CountryCodeLiteral");
                _countryCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.CountryCode);

                Literal _countryNameLiteral = (Literal)e.Item.FindControl("CountryNameLiteral");
                _countryNameLiteral.Text = HttpUtility.HtmlEncode(_temp.CountryName);
            }
        }
