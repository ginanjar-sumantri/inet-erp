<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeFile="Customer.aspx.cs" Inherits="VTSWeb.UI.Customer.Customer" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="CompanyDropDownList" runat="server">
                                    ...
                                    <asp:ListItem Value="CustTypeName" Text="Company Type"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>
            ...
            <td align="left">
                ...
                <table cellpadding="3" cellspacing="1" width="0" border="0">
                    <tr class="bgcolor_gray">
                        ...
                        <td style="width: 120px" class="tahoma_11_white" align="left">
                            <b>ZipCode </b><b></b>
                        </td>
                        <td style="width: 120px" class="tahoma_11_white" align="left">
                            <b>Phone </b>
                        ...
                        <td style="width: 50px" class="tahoma_11_white" align="left">
                            <b>FgActive </b>
                        </td>
                    </tr>
