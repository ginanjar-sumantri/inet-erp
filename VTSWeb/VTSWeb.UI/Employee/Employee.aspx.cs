...
namespace VTSWeb.UI
{
    public partial class Employee : EmployeeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._employeeBL.RowsCount(this.EmployeeDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._employeeBL.GetList(_prmCurrentPage, _maxrow, this.EmployeeDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Literal _employeeNumb = (Literal)e.Item.FindControl("EmployeeNumbLiteral");
                _employeeNumb.Text = HttpUtility.HtmlEncode(_temp.EmpNumb);

                Literal _employeeName = (Literal)e.Item.FindControl("EmployeeNameLiteral");
                _employeeName.Text = HttpUtility.HtmlEncode(_temp.EmpName);

                Literal _jobTitle = (Literal)e.Item.FindControl("JobTitleLiteral");
                _jobTitle.Text = HttpUtility.HtmlEncode(_temp.JobTitle);

                Literal _jobLevel = (Literal)e.Item.FindControl("JobLevelLiteral");
                _jobLevel.Text = HttpUtility.HtmlEncode(_temp.JobLevel);

                Literal _active = (Literal)e.Item.FindControl("ActiveLiteral");
                _active.Text = HttpUtility.HtmlEncode(_temp.Active.ToString());
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._employeeBL.DeleteMulti(_tempSplit);
