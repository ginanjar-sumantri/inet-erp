<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="EmployeeEdit.aspx.cs" Inherits="VTSWeb.UI.EmployeeEdit" %>
                ...
                <td>
                    <table cellpadding="3" cellspacing="0" width="0" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="EmpNoTextBox" Width="150" MaxLength="100" BackColor="#CCCCCC"
