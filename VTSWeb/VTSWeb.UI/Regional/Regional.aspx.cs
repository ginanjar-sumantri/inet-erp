...
namespace VTSWeb.UI
{
    public partial class Regional : RegionalBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._RegionalBL.RowsCount(this.RegionalDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._RegionalBL.GetList(_prmCurrentPage, _maxrow, this.RegionalDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Literal _RegionalCodeLiteral = (Literal)e.Item.FindControl("RegionalCodeLiteral");
                _RegionalCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.RegionalCode);

                Literal _RegionalNameLiteral = (Literal)e.Item.FindControl("RegionalNameLiteral");
                _RegionalNameLiteral.Text = HttpUtility.HtmlEncode(_temp.RegionalName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._RegionalBL.DeleteMulti(_tempSplit);
