...
namespace VTSWeb.UI
{
    public partial class CustContact : CustContactBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._CustContactBL.RowsCount(this.CompanyDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            HttpCookie cookie = Request.Cookies[ApplicationConfig.CookiesPreferences];
            this.ListRepeater.DataSource = this._CustContactBL.GetList(_prmCurrentPage, _maxrow, this.CompanyDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                _editButton.ImageUrl = "http://" + Request.ServerVariables["HTTP_HOST"] + Request.ApplicationPath + ApplicationConfig.StringSeparatorPublish + "images/edit.jpg";
                ...
                Literal _ContactTypeLiteral = (Literal)e.Item.FindControl("ContactTypeLiteral");
                _ContactTypeLiteral.Text = HttpUtility.HtmlEncode(_temp.ContactType);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._CustContactBL.DeleteMulti(_tempSplit);
