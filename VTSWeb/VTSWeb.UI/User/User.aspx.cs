...
namespace VTSWeb.UI
{
    public partial class User : UserBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._userBL.RowsCount(this.UserDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._userBL.GetList(_prmCurrentPage, _maxrow, this.UserDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                MsUser _MsUser = this._userBL.GetSingle(_temp.UserName);
                string _code = _temp.UserName;
