...
namespace VTSWeb.UI
{
    public partial class Visitor : VisitorBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._CustContactAreaBL.RowsCount(this.CompanyDropDownList.SelectedValue);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._CustContactAreaBL.GetList(_prmCurrentPage, _maxrow, this.CompanyDropDownList.SelectedValue);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsCustContact_MsArea _temp = (MsCustContact_MsArea)e.Item.DataItem;
                string _code = _temp.VisitorAreaCode.ToString();
                ...
                _areaNameLiteral.Text = HttpUtility.HtmlEncode(_temp.AreaName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._CustContactAreaBL.DeleteMulti(_tempSplit);
