...
namespace VTSWeb.UI
{
    public partial class ReportCustomerGoodInTransactionByCustomer : ReportBase
    {
        ...
        private String _reportPath0 = "Report/CustomerGoodInTransactionByCustomer.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.PageTitleLiteral.Text = this._pageTitleLiteralCustomerGoodsIn;
        ...
        protected void ViewImageButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportClearanceBL.ReportCustomerGoodInTransactionByCustomer((this.CustomerDDL.SelectedValue == "All") ? "" : this.CustomerDDL.SelectedValue);
