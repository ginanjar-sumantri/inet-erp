<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeFile="UserGroup.aspx.cs" Inherits="VTSWeb.UI.UserGroup" %>
                                ...
                                <asp:Panel ID="Panel2" DefaultButton="GoImageButton" runat="server">
                                    <table cellpadding="0" cellspacing="2" border="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="AssGroupDropDownList" runat="server">
                                                    <asp:ListItem Value="UserGroupCode" Text="User Group Code"></asp:ListItem>
                                                    <asp:ListItem Value="UserGroupName" Text="User Group Name"></asp:ListItem>
                                                    <%--<asp:ListItem Value="BusinessPhone" Text="Business Phone"></asp:ListItem>
                                         <asp:ListItem Value="EmpNumb" Text="User To"></asp:ListItem>
                                        <asp:ListItem Value="UsermentBy" Text="Userment By"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                    ...
                                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                                        <ItemTemplate>
                                            <tr id="RepeaterItemTemplate" runat="server">
                                                ...
                                                <td align="center">
                                                    <asp:Literal runat="server" ID="UserGroupCodeLiteral"></asp:Literal>
                                                </td>
                                                <td align="left">
                                                    <asp:Literal runat="server" ID="UserGroupNameLiteral"></asp:Literal>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
