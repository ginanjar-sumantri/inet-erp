...
namespace VTSWeb.UI
{
    public partial class UserGroup : UserGroupBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._UserGroupBL.RowsCount(this.AssGroupDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._UserGroupBL.GetList(_prmCurrentPage, _maxrow, this.AssGroupDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        {
            MsUserGroup _temp = (MsUserGroup)e.Item.DataItem;

            string _code = _temp.UserGroupCode.ToString();
            ...
            Literal _UserGroupCode = (Literal)e.Item.FindControl("UserGroupCodeLiteral");
            _UserGroupCode.Text = HttpUtility.HtmlEncode(_temp.UserGroupCode);

            Literal _UserGroupName = (Literal)e.Item.FindControl("UserGroupNameLiteral");
            _UserGroupName.Text = HttpUtility.HtmlEncode(_temp.UserGroupName);
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._UserGroupBL.DeleteMulti(_tempSplit);
