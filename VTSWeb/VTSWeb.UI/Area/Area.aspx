<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeFile="Area.aspx.cs" Inherits="VTSWeb.UI.Area" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="AreaDropDownList" runat="server">
                                    <asp:ListItem Value="AreaCode" Text="Area Code"></asp:ListItem>
                                    <asp:ListItem Value="AreaName" Text="Area Name"></asp:ListItem>
                    ...
                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                        <ItemTemplate>
                            <tr id="RepeaterItemTemplate" runat="server">
                                ...
                                <td align="left">
                                    <asp:Literal runat="server" ID="AreaCodeLiteral"></asp:Literal>
                                </td>
                                <td align="left">
                                    <asp:Literal runat="server" ID="AreaNamaLiteral"></asp:Literal>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
