...
namespace VTSWeb.UI
{
    public partial class Clearance : ClearanceBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._ClearanceBL.RowsCount(this.CompanyDropDownList.SelectedValue);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._ClearanceBL.GetList(_prmCurrentPage, _maxrow, this.CompanyDropDownList.SelectedValue);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                ClearanceHd _temp = (ClearanceHd)e.Item.DataItem;
                ...
                _viewDetailButton.PostBackUrl = this._detailPage + "?" + this._codeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_code, ApplicationConfig.EncryptionKey)) + "&" + this._areaKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_areaCode, ApplicationConfig.EncryptionKey)) + "&" + this._purposeKey + "=" + HttpUtility.UrlEncode(Rijndael.Encrypt(_purposeCode, ApplicationConfig.EncryptionKey));
                ...
                Literal _ClearanceCodeLiteral = (Literal)e.Item.FindControl("ClearanceCodeLiteral");
                _ClearanceCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.ClearanceCode);

                Literal _ClearanceDateLiteral = (Literal)e.Item.FindControl("ClearanceDateLiteral");
                _ClearanceDateLiteral.Text = HttpUtility.HtmlEncode(DateFormMapping.GetValue(_temp.ClearanceDate));

                Literal _commpanyLiteral = (Literal)e.Item.FindControl("CommpanyLiteral");
                _commpanyLiteral.Text = HttpUtility.HtmlEncode(_temp.CustName);

                Literal _visitorLiteral = (Literal)e.Item.FindControl("VisitorLiteral");
                _visitorLiteral.Text = HttpUtility.HtmlEncode(_temp.ContactName);

                Literal _regionalLiteral = (Literal)e.Item.FindControl("RemarkLiteral");
                _regionalLiteral.Text = HttpUtility.HtmlEncode(_temp.Remark);

                Literal _completeStatusLiteral = (Literal)e.Item.FindControl("CompleteStatusLiteral");
                _completeStatusLiteral.Text = HttpUtility.HtmlEncode(ClearanceCompleteDataMapping.GetStatus(_temp.CompleteStatus));
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._ClearanceBL.DeleteMulti(_tempSplit);
