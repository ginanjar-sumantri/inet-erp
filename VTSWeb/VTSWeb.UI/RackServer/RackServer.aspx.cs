...
namespace VTSWeb.UI
{
    public partial class RackServer : RackServerBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._rackServerBL.RowsCount(this.RackServerDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._rackServerBL.GetList(_prmCurrentPage, _maxrow, this.RackServerDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsRackServer _temp = (MsRackServer)e.Item.DataItem;
                string _code = _temp.RackCode.ToString();
                ...
                Literal _rackCodeLiteral = (Literal)e.Item.FindControl("RackCodeLiteral");
                _rackCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.RackCode);

                Literal _rackNameLiteral = (Literal)e.Item.FindControl("RackNameLiteral");
                _rackNameLiteral.Text = HttpUtility.HtmlEncode(_temp.RackName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._rackServerBL.DeleteMulti(_tempSplit);
