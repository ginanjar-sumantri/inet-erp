...
namespace VTSWeb.UI
{
    public partial class Purpose : PurposeBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._PurposeBL.RowsCount(this.PurposeDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._PurposeBL.GetList(_prmCurrentPage, _maxrow, this.PurposeDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsPurpose _temp = (MsPurpose)e.Item.DataItem;
                string _code = _temp.PurposeCode.ToString();
                ...
                Literal _PurposeCodeLiteral = (Literal)e.Item.FindControl("PurposeCodeLiteral");
                _PurposeCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.PurposeCode);

                Literal _PurposeNamaLiteral = (Literal)e.Item.FindControl("PurposeNamaLiteral");
                _PurposeNamaLiteral.Text = HttpUtility.HtmlEncode(_temp.PurposeName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._PurposeBL.DeleteMulti(_tempSplit);
