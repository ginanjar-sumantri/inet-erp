...
namespace VTSWeb.UI.Customer
{
    public partial class Customer : CustomerBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._CustomerBL.RowsCount(this.CompanyDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._CustomerBL.GetList(_prmCurrentPage, _maxrow, this.CompanyDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                _viewButton.ImageUrl = "http://" + Request.ServerVariables["HTTP_HOST"] + Request.ApplicationPath + ApplicationConfig.StringSeparatorPublish + "images/view.jpg";
                ...
                Literal _CompanyTypeNameLiteral = (Literal)e.Item.FindControl("CompanyTypeNameLiteral");
                _CompanyTypeNameLiteral.Text = HttpUtility.HtmlEncode(_temp.CustType);

                Literal _Address1Literal = (Literal)e.Item.FindControl("Address1Literal");
                _Address1Literal.Text = HttpUtility.HtmlEncode(_temp.Address1);
                ...
                Literal _PhoneLiteralLiteral = (Literal)e.Item.FindControl("PhoneLiteral");
                _PhoneLiteralLiteral.Text = HttpUtility.HtmlEncode(_temp.Phone);
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._CustomerBL.DeleteMulti(_tempSplit);
