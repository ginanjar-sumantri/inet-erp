<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeFile="PurposeAdd.aspx.cs" Inherits="VTSWeb.UI.PurposeAdd" %>
            ...
            <td>
                <table cellpadding="3" cellspacing="0" width="0" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="PurposeNamaTextBox" Width="250" MaxLength="100"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="PurposeNamaRequiredFieldValidator" runat="server"
                                ErrorMessage="Purpose Name Must Be Filled" Text="*" ControlToValidate="PurposeNamaTextBox"
                                Display="Dynamic"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr valign="top">
