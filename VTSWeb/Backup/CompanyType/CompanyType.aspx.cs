...
namespace VTSWeb.UI
{
    public partial class CompanyType : CompanyTypeBase
    {
        private MsCustTypeBL _MsCustTypeBL = new MsCustTypeBL();
        ...
        private double RowCount()
        {
            ...
            _result = this._MsCustTypeBL.RowsCount(this.CustTypeDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._MsCustTypeBL.GetList(_prmCurrentPage, _maxrow, this.CustTypeDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Literal _CompanyTypeCodeLiteral = (Literal)e.Item.FindControl("CompanyTypeCodeLiteral");
                _CompanyTypeCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.CustTypeCode);

                Literal _CompanyTypeNameLiteral = (Literal)e.Item.FindControl("CompanyTypeNameLiteral");
                _CompanyTypeNameLiteral.Text = HttpUtility.HtmlEncode(_temp.CustTypeName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._MsCustTypeBL.DeleteMulti(_tempSplit);
