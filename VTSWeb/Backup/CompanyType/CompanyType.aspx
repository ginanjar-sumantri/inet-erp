<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeFile="CompanyType.aspx.cs" Inherits="VTSWeb.UI.CompanyType" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="CustTypeDropDownList" runat="server">
                                    <asp:ListItem Value="CustTypeCode" Text="Comapany Type Code"></asp:ListItem>
                                    <asp:ListItem Value="CustTypeName" Text="Comapany Type Name"></asp:ListItem>
                ...
                <table cellpadding="3" cellspacing="1" width="0" border="0">
                    <tr class="bgcolor_gray">
                        ...
                        <td style="width: 200px" class="tahoma_11_white" align="center">
                            <b>Company Type Code</b>
                        </td>
                        <td style="width: 200px" class="tahoma_11_white" align="center">
                            <b>Company Type Name</b>
                        </td>
                    </tr>
                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                        <ItemTemplate>
                            <tr id="RepeaterItemTemplate" runat="server">
                                ...
                                <td align="left">
                                    <asp:Literal runat="server" ID="CompanyTypeCodeLiteral"></asp:Literal>
                                </td>
                                <td align="left">
                                    <asp:Literal runat="server" ID="CompanyTypeNameLiteral"></asp:Literal>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
