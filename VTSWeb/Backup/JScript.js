...
function secondsToDateTime(secs, _prmIncreaseTime) {
    var _result = "";
    ...
    if (_days == 0) {
        _result = padleft(hours, '0', 2) + " : " + padleft(minutes, '0', 2) + " : " + padleft(seconds, '0', 2);
    }
    else {
        _result = _days + "h " + padleft(hours, '0', 2) + " : " + padleft(minutes, '0', 2) + " : " + padleft(seconds, '0', 2);
    }

    if (_prmIncreaseTime == 1) {
        _result = _result;
    }
...
function AskYouFirst() {
    ...
    if (confirm("Anda yakin untuk menghapus data ini?") == true) {
        _result = true;
    }
    else {
        _result = false;
...
function AskYouFirstToBuy() {
    var _result = false;

    if (confirm("Anda yakin untuk membeli bid ini?") == true) {
        _result = true;
    }
    else {
        _result = false;
...
function AskYouFirstToSend() {
    var _result = false;

    if (confirm("Anda yakin untuk menyimpan data ini?") == true) {
        _result = true;
    }
    else {
        _result = false;
...
function AskYouFirstToSave(_prmHiddenField) {
    if (confirm("Anda yakin ingin menyimpan data ini?") == true) {
