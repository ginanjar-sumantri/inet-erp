<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeFile="City.aspx.cs" Inherits="VTSWeb.UI.City" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="CityDropDownList" runat="server">
                                    <asp:ListItem Value="CityCode" Text="City Code"></asp:ListItem>
                                    <asp:ListItem Value="CityName" Text="City Name"></asp:ListItem>
                    ...
                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                        <ItemTemplate>
                            <tr id="RepeaterItemTemplate" runat="server">
                                ...
                                <td align="left">
                                    <asp:Literal runat="server" ID="RegionalLiteral"></asp:Literal>
                                </td>
                                <td align="left">
