...
namespace VTSWeb.UI
{
    public partial class City : CityBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._CityBL.RowsCount(this.CityDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._CityBL.GetList(_prmCurrentPage, _maxrow,this.CityDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Literal _cityCodeLiteral = (Literal)e.Item.FindControl("CityCodeLiteral");
                _cityCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.CityCode);

                Literal _cityNameLiteral = (Literal)e.Item.FindControl("CityNameLiteral");
                _cityNameLiteral.Text = HttpUtility.HtmlEncode(_temp.CityName);

                Literal _regionalLiteral = (Literal)e.Item.FindControl("RegionalLiteral");
                _regionalLiteral.Text = HttpUtility.HtmlEncode(_temp.Regional);

                Literal _countryLiteral = (Literal)e.Item.FindControl("CountryLiteral");
                _countryLiteral.Text = HttpUtility.HtmlEncode(_temp.Country);
            }
        }
