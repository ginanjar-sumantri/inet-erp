<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeFile="RackServer.aspx.cs" Inherits="VTSWeb.UI.RackServer" %>
                ...
                <asp:Panel ID="Panel2" DefaultButton="GoImageButton" runat="server">
                    <table cellpadding="0" cellspacing="2" border="0">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="RackServerDropDownList" runat="server">
                                    <asp:ListItem Value="RackCode" Text="RackServer Code"></asp:ListItem>
                                    <asp:ListItem Value="RackName" Text="RackServer Name"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>
                    ...
                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                        <ItemTemplate>
                            <tr id="RepeaterItemTemplate" runat="server">
                                ...
                                <td align="left">
                                    <asp:Literal runat="server" ID="RackCodeLiteral"></asp:Literal>
                                </td>
                                <td align="left">
                                    <asp:Literal runat="server" ID="RackNameLiteral"></asp:Literal>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
