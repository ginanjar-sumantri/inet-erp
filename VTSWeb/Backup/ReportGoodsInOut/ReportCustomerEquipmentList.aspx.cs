...
namespace VTSWeb.UI
{
    public partial class ReportCustomerEquipmentList : ReportBase
    {
        ...
        private String _reportPath0 = "Report/CustomerEquipmentList.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.PageTitleLiteral.Text = this._pageTitleLiteralPageCustomerEquipmentList;
        ...
        protected void ViewImageButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportClearanceBL.ReportCustomerEquipmentList((this.CustomerDDL.SelectedValue == "All") ? "" : this.CustomerDDL.SelectedValue);
