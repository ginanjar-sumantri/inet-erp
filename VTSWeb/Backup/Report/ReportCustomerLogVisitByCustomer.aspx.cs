...
namespace VTSWeb.UI
{
    public partial class ReportCustomerLogVisitByCustomer : ReportBase
    {
        ...
        private String _reportPath0 = "Report/CustomerLogVisitByCust.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.PageTitleLiteral.Text = this._pageTitleLiteralCustomer;
        ...
        protected void ViewImageButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportClearanceBL.ReportCustomerLogVisitByCustomer((this.CustomerDDL.SelectedValue == "All") ? "" : this.CustomerDDL.SelectedValue);
            ...
            _reportParam[2] = new ReportParameter("ParamTitle", "Customer Log Visit By Customer", true);
