...
namespace VTSWeb.UI
{
    public partial class ReportCustomerLogVisitByDate : ReportBase
    {
        ...
        private String _reportPath0 = "Report/CustomerLogVisitByDate.rdlc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.PageTitleLiteral.Text = this._pageTitleLiteralCustomerLogVisitByDate;
        ...
        protected void ViewButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            ReportDataSource _reportDataSource1 = this._reportClearanceBL.ReportCustomerLogVisitByDate(Convert.ToDateTime(this.StartDateTextBox.Text), Convert.ToDateTime(this.EndDateTextBox.Text), this.StartNameTextBox.Text, this.EndNameTextBox.Text);
            ...
            //_reportParam[5] = new ReportParameter("ParamTitle", "Customer Log Visit By Date", true);
