...
namespace VTSWeb.UI
{
    public partial class RackCustomer : RackCustomerBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._rackCustomerBL.RowsCount(this.CompanyDropDownList.SelectedValue);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._rackCustomerBL.GetList(_prmCurrentPage, _maxrow, this.CompanyDropDownList.SelectedValue);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsRack_Customer _temp = (MsRack_Customer)e.Item.DataItem;
                string _code = _temp.RackCustomerCode.ToString();
                ...
                Literal _areaNameLiteral = (Literal)e.Item.FindControl("RackNameLiteral");
                _areaNameLiteral.Text = HttpUtility.HtmlEncode(_temp.RackName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._rackCustomerBL.DeleteMulti(_tempSplit);
