...
namespace VTSWeb.UI
{
    public partial class Area : AreaBase
    {
        ...
        private double RowCount()
        {
            ...
            _result = this._areaBL.RowsCount(this.AreaDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        private void ShowData(Int32 _prmCurrentPage)
        {
            ...
            this.ListRepeater.DataSource = this._areaBL.GetList(_prmCurrentPage, _maxrow, this.AreaDropDownList.SelectedValue, this.KeywordTextBox.Text);
        ...
        protected void ListRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                MsArea _temp = (MsArea)e.Item.DataItem;
                ...
                Literal _AreaCodeLiteral = (Literal)e.Item.FindControl("AreaCodeLiteral");
                _AreaCodeLiteral.Text = HttpUtility.HtmlEncode(_temp.AreaCode);

                Literal _AreaNamaLiteral = (Literal)e.Item.FindControl("AreaNamaLiteral");
                _AreaNamaLiteral.Text = HttpUtility.HtmlEncode(_temp.AreaName);
            }
        }
        ...
        protected void DeleteButton_Click(object sender, ImageClickEventArgs e)
        {
            ...
            bool _result = this._areaBL.DeleteMulti(_tempSplit);
