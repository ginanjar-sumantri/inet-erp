<%@ Page Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="AreaAdd.aspx.cs"
    Inherits="VTSWeb.UI.MsAreaAdd" %>
                ...
                <table cellpadding="3" cellspacing="0" width="0" border="0">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="AreaCodeRequiredFieldValidator" runat="server" ErrorMessage="Area Code Must Be Filled"
                                Text="*" ControlToValidate="AreaCodeTextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
