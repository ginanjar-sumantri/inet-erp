<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeFile="Clearance.aspx.cs" Inherits="VTSWeb.UI.Clearance" %>
                ...
                <asp:Panel ID="Panel2" DefaultButton="GoImageButton" runat="server">
                    <table cellpadding="0" cellspacing="2" border="0">
                        <tr>
                            ...
                            <td>&nbsp;
                                <asp:ImageButton ID="GoImageButton" runat="server" AutoPostBack="true" OnClick="GoImageButton_Click" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                    ...
                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                        <ItemTemplate>
                            <tr id="RepeaterItemTemplate" runat="server">
                                ...
                                <td align="left">
                                    <asp:Literal runat="server" ID="ClearanceCodeLiteral"></asp:Literal>
                                </td>
                                <td align="left">
                                    <asp:Literal runat="server" ID="ClearanceDateLiteral"></asp:Literal>
                                </td>
                                <td align="left">
                                    <asp:Literal runat="server" ID="CommpanyLiteral"></asp:Literal>
                                </td>
                                <td align="left">
                                    <asp:Literal runat="server" ID="VisitorLiteral"></asp:Literal>
                                </td>
                                <td align="left">
