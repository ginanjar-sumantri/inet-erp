<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeFile="CustContactEdit.aspx.cs" Inherits="VTSWeb.UI.CustContactEdit" %>
            ...
            <td>
                <table cellpadding="3" cellspacing="0" width="0" border="0">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="CustNameTextBox" runat="server" Width="150"> </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                        ...
                        <td width="120">
                            <asp:TextBox ID="ItemTextBox" runat="server" Width="100"> </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="EmailTextBox" runat="server" Width="300"></asp:TextBox><%--<asp:RegularExpressionValidator ID="EmailRegularExpressionValidator" runat="server"
