<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeFile="Country.aspx.cs" Inherits="VTSWeb.UI.Country" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="CountryDropDownList" runat="server">
                                    <asp:ListItem Value="CountryCode" Text="Country Code"></asp:ListItem>
                                    <asp:ListItem Value="CountryName" Text="Country Name"></asp:ListItem>
                    ...
                    <asp:Repeater runat="server" ID="ListRepeater" OnItemDataBound="ListRepeater_ItemDataBound">
                        <ItemTemplate>
                            <tr id="RepeaterItemTemplate" runat="server">
                                ...
                                <td align="left">
                                    <asp:Literal runat="server" ID="CountryCodeLiteral"></asp:Literal>
                                </td>
                                <td align="left">
