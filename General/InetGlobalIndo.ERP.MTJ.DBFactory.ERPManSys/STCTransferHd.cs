...
{
    public partial class STCTransferHd
    {
        private string _wrhsSrcName = "";
        private string _wrhsDestName = "";

        public STCTransferHd(string _prmTransNmbr, string _prmFileNmbr, DateTime _prmTransDate, char _prmStatus, string _prmWrhsArea, string _prmWrhsSrc, string _prmWrhsSrcName, string _prmWrhsDest, string _prmWrhsDestName)
        {
