...
{
    public partial class FINARPosting
    {
        public FINARPosting(string _prmInvoiceNo, DateTime _prmInvoiceDate, string _prmCustCode,
            string _prmCurrCode, decimal _prmForexRate, decimal _prmOriginalRate, string _prmCustNo,
        ...
        public FINARPosting(string _prmInvoiceNo)
        {
            this.InvoiceNo = _prmInvoiceNo;
        }

        public FINARPosting(string _prmInvoiceNo, string _prmFileNmbr)
        {
            this.InvoiceNo = _prmInvoiceNo;
