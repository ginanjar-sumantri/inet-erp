...
{
    public partial class POSTrPhotocopyDt
    {
        public POSTrPhotocopyDt(String _prmTransNmbr, int _prmItemNo, String _prmProductCode,
            Int32 _prmQty, String _prmUnit, Decimal _prmUnitPriceForex, Decimal _prmAmountForex,
        ...
        public POSTrPhotocopyDt(String _prmProductCode, Int32 _prmQty, Decimal _prmAmountForex, 
