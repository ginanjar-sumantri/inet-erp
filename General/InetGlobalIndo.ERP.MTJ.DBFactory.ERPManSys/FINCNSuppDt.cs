...
{
    public partial class FINCNSuppDt
    {
        private string _accountName = "";
        private string _unitName = "";
        private string _subledName = "";

        public FINCNSuppDt(int _prmItemNo, string _prmAccount, string _prmAccountName, decimal _prmAmountForex, string _prmSubled, string _prmSubledName, decimal _prmPriceForex, decimal _prmQty, string _prmUnit, string _prmUnitName, string _prmRemark)
        {
