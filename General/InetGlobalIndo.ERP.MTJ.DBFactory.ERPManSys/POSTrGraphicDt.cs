...
{
    public partial class POSTrGraphicDt
    {
        public POSTrGraphicDt(String _prmTransNmbr, int _prmItemNo, String _prmProductCode,
        ...
        public POSTrGraphicDt(String _prmProductCode, Int32 _prmQty, Decimal _prmAmountForex, 
