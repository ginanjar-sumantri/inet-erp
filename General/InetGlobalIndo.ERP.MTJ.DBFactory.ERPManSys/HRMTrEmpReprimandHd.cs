...
{
    public partial class HRMTrEmpReprimandHd
    {
        private string _orgUnitName = "";

        public HRMTrEmpReprimandHd(String _prmTransNmbr, String _prmFileNmbr, char _prmStatus, DateTime _prmTransDate,
        ...
        public HRMTrEmpReprimandHd(String _prmTransNmbr, String _prmFileNmbr)
        {
            this.TransNmbr = _prmTransNmbr;
            this.FileNmbr = _prmFileNmbr;
        }
