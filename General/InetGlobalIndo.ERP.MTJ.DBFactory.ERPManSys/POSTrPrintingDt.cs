...
{
    public partial class POSTrPrintingDt
    {
        public POSTrPrintingDt(String _prmTransNmbr, int _prmItemNo, String _prmProductCode,
        ...
        public POSTrPrintingDt(String _prmProductCode, Int32 _prmQty, Decimal _prmAmountForex, 
