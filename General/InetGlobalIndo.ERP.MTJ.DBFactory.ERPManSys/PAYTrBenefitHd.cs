...
{
    public partial class PAYTrBenefitHd
    {
        private string _orgUnitName = "";

        public PAYTrBenefitHd(string _prmTransNmbr, String _prmFileNmbr, char _prmStatus, DateTime _prmTransDate,
        ...
        public PAYTrBenefitHd(string _prmTransNmbr, String _prmFileNmbr)
        {
            this.TransNmbr = _prmTransNmbr;
            this.FileNmbr = _prmFileNmbr;
        }
