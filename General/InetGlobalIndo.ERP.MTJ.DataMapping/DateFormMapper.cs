...
{
    public static class DateFormMapper
    {
        private static DateForm _dateForm = DateFormMapper.GetFormat(ApplicationConfig.DateForm);
        ...
        public static String GetFormat()
        {
            ...
            switch (_dateForm)
            {
                case DateForm.SQL:
                    _result = "yyyy-mm-dd";
                    break;
                case DateForm.English:
                    _result = "mm-dd-yyyy";
                    break;
                case DateForm.Indonesian:
                    _result = "dd-mm-yyyy";
                    break;
            }
        ...
        public static String GetValue(DateTime? _prmValue)
        {
            ...
            if (_prmValue != null)
            {
                _result = DateFormMapper.GetValue((DateTime)_prmValue);
            }
